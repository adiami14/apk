...
.method private final create-RetOiIg(Ljava/lang/String;Landroidx/compose/ui/text/font/FontWeight;I)Landroid/graphics/Typeface;
    ...
    invoke-virtual {v0, p1, p2, p0}, Landroidx/compose/ui/text/platform/TypefaceAdapterHelperMethods;->create(Landroid/graphics/Typeface;IZ)Landroid/graphics/Typeface;
...
.method private final create-xC2X5gM(ILandroidx/compose/ui/text/font/FontWeight;Landroidx/compose/ui/text/font/FontListFontFamily;I)Landroid/graphics/Typeface;
    ...
    iget-object p0, p0, Landroidx/compose/ui/text/platform/TypefaceAdapter;->resourceLoader:Landroidx/compose/ui/text/font/Font$ResourceLoader;

    invoke-interface {p0, v3}, Landroidx/compose/ui/text/font/Font$ResourceLoader;->load(Landroidx/compose/ui/text/font/Font;)Ljava/lang/Object;
    ...
    :cond_0
    instance-of p0, v3, Landroidx/compose/ui/text/font/AndroidFont;

    if-eqz p0, :cond_4

    move-object p0, v3

    check-cast p0, Landroidx/compose/ui/text/font/AndroidFont;

    invoke-interface {p0}, Landroidx/compose/ui/text/font/AndroidFont;->getTypeface()Landroid/graphics/Typeface;
    ...
    invoke-static {p1, p0}, Landroidx/compose/ui/text/font/FontStyle;->equals-impl0(II)Z
    ...
    :goto_2
    sget-object p3, Landroidx/compose/ui/text/font/FontSynthesis;->Companion:Landroidx/compose/ui/text/font/FontSynthesis$Companion;

    invoke-virtual {p3}, Landroidx/compose/ui/text/font/FontSynthesis$Companion;->getNone-GVVA2EU()I

    move-result p3

    invoke-static {p4, p3}, Landroidx/compose/ui/text/font/FontSynthesis;->equals-impl0(II)Z
...
.method public create-DPcqOEQ(Landroidx/compose/ui/text/font/FontFamily;Landroidx/compose/ui/text/font/FontWeight;II)Landroid/graphics/Typeface;
    ...
    invoke-interface {p0, p2, p3, p4}, Landroidx/compose/ui/text/platform/AndroidTypeface;->getNativeTypeface-PYhJU0U(Landroidx/compose/ui/text/font/FontWeight;II)Landroid/graphics/Typeface;
...
.method public final getFontMatcher()Landroidx/compose/ui/text/font/FontMatcher;
    ...
    iget-object p0, p0, Landroidx/compose/ui/text/platform/TypefaceAdapter;->fontMatcher:Landroidx/compose/ui/text/font/FontMatcher;
