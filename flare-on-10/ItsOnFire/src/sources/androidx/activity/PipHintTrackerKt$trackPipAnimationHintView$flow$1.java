...
/* loaded from: ItsOnFire.jar:androidx/activity/PipHintTrackerKt$trackPipAnimationHintView$flow$1.class */
public final class PipHintTrackerKt$trackPipAnimationHintView$flow$1 extends SuspendLambda implements Function2<g0<? super Rect>, Continuation<? super Unit>, Object> {
    ...
    /* JADX WARN: Type inference failed for: r0v10, types: [androidx.activity.PipHintTrackerKt$trackPipAnimationHintView$flow$1$attachStateChangeListener$1, android.view.View$OnAttachStateChangeListener] */
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @Nullable
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i2 == 0) {
            ...
            final ?? r0 = new View.OnAttachStateChangeListener() { // from class: androidx.activity.PipHintTrackerKt$trackPipAnimationHintView$flow$1$attachStateChangeListener$1
            ...
            this.$view.addOnAttachStateChangeListener(r0);
            ...
            this.label = 1;
            if (e0.a(g0Var, function0, this) == coroutine_suspended) {
