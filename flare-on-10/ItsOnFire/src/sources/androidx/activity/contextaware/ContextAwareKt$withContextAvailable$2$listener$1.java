...
/* loaded from: ItsOnFire.jar:androidx/activity/contextaware/ContextAwareKt$withContextAvailable$2$listener$1.class */
public final class ContextAwareKt$withContextAvailable$2$listener$1 implements OnContextAvailableListener {
    ...
    public void onContextAvailable(@NotNull Context context) {
        ...
        try {
            ...
            m5849constructorimpl = Result.m5849constructorimpl(function1.invoke(context));
        } catch (Throwable th) {
