...
/* loaded from: ItsOnFire.jar:androidx/activity/result/ActivityResultCallerLauncher.class */
            ...
            public final AnonymousClass1 invoke() {
                ...
                return new ActivityResultContract<Unit, O>() { // from class: androidx.activity.result.ActivityResultCallerLauncher$resultContract$2.1
                    ...
                    public O parseResult(int i3, @Nullable Intent intent) {
                        return (O) activityResultCallerLauncher.getCallerContract().parseResult(i3, intent);
                    }
                };
            }
        });
