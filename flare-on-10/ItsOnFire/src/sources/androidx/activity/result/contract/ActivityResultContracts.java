...
/* loaded from: ItsOnFire.jar:androidx/activity/result/contract/ActivityResultContracts.class */
public final class ActivityResultContracts {

    /* loaded from: ItsOnFire.jar:androidx/activity/result/contract/ActivityResultContracts$CaptureVideo.class */
    ...
    @RequiresApi(19)
    /* loaded from: ItsOnFire.jar:androidx/activity/result/contract/ActivityResultContracts$CreateDocument.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/activity/result/contract/ActivityResultContracts$GetContent.class */
    ...
    @RequiresApi(18)
    /* loaded from: ItsOnFire.jar:androidx/activity/result/contract/ActivityResultContracts$GetMultipleContents.class */
    ...
    @RequiresApi(19)
    /* loaded from: ItsOnFire.jar:androidx/activity/result/contract/ActivityResultContracts$OpenDocument.class */
    ...
    @RequiresApi(21)
    /* loaded from: ItsOnFire.jar:androidx/activity/result/contract/ActivityResultContracts$OpenDocumentTree.class */
    ...
    @RequiresApi(19)
    /* loaded from: ItsOnFire.jar:androidx/activity/result/contract/ActivityResultContracts$OpenMultipleDocuments.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/activity/result/contract/ActivityResultContracts$PickContact.class */
    public static final class PickContact extends ActivityResultContract<Void, Uri> {
        @Override // androidx.activity.result.contract.ActivityResultContract
        @NonNull
        public Intent createIntent(@NonNull Context context, @Nullable Void r6) {
    ...
    /* loaded from: ItsOnFire.jar:androidx/activity/result/contract/ActivityResultContracts$RequestMultiplePermissions.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/activity/result/contract/ActivityResultContracts$RequestPermission.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/activity/result/contract/ActivityResultContracts$StartActivityForResult.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/activity/result/contract/ActivityResultContracts$StartIntentSenderForResult.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/activity/result/contract/ActivityResultContracts$TakePicture.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/activity/result/contract/ActivityResultContracts$TakePicturePreview.class */
    public static class TakePicturePreview extends ActivityResultContract<Void, Bitmap> {
        ...
        @Override // androidx.activity.result.contract.ActivityResultContract
        @Nullable
        public final ActivityResultContract.SynchronousResult<Bitmap> getSynchronousResult(@NonNull Context context, @Nullable Void r4) {
            return null;
        }
    ...
    @Deprecated
    /* loaded from: ItsOnFire.jar:androidx/activity/result/contract/ActivityResultContracts$TakeVideo.class */
