...
/* loaded from: ItsOnFire.jar:androidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat.class */
public class AnimatedStateListDrawableCompat extends StateListDrawable implements TintAwareDrawable {
    ...
    /* loaded from: ItsOnFire.jar:androidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat$AnimatableTransition.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState.class */
    public static class AnimatedStateListState extends StateListDrawable.StateListState {
        ...
        public int getKeyframeIdAt(int i2) {
            return i2 < 0 ? 0 : this.mStateIds.get(i2, 0).intValue();
        }
        ...
        public void mutate() {
            this.mTransitions = this.mTransitions.m78clone();
            this.mStateIds = this.mStateIds.m80clone();
        }
    ...
    /* loaded from: ItsOnFire.jar:androidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedVectorDrawableTransition.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat$AnimationDrawableTransition.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat$FrameInterpolator.class */
    public static class FrameInterpolator implements TimeInterpolator {
        ...
        public float getInterpolation(float f2) {
            int i2;
            int i3 = (int) ((f2 * this.mTotalDuration) + 0.5f);
            int i4 = this.mFrames;
            int[] iArr = this.mFrameTimes;
            int i5 = 0;
            while (i5 < i4 && i3 >= (i2 = iArr[i5])) {
                i3 -= i2;
                i5++;
            }
            return (i5 / i4) + (i5 < i4 ? i3 / this.mTotalDuration : 0.0f);
        }
    ...
    /* loaded from: ItsOnFire.jar:androidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat$Transition.class */
