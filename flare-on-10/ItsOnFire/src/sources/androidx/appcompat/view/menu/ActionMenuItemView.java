...
/* loaded from: ItsOnFire.jar:androidx/appcompat/view/menu/ActionMenuItemView.class */
public class ActionMenuItemView extends AppCompatTextView implements MenuView.ItemView, View.OnClickListener, ActionMenuView.ActionMenuChildView {
    ...
    /* loaded from: ItsOnFire.jar:androidx/appcompat/view/menu/ActionMenuItemView$ActionMenuItemForwardingListener.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/appcompat/view/menu/ActionMenuItemView$PopupCallback.class */
    ...
    private void updateTextButtonVisibility() {
        ...
        if (TextUtils.isEmpty(contentDescription)) {
            charSequence = z2 ? null : this.mItemData.getTitle();
        }
