...
/* loaded from: ItsOnFire.jar:androidx/appcompat/view/menu/CascadingMenuPopup.class */
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, View.OnKeyListener, PopupWindow.OnDismissListener {
    ...
    private final MenuItemHoverListener mMenuItemHoverListener = new MenuItemHoverListener() { // from class: androidx.appcompat.view.menu.CascadingMenuPopup.3
        ...
        public void onItemHoverEnter(@NonNull final MenuBuilder menuBuilder, @NonNull final MenuItem menuItem) {
            ...
            CascadingMenuPopup.this.mSubMenuHoverHandler.postAtTime(new Runnable() { // from class: androidx.appcompat.view.menu.CascadingMenuPopup.3.1
                ...
                public void run() {
                    CascadingMenuInfo cascadingMenuInfo3 = cascadingMenuInfo2;
                    if (cascadingMenuInfo3 != null) {
                        CascadingMenuPopup.this.mShouldCloseImmediately = true;
                        cascadingMenuInfo3.menu.close(false);
    ...
    /* loaded from: ItsOnFire.jar:androidx/appcompat/view/menu/CascadingMenuPopup$CascadingMenuInfo.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/appcompat/view/menu/CascadingMenuPopup$HorizPosition.class */
