...
/* loaded from: ItsOnFire.jar:androidx/appcompat/view/menu/MenuBuilder.class */
public class MenuBuilder implements SupportMenu {
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    /* loaded from: ItsOnFire.jar:androidx/appcompat/view/menu/MenuBuilder$Callback.class */
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    /* loaded from: ItsOnFire.jar:androidx/appcompat/view/menu/MenuBuilder$ItemInvoker.class */
    ...
    public int findGroupIndex(int i2, int i3) {
        ...
        while (i4 < size) {
            if (this.mItems.get(i4).getGroupId() == i2) {
                return i4;
            }
            i4++;
        }
    ...
    public void removeGroup(int i2) {
        ...
        if (findGroupIndex >= 0) {
            int size = this.mItems.size();
            for (int i3 = 0; i3 < size - findGroupIndex && this.mItems.get(findGroupIndex).getGroupId() == i2; i3++) {
