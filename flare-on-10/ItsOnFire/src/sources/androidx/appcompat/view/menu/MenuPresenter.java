...
/* loaded from: ItsOnFire.jar:androidx/appcompat/view/menu/MenuPresenter.class */
public interface MenuPresenter {

    /* loaded from: ItsOnFire.jar:androidx/appcompat/view/menu/MenuPresenter$Callback.class */
