...
/* loaded from: ItsOnFire.jar:androidx/appcompat/view/menu/StandardMenuPopup.class */
final class StandardMenuPopup extends MenuPopup implements PopupWindow.OnDismissListener, AdapterView.OnItemClickListener, MenuPresenter, View.OnKeyListener {
    ...
    public boolean onSubMenuSelected(SubMenuBuilder subMenuBuilder) {
        if (subMenuBuilder.hasVisibleItems()) {
            ...
            int i2 = horizontalOffset;
            if ((Gravity.getAbsoluteGravity(this.mDropDownGravity, ViewCompat.getLayoutDirection(this.mAnchorView)) & 7) == 5) {
                i2 = horizontalOffset + this.mAnchorView.getWidth();
            }
            if (menuPopupHelper.tryShow(i2, verticalOffset)) {
                MenuPresenter.Callback callback = this.mPresenterCallback;
                if (callback != null) {
