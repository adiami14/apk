...
/* loaded from: ItsOnFire.jar:androidx/appcompat/widget/ActionBarOverlayLayout.class */
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent, NestedScrollingParent2, NestedScrollingParent3 {
    ...
    /* loaded from: ItsOnFire.jar:androidx/appcompat/widget/ActionBarOverlayLayout$ActionBarVisibilityCallback.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/appcompat/widget/ActionBarOverlayLayout$LayoutParams.class */
    ...
    */
    private boolean applyInsets(@androidx.annotation.NonNull android.view.View r4, @androidx.annotation.NonNull android.graphics.Rect r5, boolean r6, boolean r7, boolean r8, boolean r9) {
        /*
            r3 = this;
            r0 = r4
        ...
        if (z) {
            ...
            if (this.mHasNonEmbeddedTabs) {
                ...
                if (this.mActionBarTop.getTabContainer() != null) {
                    measuredHeight = i4 + this.mActionBarHeight;
                }
            }
        } else {
    ...
    public void onWindowSystemUiVisibilityChanged(int i2) {
        ...
        if (((i3 ^ i2) & 256) == 0 || this.mActionBarVisibilityCallback == null) {
            return;
        }
        ViewCompat.requestApplyInsets(this);
    }
