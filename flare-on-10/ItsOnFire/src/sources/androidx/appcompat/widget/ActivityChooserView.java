...
/* loaded from: ItsOnFire.jar:androidx/appcompat/widget/ActivityChooserView.class */
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    /* loaded from: ItsOnFire.jar:androidx/appcompat/widget/ActivityChooserView$ActivityChooserViewAdapter.class */
    public class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public int getCount() {
            ...
            int min = Math.min(i2, this.mMaxActivityCount);
            int i3 = min;
    ...
    /* loaded from: ItsOnFire.jar:androidx/appcompat/widget/ActivityChooserView$Callbacks.class */
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    /* loaded from: ItsOnFire.jar:androidx/appcompat/widget/ActivityChooserView$InnerLayout.class */
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (this.mDefaultActivityButton.getVisibility() != 0) {
            i4 = View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i3), 1073741824);
        }
    ...
    public void showPopupUnchecked(int i2) {
        ...
        if (i2 == Integer.MAX_VALUE || activityCount <= i2 + z) {
