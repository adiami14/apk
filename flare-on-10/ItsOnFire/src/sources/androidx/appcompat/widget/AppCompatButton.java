...
/* loaded from: ItsOnFire.jar:androidx/appcompat/widget/AppCompatButton.class */
public class AppCompatButton extends Button implements TintableBackgroundView, AutoSizeableTextView, TintableCompoundDrawablesView, EmojiCompatConfigurationView {
    ...
    /* loaded from: ItsOnFire.jar:androidx/appcompat/widget/AppCompatButton$InspectionCompanion.class */
