...
/* loaded from: ItsOnFire.jar:androidx/appcompat/widget/AppCompatRadioButton.class */
public class AppCompatRadioButton extends RadioButton implements TintableCompoundButton, TintableBackgroundView, EmojiCompatConfigurationView {
    ...
    /* loaded from: ItsOnFire.jar:androidx/appcompat/widget/AppCompatRadioButton$InspectionCompanion.class */
    ...
    public int getCompoundPaddingLeft() {
        ...
        if (appCompatCompoundButtonHelper != null) {
            i2 = appCompatCompoundButtonHelper.getCompoundPaddingLeft(compoundPaddingLeft);
        }
        return i2;
    }
