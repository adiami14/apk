...
/* loaded from: ItsOnFire.jar:androidx/appcompat/widget/AppCompatTextHelper.class */
class AppCompatTextHelper {
    ...
    private void updateTypefaceAndStyle(Context context, TintTypedArray tintTypedArray) {
            ...
            try {
                Typeface font = tintTypedArray.getFont(i3, this.mStyle, new ResourcesCompat.FontCallback() { // from class: androidx.appcompat.widget.AppCompatTextHelper.1
                    ...
                    public void onFontRetrieved(@NonNull Typeface typeface2) {
                        ...
                        if (i9 != -1) {
                            typeface3 = Typeface.create(typeface2, i9, (i8 & 2) != 0);
                        }
                        AppCompatTextHelper.this.onAsyncTypefaceReceived(weakReference, typeface3);
                    }
                });
                if (font != null) {
                    Typeface typeface2 = font;
                    if (this.mFontWeight != -1) {
                        typeface2 = Typeface.create(Typeface.create(font, 0), this.mFontWeight, (this.mStyle & 2) != 0);
                    }
        ...
        if (this.mFontWeight != -1) {
            ...
            create = Typeface.create(create2, i9, z);
        } else {
