...
/* loaded from: ItsOnFire.jar:androidx/appcompat/widget/AppCompatTextViewAutoSizeHelper.class */
public class AppCompatTextViewAutoSizeHelper {
    ...
    /* loaded from: ItsOnFire.jar:androidx/appcompat/widget/AppCompatTextViewAutoSizeHelper$Impl.class */
    ...
    @RequiresApi(23)
    /* loaded from: ItsOnFire.jar:androidx/appcompat/widget/AppCompatTextViewAutoSizeHelper$Impl23.class */
    ...
    @RequiresApi(29)
    /* loaded from: ItsOnFire.jar:androidx/appcompat/widget/AppCompatTextViewAutoSizeHelper$Impl29.class */
    ...
    public static <T> T invokeAndReturnWithDefault(@NonNull Object obj, @NonNull String str, @NonNull T t2) {
        try {
            t2 = getTextViewMethod(str).invoke(obj, new Object[0]);
        } catch (Exception e2) {
