...
/* loaded from: ItsOnFire.jar:androidx/appcompat/widget/ButtonBarLayout.class */
        ...
        if (nextVisibleChildIndex >= 0) {
            ...
            if (isStacked()) {
                ...
                if (nextVisibleChildIndex2 >= 0) {
                    i5 = paddingTop + getChildAt(nextVisibleChildIndex2).getPaddingTop() + ((int) (getResources().getDisplayMetrics().density * 16.0f));
                }
            } else {
