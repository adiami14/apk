...
/* loaded from: ItsOnFire.jar:androidx/appcompat/widget/LinearLayoutCompat.class */
public class LinearLayoutCompat extends ViewGroup {
    ...
    /* loaded from: ItsOnFire.jar:androidx/appcompat/widget/LinearLayoutCompat$DividerMode.class */
    public @interface DividerMode {
    }

    @RequiresApi(29)
    @RestrictTo({RestrictTo.Scope.LIBRARY})
    /* loaded from: ItsOnFire.jar:androidx/appcompat/widget/LinearLayoutCompat$InspectionCompanion.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/appcompat/widget/LinearLayoutCompat$LayoutParams.class */
    ...
    @Retention(RetentionPolicy.SOURCE)
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    /* loaded from: ItsOnFire.jar:androidx/appcompat/widget/LinearLayoutCompat$OrientationMode.class */
    ...
    public int getBaseline() {
        ...
        if (childCount > i2) {
            ...
            if (this.mOrientation == 1) {
                int i5 = this.mGravity & R.styleable.AppCompatTheme_toolbarNavigationButtonStyle;
                i4 = i3;
                if (i5 != 48) {
                    i4 = i5 != 16 ? i5 != 80 ? i3 : ((getBottom() - getTop()) - getPaddingBottom()) - this.mTotalLength : i3 + (((((getBottom() - getTop()) - getPaddingTop()) - getPaddingBottom()) - this.mTotalLength) / 2);
                }
            }
    ...
    public void layoutHorizontal(int i2, int i3, int i4, int i5) {
        ...
        while (i12 < virtualChildCount) {
            ...
            if (virtualChildAt == null) {
                ...
                LayoutParams layoutParams = (LayoutParams) virtualChildAt.getLayoutParams();
                int baseline = (!z || ((LinearLayout.LayoutParams) layoutParams).height == -1) ? -1 : virtualChildAt.getBaseline();
                ...
                if (i16 == 16) {
                    i8 = ((((((i9 - paddingTop) - paddingBottom2) - measuredHeight) / 2) + paddingTop) + ((LinearLayout.LayoutParams) layoutParams).topMargin) - ((LinearLayout.LayoutParams) layoutParams).bottomMargin;
                } else if (i16 == 48) {
                    int i17 = ((LinearLayout.LayoutParams) layoutParams).topMargin + paddingTop;
                    i8 = i17;
                    if (baseline != -1) {
                    ...
                    int i18 = ((i9 - paddingBottom) - measuredHeight) - ((LinearLayout.LayoutParams) layoutParams).bottomMargin;
                    i8 = i18;
                    if (baseline != -1) {
                        i8 = i18 - (iArr2[2] - (virtualChildAt.getMeasuredHeight() - baseline));
                    }
                }
                int i19 = paddingLeft;
                if (hasDividerBeforeChildAt(i13)) {
                    i19 = paddingLeft + this.mDividerWidth;
                }
                int i20 = ((LinearLayout.LayoutParams) layoutParams).leftMargin + i19;
                setChildFrame(virtualChildAt, i20 + getLocationOffset(virtualChildAt), i8, measuredWidth, measuredHeight);
                int i21 = ((LinearLayout.LayoutParams) layoutParams).rightMargin;
                int nextLocationOffset = getNextLocationOffset(virtualChildAt);
                i12 += getChildrenSkipCount(virtualChildAt, i13);
                paddingLeft = i20 + measuredWidth + i21 + nextLocationOffset;
            }
            i12++;
        }
    }
