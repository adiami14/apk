...
/* loaded from: ItsOnFire.jar:androidx/appcompat/widget/MenuPopupWindow.class */
public class MenuPopupWindow extends ListPopupWindow implements MenuItemHoverListener {
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    /* loaded from: ItsOnFire.jar:androidx/appcompat/widget/MenuPopupWindow$MenuDropDownListView.class */
    public static class MenuDropDownListView extends DropDownListView {
        ...
        public boolean onKeyDown(int i2, KeyEvent keyEvent) {
            ...
            if (listMenuItemView != null && i2 == this.mAdvanceKey) {
                ...
                ((MenuAdapter) listAdapter).getAdapterMenu().close(false);
                return true;
            }
        }
