...
/* loaded from: ItsOnFire.jar:androidx/appcompat/widget/SwitchCompat.class */
public class SwitchCompat extends CompoundButton implements EmojiCompatConfigurationView {
    ...
    /* loaded from: ItsOnFire.jar:androidx/appcompat/widget/SwitchCompat$EmojiCompatInitCallback.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/appcompat/widget/SwitchCompat$InspectionCompanion.class */
    ...
    private boolean hitThumb(float f2, float f3) {
        ...
        int i4 = (this.mSwitchLeft + thumbOffset) - this.mTouchSlop;
    ...
    public void draw(Canvas canvas) {
        ...
        if (drawable2 != null) {
            ...
            if (opticalBounds != null) {
                ...
                if (i19 > i20) {
                    i6 = i14;
                    i3 = i9 - (i19 - i20);
                    this.mTrackDrawable.setBounds(i6, i4, i5, i3);
                    i10 = i12;
                }
            } else {
                i2 = i7;
        ...
        if (drawable3 != null) {
            ...
            int i22 = i10 + this.mThumbWidth + rect.right;
            this.mThumbDrawable.setBounds(i21, i7, i22, i9);
            Drawable background = getBackground();
            if (background != null) {
                DrawableCompat.setHotspotBounds(background, i21, i7, i22, i9);
            }
        }
        super.draw(canvas);
    }
    ...
    public int getCompoundPaddingLeft() {
        if (ViewUtils.isLayoutRtl(this)) {
            ...
            if (!TextUtils.isEmpty(getText())) {
                i2 = compoundPaddingLeft + this.mSwitchPadding;
            }
            return i2;
        }
    ...
    public int getCompoundPaddingRight() {
        ...
        if (!TextUtils.isEmpty(getText())) {
            i2 = compoundPaddingRight + this.mSwitchPadding;
        }
        return i2;
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (layout != null) {
            ...
            canvas.translate((width / 2) - (layout.getWidth() / 2), (((i2 + i4) + (i3 - i5)) / 2) - (layout.getHeight() / 2));
            layout.draw(canvas);
        }
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (drawable3 != null) {
            ...
            i10 = Math.max(i7, opticalBounds.left);
            i9 = Math.max(i8, opticalBounds.right);
        }
        int max = Math.max(this.mSwitchMinWidth, (this.mThumbWidth * 2) + i10 + i9);
