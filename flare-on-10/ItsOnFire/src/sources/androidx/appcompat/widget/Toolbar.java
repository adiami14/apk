...
/* loaded from: ItsOnFire.jar:androidx/appcompat/widget/Toolbar.class */
public class Toolbar extends ViewGroup implements MenuHost {
    ...
    /* loaded from: ItsOnFire.jar:androidx/appcompat/widget/Toolbar$ExpandedActionViewMenuPresenter.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/appcompat/widget/Toolbar$InspectionCompanion.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/appcompat/widget/Toolbar$LayoutParams.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/appcompat/widget/Toolbar$OnMenuItemClickListener.class */
    public interface OnMenuItemClickListener {
        boolean onMenuItemClick(MenuItem menuItem);
    }

    /* loaded from: ItsOnFire.jar:androidx/appcompat/widget/Toolbar$SavedState.class */
    ...
    public Toolbar(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        int dimensionPixelOffset2 = obtainStyledAttributes.hasValue(i3) ? obtainStyledAttributes.getDimensionPixelOffset(i3, dimensionPixelOffset) : dimensionPixelOffset;
    ...
    private void measureChildConstrained(View view, int i2, int i3, int i4, int i5, int i6) {
        ...
        int i7 = childMeasureSpec2;
        if (mode != 1073741824) {
            i7 = childMeasureSpec2;
            if (i6 >= 0) {
                int i8 = i6;
                if (mode != 0) {
                    i8 = Math.min(View.MeasureSpec.getSize(childMeasureSpec2), i6);
                }
    ...
    /* JADX WARN: Removed duplicated region for block: B:123:0x0548 A[LOOP:0: B:121:0x0542->B:123:0x0548, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:127:0x057d A[LOOP:1: B:125:0x0577->B:127:0x057d, LOOP_END] */
    ...
    */
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (shouldLayout(this.mCollapseButtonView)) {
            ...
            i11 = Math.max(i5, this.mCollapseButtonView.getMeasuredHeight() + getVerticalMargins(this.mCollapseButtonView));
            i12 = View.combineMeasuredStates(i6, this.mCollapseButtonView.getMeasuredState());
        }
        ...
        iArr[!isLayoutRtl ? 1 : 0] = Math.max(0, currentContentInsetEnd - i7);
        int i13 = i11;
        int i14 = i12;
        int i15 = max2;
        if (shouldLayout(this.mExpandedActionView)) {
            i15 = max2 + measureChildCollapseMargins(this.mExpandedActionView, i2, max2, i3, 0, iArr);
            i13 = Math.max(i11, this.mExpandedActionView.getMeasuredHeight() + getVerticalMargins(this.mExpandedActionView));
            i14 = View.combineMeasuredStates(i12, this.mExpandedActionView.getMeasuredState());
        }
        int i16 = i13;
        int i17 = i14;
        int i18 = i15;
        if (shouldLayout(this.mLogoView)) {
            i18 = i15 + measureChildCollapseMargins(this.mLogoView, i2, i15, i3, 0, iArr);
        ...
        while (i20 < childCount) {
            ...
            if (((LayoutParams) childAt.getLayoutParams()).mViewType == 0) {
                if (shouldLayout(childAt)) {
                    i23 = i18 + measureChildCollapseMargins(childAt, i2, i18, i3, 0, iArr);
                    i21 = Math.max(i19, childAt.getMeasuredHeight() + getVerticalMargins(childAt));
        ...
        if (shouldLayout(this.mTitleTextView)) {
            measureChildCollapseMargins(this.mTitleTextView, i2, i18 + i25, i3, i24, iArr);
        ...
        if (shouldLayout(this.mSubtitleTextView)) {
            i9 = Math.max(i9, measureChildCollapseMargins(this.mSubtitleTextView, i2, i18 + i25, i3, i8 + i24, iArr));
        ...
        int paddingTop = getPaddingTop();
        int paddingBottom = getPaddingBottom();
        int resolveSizeAndState = View.resolveSizeAndState(Math.max(i18 + i9 + paddingLeft + paddingRight, getSuggestedMinimumWidth()), i2, (-16777216) & i17);
        int resolveSizeAndState2 = View.resolveSizeAndState(Math.max(max3 + paddingTop + paddingBottom, getSuggestedMinimumHeight()), i3, i17 << 16);
        if (shouldCollapse()) {
