...
/* loaded from: ItsOnFire.jar:androidx/arch/core/internal/SafeIterableMap.class */
public class SafeIterableMap<K, V> implements Iterable<Map.Entry<K, V>> {
    ...
    /* loaded from: ItsOnFire.jar:androidx/arch/core/internal/SafeIterableMap$AscendingIterator.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/arch/core/internal/SafeIterableMap$DescendingIterator.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/arch/core/internal/SafeIterableMap$Entry.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/arch/core/internal/SafeIterableMap$IteratorWithAdditions.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/arch/core/internal/SafeIterableMap$ListIterator.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/arch/core/internal/SafeIterableMap$SupportRemove.class */
    ...
    public Entry<K, V> get(K k2) {
        ...
        while (true) {
            entry = entry2;
            if (entry == null || entry.mKey.equals(k2)) {
                break;
            }
            entry2 = entry.mNext;
        }
