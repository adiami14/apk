...
/* loaded from: ItsOnFire.jar:androidx/compose/animation/ChangeSize.class */
public final class ChangeSize {
    ...
    public /* synthetic */ ChangeSize(Alignment alignment, Function1 function1, FiniteAnimationSpec finiteAnimationSpec, boolean z, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(alignment, (i2 & 2) != 0 ? new Function1<IntSize, IntSize>() { // from class: androidx.compose.animation.ChangeSize.1
            ...
            public /* bridge */ /* synthetic */ IntSize invoke(IntSize intSize) {
                return IntSize.m4943boximpl(m130invokemzRDjE0(intSize.m4955unboximpl()));
            }

            /* renamed from: invoke-mzRDjE0  reason: not valid java name */
            public final long m130invokemzRDjE0(long j2) {
    ...
    public int hashCode() {
        ...
        int hashCode3 = this.animationSpec.hashCode();
        boolean z = this.clip;
        int i2 = z ? 1 : 0;
        if (z) {
            i2 = 1;
