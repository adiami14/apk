...
/* loaded from: ItsOnFire.jar:androidx/compose/animation/FlingCalculator.class */
public final class FlingCalculator {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/animation/FlingCalculator$FlingInfo.class */
    ...
    public final float flingDistance(float f2) {
        ...
        return (float) (this.friction * this.magicPhysicalCoefficient * Math.exp((f4 / (d2 - 1.0d)) * splineDeceleration));
    }
