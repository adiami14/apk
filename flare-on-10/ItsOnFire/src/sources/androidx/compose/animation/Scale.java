...
/* loaded from: ItsOnFire.jar:androidx/compose/animation/Scale.class */
public final class Scale {
    ...
    public static /* synthetic */ Scale m196copybnNdC4k$default(Scale scale, float f2, long j2, FiniteAnimationSpec finiteAnimationSpec, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            f2 = scale.scale;
        }
        if ((i2 & 2) != 0) {
        ...
        return scale.m198copybnNdC4k(f2, j2, finiteAnimationSpec);
    }
    ...
    public final long m197component2SzJe1aQ() {
    ...
    public final Scale m198copybnNdC4k(float f2, long j2, @NotNull FiniteAnimationSpec<Float> animationSpec) {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof Scale) {
            ...
            return Intrinsics.areEqual((Object) Float.valueOf(this.scale), (Object) Float.valueOf(scale.scale)) && TransformOrigin.m2747equalsimpl0(this.transformOrigin, scale.transformOrigin) && Intrinsics.areEqual(this.animationSpec, scale.animationSpec);
        }
        return false;
    }
    ...
    public final long m199getTransformOriginSzJe1aQ() {
        return this.transformOrigin;
    }

    public int hashCode() {
        return (((Float.hashCode(this.scale) * 31) + TransformOrigin.m2750hashCodeimpl(this.transformOrigin)) * 31) + this.animationSpec.hashCode();
    }

    @NotNull
    public String toString() {
        return "Scale(scale=" + this.scale + ", transformOrigin=" + ((Object) TransformOrigin.m2751toStringimpl(this.transformOrigin)) + ", animationSpec=" + this.animationSpec + ')';
    }
}
