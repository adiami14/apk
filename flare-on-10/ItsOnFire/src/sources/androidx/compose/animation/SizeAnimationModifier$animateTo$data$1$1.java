...
/* loaded from: ItsOnFire.jar:androidx/compose/animation/SizeAnimationModifier$animateTo$data$1$1.class */
public final class SizeAnimationModifier$animateTo$data$1$1 extends SuspendLambda implements Function2<u0, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i2 == 0) {
            ...
            IntSize m4943boximpl = IntSize.m4943boximpl(this.$targetSize);
            AnimationSpec<IntSize> animSpec = this.this$0.getAnimSpec();
            this.label = 1;
            Object animateTo$default = Animatable.animateTo$default(anim, m4943boximpl, animSpec, null, null, this, 12, null);
        ...
        if (animationResult.getEndReason() == AnimationEndReason.Finished && (listener = this.this$0.getListener()) != null) {
            listener.invoke(IntSize.m4943boximpl(this.$this_apply.m208getStartSizeYbymL2g()), animationResult.getEndState().getValue());
        }
