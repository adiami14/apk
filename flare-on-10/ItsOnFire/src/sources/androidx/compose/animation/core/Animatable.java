...
/* loaded from: ItsOnFire.jar:androidx/compose/animation/core/Animatable.class */
public final class Animatable<T, V extends AnimationVector> {
    ...
    public static /* synthetic */ void updateBounds$default(Animatable animatable, Object obj, Object obj2, int i2, Object obj3) {
        T t2 = obj;
        if ((i2 & 1) != 0) {
            t2 = animatable.lowerBound;
        }
        T t3 = obj2;
        if ((i2 & 2) != 0) {
            t3 = animatable.upperBound;
        }
        animatable.updateBounds(t2, t3);
    }
    ...
    public final void updateBounds(@Nullable T t2, @Nullable T t3) {
        ...
        V invoke2 = t3 == null ? null : getTypeConverter().getConvertToVector().invoke(t3);
        V v3 = invoke2;
        if (invoke2 == null) {
            v3 = this.positiveInfinityBounds;
        }
