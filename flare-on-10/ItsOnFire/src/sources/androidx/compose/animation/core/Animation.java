...
/* loaded from: ItsOnFire.jar:androidx/compose/animation/core/Animation.class */
public interface Animation<T, V extends AnimationVector> {

    @Metadata(k = 3, mv = {1, 6, 0}, xi = androidx.appcompat.R.styleable.AppCompatTheme_checkboxStyle)
    /* loaded from: ItsOnFire.jar:androidx/compose/animation/core/Animation$DefaultImpls.class */
