...
/* loaded from: ItsOnFire.jar:androidx/compose/animation/core/AnimationSpecKt.class */
public final class AnimationSpecKt {
    ...
    public static final /* synthetic */ InfiniteRepeatableSpec infiniteRepeatable(DurationBasedAnimationSpec animation, RepeatMode repeatMode) {
        ...
        return new InfiniteRepeatableSpec(animation, repeatMode, StartOffset.m278constructorimpl$default(0, 0, 2, null), (DefaultConstructorMarker) null);
    }
    ...
    public static final <T> InfiniteRepeatableSpec<T> m235infiniteRepeatable9IiC70o(@NotNull DurationBasedAnimationSpec<T> animation, @NotNull RepeatMode repeatMode, long j2) {
        Intrinsics.checkNotNullParameter(animation, "animation");
        Intrinsics.checkNotNullParameter(repeatMode, "repeatMode");
    ...
    public static /* synthetic */ InfiniteRepeatableSpec m236infiniteRepeatable9IiC70o$default(DurationBasedAnimationSpec durationBasedAnimationSpec, RepeatMode repeatMode, long j2, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            repeatMode = RepeatMode.Restart;
        }
        if ((i2 & 4) != 0) {
            j2 = StartOffset.m278constructorimpl$default(0, 0, 2, null);
        }
        return m235infiniteRepeatable9IiC70o(durationBasedAnimationSpec, repeatMode, j2);
    }
    ...
    public static final /* synthetic */ RepeatableSpec repeatable(int i2, DurationBasedAnimationSpec animation, RepeatMode repeatMode) {
        Intrinsics.checkNotNullParameter(animation, "animation");
        Intrinsics.checkNotNullParameter(repeatMode, "repeatMode");
        return new RepeatableSpec(i2, animation, repeatMode, StartOffset.m278constructorimpl$default(0, 0, 2, null), (DefaultConstructorMarker) null);
    }
    ...
    public static final <T> RepeatableSpec<T> m237repeatable91I0pcU(int i2, @NotNull DurationBasedAnimationSpec<T> animation, @NotNull RepeatMode repeatMode, long j2) {
        Intrinsics.checkNotNullParameter(animation, "animation");
        Intrinsics.checkNotNullParameter(repeatMode, "repeatMode");
    ...
    public static /* synthetic */ RepeatableSpec m238repeatable91I0pcU$default(int i2, DurationBasedAnimationSpec durationBasedAnimationSpec, RepeatMode repeatMode, long j2, int i3, Object obj) {
        if ((i3 & 4) != 0) {
            repeatMode = RepeatMode.Restart;
        }
        if ((i3 & 8) != 0) {
        ...
        return m237repeatable91I0pcU(i2, durationBasedAnimationSpec, repeatMode, j2);
    }
