...
/* loaded from: ItsOnFire.jar:androidx/compose/animation/core/AnimationState.class */
public final class AnimationState<T, V extends AnimationVector> implements State<T> {
    ...
    public AnimationState(@NotNull TwoWayConverter<T, V> typeConverter, T t2, @Nullable V v2, long j2, long j3, boolean z) {
        ...
        AnimationVector copy = v2 == null ? null : AnimationVectorsKt.copy(v2);
        this.velocityVector = (V) (copy == null ? AnimationStateKt.createZeroVectorFrom(typeConverter, t2) : copy);
