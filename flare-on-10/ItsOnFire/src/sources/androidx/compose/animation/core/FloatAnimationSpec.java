...
/* loaded from: ItsOnFire.jar:androidx/compose/animation/core/FloatAnimationSpec.class */
public interface FloatAnimationSpec extends AnimationSpec<Float> {

    @Metadata(k = 3, mv = {1, 6, 0}, xi = androidx.appcompat.R.styleable.AppCompatTheme_checkboxStyle)
    /* loaded from: ItsOnFire.jar:androidx/compose/animation/core/FloatAnimationSpec$DefaultImpls.class */
