...
/* loaded from: ItsOnFire.jar:androidx/compose/animation/core/FloatSpringSpec.class */
public final class FloatSpringSpec implements FloatAnimationSpec {
    ...
    public float getValueFromNanos(long j2, float f2, float f3, float f4) {
        ...
        return Motion.m262getValueimpl(this.spring.m273updateValuesIJZedt4$animation_core_release(f2, f4, j2 / 1000000));
    }

    @Override // androidx.compose.animation.core.FloatAnimationSpec
    public float getVelocityFromNanos(long j2, float f2, float f3, float f4) {
        this.spring.setFinalPosition(f3);
        return Motion.m263getVelocityimpl(this.spring.m273updateValuesIJZedt4$animation_core_release(f2, f4, j2 / 1000000));
    }
