...
/* loaded from: ItsOnFire.jar:androidx/compose/animation/core/InfiniteRepeatableSpec.class */
public final class InfiniteRepeatableSpec<T> implements AnimationSpec<T> {
    ...
    public /* synthetic */ InfiniteRepeatableSpec(DurationBasedAnimationSpec animation, RepeatMode repeatMode) {
        this(animation, repeatMode, StartOffset.m278constructorimpl$default(0, 0, 2, null), (DefaultConstructorMarker) null);
    ...
    public /* synthetic */ InfiniteRepeatableSpec(DurationBasedAnimationSpec durationBasedAnimationSpec, RepeatMode repeatMode, long j2, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(durationBasedAnimationSpec, (i2 & 2) != 0 ? RepeatMode.Restart : repeatMode, (i2 & 4) != 0 ? StartOffset.m278constructorimpl$default(0, 0, 2, null) : j2, (DefaultConstructorMarker) null);
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof InfiniteRepeatableSpec) {
            ...
            if (Intrinsics.areEqual(infiniteRepeatableSpec.animation, this.animation)) {
                z = false;
                if (infiniteRepeatableSpec.repeatMode == this.repeatMode) {
                    z = false;
                    if (StartOffset.m280equalsimpl0(infiniteRepeatableSpec.m252getInitialStartOffsetRmkjzm4(), m252getInitialStartOffsetRmkjzm4())) {
                        z = true;
                    }
                }
            }
    ...
    public final long m252getInitialStartOffsetRmkjzm4() {
    ...
    public int hashCode() {
        return (((this.animation.hashCode() * 31) + this.repeatMode.hashCode()) * 31) + StartOffset.m283hashCodeimpl(m252getInitialStartOffsetRmkjzm4());
    }
    ...
    public <V extends AnimationVector> VectorizedAnimationSpec<V> vectorize(@NotNull TwoWayConverter<T, V> converter) {
        ...
        return new VectorizedInfiniteRepeatableSpec(this.animation.vectorize((TwoWayConverter) converter), this.repeatMode, m252getInitialStartOffsetRmkjzm4(), (DefaultConstructorMarker) null);
    }
}
