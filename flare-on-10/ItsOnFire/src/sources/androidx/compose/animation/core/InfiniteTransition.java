...
/* loaded from: ItsOnFire.jar:androidx/compose/animation/core/InfiniteTransition.class */
public final class InfiniteTransition {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/animation/core/InfiniteTransition$TransitionAnimationState.class */
    ...
    public final void onFrame(long j2) {
        ...
        if (size > 0) {
            ...
            int i3 = 0;
            do {
                TransitionAnimationState<?, ?> transitionAnimationState = content[i3];
                if (!transitionAnimationState.isFinished()) {
                    transitionAnimationState.onPlayTimeChanged(j2 - j3);
                }
                z = z2;
                if (!transitionAnimationState.isFinished()) {
                    z = false;
