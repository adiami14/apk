...
/* loaded from: ItsOnFire.jar:androidx/compose/animation/core/RepeatableSpec.class */
public final class RepeatableSpec<T> implements FiniteAnimationSpec<T> {
    ...
    public /* synthetic */ RepeatableSpec(int i2, DurationBasedAnimationSpec animation, RepeatMode repeatMode) {
        this(i2, animation, repeatMode, StartOffset.m278constructorimpl$default(0, 0, 2, null), (DefaultConstructorMarker) null);
    ...
    public /* synthetic */ RepeatableSpec(int i2, DurationBasedAnimationSpec durationBasedAnimationSpec, RepeatMode repeatMode, long j2, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this(i2, durationBasedAnimationSpec, (i3 & 4) != 0 ? RepeatMode.Restart : repeatMode, (i3 & 8) != 0 ? StartOffset.m278constructorimpl$default(0, 0, 2, null) : j2, (DefaultConstructorMarker) null);
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof RepeatableSpec) {
            ...
            z = false;
            if (repeatableSpec.iterations == this.iterations) {
                z = false;
                if (Intrinsics.areEqual(repeatableSpec.animation, this.animation)) {
                    z = false;
                    if (repeatableSpec.repeatMode == this.repeatMode) {
                        z = false;
                        if (StartOffset.m280equalsimpl0(repeatableSpec.m270getInitialStartOffsetRmkjzm4(), m270getInitialStartOffsetRmkjzm4())) {
                            z = true;
                        }
                    }
                }
    ...
    public final long m270getInitialStartOffsetRmkjzm4() {
    ...
    public int hashCode() {
        return (((((this.iterations * 31) + this.animation.hashCode()) * 31) + this.repeatMode.hashCode()) * 31) + StartOffset.m283hashCodeimpl(m270getInitialStartOffsetRmkjzm4());
    }
    ...
    public <V extends AnimationVector> VectorizedFiniteAnimationSpec<V> vectorize(@NotNull TwoWayConverter<T, V> converter) {
        ...
        return new VectorizedRepeatableSpec(this.iterations, this.animation.vectorize((TwoWayConverter) converter), this.repeatMode, m270getInitialStartOffsetRmkjzm4(), (DefaultConstructorMarker) null);
    }
}
