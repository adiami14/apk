...
@JvmInline
/* loaded from: ItsOnFire.jar:androidx/compose/animation/core/StartOffsetType.class */
public final class StartOffsetType {
    @NotNull
    public static final Companion Companion = new Companion(null);
    private static final int Delay = m288constructorimpl(-1);
    private static final int FastForward = m288constructorimpl(1);
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/animation/core/StartOffsetType$Companion.class */
    ...
    public static final /* synthetic */ StartOffsetType m287boximpl(int i2) {
        return new StartOffsetType(i2);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m288constructorimpl(int i2) {
        return i2;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m289equalsimpl(int i2, Object obj) {
        return (obj instanceof StartOffsetType) && i2 == ((StartOffsetType) obj).m293unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m290equalsimpl0(int i2, int i3) {
        return i2 == i3;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m291hashCodeimpl(int i2) {
        return Integer.hashCode(i2);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m292toStringimpl(int i2) {
