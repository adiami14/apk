...
/* loaded from: ItsOnFire.jar:androidx/compose/animation/core/Transition.class */
public final class Transition<S> {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/animation/core/Transition$DeferredAnimation.class */
    public final class DeferredAnimation<T, V extends AnimationVector> {
        ...
        /* loaded from: ItsOnFire.jar:androidx/compose/animation/core/Transition$DeferredAnimation$DeferredAnimationData.class */
        ...
        public final State<T> animate(@NotNull Function1<? super Segment<S>, ? extends FiniteAnimationSpec<T>> transitionSpec, @NotNull Function1<? super S, ? extends T> targetValueByState) {
            ...
            Transition<S>.DeferredAnimationData<T, V>.DeferredAnimationData<T, V> deferredAnimationData2 = deferredAnimationData;
            if (deferredAnimationData == null) {
                Transition<S> transition = this.this$0;
                deferredAnimationData2 = new DeferredAnimationData<>(this, new TransitionAnimationState(transition, targetValueByState.invoke((S) transition.getCurrentState()), AnimationStateKt.createZeroVectorFrom(this.typeConverter, targetValueByState.invoke((S) this.this$0.getCurrentState())), this.typeConverter, this.label), transitionSpec, targetValueByState);
                Transition<S> transition2 = this.this$0;
                setData$animation_core_release(deferredAnimationData2);
                transition2.addAnimation$animation_core_release(deferredAnimationData2.getAnimation());
            }
            Transition<S> transition3 = this.this$0;
            deferredAnimationData2.setTargetValueByState(targetValueByState);
            deferredAnimationData2.setTransitionSpec(transitionSpec);
            deferredAnimationData2.updateAnimationStates(transition3.getSegment());
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/animation/core/Transition$Segment.class */
    public interface Segment<S> {

        @Metadata(k = 3, mv = {1, 6, 0}, xi = androidx.appcompat.R.styleable.AppCompatTheme_checkboxStyle)
        /* loaded from: ItsOnFire.jar:androidx/compose/animation/core/Transition$Segment$DefaultImpls.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/animation/core/Transition$SegmentImpl.class */
    public static final class SegmentImpl<S> implements Segment<S> {
        ...
        public int hashCode() {
            ...
            int i2 = 0;
            int hashCode = initialState == null ? 0 : initialState.hashCode();
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/animation/core/Transition$TransitionAnimationState.class */
        ...
        this.totalDurationNanos$delegate = SnapshotStateKt.derivedStateOf(new Function0<Long>(this) { // from class: androidx.compose.animation.core.Transition$totalDurationNanos$2
            ...
            public final Long invoke() {
                ...
                while (true) {
                    ...
                    j3 = Math.max(j2, ((Transition.TransitionAnimationState) it.next()).getDurationNanos$animation_core_release());
                }
    ...
    */
    public final void animateTo$animation_core_release(final S r8, @org.jetbrains.annotations.Nullable androidx.compose.runtime.Composer r9, final int r10) {
        /*
    ...
    @Composable
    public final void updateTarget$animation_core_release(final S s2, @Nullable Composer composer, final int i2) {
        ...
        if ((i2 & androidx.appcompat.R.styleable.AppCompatTheme_toolbarNavigationButtonStyle) == 0) {
            i4 = i3 | (startRestartGroup.changed(this) ? 32 : 16);
        }
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>(this) { // from class: androidx.compose.animation.core.Transition$updateTarget$2
            ...
            public final void invoke(@Nullable Composer composer2, int i5) {
                this.$tmp0_rcvr.updateTarget$animation_core_release(s2, composer2, i2 | 1);
            }
        });
    }
}
