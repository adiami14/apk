...
/* loaded from: ItsOnFire.jar:androidx/compose/animation/core/TweenSpec.class */
public final class TweenSpec<T> implements DurationBasedAnimationSpec<T> {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof TweenSpec) {
            ...
            z = false;
            if (tweenSpec.durationMillis == this.durationMillis) {
                z = false;
                if (tweenSpec.delay == this.delay) {
                    z = false;
                    if (Intrinsics.areEqual(tweenSpec.easing, this.easing)) {
                        z = true;
                    }
                }
            }
