...
/* loaded from: ItsOnFire.jar:androidx/compose/animation/core/VectorizedDurationBasedAnimationSpec.class */
public interface VectorizedDurationBasedAnimationSpec<V extends AnimationVector> extends VectorizedFiniteAnimationSpec<V> {

    @Metadata(k = 3, mv = {1, 6, 0}, xi = androidx.appcompat.R.styleable.AppCompatTheme_checkboxStyle)
    /* loaded from: ItsOnFire.jar:androidx/compose/animation/core/VectorizedDurationBasedAnimationSpec$DefaultImpls.class */
