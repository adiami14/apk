...
/* loaded from: ItsOnFire.jar:androidx/compose/animation/core/VectorizedFiniteAnimationSpec.class */
public interface VectorizedFiniteAnimationSpec<V extends AnimationVector> extends VectorizedAnimationSpec<V> {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/animation/core/VectorizedFiniteAnimationSpec$DefaultImpls.class */
