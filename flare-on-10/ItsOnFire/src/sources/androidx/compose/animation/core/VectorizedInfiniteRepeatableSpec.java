...
/* loaded from: ItsOnFire.jar:androidx/compose/animation/core/VectorizedInfiniteRepeatableSpec.class */
public final class VectorizedInfiniteRepeatableSpec<V extends AnimationVector> implements VectorizedAnimationSpec<V> {
    ...
    public /* synthetic */ VectorizedInfiniteRepeatableSpec(VectorizedDurationBasedAnimationSpec vectorizedDurationBasedAnimationSpec, RepeatMode repeatMode, long j2, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(vectorizedDurationBasedAnimationSpec, (i2 & 2) != 0 ? RepeatMode.Restart : repeatMode, (i2 & 4) != 0 ? StartOffset.m278constructorimpl$default(0, 0, 2, null) : j2, (DefaultConstructorMarker) null);
    }
    ...
    private final V repetitionStartVelocity(long j2, V v2, V v3, V v4) {
        ...
        V v5 = v3;
        if (j2 + j3 > j4) {
            v5 = getVelocityFromNanos(j4 - j3, v2, v3, v4);
        }
        return v5;
    }
