...
/* loaded from: ItsOnFire.jar:androidx/compose/animation/core/VisibilityThresholdsKt.class */
public final class VisibilityThresholdsKt {
    ...
    static {
        ...
        Pair pair2 = TuplesKt.to(VectorConvertersKt.getVectorConverter(IntSize.Companion), valueOf2);
        Pair pair3 = TuplesKt.to(VectorConvertersKt.getVectorConverter(IntOffset.Companion), valueOf2);
        Pair pair4 = TuplesKt.to(VectorConvertersKt.getVectorConverter(FloatCompanionObject.INSTANCE), Float.valueOf(0.01f));
        Pair pair5 = TuplesKt.to(VectorConvertersKt.getVectorConverter(Rect.Companion), valueOf);
        Pair pair6 = TuplesKt.to(VectorConvertersKt.getVectorConverter(Size.Companion), valueOf);
        Pair pair7 = TuplesKt.to(VectorConvertersKt.getVectorConverter(Offset.Companion), valueOf);
        ...
        mapOf = MapsKt__MapsKt.mapOf(pair, pair2, pair3, pair4, pair5, pair6, pair7, TuplesKt.to(vectorConverter2, valueOf3), TuplesKt.to(VectorConvertersKt.getVectorConverter(DpOffset.Companion), valueOf3));
        visibilityThresholdMap = mapOf;
    }

    public static final float getVisibilityThreshold(@NotNull Dp.Companion companion) {
        Intrinsics.checkNotNullParameter(companion, "<this>");
        return Dp.m4785constructorimpl(DpVisibilityThreshold);
    }
    ...
    public static final long getVisibilityThreshold(@NotNull DpOffset.Companion companion) {
        ...
        return DpKt.m4806DpOffsetYgX7TsA(getVisibilityThreshold(companion2), getVisibilityThreshold(companion2));
    }
