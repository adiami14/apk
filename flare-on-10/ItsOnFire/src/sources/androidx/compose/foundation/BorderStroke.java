...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/BorderStroke.class */
public final class BorderStroke {
    ...
    public static /* synthetic */ BorderStroke m361copyD5KLDUw$default(BorderStroke borderStroke, float f2, Brush brush, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            f2 = borderStroke.m363getWidthD9Ej5fM();
        }
        if ((i2 & 2) != 0) {
            brush = borderStroke.brush;
        }
        return borderStroke.m362copyD5KLDUw(f2, brush);
    }

    @NotNull
    /* renamed from: copy-D5KLDUw  reason: not valid java name */
    public final BorderStroke m362copyD5KLDUw(float f2, @NotNull Brush brush) {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof BorderStroke) {
            ...
            return Dp.m4790equalsimpl0(m363getWidthD9Ej5fM(), borderStroke.m363getWidthD9Ej5fM()) && Intrinsics.areEqual(this.brush, borderStroke.brush);
        }
        return false;
    }
    ...
    public final float m363getWidthD9Ej5fM() {
        return this.width;
    }

    public int hashCode() {
        return (Dp.m4791hashCodeimpl(m363getWidthD9Ej5fM()) * 31) + this.brush.hashCode();
    }

    @NotNull
    public String toString() {
        return "BorderStroke(width=" + ((Object) Dp.m4796toStringimpl(m363getWidthD9Ej5fM())) + ", brush=" + this.brush + ')';
    }
}
