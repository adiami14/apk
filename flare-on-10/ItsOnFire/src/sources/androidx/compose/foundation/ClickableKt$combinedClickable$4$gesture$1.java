...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/ClickableKt$combinedClickable$4$gesture$1.class */
public final class ClickableKt$combinedClickable$4$gesture$1 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/foundation/ClickableKt$combinedClickable$4$gesture$1$3.class */
    public static final class AnonymousClass3 extends SuspendLambda implements Function3<PressGestureScope, Offset, Continuation<? super Unit>, Object> {
        ...
        public /* bridge */ /* synthetic */ Object invoke(PressGestureScope pressGestureScope, Offset offset, Continuation<? super Unit> continuation) {
            return m380invoked4ec7I(pressGestureScope, offset.m2177unboximpl(), continuation);
        }

        @Nullable
        /* renamed from: invoke-d-4ec7I  reason: not valid java name */
        public final Object m380invoked4ec7I(@NotNull PressGestureScope pressGestureScope, long j2, @Nullable Continuation<? super Unit> continuation) {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i2 == 0) {
                ...
                if (this.$enabled) {
                    ...
                    this.label = 1;
                    if (ClickableKt.m375handlePressInteractionEPk0efs(pressGestureScope, j2, mutableInteractionSource, mutableState, state, this) == coroutine_suspended) {
        ...
        if (i2 == 0) {
            ...
            if (this.$hasDoubleClick && this.$enabled) {
                ...
                function1 = new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.ClickableKt$combinedClickable$4$gesture$1.1
                    ...
                    public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                        m378invokek4lQ0M(offset.m2177unboximpl());
                        return Unit.INSTANCE;
                    }

                    /* renamed from: invoke-k-4lQ0M  reason: not valid java name */
                    public final void m378invokek4lQ0M(long j2) {
            ...
            if (this.$hasLongClick && this.$enabled) {
                ...
                function12 = new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.ClickableKt$combinedClickable$4$gesture$1.2
                    ...
                    @Override // kotlin.jvm.functions.Function1
                    public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                        m379invokek4lQ0M(offset.m2177unboximpl());
                        return Unit.INSTANCE;
                    }

                    /* renamed from: invoke-k-4lQ0M  reason: not valid java name */
                    public final void m379invokek4lQ0M(long j2) {
            ...
            Function1<Offset, Unit> function13 = new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.ClickableKt$combinedClickable$4$gesture$1.4
                ...
                @Override // kotlin.jvm.functions.Function1
                public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                    m381invokek4lQ0M(offset.m2177unboximpl());
                    return Unit.INSTANCE;
                }

                /* renamed from: invoke-k-4lQ0M  reason: not valid java name */
                public final void m381invokek4lQ0M(long j2) {
                    if (z) {
