...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/MagnifierStyle.class */
public final class MagnifierStyle {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/foundation/MagnifierStyle$Companion.class */
    public static final class Companion {
        ...
        public final boolean isStyleSupported$foundation_release(@NotNull MagnifierStyle style, int i2) {
            ...
            if (MagnifierKt.isPlatformMagnifierSupported(i2) && !style.getFishEyeEnabled$foundation_release()) {
                z = true;
                if (!style.getUseTextDefault$foundation_release()) {
                    if (Intrinsics.areEqual(style, getDefault())) {
                        z = true;
                    } else if (i2 >= 29) {
                        z = true;
                    }
    ...
    static {
        ...
        TextDefault = new MagnifierStyle(true, magnifierStyle.m412getSizeMYxV2XQ$foundation_release(), magnifierStyle.m410getCornerRadiusD9Ej5fM$foundation_release(), magnifierStyle.m411getElevationD9Ej5fM$foundation_release(), magnifierStyle.clippingEnabled, magnifierStyle.fishEyeEnabled, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ MagnifierStyle(long j2, float f2, float f3, boolean z, boolean z2, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this((i2 & 1) != 0 ? DpSize.Companion.m4895getUnspecifiedMYxV2XQ() : j2, (i2 & 2) != 0 ? Dp.Companion.m4805getUnspecifiedD9Ej5fM() : f2, (i2 & 4) != 0 ? Dp.Companion.m4805getUnspecifiedD9Ej5fM() : f3, (i2 & 8) != 0 ? true : z, (i2 & 16) != 0 ? false : z2, (DefaultConstructorMarker) null);
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof MagnifierStyle) {
            ...
            return this.useTextDefault == magnifierStyle.useTextDefault && DpSize.m4883equalsimpl0(m412getSizeMYxV2XQ$foundation_release(), magnifierStyle.m412getSizeMYxV2XQ$foundation_release()) && Dp.m4790equalsimpl0(m410getCornerRadiusD9Ej5fM$foundation_release(), magnifierStyle.m410getCornerRadiusD9Ej5fM$foundation_release()) && Dp.m4790equalsimpl0(m411getElevationD9Ej5fM$foundation_release(), magnifierStyle.m411getElevationD9Ej5fM$foundation_release()) && this.clippingEnabled == magnifierStyle.clippingEnabled && this.fishEyeEnabled == magnifierStyle.fishEyeEnabled;
        }
        return false;
    }
    ...
    public final float m410getCornerRadiusD9Ej5fM$foundation_release() {
        return this.cornerRadius;
    }

    /* renamed from: getElevation-D9Ej5fM$foundation_release  reason: not valid java name */
    public final float m411getElevationD9Ej5fM$foundation_release() {
    ...
    public final long m412getSizeMYxV2XQ$foundation_release() {
        return this.size;
    }
    ...
    public int hashCode() {
        return (((((((((Boolean.hashCode(this.useTextDefault) * 31) + DpSize.m4888hashCodeimpl(m412getSizeMYxV2XQ$foundation_release())) * 31) + Dp.m4791hashCodeimpl(m410getCornerRadiusD9Ej5fM$foundation_release())) * 31) + Dp.m4791hashCodeimpl(m411getElevationD9Ej5fM$foundation_release())) * 31) + Boolean.hashCode(this.clippingEnabled)) * 31) + Boolean.hashCode(this.fishEyeEnabled);
    }
    ...
    public String toString() {
        ...
        if (this.useTextDefault) {
            ...
            str = "MagnifierStyle(size=" + ((Object) DpSize.m4893toStringimpl(m412getSizeMYxV2XQ$foundation_release())) + ", cornerRadius=" + ((Object) Dp.m4796toStringimpl(m410getCornerRadiusD9Ej5fM$foundation_release())) + ", elevation=" + ((Object) Dp.m4796toStringimpl(m411getElevationD9Ej5fM$foundation_release())) + ", clippingEnabled=" + this.clippingEnabled + ", fishEyeEnabled=" + this.fishEyeEnabled + ')';
        }
        return str;
    }
}
