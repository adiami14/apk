...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/MutatorMutex$mutate$2.class */
public final class MutatorMutex$mutate$2<R> extends SuspendLambda implements Function2<u0, Continuation<? super R>, Object> {
    ...
    /* JADX WARN: Not initialized variable reg: 11, insn: 0x0182: MOVE  (r0 I:??[int, float, boolean, short, byte, char, OBJECT, ARRAY]) = (r11 I:??[int, float, boolean, short, byte, char, OBJECT, ARRAY]), block:B:38:0x0182 */
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @Nullable
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        try {
            try {
                if (i2 == 0) {
                    ...
                    if (i2 == 2) {
                        ...
                        try {
                            ...
                            a.a(atomicReference2, mutator3, null);
                            cVar4.d(null);
                            return obj;
                        } catch (Throwable th) {
                            cVar3 = cVar5;
                ...
                MutatorMutex.Mutator mutator5 = mutator;
                cVar4 = cVar3;
                obj = invoke;
                mutator3 = mutator5;
