...
@RequiresApi(28)
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/PlatformMagnifierFactoryApi28Impl.class */
public final class PlatformMagnifierFactoryApi28Impl implements PlatformMagnifierFactory {
    ...
    @RequiresApi(28)
    /* loaded from: ItsOnFire.jar:androidx/compose/foundation/PlatformMagnifierFactoryApi28Impl$PlatformMagnifierImpl.class */
    public static class PlatformMagnifierImpl implements PlatformMagnifier {
        ...
        public void mo416updateWko1d7g(long j2, long j3, float f2) {
            this.magnifier.show(Offset.m2167getXimpl(j2), Offset.m2168getYimpl(j2));
        }
