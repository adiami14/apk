...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/gestures/BringIntoViewResponder$bringIntoView$2.class */
public final class BringIntoViewResponder$bringIntoView$2 extends SuspendLambda implements Function2<u0, Continuation<? super n2>, Object> {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/foundation/gestures/BringIntoViewResponder$bringIntoView$2$1.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/foundation/gestures/BringIntoViewResponder$bringIntoView$2$2.class */
    public static final class AnonymousClass2 extends SuspendLambda implements Function2<u0, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i2 == 0) {
                ...
                androidx.compose.foundation.relocation.BringIntoViewResponder bringIntoViewResponder3 = bringIntoViewResponder;
                if (bringIntoViewResponder == null) {
                    Intrinsics.throwUninitializedPropertyAccessException("parent");
                    bringIntoViewResponder3 = null;
                }
                bringIntoViewResponder2 = this.this$0.parent;
                androidx.compose.foundation.relocation.BringIntoViewResponder bringIntoViewResponder4 = bringIntoViewResponder2;
                if (bringIntoViewResponder2 == null) {
                    Intrinsics.throwUninitializedPropertyAccessException("parent");
                    bringIntoViewResponder4 = null;
                }
                ...
                Rect localRect = bringIntoViewResponder4.toLocalRect(rect, layoutCoordinates2);
                this.label = 1;
                if (bringIntoViewResponder3.bringIntoView(localRect, this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else if (i2 != 1) {
                throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
