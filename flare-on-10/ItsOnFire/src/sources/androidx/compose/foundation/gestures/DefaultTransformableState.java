...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/gestures/DefaultTransformableState.class */
final class DefaultTransformableState implements TransformableState {
    ...
    public DefaultTransformableState(@NotNull Function3<? super Float, ? super Offset, ? super Float, Unit> onTransformation) {
        ...
        this.transformScope = new TransformScope() { // from class: androidx.compose.foundation.gestures.DefaultTransformableState$transformScope$1
            ...
            public void mo445transformByd4ec7I(float f2, long j2, float f3) {
                DefaultTransformableState.this.getOnTransformation().invoke(Float.valueOf(f2), Offset.m2156boximpl(j2), Float.valueOf(f3));
            }
        };
