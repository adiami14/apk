...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/gestures/DraggableState.class */
public interface DraggableState {

    @Metadata(k = 3, mv = {1, 6, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
    /* loaded from: ItsOnFire.jar:androidx/compose/foundation/gestures/DraggableState$DefaultImpls.class */
