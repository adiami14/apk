...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/gestures/EdgeEffectCompat.class */
public final class EdgeEffectCompat {
    ...
    public final float getDistanceCompat(@NotNull EdgeEffect edgeEffect) {
        ...
        return Build.VERSION.SDK_INT >= 31 ? Api31Impl.INSTANCE.getDistance(edgeEffect) : 0.0f;
    }
