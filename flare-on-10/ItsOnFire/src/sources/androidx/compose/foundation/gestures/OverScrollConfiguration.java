...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/gestures/OverScrollConfiguration.class */
public final class OverScrollConfiguration {
    ...
    public /* synthetic */ OverScrollConfiguration(long j2, boolean z, PaddingValues paddingValues, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this((i2 & 1) != 0 ? ColorKt.Color(4284900966L) : j2, (i2 & 2) != 0 ? false : z, (i2 & 4) != 0 ? PaddingKt.m671PaddingValuesYgX7TsA$default(0.0f, 0.0f, 3, null) : paddingValues, null);
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (Intrinsics.areEqual(OverScrollConfiguration.class, obj == null ? null : obj.getClass())) {
            if (obj != null) {
                ...
                return Color.m2415equalsimpl0(m502getGlowColor0d7_KjU(), overScrollConfiguration.m502getGlowColor0d7_KjU()) && this.forceShowAlways == overScrollConfiguration.forceShowAlways && Intrinsics.areEqual(this.drawPadding, overScrollConfiguration.drawPadding);
            }
    ...
    public final long m502getGlowColor0d7_KjU() {
        return this.glowColor;
    }

    public int hashCode() {
        return (((Color.m2421hashCodeimpl(m502getGlowColor0d7_KjU()) * 31) + Boolean.hashCode(this.forceShowAlways)) * 31) + this.drawPadding.hashCode();
    }

    @NotNull
    public String toString() {
        return "OverScrollConfiguration(glowColor=" + ((Object) Color.m2422toStringimpl(m502getGlowColor0d7_KjU())) + ", forceShowAlways=" + this.forceShowAlways + ", drawPadding=" + this.drawPadding + ')';
    }
}
