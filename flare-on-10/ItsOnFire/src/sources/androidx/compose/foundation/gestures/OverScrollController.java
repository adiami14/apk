...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/gestures/OverScrollController.class */
public interface OverScrollController {
    /* renamed from: consumePostFling-TH1AsA0 */
    void mo437consumePostFlingTH1AsA0(long j2);

    /* renamed from: consumePostScroll-l7mfB5k */
    void mo438consumePostScrolll7mfB5k(long j2, long j3, @Nullable Offset offset, int i2);

    /* renamed from: consumePreFling-AH228Gc */
    long mo439consumePreFlingAH228Gc(long j2);

    /* renamed from: consumePreScroll-A0NYTsA */
    long mo440consumePreScrollA0NYTsA(long j2, @Nullable Offset offset, int i2);

    void drawOverScroll(@NotNull DrawScope drawScope);

    /* renamed from: refreshContainerInfo-TmRCtEA */
    void mo441refreshContainerInfoTmRCtEA(long j2, boolean z);
