...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/gestures/ScrollDraggableState.class */
public final class ScrollDraggableState implements PointerAwareDraggableState, PointerAwareDragScope {
    ...
    public void dispatchRawDelta(float f2) {
        ...
        value.m539performRawScrollMKHz9U(value.m542toOffsettuRUvjQ(f2));
    }
    ...
    public void mo499dragByUv8p0NA(float f2, long j2) {
        this.scrollLogic.getValue().m537dispatchScrolliGfEq8s(getLatestScrollScope(), f2, Offset.m2156boximpl(j2), NestedScrollSource.Companion.m3700getDragWNlRxjI());
    }
