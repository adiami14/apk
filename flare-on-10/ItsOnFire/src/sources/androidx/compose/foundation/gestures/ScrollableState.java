...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/gestures/ScrollableState.class */
public interface ScrollableState {

    @Metadata(k = 3, mv = {1, 6, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
    /* loaded from: ItsOnFire.jar:androidx/compose/foundation/gestures/ScrollableState$DefaultImpls.class */
