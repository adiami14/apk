...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/gestures/TransformScope.class */
public interface TransformScope {

    @Metadata(k = 3, mv = {1, 6, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
    /* loaded from: ItsOnFire.jar:androidx/compose/foundation/gestures/TransformScope$DefaultImpls.class */
    public static final class DefaultImpls {
        /* renamed from: transformBy-d-4ec7I$default  reason: not valid java name */
        public static /* synthetic */ void m548transformByd4ec7I$default(TransformScope transformScope, float f2, long j2, float f3, int i2, Object obj) {
            if (obj != null) {
            ...
            transformScope.mo445transformByd4ec7I(f2, j2, f3);
        }
    }

    /* renamed from: transformBy-d-4ec7I */
    void mo445transformByd4ec7I(float f2, long j2, float f3);
}
