...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/gestures/TransformableState.class */
public interface TransformableState {

    @Metadata(k = 3, mv = {1, 6, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
    /* loaded from: ItsOnFire.jar:androidx/compose/foundation/gestures/TransformableState$DefaultImpls.class */
