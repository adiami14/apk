...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/gestures/TransformableStateKt.class */
public final class TransformableStateKt {
    ...
    public static final Object m549animatePanByubNVwUQ(@NotNull TransformableState transformableState, long j2, @NotNull AnimationSpec<Offset> animationSpec, @NotNull Continuation<? super Unit> continuation) {
        Object coroutine_suspended;
        Ref.LongRef longRef = new Ref.LongRef();
        longRef.element = Offset.Companion.m2183getZeroF1C5BW0();
    ...
    public static /* synthetic */ Object m550animatePanByubNVwUQ$default(TransformableState transformableState, long j2, AnimationSpec animationSpec, Continuation continuation, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            animationSpec = new SpringSpec(0.0f, 200.0f, null, 5, null);
        }
        return m549animatePanByubNVwUQ(transformableState, j2, animationSpec, continuation);
    }
    ...
    public static final Object m551panByd4ec7I(@NotNull TransformableState transformableState, long j2, @NotNull Continuation<? super Unit> continuation) {
        Object coroutine_suspended;
    ...
    public static final TransformableState rememberTransformableState(@NotNull Function3<? super Float, ? super Offset, ? super Float, Unit> onTransformation, @Nullable Composer composer, int i2) {
        ...
        final State rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(onTransformation, composer, i2 & 14);
        composer.startReplaceableGroup(-3687241);
        Object rememberedValue = composer.rememberedValue();
        TransformableState transformableState = rememberedValue;
        if (rememberedValue == Composer.Companion.getEmpty()) {
            transformableState = TransformableState(new Function3<Float, Offset, Float, Unit>() { // from class: androidx.compose.foundation.gestures.TransformableStateKt$rememberTransformableState$1$1
                ...
                public /* bridge */ /* synthetic */ Unit invoke(Float f2, Offset offset, Float f3) {
                    m552invoked4ec7I(f2.floatValue(), offset.m2177unboximpl(), f3.floatValue());
                    return Unit.INSTANCE;
                }

                /* renamed from: invoke-d-4ec7I  reason: not valid java name */
                public final void m552invoked4ec7I(float f2, long j2, float f3) {
                    rememberUpdatedState.getValue().invoke(Float.valueOf(f2), Offset.m2156boximpl(j2), Float.valueOf(f3));
                }
            });
            composer.updateRememberedValue(transformableState);
        }
        composer.endReplaceableGroup();
        TransformableState transformableState2 = (TransformableState) transformableState;
        composer.endReplaceableGroup();
        return transformableState2;
    }
