...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/interaction/FocusInteractionKt.class */
public final class FocusInteractionKt {
    ...
    public static final State<Boolean> collectIsFocusedAsState(@NotNull InteractionSource interactionSource, @Nullable Composer composer, int i2) {
        ...
        EffectsKt.LaunchedEffect(interactionSource, new FocusInteractionKt$collectIsFocusedAsState$1(interactionSource, mutableState2, null), composer, i2 & 14);
        composer.endReplaceableGroup();
