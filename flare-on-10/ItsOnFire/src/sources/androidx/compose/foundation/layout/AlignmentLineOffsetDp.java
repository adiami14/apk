...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/layout/AlignmentLineOffsetDp.class */
final class AlignmentLineOffsetDp extends InspectorValueInfo implements LayoutModifier {
    ...
    private AlignmentLineOffsetDp(AlignmentLine alignmentLine, float f2, float f3, Function1<? super InspectorInfo, Unit> function1) {
        ...
        this.before = f2;
        this.after = f3;
        if (!((m575getBeforeD9Ej5fM() >= 0.0f || Dp.m4790equalsimpl0(m575getBeforeD9Ej5fM(), Dp.Companion.m4805getUnspecifiedD9Ej5fM())) && (m574getAfterD9Ej5fM() >= 0.0f || Dp.m4790equalsimpl0(m574getAfterD9Ej5fM(), Dp.Companion.m4805getUnspecifiedD9Ej5fM())))) {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (!Intrinsics.areEqual(this.alignmentLine, alignmentLineOffsetDp.alignmentLine) || !Dp.m4790equalsimpl0(m575getBeforeD9Ej5fM(), alignmentLineOffsetDp.m575getBeforeD9Ej5fM()) || !Dp.m4790equalsimpl0(m574getAfterD9Ej5fM(), alignmentLineOffsetDp.m574getAfterD9Ej5fM())) {
            z = false;
        }
        return z;
    }
    ...
    public final float m574getAfterD9Ej5fM() {
        return this.after;
    }
    ...
    public final float m575getBeforeD9Ej5fM() {
        return this.before;
    }

    public int hashCode() {
        return (((this.alignmentLine.hashCode() * 31) + Dp.m4791hashCodeimpl(m575getBeforeD9Ej5fM())) * 31) + Dp.m4791hashCodeimpl(m574getAfterD9Ej5fM());
    }
    ...
    public MeasureResult mo105measure3p2s80s(@NotNull MeasureScope receiver, @NotNull Measurable measurable, long j2) {
        ...
        return AlignmentLineKt.m564access$alignmentLineOffsetMeasuretjqqzMA(receiver, this.alignmentLine, m575getBeforeD9Ej5fM(), m574getAfterD9Ej5fM(), measurable, j2);
    }
    ...
    public String toString() {
        return "AlignmentLineOffset(alignmentLine=" + this.alignmentLine + ", before=" + ((Object) Dp.m4796toStringimpl(m575getBeforeD9Ej5fM())) + ", after=" + ((Object) Dp.m4796toStringimpl(m574getAfterD9Ej5fM())) + ')';
    }
}
