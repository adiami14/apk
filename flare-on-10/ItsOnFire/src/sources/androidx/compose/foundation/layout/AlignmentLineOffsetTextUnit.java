...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/layout/AlignmentLineOffsetTextUnit.class */
public final class AlignmentLineOffsetTextUnit extends InspectorValueInfo implements LayoutModifier {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (!Intrinsics.areEqual(this.alignmentLine, alignmentLineOffsetTextUnit.alignmentLine) || !TextUnit.m4971equalsimpl0(m577getBeforeXSAIIZE(), alignmentLineOffsetTextUnit.m577getBeforeXSAIIZE()) || !TextUnit.m4971equalsimpl0(m576getAfterXSAIIZE(), alignmentLineOffsetTextUnit.m576getAfterXSAIIZE())) {
            z = false;
        }
        return z;
    }
    ...
    public final long m576getAfterXSAIIZE() {
        return this.after;
    }
    ...
    public final long m577getBeforeXSAIIZE() {
        return this.before;
    }

    public int hashCode() {
        return (((this.alignmentLine.hashCode() * 31) + TextUnit.m4975hashCodeimpl(m577getBeforeXSAIIZE())) * 31) + TextUnit.m4975hashCodeimpl(m576getAfterXSAIIZE());
    }
    ...
    public MeasureResult mo105measure3p2s80s(@NotNull MeasureScope receiver, @NotNull Measurable measurable, long j2) {
        MeasureResult m565alignmentLineOffsetMeasuretjqqzMA;
        Intrinsics.checkNotNullParameter(receiver, "$receiver");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        m565alignmentLineOffsetMeasuretjqqzMA = AlignmentLineKt.m565alignmentLineOffsetMeasuretjqqzMA(receiver, this.alignmentLine, !TextUnitKt.m4992isUnspecifiedR2X_6o(m577getBeforeXSAIIZE()) ? receiver.mo519toDpGaN1DYA(m577getBeforeXSAIIZE()) : Dp.Companion.m4805getUnspecifiedD9Ej5fM(), !TextUnitKt.m4992isUnspecifiedR2X_6o(m576getAfterXSAIIZE()) ? receiver.mo519toDpGaN1DYA(m576getAfterXSAIIZE()) : Dp.Companion.m4805getUnspecifiedD9Ej5fM(), measurable, j2);
        return m565alignmentLineOffsetMeasuretjqqzMA;
    }
    ...
    public String toString() {
        return "AlignmentLineOffset(alignmentLine=" + this.alignmentLine + ", before=" + ((Object) TextUnit.m4981toStringimpl(m577getBeforeXSAIIZE())) + ", after=" + ((Object) TextUnit.m4981toStringimpl(m576getAfterXSAIIZE())) + ')';
    }
}
