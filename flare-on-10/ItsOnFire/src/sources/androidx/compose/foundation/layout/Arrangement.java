...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/layout/Arrangement.class */
public final class Arrangement {
    ...
    private static final Horizontal Start = new Horizontal() { // from class: androidx.compose.foundation.layout.Arrangement$Start$1
        ...
        public float mo588getSpacingD9Ej5fM() {
            return Arrangement.Horizontal.DefaultImpls.m589getSpacingD9Ej5fM(this);
        }
    ...
    private static final Vertical Top = new Vertical() { // from class: androidx.compose.foundation.layout.Arrangement$Top$1
        ...
        /* renamed from: getSpacing-D9Ej5fM */
        public float mo588getSpacingD9Ej5fM() {
            return Arrangement.Vertical.DefaultImpls.m595getSpacingD9Ej5fM(this);
        }
    ...
    private static final HorizontalOrVertical Center = new HorizontalOrVertical() { // from class: androidx.compose.foundation.layout.Arrangement$Center$1
        private final float spacing = Dp.m4785constructorimpl(0);
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/foundation/layout/Arrangement$Absolute.class */
    public static final class Absolute {
        ...
        public final Horizontal aligned(@NotNull final Alignment.Horizontal alignment) {
            ...
            return new SpacedAligned(Dp.m4785constructorimpl(0), false, new Function2<Integer, LayoutDirection, Integer>() { // from class: androidx.compose.foundation.layout.Arrangement$Absolute$aligned$1
                {
                    super(2);
                }
                ...
                public final Integer invoke(int i2, @NotNull LayoutDirection layoutDirection) {
                    Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
                    return Integer.valueOf(Alignment.Horizontal.this.align(0, i2, layoutDirection));
                }
        ...
        public final HorizontalOrVertical m585spacedBy0680j_4(float f2) {
        ...
        public final Horizontal m586spacedByD5KLDUw(float f2, @NotNull final Alignment.Horizontal alignment) {
            Intrinsics.checkNotNullParameter(alignment, "alignment");
        ...
        @NotNull
        /* renamed from: spacedBy-D5KLDUw  reason: not valid java name */
        public final Vertical m587spacedByD5KLDUw(float f2, @NotNull final Alignment.Vertical alignment) {
            Intrinsics.checkNotNullParameter(alignment, "alignment");
            return new SpacedAligned(f2, false, new Function2<Integer, LayoutDirection, Integer>() { // from class: androidx.compose.foundation.layout.Arrangement$Absolute$spacedBy$2
                ...
                public final Integer invoke(int i2, @NotNull LayoutDirection noName_1) {
                    ...
                    return Integer.valueOf(Alignment.Vertical.this.align(0, i2));
                }
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/foundation/layout/Arrangement$Horizontal.class */
    public interface Horizontal {

        @Metadata(k = 3, mv = {1, 6, 0}, xi = androidx.appcompat.R.styleable.AppCompatTheme_checkboxStyle)
        /* loaded from: ItsOnFire.jar:androidx/compose/foundation/layout/Arrangement$Horizontal$DefaultImpls.class */
        public static final class DefaultImpls {
            /* renamed from: getSpacing-D9Ej5fM  reason: not valid java name */
            public static float m589getSpacingD9Ej5fM(@NotNull Horizontal horizontal) {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/foundation/layout/Arrangement$HorizontalOrVertical.class */
    public interface HorizontalOrVertical extends Horizontal, Vertical {

        @Metadata(k = 3, mv = {1, 6, 0}, xi = androidx.appcompat.R.styleable.AppCompatTheme_checkboxStyle)
        /* loaded from: ItsOnFire.jar:androidx/compose/foundation/layout/Arrangement$HorizontalOrVertical$DefaultImpls.class */
        public static final class DefaultImpls {
            /* renamed from: getSpacing-D9Ej5fM  reason: not valid java name */
            public static float m590getSpacingD9Ej5fM(@NotNull HorizontalOrVertical horizontalOrVertical) {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/foundation/layout/Arrangement$SpacedAligned.class */
    public static final class SpacedAligned implements HorizontalOrVertical {
        ...
        private SpacedAligned(float f2, boolean z, Function2<? super Integer, ? super LayoutDirection, Integer> function2) {
            ...
            this.spacing = m594getSpaceD9Ej5fM();
        }
        ...
        public static /* synthetic */ SpacedAligned m591copy8Feqmps$default(SpacedAligned spacedAligned, float f2, boolean z, Function2 function2, int i2, Object obj) {
            if ((i2 & 1) != 0) {
            ...
            return spacedAligned.m593copy8Feqmps(f2, z, function2);
        }
        ...
        public void arrange(@NotNull Density density, int i2, @NotNull int[] sizes, @NotNull LayoutDirection layoutDirection, @NotNull int[] outPositions) {
            ...
            int mo518roundToPx0680j_4 = density.mo518roundToPx0680j_4(m594getSpaceD9Ej5fM());
            ...
            if (!z) {
                ...
                while (true) {
                    ...
                    int min3 = Math.min(mo518roundToPx0680j_4, (i2 - min2) - i8);
                    i7++;
                    i4 = min3;
                    i6 = outPositions[i7] + i8 + min3;
                }
            } else {
                ...
                if (length2 >= 0) {
                    ...
                    while (true) {
                        int i10 = length2 - 1;
                        int i11 = sizes[length2];
                        int min4 = Math.min(i9, i2 - i11);
                        outPositions[length2] = min4;
                        min = Math.min(mo518roundToPx0680j_4, (i2 - min4) - i11);
                        i9 = outPositions[length2] + i11 + min;
                        if (i10 < 0) {
                            break;
                        }
                        length2 = i10;
            ...
            if (function2 == null || i12 >= i2) {
                return;
            }
            int intValue = function2.invoke(Integer.valueOf(i2 - i12), layoutDirection).intValue();
        ...
        public final float m592component1D9Ej5fM() {
            return this.space;
        }
        ...
        public final SpacedAligned m593copy8Feqmps(float f2, boolean z, @Nullable Function2<? super Integer, ? super LayoutDirection, Integer> function2) {
        ...
        public boolean equals(@Nullable Object obj) {
            ...
            if (obj instanceof SpacedAligned) {
                ...
                return Dp.m4790equalsimpl0(this.space, spacedAligned.space) && this.rtlMirror == spacedAligned.rtlMirror && Intrinsics.areEqual(this.alignment, spacedAligned.alignment);
            }
            return false;
        }
        ...
        public final float m594getSpaceD9Ej5fM() {
            return this.space;
        }
        ...
        public int hashCode() {
            int m4791hashCodeimpl = Dp.m4791hashCodeimpl(this.space);
            ...
            Function2<Integer, LayoutDirection, Integer> function2 = this.alignment;
            return (((m4791hashCodeimpl * 31) + i2) * 31) + (function2 == null ? 0 : function2.hashCode());
        }
        ...
        public String toString() {
            ...
            sb.append((Object) Dp.m4796toStringimpl(m594getSpaceD9Ej5fM()));
            sb.append(", ");
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/foundation/layout/Arrangement$Vertical.class */
    public interface Vertical {

        @Metadata(k = 3, mv = {1, 6, 0}, xi = androidx.appcompat.R.styleable.AppCompatTheme_checkboxStyle)
        /* loaded from: ItsOnFire.jar:androidx/compose/foundation/layout/Arrangement$Vertical$DefaultImpls.class */
        public static final class DefaultImpls {
            /* renamed from: getSpacing-D9Ej5fM  reason: not valid java name */
            public static float m595getSpacingD9Ej5fM(@NotNull Vertical vertical) {
    ...
    public final Horizontal aligned(@NotNull final Alignment.Horizontal alignment) {
        Intrinsics.checkNotNullParameter(alignment, "alignment");
        return new SpacedAligned(Dp.m4785constructorimpl(0), true, new Function2<Integer, LayoutDirection, Integer>() { // from class: androidx.compose.foundation.layout.Arrangement$aligned$1
            {
                super(2);
            }
    ...
    public final Vertical aligned(@NotNull final Alignment.Vertical alignment) {
        Intrinsics.checkNotNullParameter(alignment, "alignment");
        return new SpacedAligned(Dp.m4785constructorimpl(0), false, new Function2<Integer, LayoutDirection, Integer>() { // from class: androidx.compose.foundation.layout.Arrangement$aligned$2
            {
                super(2);
            }
    ...
    public final void placeSpaceAround$foundation_layout_release(int i2, @NotNull int[] size, @NotNull int[] outPosition, boolean z) {
        ...
        float length2 = (size.length == 0) ^ true ? (i2 - i3) / size.length : 0.0f;
        float f2 = length2 / 2;
        if (!z) {
    ...
    public final void placeSpaceBetween$foundation_layout_release(int i2, @NotNull int[] size, @NotNull int[] outPosition, boolean z) {
        ...
        float f2 = 0.0f;
        float length2 = size.length > 1 ? (i2 - i3) / (size.length - 1) : 0.0f;
        int length3 = size.length;
        if (!z) {
            int i6 = 0;
            int i7 = 0;
    ...
    public final void placeSpaceEvenly$foundation_layout_release(int i2, @NotNull int[] size, @NotNull int[] outPosition, boolean z) {
        ...
        float length2 = (i2 - i3) / (size.length + 1);
        int length3 = size.length;
        if (!z) {
            float f2 = length2;
            int i6 = 0;
    ...
    @NotNull
    /* renamed from: spacedBy-0680j_4  reason: not valid java name */
    public final HorizontalOrVertical m581spacedBy0680j_4(float f2) {
    ...
    @NotNull
    /* renamed from: spacedBy-D5KLDUw  reason: not valid java name */
    public final Horizontal m582spacedByD5KLDUw(float f2, @NotNull final Alignment.Horizontal alignment) {
        Intrinsics.checkNotNullParameter(alignment, "alignment");
    ...
    @NotNull
    /* renamed from: spacedBy-D5KLDUw  reason: not valid java name */
    public final Vertical m583spacedByD5KLDUw(float f2, @NotNull final Alignment.Vertical alignment) {
        Intrinsics.checkNotNullParameter(alignment, "alignment");
