...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/layout/BoxWithConstraintsScopeImpl.class */
final class BoxWithConstraintsScopeImpl implements BoxWithConstraintsScope, BoxScope {
    ...
    public static /* synthetic */ BoxWithConstraintsScopeImpl m617copy0kLqBqw$default(BoxWithConstraintsScopeImpl boxWithConstraintsScopeImpl, Density density, long j2, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            density = boxWithConstraintsScopeImpl.density;
        }
        if ((i2 & 2) != 0) {
            j2 = boxWithConstraintsScopeImpl.mo612getConstraintsmsEJaDk();
        }
        return boxWithConstraintsScopeImpl.m619copy0kLqBqw(density, j2);
    }
    ...
    public final long m618component2msEJaDk() {
        return mo612getConstraintsmsEJaDk();
    }

    @NotNull
    /* renamed from: copy-0kLqBqw  reason: not valid java name */
    public final BoxWithConstraintsScopeImpl m619copy0kLqBqw(@NotNull Density density, long j2) {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof BoxWithConstraintsScopeImpl) {
            ...
            return Intrinsics.areEqual(this.density, boxWithConstraintsScopeImpl.density) && Constraints.m4745equalsimpl0(mo612getConstraintsmsEJaDk(), boxWithConstraintsScopeImpl.mo612getConstraintsmsEJaDk());
        }
        return false;
    }
    ...
    public long mo612getConstraintsmsEJaDk() {
        return this.constraints;
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* renamed from: getMaxHeight-D9Ej5fM */
    public float mo613getMaxHeightD9Ej5fM() {
        return this.density.mo521toDpu2uoSUM(Constraints.m4751getMaxHeightimpl(mo612getConstraintsmsEJaDk()));
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* renamed from: getMaxWidth-D9Ej5fM */
    public float mo614getMaxWidthD9Ej5fM() {
        return this.density.mo521toDpu2uoSUM(Constraints.m4752getMaxWidthimpl(mo612getConstraintsmsEJaDk()));
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* renamed from: getMinHeight-D9Ej5fM */
    public float mo615getMinHeightD9Ej5fM() {
        return this.density.mo521toDpu2uoSUM(Constraints.m4753getMinHeightimpl(mo612getConstraintsmsEJaDk()));
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* renamed from: getMinWidth-D9Ej5fM */
    public float mo616getMinWidthD9Ej5fM() {
        return this.density.mo521toDpu2uoSUM(Constraints.m4754getMinWidthimpl(mo612getConstraintsmsEJaDk()));
    }

    public int hashCode() {
        return (this.density.hashCode() * 31) + Constraints.m4755hashCodeimpl(mo612getConstraintsmsEJaDk());
    }
    ...
    public String toString() {
        return "BoxWithConstraintsScopeImpl(density=" + this.density + ", constraints=" + ((Object) Constraints.m4757toStringimpl(mo612getConstraintsmsEJaDk())) + ')';
    }
}
