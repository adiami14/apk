...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/layout/ColumnScope.class */
public interface ColumnScope {

    @Metadata(k = 3, mv = {1, 6, 0}, xi = androidx.appcompat.R.styleable.AppCompatTheme_checkboxStyle)
    /* loaded from: ItsOnFire.jar:androidx/compose/foundation/layout/ColumnScope$DefaultImpls.class */
