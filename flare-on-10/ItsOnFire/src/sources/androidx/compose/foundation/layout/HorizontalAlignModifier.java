...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/layout/HorizontalAlignModifier.class */
public final class HorizontalAlignModifier extends InspectorValueInfo implements ParentDataModifier {
    ...
    public RowColumnParentData modifyParentData(@NotNull Density density, @Nullable Object obj) {
        ...
        rowColumnParentData2.setCrossAxisAlignment(CrossAxisAlignment.Companion.horizontal$foundation_layout_release(getHorizontal()));
