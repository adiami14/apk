...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/layout/IntrinsicSizeModifier.class */
interface IntrinsicSizeModifier extends LayoutModifier {

    @Metadata(k = 3, mv = {1, 6, 0}, xi = androidx.appcompat.R.styleable.AppCompatTheme_checkboxStyle)
    /* loaded from: ItsOnFire.jar:androidx/compose/foundation/layout/IntrinsicSizeModifier$DefaultImpls.class */
    public static final class DefaultImpls {
        ...
        public static MeasureResult m656measure3p2s80s(@NotNull IntrinsicSizeModifier intrinsicSizeModifier, @NotNull MeasureScope receiver, @NotNull Measurable measurable, long j2) {
            Intrinsics.checkNotNullParameter(intrinsicSizeModifier, "this");
            Intrinsics.checkNotNullParameter(receiver, "receiver");
            Intrinsics.checkNotNullParameter(measurable, "measurable");
            long mo655calculateContentConstraintsl58MMJ0 = intrinsicSizeModifier.mo655calculateContentConstraintsl58MMJ0(receiver, measurable, j2);
            long j3 = mo655calculateContentConstraintsl58MMJ0;
            if (intrinsicSizeModifier.getEnforceIncoming()) {
                j3 = ConstraintsKt.m4764constrainN9IONVI(j2, mo655calculateContentConstraintsl58MMJ0);
            }
            final Placeable mo3910measureBRTryo0 = measurable.mo3910measureBRTryo0(j3);
            return MeasureScope.DefaultImpls.layout$default(receiver, mo3910measureBRTryo0.getWidth(), mo3910measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.IntrinsicSizeModifier$measure$1
                {
                    super(1);
                }
                ...
                public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                    ...
                    Placeable.PlacementScope.m3963placeRelative70tqf50$default(layout, Placeable.this, IntOffset.Companion.m4917getZeronOccac(), 0.0f, 2, null);
                }
            }, 4, null);
        }
    ...
    long mo655calculateContentConstraintsl58MMJ0(@NotNull MeasureScope measureScope, @NotNull Measurable measurable, long j2);
    ...
    MeasureResult mo105measure3p2s80s(@NotNull MeasureScope measureScope, @NotNull Measurable measurable, long j2);
