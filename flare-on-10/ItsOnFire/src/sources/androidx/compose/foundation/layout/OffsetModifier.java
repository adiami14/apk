...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/layout/OffsetModifier.class */
final class OffsetModifier extends InspectorValueInfo implements LayoutModifier {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (!Dp.m4790equalsimpl0(m666getXD9Ej5fM(), offsetModifier.m666getXD9Ej5fM()) || !Dp.m4790equalsimpl0(m667getYD9Ej5fM(), offsetModifier.m667getYD9Ej5fM()) || this.rtlAware != offsetModifier.rtlAware) {
            z = false;
        }
        return z;
    }
    ...
    public int hashCode() {
        return (((Dp.m4791hashCodeimpl(m666getXD9Ej5fM()) * 31) + Dp.m4791hashCodeimpl(m667getYD9Ej5fM())) * 31) + Boolean.hashCode(this.rtlAware);
    }
    ...
    public MeasureResult mo105measure3p2s80s(@NotNull final MeasureScope receiver, @NotNull Measurable measurable, long j2) {
        ...
        return MeasureScope.DefaultImpls.layout$default(receiver, mo3910measureBRTryo0.getWidth(), mo3910measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.OffsetModifier$measure$1
            ...
            public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                ...
                boolean rtlAware = OffsetModifier.this.getRtlAware();
                Placeable placeable = mo3910measureBRTryo0;
                if (rtlAware) {
                    Placeable.PlacementScope.placeRelative$default(layout, placeable, receiver.mo518roundToPx0680j_4(OffsetModifier.this.m666getXD9Ej5fM()), receiver.mo518roundToPx0680j_4(OffsetModifier.this.m667getYD9Ej5fM()), 0.0f, 4, null);
                } else {
                    Placeable.PlacementScope.place$default(layout, placeable, receiver.mo518roundToPx0680j_4(OffsetModifier.this.m666getXD9Ej5fM()), receiver.mo518roundToPx0680j_4(OffsetModifier.this.m667getYD9Ej5fM()), 0.0f, 4, null);
                }
            }
        }, 4, null);
    }
    ...
    public String toString() {
        return "OffsetModifier(x=" + ((Object) Dp.m4796toStringimpl(m666getXD9Ej5fM())) + ", y=" + ((Object) Dp.m4796toStringimpl(m667getYD9Ej5fM())) + ", rtlAware=" + this.rtlAware + ')';
    }
}
