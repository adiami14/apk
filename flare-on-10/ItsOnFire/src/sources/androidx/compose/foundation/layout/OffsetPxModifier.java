...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/layout/OffsetPxModifier.class */
final class OffsetPxModifier extends InspectorValueInfo implements LayoutModifier {
    ...
    public MeasureResult mo105measure3p2s80s(@NotNull final MeasureScope receiver, @NotNull Measurable measurable, long j2) {
        ...
        return MeasureScope.DefaultImpls.layout$default(receiver, mo3910measureBRTryo0.getWidth(), mo3910measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.OffsetPxModifier$measure$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                ...
                long m4916unboximpl = OffsetPxModifier.this.getOffset().invoke(receiver).m4916unboximpl();
                boolean rtlAware = OffsetPxModifier.this.getRtlAware();
                Placeable placeable = mo3910measureBRTryo0;
                if (rtlAware) {
                    Placeable.PlacementScope.placeRelativeWithLayer$default(layout, placeable, IntOffset.m4907getXimpl(m4916unboximpl), IntOffset.m4908getYimpl(m4916unboximpl), 0.0f, null, 12, null);
                } else {
                    Placeable.PlacementScope.placeWithLayer$default(layout, placeable, IntOffset.m4907getXimpl(m4916unboximpl), IntOffset.m4908getYimpl(m4916unboximpl), 0.0f, null, 12, null);
                }
            }
        }, 4, null);
    }
