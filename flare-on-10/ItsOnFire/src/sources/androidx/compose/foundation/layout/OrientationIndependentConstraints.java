...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/layout/OrientationIndependentConstraints.class */
public final class OrientationIndependentConstraints {
    ...
    */
    private OrientationIndependentConstraints(long r7, androidx.compose.foundation.layout.LayoutOrientation r9) {
        /*
            r6 = this;
    ...
    public final long m668toBoxConstraintsOenEA2s(@NotNull LayoutOrientation orientation) {
        int i2;
        int i3;
        int i4;
        int i5;
