...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/layout/PaddingValues.class */
public interface PaddingValues {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/foundation/layout/PaddingValues$Absolute.class */
    public static final class Absolute implements PaddingValues {
        ...
        private static /* synthetic */ void m689getBottomD9Ej5fM$annotations() {
        }

        @Stable
        /* renamed from: getLeft-D9Ej5fM$annotations  reason: not valid java name */
        private static /* synthetic */ void m690getLeftD9Ej5fM$annotations() {
        }

        @Stable
        /* renamed from: getRight-D9Ej5fM$annotations  reason: not valid java name */
        private static /* synthetic */ void m691getRightD9Ej5fM$annotations() {
        }

        @Stable
        /* renamed from: getTop-D9Ej5fM$annotations  reason: not valid java name */
        private static /* synthetic */ void m692getTopD9Ej5fM$annotations() {
        }
        ...
        public boolean equals(@Nullable Object obj) {
            if (obj instanceof Absolute) {
                ...
                boolean z = false;
                if (Dp.m4790equalsimpl0(this.left, absolute.left)) {
                    z = false;
                    if (Dp.m4790equalsimpl0(this.top, absolute.top)) {
                        z = false;
                        if (Dp.m4790equalsimpl0(this.right, absolute.right)) {
                            z = false;
                            if (Dp.m4790equalsimpl0(this.bottom, absolute.bottom)) {
                                z = true;
                            }
                        }
                    }
        ...
        public String toString() {
            return "PaddingValues.Absolute(left=" + ((Object) Dp.m4796toStringimpl(this.left)) + ", top=" + ((Object) Dp.m4796toStringimpl(this.top)) + ", right=" + ((Object) Dp.m4796toStringimpl(this.right)) + ", bottom=" + ((Object) Dp.m4796toStringimpl(this.bottom)) + ')';
        }
    }

    /* renamed from: calculateBottomPadding-D9Ej5fM  reason: not valid java name */
    float mo685calculateBottomPaddingD9Ej5fM();

    /* renamed from: calculateLeftPadding-u2uoSUM  reason: not valid java name */
    float mo686calculateLeftPaddingu2uoSUM(@NotNull LayoutDirection layoutDirection);

    /* renamed from: calculateRightPadding-u2uoSUM  reason: not valid java name */
    float mo687calculateRightPaddingu2uoSUM(@NotNull LayoutDirection layoutDirection);

    /* renamed from: calculateTopPadding-D9Ej5fM  reason: not valid java name */
    float mo688calculateTopPaddingD9Ej5fM();
}
