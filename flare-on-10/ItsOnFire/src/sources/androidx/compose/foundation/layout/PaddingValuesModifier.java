...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/layout/PaddingValuesModifier.class */
public final class PaddingValuesModifier extends InspectorValueInfo implements LayoutModifier {
    ...
    public MeasureResult mo105measure3p2s80s(@NotNull final MeasureScope receiver, @NotNull Measurable measurable, long j2) {
        ...
        float f2 = 0;
        boolean z = false;
        if (Dp.m4784compareTo0680j_4(this.paddingValues.mo686calculateLeftPaddingu2uoSUM(receiver.getLayoutDirection()), Dp.m4785constructorimpl(f2)) >= 0) {
            z = false;
            if (Dp.m4784compareTo0680j_4(this.paddingValues.mo688calculateTopPaddingD9Ej5fM(), Dp.m4785constructorimpl(f2)) >= 0) {
                z = false;
                if (Dp.m4784compareTo0680j_4(this.paddingValues.mo687calculateRightPaddingu2uoSUM(receiver.getLayoutDirection()), Dp.m4785constructorimpl(f2)) >= 0) {
                    z = false;
                    if (Dp.m4784compareTo0680j_4(this.paddingValues.mo685calculateBottomPaddingD9Ej5fM(), Dp.m4785constructorimpl(f2)) >= 0) {
                        z = true;
                    }
                }
            }
        ...
        if (z) {
            int mo518roundToPx0680j_4 = receiver.mo518roundToPx0680j_4(this.paddingValues.mo686calculateLeftPaddingu2uoSUM(receiver.getLayoutDirection())) + receiver.mo518roundToPx0680j_4(this.paddingValues.mo687calculateRightPaddingu2uoSUM(receiver.getLayoutDirection()));
            int mo518roundToPx0680j_42 = receiver.mo518roundToPx0680j_4(this.paddingValues.mo688calculateTopPaddingD9Ej5fM()) + receiver.mo518roundToPx0680j_4(this.paddingValues.mo685calculateBottomPaddingD9Ej5fM());
            ...
            return MeasureScope.DefaultImpls.layout$default(receiver, ConstraintsKt.m4766constrainWidthK40F9xA(j2, mo3910measureBRTryo0.getWidth() + mo518roundToPx0680j_4), ConstraintsKt.m4765constrainHeightK40F9xA(j2, mo3910measureBRTryo0.getHeight() + mo518roundToPx0680j_42), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.PaddingValuesModifier$measure$2
                ...
                public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                    ...
                    Placeable.PlacementScope.place$default(layout, Placeable.this, receiver.mo518roundToPx0680j_4(this.getPaddingValues().mo686calculateLeftPaddingu2uoSUM(receiver.getLayoutDirection())), receiver.mo518roundToPx0680j_4(this.getPaddingValues().mo688calculateTopPaddingD9Ej5fM()), 0.0f, 4, null);
                }
            }, 4, null);
        }
