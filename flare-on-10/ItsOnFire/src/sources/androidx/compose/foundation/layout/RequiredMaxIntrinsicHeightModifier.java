...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/layout/RequiredMaxIntrinsicHeightModifier.class */
final class RequiredMaxIntrinsicHeightModifier implements IntrinsicSizeModifier {
    ...
    public long mo655calculateContentConstraintsl58MMJ0(@NotNull MeasureScope receiver, @NotNull Measurable measurable, long j2) {
        ...
        return Constraints.Companion.m4761fixedHeightOenEA2s(measurable.maxIntrinsicHeight(Constraints.m4752getMaxWidthimpl(j2)));
    }
