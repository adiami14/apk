...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/layout/RequiredMinIntrinsicHeightModifier.class */
final class RequiredMinIntrinsicHeightModifier implements IntrinsicSizeModifier {
    ...
    public long mo655calculateContentConstraintsl58MMJ0(@NotNull MeasureScope receiver, @NotNull Measurable measurable, long j2) {
        Intrinsics.checkNotNullParameter(receiver, "$receiver");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return Constraints.Companion.m4761fixedHeightOenEA2s(measurable.minIntrinsicHeight(Constraints.m4752getMaxWidthimpl(j2)));
    }
    ...
    public MeasureResult mo105measure3p2s80s(@NotNull MeasureScope measureScope, @NotNull Measurable measurable, long j2) {
        return IntrinsicSizeModifier.DefaultImpls.m656measure3p2s80s(this, measureScope, measurable, j2);
    }
