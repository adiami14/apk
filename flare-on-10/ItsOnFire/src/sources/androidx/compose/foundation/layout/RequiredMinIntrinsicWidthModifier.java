...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/layout/RequiredMinIntrinsicWidthModifier.class */
final class RequiredMinIntrinsicWidthModifier implements IntrinsicSizeModifier {
    ...
    public long mo655calculateContentConstraintsl58MMJ0(@NotNull MeasureScope receiver, @NotNull Measurable measurable, long j2) {
        ...
        return Constraints.Companion.m4762fixedWidthOenEA2s(measurable.minIntrinsicWidth(Constraints.m4751getMaxHeightimpl(j2)));
    }
