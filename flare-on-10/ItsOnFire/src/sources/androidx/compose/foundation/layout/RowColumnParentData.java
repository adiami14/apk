...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/layout/RowColumnParentData.class */
public final class RowColumnParentData {
    ...
    public int hashCode() {
        ...
        return (((hashCode * 31) + i2) * 31) + (crossAxisAlignment == null ? 0 : crossAxisAlignment.hashCode());
    }
