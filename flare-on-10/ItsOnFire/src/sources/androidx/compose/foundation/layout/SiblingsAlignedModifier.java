...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/layout/SiblingsAlignedModifier.class */
public abstract class SiblingsAlignedModifier extends InspectorValueInfo implements ParentDataModifier {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/foundation/layout/SiblingsAlignedModifier$WithAlignmentLine.class */
    public static final class WithAlignmentLine extends SiblingsAlignedModifier {
        ...
        public Object modifyParentData(@NotNull Density density, @Nullable Object obj) {
            ...
            RowColumnParentData rowColumnParentData2 = rowColumnParentData;
            if (rowColumnParentData == null) {
                rowColumnParentData2 = new RowColumnParentData(0.0f, false, null, 7, null);
            }
            rowColumnParentData2.setCrossAxisAlignment(CrossAxisAlignment.Companion.Relative$foundation_layout_release(new AlignmentLineProvider.Value(getAlignmentLine())));
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/foundation/layout/SiblingsAlignedModifier$WithAlignmentLineBlock.class */
    public static final class WithAlignmentLineBlock extends SiblingsAlignedModifier {
        ...
        public Object modifyParentData(@NotNull Density density, @Nullable Object obj) {
            ...
            rowColumnParentData2.setCrossAxisAlignment(CrossAxisAlignment.Companion.Relative$foundation_layout_release(new AlignmentLineProvider.Block(getBlock())));
            return rowColumnParentData2;
        }
