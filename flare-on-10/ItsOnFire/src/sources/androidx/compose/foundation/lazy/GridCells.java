...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/lazy/GridCells.class */
public abstract class GridCells {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/foundation/lazy/GridCells$Adaptive.class */
    public static final class Adaptive extends GridCells {
        ...
        public final float m747getMinSizeD9Ej5fM() {
            return this.minSize;
        }
    }
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/foundation/lazy/GridCells$Fixed.class */
