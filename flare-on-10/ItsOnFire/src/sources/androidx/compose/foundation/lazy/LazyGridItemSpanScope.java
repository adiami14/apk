...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/lazy/LazyGridItemSpanScope.class */
public interface LazyGridItemSpanScope {

    @Metadata(k = 3, mv = {1, 6, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
    /* loaded from: ItsOnFire.jar:androidx/compose/foundation/lazy/LazyGridItemSpanScope$DefaultImpls.class */
