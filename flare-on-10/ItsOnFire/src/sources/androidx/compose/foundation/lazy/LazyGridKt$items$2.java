...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/lazy/LazyGridKt$items$2.class */
public final class LazyGridKt$items$2 extends Lambda implements Function4<LazyItemScope, Integer, Composer, Integer, Unit> {
    ...
    public final void invoke(@NotNull LazyItemScope items, int i2, @Nullable Composer composer, int i3) {
        ...
        if (((i5 & 731) ^ 146) == 0 && composer.getSkipping()) {
            ...
            this.$itemContent.invoke(items, this.$items.get(i2), composer, Integer.valueOf(i5 & 14));
        }
    }
}
