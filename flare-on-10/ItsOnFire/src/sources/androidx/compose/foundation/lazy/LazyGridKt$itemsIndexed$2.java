...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/lazy/LazyGridKt$itemsIndexed$2.class */
public final class LazyGridKt$itemsIndexed$2 extends Lambda implements Function4<LazyItemScope, Integer, Composer, Integer, Unit> {
    ...
    public final void invoke(@NotNull LazyItemScope items, int i2, @Nullable Composer composer, int i3) {
        ...
        if (((i5 & 731) ^ 146) == 0 && composer.getSkipping()) {
            ...
            this.$itemContent.invoke(items, Integer.valueOf(i2), this.$items.get(i2), composer, Integer.valueOf((i5 & 14) | (i5 & R.styleable.AppCompatTheme_toolbarNavigationButtonStyle)));
        }
    }
}
