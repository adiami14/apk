...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/lazy/LazyGridKt$itemsIndexed$3$1.class */
public final class LazyGridKt$itemsIndexed$3$1 extends Lambda implements Function2<LazyGridItemSpanScope, Integer, GridItemSpan> {
    ...
    public /* bridge */ /* synthetic */ GridItemSpan invoke(LazyGridItemSpanScope lazyGridItemSpanScope, Integer num) {
        return GridItemSpan.m749boximpl(m761invokeOHRMr_U(lazyGridItemSpanScope, num.intValue()));
    }

    /* renamed from: invoke-OHRMr_U  reason: not valid java name */
    public final long m761invokeOHRMr_U(@NotNull LazyGridItemSpanScope lazyGridItemSpanScope, int i2) {
        Intrinsics.checkNotNullParameter(lazyGridItemSpanScope, "$this$null");
        return this.$spans.invoke(lazyGridItemSpanScope, Integer.valueOf(i2), this.$items[i2]).m756unboximpl();
    }
}
