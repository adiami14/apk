...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/lazy/LazyGridScope.class */
public interface LazyGridScope {

    @Metadata(k = 3, mv = {1, 6, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
    /* loaded from: ItsOnFire.jar:androidx/compose/foundation/lazy/LazyGridScope$DefaultImpls.class */
