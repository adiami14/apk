...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/lazy/LazyItemScope.class */
public interface LazyItemScope {

    @Metadata(k = 3, mv = {1, 6, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
    /* loaded from: ItsOnFire.jar:androidx/compose/foundation/lazy/LazyItemScope$DefaultImpls.class */
