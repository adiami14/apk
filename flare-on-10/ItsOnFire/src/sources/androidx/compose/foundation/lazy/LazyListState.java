...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/lazy/LazyListState.class */
public final class LazyListState implements ScrollableState {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/foundation/lazy/LazyListState$Companion.class */
    ...
    public final int m767getFirstVisibleItemIndexNonObservableAUyieIw$foundation_release() {
        return this.scrollPosition.m818getIndexAUyieIw();
    }
    ...
    public final float onScroll$foundation_release(float f2) {
        if (f2 >= 0.0f || this.canScrollForward) {
            if (f2 <= 0.0f || this.canScrollBackward) {
    ...
    public final void snapToItemIndexInternal$foundation_release(int i2, int i3) {
        this.scrollPosition.m819requestPositionNTjDD6g(DataIndex.m783constructorimpl(i2), i3);
