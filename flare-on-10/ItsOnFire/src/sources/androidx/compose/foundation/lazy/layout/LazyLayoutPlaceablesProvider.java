...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/lazy/layout/LazyLayoutPlaceablesProvider.class */
public final class LazyLayoutPlaceablesProvider {
    ...
    public final LazyLayoutPlaceable[] m773getAndMeasure0kLqBqw(int i2, long j2) {
        ...
        if (lazyLayoutPlaceableArr == null) {
            ...
            lazyLayoutPlaceableArr = new LazyLayoutPlaceable[size];
            for (int i3 = 0; i3 < size; i3++) {
                Measurable measurable = subcompose.get(i3);
                lazyLayoutPlaceableArr[i3] = new LazyLayoutPlaceable(measurable.mo3910measureBRTryo0(j2), measurable.getParentData());
            }
            this.placeablesCache.put(Integer.valueOf(i2), lazyLayoutPlaceableArr);
        }
