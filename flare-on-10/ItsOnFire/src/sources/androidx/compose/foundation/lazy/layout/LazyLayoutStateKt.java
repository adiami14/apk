...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/lazy/layout/LazyLayoutStateKt.class */
public final class LazyLayoutStateKt {
    ...
    public static final LazyLayoutState rememberLazyLayoutState(@Nullable Composer composer, int i2) {
        ...
        LazyLayoutState lazyLayoutState = rememberedValue;
        if (rememberedValue == Composer.Companion.getEmpty()) {
            lazyLayoutState = new LazyLayoutState();
            composer.updateRememberedValue(lazyLayoutState);
        }
        composer.endReplaceableGroup();
        LazyLayoutState lazyLayoutState2 = (LazyLayoutState) lazyLayoutState;
        composer.endReplaceableGroup();
        return lazyLayoutState2;
    }
}
