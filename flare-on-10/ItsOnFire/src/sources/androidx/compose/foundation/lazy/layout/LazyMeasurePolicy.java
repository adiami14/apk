...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/lazy/layout/LazyMeasurePolicy.class */
public interface LazyMeasurePolicy {
    @NotNull
    /* renamed from: measure-3p2s80s  reason: not valid java name */
    LazyLayoutMeasureResult mo778measure3p2s80s(@NotNull MeasureScope measureScope, @NotNull LazyLayoutPlaceablesProvider lazyLayoutPlaceablesProvider, long j2);
}
