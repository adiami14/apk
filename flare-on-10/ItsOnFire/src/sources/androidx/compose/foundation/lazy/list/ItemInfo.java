...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/lazy/list/ItemInfo.class */
public final class ItemInfo {
    private int index;
    private long notAnimatableDelta = IntOffset.Companion.m4917getZeronOccac();
    @NotNull
    ...
    public final long m794getNotAnimatableDeltanOccac() {
    ...
    public final void m795setNotAnimatableDeltagyyYBs(long j2) {
