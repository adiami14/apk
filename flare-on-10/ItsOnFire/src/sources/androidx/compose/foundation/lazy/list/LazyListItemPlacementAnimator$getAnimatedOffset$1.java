...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/lazy/list/LazyListItemPlacementAnimator$getAnimatedOffset$1.class */
public final class LazyListItemPlacementAnimator$getAnimatedOffset$1 extends SuspendLambda implements Function2<u0, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i2 == 0) {
            ...
            IntOffset m4898boximpl = IntOffset.m4898boximpl(this.$item.m825getTargetOffsetnOccac());
            this.label = 1;
            if (animatedOffset.snapTo(m4898boximpl, this) == coroutine_suspended) {
