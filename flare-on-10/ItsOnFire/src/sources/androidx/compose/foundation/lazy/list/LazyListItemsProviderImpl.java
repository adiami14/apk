...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/lazy/list/LazyListItemsProviderImpl.class */
public final class LazyListItemsProviderImpl implements LazyListItemsProvider {
    ...
    public Function2<Composer, Integer, Unit> mo780getContent(int i2) {
        IntervalHolder intervalForIndex = IntervalListKt.intervalForIndex(this.list, i2);
        int startIndex = intervalForIndex.getStartIndex();
        ...
        return content.invoke(value, Integer.valueOf(i2 - startIndex));
    }
    ...
    public Object getKey(int i2) {
        ...
        Object invoke = key == null ? null : key.invoke(Integer.valueOf(i2 - startIndex));
        Object obj = invoke;
        if (invoke == null) {
            obj = Lazy_androidKt.getDefaultLazyKeyFor(i2);
        }
        return obj;
    }
