...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/lazy/list/LazyListScrollPosition.class */
public final class LazyListScrollPosition {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/foundation/lazy/list/LazyListScrollPosition$Companion.class */
    public static final class Companion {
        ...
        public final int m821findLazyListIndexByKeyM1M1bNc(Object obj, int i2, LazyListItemsProvider lazyListItemsProvider) {
            Integer num;
            if (obj == null) {
                return i2;
            }
            if ((i2 >= lazyListItemsProvider.getItemsCount() || !Intrinsics.areEqual(obj, lazyListItemsProvider.getKey(i2))) && (num = lazyListItemsProvider.getKeyToIndexMap().get(obj)) != null) {
                return DataIndex.m783constructorimpl(num.intValue());
            }
            return i2;
        }
    }
    ...
    public LazyListScrollPosition(int i2, int i3) {
        ...
        this.index = DataIndex.m783constructorimpl(i2);
        this.scrollOffset = i3;
        mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Integer.valueOf(m818getIndexAUyieIw()), null, 2, null);
    ...
    private final void m817updateNTjDD6g(int i2, int i3) {
        if (!(((float) i2) >= 0.0f)) {
            throw new IllegalArgumentException(("Index should be non-negative (" + i2 + ')').toString());
        }
        if (!DataIndex.m786equalsimpl0(i2, m818getIndexAUyieIw())) {
            this.index = i2;
    ...
    public final int m818getIndexAUyieIw() {
        return this.index;
    }
    ...
    public final void m819requestPositionNTjDD6g(int i2, int i3) {
        m817updateNTjDD6g(i2, i3);
    ...
    public final void updateFromMeasureResult(@NotNull LazyListMeasureResult measureResult) {
        ...
        if (this.hadFirstNotEmptyLayout || measureResult.getTotalItemsCount() > 0) {
            ...
            if (z) {
                ...
                m817updateNTjDD6g(DataIndex.m783constructorimpl(firstVisibleItem2 == null ? 0 : firstVisibleItem2.getIndex()), firstVisibleItemScrollOffset);
                return;
            }
    ...
    public final void updateScrollPositionIfTheFirstItemWasMoved(@NotNull LazyListItemsProvider itemsProvider) {
        ...
        m817updateNTjDD6g(Companion.m821findLazyListIndexByKeyM1M1bNc(this.lastKnownFirstItemKey, m818getIndexAUyieIw(), itemsProvider), this.scrollOffset);
    }
}
