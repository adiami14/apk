...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/lazy/list/LazyListScrollingKt.class */
public final class LazyListScrollingKt {
    private static final boolean DEBUG = false;
    private static final float TargetDistance = Dp.m4785constructorimpl(2500);
    private static final float BoundDistance = Dp.m4785constructorimpl((float) ConnectionResult.DRIVE_EXTERNAL_STORAGE_REQUIRED);
