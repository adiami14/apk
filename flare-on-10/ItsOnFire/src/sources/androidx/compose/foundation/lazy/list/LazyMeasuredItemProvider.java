...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/lazy/list/LazyMeasuredItemProvider.class */
public final class LazyMeasuredItemProvider {
    ...
    private LazyMeasuredItemProvider(long j2, boolean z, LazyListItemsProvider lazyListItemsProvider, LazyLayoutPlaceablesProvider lazyLayoutPlaceablesProvider, MeasuredItemFactory measuredItemFactory) {
        ...
        this.childConstraints = ConstraintsKt.Constraints$default(0, z ? Constraints.m4752getMaxWidthimpl(j2) : Integer.MAX_VALUE, 0, z ? Integer.MAX_VALUE : Constraints.m4751getMaxHeightimpl(j2), 5, null);
    }
    ...
    public final LazyMeasuredItem m823getAndMeasureoA9DU0(int i2) {
        return this.measuredItemFactory.mo810createItem8xJyyfI(i2, this.itemsProvider.getKey(i2), this.placeablesProvider.m773getAndMeasure0kLqBqw(i2, m824getChildConstraintsmsEJaDk()));
    }

    /* renamed from: getChildConstraints-msEJaDk  reason: not valid java name */
    public final long m824getChildConstraintsmsEJaDk() {
