...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/lazy/list/MeasuredItemFactory.class */
public interface MeasuredItemFactory {
    @NotNull
    /* renamed from: createItem-8xJyyfI */
    LazyMeasuredItem mo810createItem8xJyyfI(int i2, @NotNull Object obj, @NotNull LazyLayoutPlaceable[] lazyLayoutPlaceableArr);
}
