...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/lazy/list/PlaceableInfo.class */
public final class PlaceableInfo {
    ...
    private PlaceableInfo(long j2, int i2) {
        ...
        this.size = i2;
        this.animatedOffset = new Animatable<>(IntOffset.m4898boximpl(j2), VectorConvertersKt.getVectorConverter(IntOffset.Companion), null, 4, null);
    ...
    public final long m825getTargetOffsetnOccac() {
    ...
    public final void m826setTargetOffsetgyyYBs(long j2) {
        this.targetOffset = j2;
    }
}
