...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/relocation/BringIntoViewData.class */
final class BringIntoViewData {
    ...
    public int hashCode() {
        int hashCode = this.bringRectangleOnScreenRequester.hashCode();
        int hashCode2 = this.parent.hashCode();
        LayoutCoordinates layoutCoordinates = this.layoutCoordinates;
        return (((hashCode * 31) + hashCode2) * 31) + (layoutCoordinates == null ? 0 : layoutCoordinates.hashCode());
    }
