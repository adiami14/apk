...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/relocation/BringIntoViewRequester.class */
public interface BringIntoViewRequester {

    @Metadata(k = 3, mv = {1, 6, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
    /* loaded from: ItsOnFire.jar:androidx/compose/foundation/relocation/BringIntoViewRequester$DefaultImpls.class */
