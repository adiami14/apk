...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/relocation/BringIntoViewResponder.class */
public interface BringIntoViewResponder {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/foundation/relocation/BringIntoViewResponder$Companion.class */
    public static final class Companion {
        ...
        private static final BringIntoViewResponder RootBringIntoViewResponder = new BringIntoViewResponder() { // from class: androidx.compose.foundation.relocation.BringIntoViewResponder$Companion$RootBringIntoViewResponder$1
            ...
            public Rect toLocalRect(@NotNull Rect rect, @NotNull LayoutCoordinates layoutCoordinates) {
                ...
                return RectKt.m2208Recttz77jQw(layoutCoordinates.mo3929localToRootMKHz9U(rect.m2203getTopLeftF1C5BW0()), rect.m2201getSizeNHjbRc());
            }
        };
