...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/selection/ToggleableKt$toggleableImpl$1$gestures$1.class */
public final class ToggleableKt$toggleableImpl$1$gestures$1 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/foundation/selection/ToggleableKt$toggleableImpl$1$gestures$1$1.class */
    public static final class AnonymousClass1 extends SuspendLambda implements Function3<PressGestureScope, Offset, Continuation<? super Unit>, Object> {
        ...
        public /* bridge */ /* synthetic */ Object invoke(PressGestureScope pressGestureScope, Offset offset, Continuation<? super Unit> continuation) {
            return m846invoked4ec7I(pressGestureScope, offset.m2177unboximpl(), continuation);
        }

        @Nullable
        /* renamed from: invoke-d-4ec7I  reason: not valid java name */
        public final Object m846invoked4ec7I(@NotNull PressGestureScope pressGestureScope, long j2, @Nullable Continuation<? super Unit> continuation) {
        ...
        if (i2 == 0) {
            ...
            Function1<Offset, Unit> function1 = new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.selection.ToggleableKt$toggleableImpl$1$gestures$1.2
                ...
                public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                    m847invokek4lQ0M(offset.m2177unboximpl());
                    return Unit.INSTANCE;
                }

                /* renamed from: invoke-k-4lQ0M  reason: not valid java name */
                public final void m847invokek4lQ0M(long j2) {
                    if (z) {
