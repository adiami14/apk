...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/shape/AbsoluteCutCornerShape.class */
public final class AbsoluteCutCornerShape extends CornerBasedShape {
    ...
    public Outline mo849createOutlineLjSzlW0(long j2, float f2, float f3, float f4, float f5, @NotNull LayoutDirection layoutDirection) {
        ...
        if (((f2 + f3) + f5) + f4 == 0.0f) {
            ...
            Path.moveTo(0.0f, f2);
            Path.lineTo(f2, 0.0f);
            Path.lineTo(Size.m2239getWidthimpl(j2) - f3, 0.0f);
            Path.lineTo(Size.m2239getWidthimpl(j2), f3);
            Path.lineTo(Size.m2239getWidthimpl(j2), Size.m2236getHeightimpl(j2) - f4);
            Path.lineTo(Size.m2239getWidthimpl(j2) - f4, Size.m2236getHeightimpl(j2));
            Path.lineTo(f5, Size.m2236getHeightimpl(j2));
            Path.lineTo(0.0f, Size.m2236getHeightimpl(j2) - f5);
            Path.close();
