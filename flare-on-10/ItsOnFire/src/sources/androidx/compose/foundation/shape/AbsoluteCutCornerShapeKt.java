...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/shape/AbsoluteCutCornerShapeKt.class */
public final class AbsoluteCutCornerShapeKt {
    ...
    public static final AbsoluteCutCornerShape m850AbsoluteCutCornerShape0680j_4(float f2) {
        return AbsoluteCutCornerShape(CornerSizeKt.m861CornerSize0680j_4(f2));
    }

    @NotNull
    /* renamed from: AbsoluteCutCornerShape-a9UjIt4  reason: not valid java name */
    public static final AbsoluteCutCornerShape m851AbsoluteCutCornerShapea9UjIt4(float f2, float f3, float f4, float f5) {
        return new AbsoluteCutCornerShape(CornerSizeKt.m861CornerSize0680j_4(f2), CornerSizeKt.m861CornerSize0680j_4(f3), CornerSizeKt.m861CornerSize0680j_4(f4), CornerSizeKt.m861CornerSize0680j_4(f5));
    }

    /* renamed from: AbsoluteCutCornerShape-a9UjIt4$default  reason: not valid java name */
    public static /* synthetic */ AbsoluteCutCornerShape m852AbsoluteCutCornerShapea9UjIt4$default(float f2, float f3, float f4, float f5, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return m851AbsoluteCutCornerShapea9UjIt4(f2, f3, f4, f5);
    }
}
