...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/shape/AbsoluteRoundedCornerShape.class */
public final class AbsoluteRoundedCornerShape extends CornerBasedShape {
    ...
    private final long m854toRadiusBz7bX_o(float f2) {
    ...
    public Outline mo849createOutlineLjSzlW0(long j2, float f2, float f3, float f4, float f5, @NotNull LayoutDirection layoutDirection) {
        ...
        return ((((f2 + f3) + f4) + f5) > 0.0f ? 1 : ((((f2 + f3) + f4) + f5) == 0.0f ? 0 : -1)) == 0 ? new Outline.Rectangle(SizeKt.m2260toRectuvyYCjk(j2)) : new Outline.Rounded(RoundRectKt.m2221RoundRectZAM2FJo(SizeKt.m2260toRectuvyYCjk(j2), CornerRadiusKt.CornerRadius$default(f2, 0.0f, 2, null), CornerRadiusKt.CornerRadius$default(f3, 0.0f, 2, null), CornerRadiusKt.CornerRadius$default(f4, 0.0f, 2, null), CornerRadiusKt.CornerRadius$default(f5, 0.0f, 2, null)));
    }
