...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/shape/AbsoluteRoundedCornerShapeKt.class */
public final class AbsoluteRoundedCornerShapeKt {
    ...
    public static final AbsoluteRoundedCornerShape m855AbsoluteRoundedCornerShape0680j_4(float f2) {
        return AbsoluteRoundedCornerShape(CornerSizeKt.m861CornerSize0680j_4(f2));
    }

    @NotNull
    /* renamed from: AbsoluteRoundedCornerShape-a9UjIt4  reason: not valid java name */
    public static final AbsoluteRoundedCornerShape m856AbsoluteRoundedCornerShapea9UjIt4(float f2, float f3, float f4, float f5) {
        return new AbsoluteRoundedCornerShape(CornerSizeKt.m861CornerSize0680j_4(f2), CornerSizeKt.m861CornerSize0680j_4(f3), CornerSizeKt.m861CornerSize0680j_4(f4), CornerSizeKt.m861CornerSize0680j_4(f5));
    }

    /* renamed from: AbsoluteRoundedCornerShape-a9UjIt4$default  reason: not valid java name */
    public static /* synthetic */ AbsoluteRoundedCornerShape m857AbsoluteRoundedCornerShapea9UjIt4$default(float f2, float f3, float f4, float f5, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return m856AbsoluteRoundedCornerShapea9UjIt4(f2, f3, f4, f5);
    }
}
