...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/shape/CutCornerShapeKt.class */
public final class CutCornerShapeKt {
    ...
    public static final CutCornerShape m863CutCornerShape0680j_4(float f2) {
        return CutCornerShape(CornerSizeKt.m861CornerSize0680j_4(f2));
    }

    @NotNull
    /* renamed from: CutCornerShape-a9UjIt4  reason: not valid java name */
    public static final CutCornerShape m864CutCornerShapea9UjIt4(float f2, float f3, float f4, float f5) {
        return new CutCornerShape(CornerSizeKt.m861CornerSize0680j_4(f2), CornerSizeKt.m861CornerSize0680j_4(f3), CornerSizeKt.m861CornerSize0680j_4(f4), CornerSizeKt.m861CornerSize0680j_4(f5));
    }

    /* renamed from: CutCornerShape-a9UjIt4$default  reason: not valid java name */
    public static /* synthetic */ CutCornerShape m865CutCornerShapea9UjIt4$default(float f2, float f3, float f4, float f5, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return m864CutCornerShapea9UjIt4(f2, f3, f4, f5);
    }
}
