...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/shape/DpCornerSize.class */
final class DpCornerSize implements CornerSize, InspectableValue {
    ...
    private final float m866component1D9Ej5fM() {
        return this.size;
    }

    /* renamed from: copy-0680j_4$default  reason: not valid java name */
    public static /* synthetic */ DpCornerSize m867copy0680j_4$default(DpCornerSize dpCornerSize, float f2, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            f2 = dpCornerSize.size;
        }
        return dpCornerSize.m868copy0680j_4(f2);
    }

    @NotNull
    /* renamed from: copy-0680j_4  reason: not valid java name */
    public final DpCornerSize m868copy0680j_4(float f2) {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return (obj instanceof DpCornerSize) && Dp.m4790equalsimpl0(this.size, ((DpCornerSize) obj).size);
    }
    ...
    public /* bridge */ /* synthetic */ Object getValueOverride() {
        return Dp.m4783boximpl(m869getValueOverrideD9Ej5fM());
    }

    /* renamed from: getValueOverride-D9Ej5fM  reason: not valid java name */
    public float m869getValueOverrideD9Ej5fM() {
        return this.size;
    }

    public int hashCode() {
        return Dp.m4791hashCodeimpl(this.size);
    }
    ...
    public float mo859toPxTmRCtEA(long j2, @NotNull Density density) {
        ...
        return density.mo524toPx0680j_4(this.size);
    }
