...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/shape/GenericShape.class */
public final class GenericShape implements Shape {
    ...
    public Outline mo426createOutlinePq9zytI(long j2, @NotNull LayoutDirection layoutDirection, @NotNull Density density) {
        ...
        this.builder.invoke(Path, Size.m2227boximpl(j2), layoutDirection);
        Path.close();
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return Intrinsics.areEqual(genericShape == null ? null : genericShape.builder, this.builder);
    }
