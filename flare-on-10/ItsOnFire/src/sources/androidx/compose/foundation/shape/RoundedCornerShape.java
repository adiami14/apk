...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/shape/RoundedCornerShape.class */
public final class RoundedCornerShape extends CornerBasedShape {
    ...
    public Outline mo849createOutlineLjSzlW0(long j2, float f2, float f3, float f4, float f5, @NotNull LayoutDirection layoutDirection) {
        ...
        if (((f2 + f3) + f4) + f5 == 0.0f) {
            rounded = new Outline.Rectangle(SizeKt.m2260toRectuvyYCjk(j2));
        } else {
            Rect m2260toRectuvyYCjk = SizeKt.m2260toRectuvyYCjk(j2);
            LayoutDirection layoutDirection2 = LayoutDirection.Ltr;
            long CornerRadius$default = CornerRadiusKt.CornerRadius$default(layoutDirection == layoutDirection2 ? f2 : f3, 0.0f, 2, null);
            if (layoutDirection == layoutDirection2) {
                f2 = f3;
            }
            long CornerRadius$default2 = CornerRadiusKt.CornerRadius$default(f2, 0.0f, 2, null);
            long CornerRadius$default3 = CornerRadiusKt.CornerRadius$default(layoutDirection == layoutDirection2 ? f4 : f5, 0.0f, 2, null);
            if (layoutDirection == layoutDirection2) {
                f4 = f5;
            }
            rounded = new Outline.Rounded(RoundRectKt.m2221RoundRectZAM2FJo(m2260toRectuvyYCjk, CornerRadius$default, CornerRadius$default2, CornerRadius$default3, CornerRadiusKt.CornerRadius$default(f4, 0.0f, 2, null)));
        }
        return rounded;
    }
