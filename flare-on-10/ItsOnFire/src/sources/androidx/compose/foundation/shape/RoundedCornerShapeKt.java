...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/shape/RoundedCornerShapeKt.class */
public final class RoundedCornerShapeKt {
    ...
    public static final RoundedCornerShape m873RoundedCornerShape0680j_4(float f2) {
        return RoundedCornerShape(CornerSizeKt.m861CornerSize0680j_4(f2));
    }

    @NotNull
    /* renamed from: RoundedCornerShape-a9UjIt4  reason: not valid java name */
    public static final RoundedCornerShape m874RoundedCornerShapea9UjIt4(float f2, float f3, float f4, float f5) {
        return new RoundedCornerShape(CornerSizeKt.m861CornerSize0680j_4(f2), CornerSizeKt.m861CornerSize0680j_4(f3), CornerSizeKt.m861CornerSize0680j_4(f4), CornerSizeKt.m861CornerSize0680j_4(f5));
    }

    /* renamed from: RoundedCornerShape-a9UjIt4$default  reason: not valid java name */
    public static /* synthetic */ RoundedCornerShape m875RoundedCornerShapea9UjIt4$default(float f2, float f3, float f4, float f5, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return m874RoundedCornerShapea9UjIt4(f2, f3, f4, f5);
    }
