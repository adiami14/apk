...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/text/ComposableSingletons$BasicTextFieldKt$lambda_2$1.class */
public final class ComposableSingletons$BasicTextFieldKt$lambda_2$1 extends Lambda implements Function3<Function2<? super Composer, ? super Integer, ? extends Unit>, Composer, Integer, Unit> {
    public static final ComposableSingletons$BasicTextFieldKt.lambda-2.1 INSTANCE = new ComposableSingletons$BasicTextFieldKt$lambda_2$1();

    public ComposableSingletons$BasicTextFieldKt$lambda_2$1() {
        super(3);
    }
