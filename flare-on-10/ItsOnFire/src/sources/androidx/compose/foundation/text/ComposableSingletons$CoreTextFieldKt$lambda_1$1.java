...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/text/ComposableSingletons$CoreTextFieldKt$lambda_1$1.class */
public final class ComposableSingletons$CoreTextFieldKt$lambda_1$1 extends Lambda implements Function3<Function2<? super Composer, ? super Integer, ? extends Unit>, Composer, Integer, Unit> {
    public static final ComposableSingletons$CoreTextFieldKt.lambda-1.1 INSTANCE = new ComposableSingletons$CoreTextFieldKt$lambda_1$1();

    public ComposableSingletons$CoreTextFieldKt$lambda_1$1() {
        super(3);
    }
