...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/text/HorizontalScrollLayoutModifier.class */
final class HorizontalScrollLayoutModifier implements LayoutModifier {
    ...
    public MeasureResult mo105measure3p2s80s(@NotNull final MeasureScope receiver, @NotNull Measurable measurable, long j2) {
        ...
        final Placeable mo3910measureBRTryo0 = measurable.mo3910measureBRTryo0(measurable.maxIntrinsicWidth(Constraints.m4751getMaxHeightimpl(j2)) < Constraints.m4752getMaxWidthimpl(j2) ? j2 : Constraints.m4743copyZbe2FdA$default(j2, 0, Integer.MAX_VALUE, 0, 0, 13, null));
        final int min = Math.min(mo3910measureBRTryo0.getWidth(), Constraints.m4752getMaxWidthimpl(j2));
        return MeasureScope.DefaultImpls.layout$default(receiver, min, mo3910measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.HorizontalScrollLayoutModifier$measure$1
            ...
            public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                ...
                this.getScrollerPosition().update(Orientation.Horizontal, TextFieldScrollKt.access$getCursorRectInScroller(measureScope, cursorOffset, transformedText, invoke == null ? null : invoke.getValue(), MeasureScope.this.getLayoutDirection() == LayoutDirection.Rtl, mo3910measureBRTryo0.getWidth()), min, mo3910measureBRTryo0.getWidth());
