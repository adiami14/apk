...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/text/TextFieldDelegate.class */
public final class TextFieldDelegate {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/foundation/text/TextFieldDelegate$Companion.class */
    public static final class Companion {
        ...
        public static /* synthetic */ Triple m976layout_EkL_Y$foundation_release$default(Companion companion, TextDelegate textDelegate, long j2, LayoutDirection layoutDirection, TextLayoutResult textLayoutResult, int i2, Object obj) {
            if ((i2 & 8) != 0) {
                textLayoutResult = null;
            }
            return companion.m978layout_EkL_Y$foundation_release(textDelegate, j2, layoutDirection, textLayoutResult);
        }
        ...
        public final TransformedText m977applyCompositionDecoration72CqOWE(long j2, @NotNull TransformedText transformed) {
            Intrinsics.checkNotNullParameter(transformed, "transformed");
            AnnotatedString.Builder builder = new AnnotatedString.Builder(transformed.getText());
            builder.addStyle(new SpanStyle(0L, 0L, null, null, null, null, null, 0L, null, null, null, 0L, TextDecoration.Companion.getUnderline(), null, 12287, null), transformed.getOffsetMapping().originalToTransformed(TextRange.m4475getStartimpl(j2)), transformed.getOffsetMapping().originalToTransformed(TextRange.m4470getEndimpl(j2)));
        ...
        public final void draw$foundation_release(@NotNull Canvas canvas, @NotNull TextFieldValue value, @NotNull OffsetMapping offsetMapping, @NotNull TextLayoutResult textLayoutResult, @NotNull Paint selectionPaint) {
            ...
            if (!TextRange.m4469getCollapsedimpl(value.m4616getSelectiond9O1mEE()) && (originalToTransformed = offsetMapping.originalToTransformed(TextRange.m4473getMinimpl(value.m4616getSelectiond9O1mEE()))) != (originalToTransformed2 = offsetMapping.originalToTransformed(TextRange.m4472getMaximpl(value.m4616getSelectiond9O1mEE())))) {
        ...
        public final Triple<Integer, Integer, TextLayoutResult> m978layout_EkL_Y$foundation_release(@NotNull TextDelegate textDelegate, long j2, @NotNull LayoutDirection layoutDirection, @Nullable TextLayoutResult textLayoutResult) {
            Intrinsics.checkNotNullParameter(textDelegate, "textDelegate");
            Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
            TextLayoutResult m970layoutNN6EwU = textDelegate.m970layoutNN6EwU(j2, layoutDirection, textLayoutResult);
            return new Triple<>(Integer.valueOf(IntSize.m4951getWidthimpl(m970layoutNN6EwU.m4457getSizeYbymL2g())), Integer.valueOf(IntSize.m4950getHeightimpl(m970layoutNN6EwU.m4457getSizeYbymL2g())), m970layoutNN6EwU);
        }
        ...
        public final void notifyFocusedRect$foundation_release(@NotNull TextFieldValue value, @NotNull TextDelegate textDelegate, @NotNull TextLayoutResult textLayoutResult, @NotNull LayoutCoordinates layoutCoordinates, @NotNull TextInputSession textInputSession, boolean z, @NotNull OffsetMapping offsetMapping) {
            ...
            Intrinsics.checkNotNullParameter(offsetMapping, "offsetMapping");
            if (z) {
                int originalToTransformed = offsetMapping.originalToTransformed(TextRange.m4472getMaximpl(value.m4616getSelectiond9O1mEE()));
                if (originalToTransformed >= textLayoutResult.getLayoutInput().getText().length()) {
                    if (originalToTransformed == 0) {
                        rect = new Rect(0.0f, 0.0f, 1.0f, IntSize.m4950getHeightimpl(TextFieldDelegateKt.computeSizeForDefaultText$default(textDelegate.getStyle(), textDelegate.getDensity(), textDelegate.getResourceLoader(), null, 0, 24, null)));
                        long mo3929localToRootMKHz9U = layoutCoordinates.mo3929localToRootMKHz9U(OffsetKt.Offset(rect.getLeft(), rect.getTop()));
                        textInputSession.notifyFocusedRect(RectKt.m2208Recttz77jQw(OffsetKt.Offset(Offset.m2167getXimpl(mo3929localToRootMKHz9U), Offset.m2168getYimpl(mo3929localToRootMKHz9U)), SizeKt.Size(rect.getWidth(), rect.getHeight())));
                    }
                    originalToTransformed--;
                }
                rect = textLayoutResult.getBoundingBox(originalToTransformed);
                long mo3929localToRootMKHz9U2 = layoutCoordinates.mo3929localToRootMKHz9U(OffsetKt.Offset(rect.getLeft(), rect.getTop()));
                textInputSession.notifyFocusedRect(RectKt.m2208Recttz77jQw(OffsetKt.Offset(Offset.m2167getXimpl(mo3929localToRootMKHz9U2), Offset.m2168getYimpl(mo3929localToRootMKHz9U2)), SizeKt.Size(rect.getWidth(), rect.getHeight())));
            }
        }
        ...
        public final void onBlur$foundation_release(@NotNull TextInputSession textInputSession, @NotNull EditProcessor editProcessor, @NotNull Function1<? super TextFieldValue, Unit> onValueChange) {
            ...
            onValueChange.invoke(TextFieldValue.m4611copy3r_uNRQ$default(editProcessor.toTextFieldValue(), (AnnotatedString) null, 0L, (TextRange) null, 3, (Object) null));
        ...
        public final TextInputSession restartInput$foundation_release(@NotNull TextInputService textInputService, @NotNull TextFieldValue value, @NotNull final EditProcessor editProcessor, @NotNull ImeOptions imeOptions, @NotNull final Function1<? super TextFieldValue, Unit> onValueChange, @NotNull Function1<? super ImeAction, Unit> onImeActionPerformed) {
            ...
            Intrinsics.checkNotNullParameter(onValueChange, "onValueChange");
            Intrinsics.checkNotNullParameter(onImeActionPerformed, "onImeActionPerformed");
            return textInputService.startInput(TextFieldValue.m4611copy3r_uNRQ$default(value, (AnnotatedString) null, 0L, (TextRange) null, 7, (Object) null), imeOptions, new Function1<List<? extends EditCommand>, Unit>() { // from class: androidx.compose.foundation.text.TextFieldDelegate$Companion$restartInput$1
        ...
        public final void m979setCursorOffsetULxng0E$foundation_release(long j2, @NotNull TextLayoutResultProxy textLayoutResult, @NotNull EditProcessor editProcessor, @NotNull OffsetMapping offsetMapping, @NotNull Function1<? super TextFieldValue, Unit> onValueChange) {
            Intrinsics.checkNotNullParameter(textLayoutResult, "textLayoutResult");
            Intrinsics.checkNotNullParameter(editProcessor, "editProcessor");
            Intrinsics.checkNotNullParameter(offsetMapping, "offsetMapping");
            Intrinsics.checkNotNullParameter(onValueChange, "onValueChange");
            onValueChange.invoke(TextFieldValue.m4611copy3r_uNRQ$default(editProcessor.toTextFieldValue(), (AnnotatedString) null, TextRangeKt.TextRange(offsetMapping.transformedToOriginal(TextLayoutResultProxy.m1024getOffsetForPosition3MmeM6k$default(textLayoutResult, j2, false, 2, null))), (TextRange) null, 5, (Object) null));
        }
    }
