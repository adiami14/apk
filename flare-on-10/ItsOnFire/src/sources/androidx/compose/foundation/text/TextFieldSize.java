...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/text/TextFieldSize.class */
public final class TextFieldSize {
    ...
    public TextFieldSize(@NotNull LayoutDirection layoutDirection, @NotNull Density density, @NotNull Font.ResourceLoader resourceLoader, @NotNull TextStyle style) {
        ...
        this.style = style;
        this.minSize = m1017computeMinSizeYbymL2g();
    }

    /* renamed from: computeMinSize-YbymL2g  reason: not valid java name */
    private final long m1017computeMinSizeYbymL2g() {
    ...
    public final long m1018getMinSizeYbymL2g() {
        return this.minSize;
    }
