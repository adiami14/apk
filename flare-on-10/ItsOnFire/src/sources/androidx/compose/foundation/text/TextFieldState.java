...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/text/TextFieldState.class */
public final class TextFieldState {
    ...
    public final void m1020updateaKPrnQ(@NotNull AnnotatedString visualText, @NotNull TextStyle textStyle, boolean z, @NotNull Density density, @NotNull Font.ResourceLoader resourceLoader, @NotNull Function1<? super TextFieldValue, Unit> onValueChange, @NotNull KeyboardActions keyboardActions, @NotNull FocusManager focusManager, long j2) {
        List emptyList;
        ...
        this.selectionPaint.mo2294setColor8_81llA(j2);
        ...
        this.textDelegate = CoreTextKt.m910updateTextDelegatex_uQXYA$default(textDelegate, visualText, textStyle, density, resourceLoader, z, 0, 0, emptyList, 192, null);
    }
}
