...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/text/VerticalScrollLayoutModifier.class */
final class VerticalScrollLayoutModifier implements LayoutModifier {
    ...
    public MeasureResult mo105measure3p2s80s(@NotNull final MeasureScope receiver, @NotNull Measurable measurable, long j2) {
        ...
        final Placeable mo3910measureBRTryo0 = measurable.mo3910measureBRTryo0(Constraints.m4743copyZbe2FdA$default(j2, 0, 0, 0, Integer.MAX_VALUE, 7, null));
        final int min = Math.min(mo3910measureBRTryo0.getHeight(), Constraints.m4751getMaxHeightimpl(j2));
        return MeasureScope.DefaultImpls.layout$default(receiver, mo3910measureBRTryo0.getWidth(), min, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.VerticalScrollLayoutModifier$measure$1
            ...
            public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                ...
                this.getScrollerPosition().update(Orientation.Vertical, TextFieldScrollKt.access$getCursorRectInScroller(measureScope, cursorOffset, transformedText, invoke == null ? null : invoke.getValue(), false, mo3910measureBRTryo0.getWidth()), min, mo3910measureBRTryo0.getHeight());
