...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/text/selection/BaseTextPreparedSelection.class */
public abstract class BaseTextPreparedSelection<T extends BaseTextPreparedSelection<T>> {
    ...
    private BaseTextPreparedSelection(AnnotatedString annotatedString, long j2, TextLayoutResult textLayoutResult, OffsetMapping offsetMapping, TextPreparedSelectionState textPreparedSelectionState) {
        ...
        this.selection = m1040getOriginalSelectiond9O1mEE();
    ...
    private final int getNextWordOffset(TextLayoutResult textLayoutResult, int i2) {
        ...
        long m4458getWordBoundaryjx7JFs = textLayoutResult.m4458getWordBoundaryjx7JFs(charOffset(i2));
        return TextRange.m4470getEndimpl(m4458getWordBoundaryjx7JFs) <= i2 ? getNextWordOffset(textLayoutResult, i2 + 1) : this.offsetMapping.transformedToOriginal(TextRange.m4470getEndimpl(m4458getWordBoundaryjx7JFs));
    }
    ...
    private final int getParagraphEnd() {
        return StringHelpersKt.findParagraphEnd(getText$foundation_release(), TextRange.m4472getMaximpl(m1041getSelectiond9O1mEE()));
    }

    private final int getParagraphStart() {
        return StringHelpersKt.findParagraphStart(getText$foundation_release(), TextRange.m4473getMinimpl(m1041getSelectiond9O1mEE()));
    }
    ...
    private final int getPrevWordOffset(TextLayoutResult textLayoutResult, int i2) {
        ...
        long m4458getWordBoundaryjx7JFs = textLayoutResult.m4458getWordBoundaryjx7JFs(charOffset(i2));
        return TextRange.m4475getStartimpl(m4458getWordBoundaryjx7JFs) >= i2 ? getPrevWordOffset(textLayoutResult, i2 - 1) : this.offsetMapping.transformedToOriginal(TextRange.m4475getStartimpl(m4458getWordBoundaryjx7JFs));
    }
    ...
    private final boolean isLtr() {
        ...
        return (textLayoutResult == null ? null : textLayoutResult.getParagraphDirection(TextRange.m4470getEndimpl(m1041getSelectiond9O1mEE()))) != ResolvedTextDirection.Rtl;
    }
    ...
    private final int jumpByLinesOffset(TextLayoutResult textLayoutResult, int i2) {
        ...
        if ((!isLtr() || floatValue < textLayoutResult.getLineRight(lineForOffset)) && (isLtr() || floatValue > textLayoutResult.getLineLeft(lineForOffset))) {
            return getOffsetMapping().transformedToOriginal(textLayoutResult.m4456getOffsetForPositionk4lQ0M(OffsetKt.Offset(cachedX.floatValue(), lineBottom - f2)));
        }
        return textLayoutResult.getLineEnd(lineForOffset, true);
    }

    private final int transformedEndOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m4470getEndimpl(m1041getSelectiond9O1mEE()));
    }

    private final int transformedMaxOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m4472getMaximpl(m1041getSelectiond9O1mEE()));
    }

    private final int transformedMinOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m4473getMinimpl(m1041getSelectiond9O1mEE()));
    }
    ...
    public final T collapseLeftOr(@NotNull Function1<? super T, Unit> or) {
        ...
        if (getText$foundation_release().length() > 0) {
            if (TextRange.m4469getCollapsedimpl(m1041getSelectiond9O1mEE())) {
                ...
                boolean isLtr = isLtr();
                long m1041getSelectiond9O1mEE = m1041getSelectiond9O1mEE();
                setCursor(isLtr ? TextRange.m4473getMinimpl(m1041getSelectiond9O1mEE) : TextRange.m4472getMaximpl(m1041getSelectiond9O1mEE));
            }
        }
        return this;
    }
    ...
    public final T collapseRightOr(@NotNull Function1<? super T, Unit> or) {
        ...
        if (getText$foundation_release().length() > 0) {
            if (TextRange.m4469getCollapsedimpl(m1041getSelectiond9O1mEE())) {
                ...
                boolean isLtr = isLtr();
                long m1041getSelectiond9O1mEE = m1041getSelectiond9O1mEE();
                setCursor(isLtr ? TextRange.m4472getMaximpl(m1041getSelectiond9O1mEE) : TextRange.m4473getMinimpl(m1041getSelectiond9O1mEE));
            }
        }
        return this;
    }
    ...
    public final T deleteSelected() {
        ...
        if (getText$foundation_release().length() > 0) {
            ...
            setAnnotatedString(getAnnotatedString().subSequence(Math.max(0, TextRange.m4473getMinimpl(m1041getSelectiond9O1mEE()) - length), TextRange.m4473getMinimpl(m1041getSelectiond9O1mEE())).plus(getAnnotatedString().subSequence(TextRange.m4472getMaximpl(m1041getSelectiond9O1mEE()), Math.min(TextRange.m4472getMaximpl(m1041getSelectiond9O1mEE()) + length, getText$foundation_release().length()))));
            setCursor(TextRange.m4473getMinimpl(m1041getSelectiond9O1mEE()));
        }
        return this;
    }
    ...
    public final T deselect() {
        getState().resetCachedX();
        if (getText$foundation_release().length() > 0) {
            setCursor(TextRange.m4470getEndimpl(m1041getSelectiond9O1mEE()));
        }
        return this;
    }
    ...
    public final long m1040getOriginalSelectiond9O1mEE() {
    ...
    public final long m1041getSelectiond9O1mEE() {
    ...
    public final T moveCursorNext() {
        ...
        getState().resetCachedX();
        if ((getText$foundation_release().length() > 0) && (findFollowingBreak = StringHelpers_androidKt.findFollowingBreak(getAnnotatedString().getText(), TextRange.m4470getEndimpl(m1041getSelectiond9O1mEE()))) != -1) {
    ...
    public final T moveCursorPrev() {
        ...
        getState().resetCachedX();
        if ((getText$foundation_release().length() > 0) && (findPrecedingBreak = StringHelpers_androidKt.findPrecedingBreak(getAnnotatedString().getText(), TextRange.m4470getEndimpl(m1041getSelectiond9O1mEE()))) != -1) {
    ...
    public final T selectMovement() {
        if (getText$foundation_release().length() > 0) {
            m1042setSelection5zctL8(TextRangeKt.TextRange(TextRange.m4475getStartimpl(m1040getOriginalSelectiond9O1mEE()), TextRange.m4470getEndimpl(m1041getSelectiond9O1mEE())));
        }
        return this;
    }
    ...
    public final void setSelection(int i2, int i3) {
        m1042setSelection5zctL8(TextRangeKt.TextRange(i2, i3));
    }

    /* renamed from: setSelection-5zc-tL8  reason: not valid java name */
    public final void m1042setSelection5zctL8(long j2) {
        this.selection = j2;
    }
}
