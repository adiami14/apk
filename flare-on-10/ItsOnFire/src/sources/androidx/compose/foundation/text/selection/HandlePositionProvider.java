...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/text/selection/HandlePositionProvider.class */
public final class HandlePositionProvider implements PopupPositionProvider {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/foundation/text/selection/HandlePositionProvider$WhenMappings.class */
    ...
    public long mo1044calculatePositionllwVHH4(@NotNull IntRect anchorBounds, long j2, @NotNull LayoutDirection layoutDirection, long j3) {
        ...
        if (i2 == 1) {
            left = anchorBounds.getLeft() + IntOffset.m4907getXimpl(this.offset);
        } else if (i2 == 2) {
            left = (anchorBounds.getLeft() + IntOffset.m4907getXimpl(this.offset)) - IntSize.m4951getWidthimpl(j3);
        } else if (i2 != 3) {
            throw new NoWhenBranchMatchedException();
        } else {
            left = (anchorBounds.getLeft() + IntOffset.m4907getXimpl(this.offset)) - (IntSize.m4951getWidthimpl(j3) / 2);
        }
        return IntOffsetKt.IntOffset(left, anchorBounds.getTop() + IntOffset.m4908getYimpl(this.offset));
    }
}
