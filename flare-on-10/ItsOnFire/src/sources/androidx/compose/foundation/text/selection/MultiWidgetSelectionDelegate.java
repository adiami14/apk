...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/text/selection/MultiWidgetSelectionDelegate.class */
public final class MultiWidgetSelectionDelegate implements Selectable {
    ...
    public long mo1047getHandlePositiondBAh8RU(@NotNull Selection selection, boolean z) {
    ...
    public Selection getSelectAllSelection() {
        ...
        return MultiWidgetSelectionDelegateKt.m1049access$getAssembledSelectionInfovJH6DeI(TextRangeKt.TextRange(0, invoke.getLayoutInput().getText().length()), false, getSelectableId(), invoke);
    }
    ...
    public Pair<Selection, Boolean> mo1048updateSelectionqCDeeow(long j2, long j3, @Nullable Offset offset, boolean z, @NotNull LayoutCoordinates containerLayoutCoordinates, @NotNull SelectionAdjustment adjustment, @Nullable Selection selection) {
        TextLayoutResult invoke;
        ...
        if (selection == null || (getSelectableId() == selection.getStart().getSelectableId() && getSelectableId() == selection.getEnd().getSelectableId())) {
            ...
            if (layoutCoordinates != null && (invoke = this.layoutResultCallback.invoke()) != null) {
                long mo3928localPositionOfR5De75A = containerLayoutCoordinates.mo3928localPositionOfR5De75A(layoutCoordinates, Offset.Companion.m2183getZeroF1C5BW0());
                return MultiWidgetSelectionDelegateKt.m1052getTextSelectionInfoyM0VcXU(invoke, Offset.m2171minusMKHz9U(j2, mo3928localPositionOfR5De75A), Offset.m2171minusMKHz9U(j3, mo3928localPositionOfR5De75A), offset == null ? null : Offset.m2156boximpl(Offset.m2171minusMKHz9U(offset.m2177unboximpl(), mo3928localPositionOfR5De75A)), getSelectableId(), adjustment, selection, z);
            }
