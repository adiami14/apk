...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/text/selection/Selectable.class */
public interface Selectable {

    @Metadata(k = 3, mv = {1, 6, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
    /* loaded from: ItsOnFire.jar:androidx/compose/foundation/text/selection/Selectable$DefaultImpls.class */
    public static final class DefaultImpls {
        /* renamed from: updateSelection-qCDeeow$default  reason: not valid java name */
        public static /* synthetic */ Pair m1054updateSelectionqCDeeow$default(Selectable selectable, long j2, long j3, Offset offset, boolean z, LayoutCoordinates layoutCoordinates, SelectionAdjustment selectionAdjustment, Selection selection, int i2, Object obj) {
            if (obj == null) {
                if ((i2 & 8) != 0) {
                    z = true;
                }
                ...
                return selectable.mo1048updateSelectionqCDeeow(j2, j3, offset, z, layoutCoordinates, selectionAdjustment, selection);
            }
    ...
    long mo1047getHandlePositiondBAh8RU(@NotNull Selection selection, boolean z);
    ...
    Pair<Selection, Boolean> mo1048updateSelectionqCDeeow(long j2, long j3, @Nullable Offset offset, boolean z, @NotNull LayoutCoordinates layoutCoordinates, @NotNull SelectionAdjustment selectionAdjustment, @Nullable Selection selection);
}
