...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/text/selection/Selection.class */
public final class Selection {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/foundation/text/selection/Selection$AnchorInfo.class */
    ...
    public int hashCode() {
        ...
        int hashCode2 = this.end.hashCode();
    ...
    public final Selection merge(@Nullable Selection selection) {
        ...
        return this.handlesCrossed ? copy$default(this, selection.start, null, false, 6, null) : copy$default(this, null, selection.end, false, 5, null);
    }
    ...
    public final long m1055toTextRanged9O1mEE() {
