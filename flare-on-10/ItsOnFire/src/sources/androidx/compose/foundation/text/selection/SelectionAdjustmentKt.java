...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/text/selection/SelectionAdjustmentKt.class */
public final class SelectionAdjustmentKt {
    public static final long ensureAtLeastOneChar(int i2, int i3, boolean z, boolean z2) {
        ...
        if (i2 == 0) {
            ...
            if (z) {
                TextRange = TextRangeKt.TextRange(!z2 ? i2 - 1 : i2 + 1, i2);
            } else {
                TextRange = TextRangeKt.TextRange(i2, !z2 ? i2 + 1 : i2 - 1);
            }
            return TextRange;
        }
    }
