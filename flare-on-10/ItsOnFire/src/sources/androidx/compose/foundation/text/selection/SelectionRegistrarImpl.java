...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/text/selection/SelectionRegistrarImpl.class */
public final class SelectionRegistrarImpl implements SelectionRegistrar {
    ...
    public static final int m1095sort$lambda2(LayoutCoordinates containerLayoutCoordinates, Selectable a2, Selectable b2) {
        Float valueOf;
        float m2168getYimpl;
        int compareValues;
        ...
        long mo3928localPositionOfR5De75A = layoutCoordinates != null ? containerLayoutCoordinates.mo3928localPositionOfR5De75A(layoutCoordinates, Offset.Companion.m2183getZeroF1C5BW0()) : Offset.Companion.m2183getZeroF1C5BW0();
        long mo3928localPositionOfR5De75A2 = layoutCoordinates2 != null ? containerLayoutCoordinates.mo3928localPositionOfR5De75A(layoutCoordinates2, Offset.Companion.m2183getZeroF1C5BW0()) : Offset.Companion.m2183getZeroF1C5BW0();
        if (Offset.m2168getYimpl(mo3928localPositionOfR5De75A) == Offset.m2168getYimpl(mo3928localPositionOfR5De75A2)) {
            valueOf = Float.valueOf(Offset.m2167getXimpl(mo3928localPositionOfR5De75A));
            m2168getYimpl = Offset.m2167getXimpl(mo3928localPositionOfR5De75A2);
        } else {
            valueOf = Float.valueOf(Offset.m2168getYimpl(mo3928localPositionOfR5De75A));
            m2168getYimpl = Offset.m2168getYimpl(mo3928localPositionOfR5De75A2);
        }
        compareValues = ComparisonsKt__ComparisonsKt.compareValues(valueOf, Float.valueOf(m2168getYimpl));
    ...
    public boolean mo1092notifySelectionUpdate5iVPX68(@NotNull LayoutCoordinates layoutCoordinates, long j2, long j3, boolean z, @NotNull SelectionAdjustment adjustment) {
        ...
        if (function5 == null) {
            ...
            Boolean invoke = function5.invoke(layoutCoordinates, Offset.m2156boximpl(j2), Offset.m2156boximpl(j3), Boolean.valueOf(z), adjustment);
            booleanValue = invoke == null ? true : invoke.booleanValue();
        }
        return booleanValue;
    }
    ...
    public void mo1093notifySelectionUpdateStartd4ec7I(@NotNull LayoutCoordinates layoutCoordinates, long j2, @NotNull SelectionAdjustment adjustment) {
        Intrinsics.checkNotNullParameter(layoutCoordinates, "layoutCoordinates");
        Intrinsics.checkNotNullParameter(adjustment, "adjustment");
        ...
        function3.invoke(layoutCoordinates, Offset.m2156boximpl(j2), adjustment);
    }
        ...
        if (!this.sorted) {
            CollectionsKt__MutableCollectionsJVMKt.sortWith(this._selectables, new Comparator() { // from class: androidx.compose.foundation.text.selection.a
                ...
                public final int compare(Object obj, Object obj2) {
                    int m1095sort$lambda2;
                    m1095sort$lambda2 = SelectionRegistrarImpl.m1095sort$lambda2(LayoutCoordinates.this, (Selectable) obj, (Selectable) obj2);
                    return m1095sort$lambda2;
                }
            });
            this.sorted = true;
        }
