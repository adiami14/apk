...
/* loaded from: ItsOnFire.jar:androidx/compose/foundation/text/selection/TextFieldSelectionDelegateKt.class */
public final class TextFieldSelectionDelegateKt {
    /* renamed from: getTextFieldSelection-bb3KNj8  reason: not valid java name */
    public static final long m1099getTextFieldSelectionbb3KNj8(@Nullable TextLayoutResult textLayoutResult, int i2, int i3, @Nullable TextRange textRange, boolean z, @NotNull SelectionAdjustment adjustment) {
        Intrinsics.checkNotNullParameter(adjustment, "adjustment");
        if (textLayoutResult == null) {
            return TextRangeKt.TextRange(0, 0);
        }
        long TextRange = TextRangeKt.TextRange(i2, i3);
        return (textRange == null && Intrinsics.areEqual(adjustment, SelectionAdjustment.Companion.getCharacter())) ? TextRange : adjustment.mo1057adjustZXO7KMw(textLayoutResult, TextRange, -1, z, textRange);
    }
}
