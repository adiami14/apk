...
/* loaded from: ItsOnFire.jar:androidx/compose/material/AppBarDefaults.class */
public final class AppBarDefaults {
    ...
    private static final float TopAppBarElevation = Dp.m4785constructorimpl(4);
    private static final float BottomAppBarElevation = Dp.m4785constructorimpl(8);
    ...
    static {
        ...
        ContentPadding = PaddingKt.m673PaddingValuesa9UjIt4$default(f2, 0.0f, f3, 0.0f, 10, null);
    }
    ...
    public final float m1118getBottomAppBarElevationD9Ej5fM() {
    ...
    public final float m1119getTopAppBarElevationD9Ej5fM() {
