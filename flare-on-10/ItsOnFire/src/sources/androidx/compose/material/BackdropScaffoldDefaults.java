...
/* loaded from: ItsOnFire.jar:androidx/compose/material/BackdropScaffoldDefaults.class */
public final class BackdropScaffoldDefaults {
    public static final int $stable = 0;
    @NotNull
    public static final BackdropScaffoldDefaults INSTANCE = new BackdropScaffoldDefaults();
    private static final float PeekHeight = Dp.m4785constructorimpl(56);
    private static final float HeaderHeight = Dp.m4785constructorimpl(48);
    private static final float FrontLayerElevation = Dp.m4785constructorimpl(1);

    private BackdropScaffoldDefaults() {
    }

    /* renamed from: getFrontLayerElevation-D9Ej5fM  reason: not valid java name */
    public final float m1128getFrontLayerElevationD9Ej5fM() {
    ...
    public final long getFrontLayerScrimColor(@Nullable Composer composer, int i2) {
        ...
        long m2413copywmQWz5c$default = Color.m2413copywmQWz5c$default(MaterialTheme.INSTANCE.getColors(composer, 6).m1232getSurface0d7_KjU(), 0.6f, 0.0f, 0.0f, 0.0f, 14, null);
    ...
    public final Shape getFrontLayerShape(@Nullable Composer composer, int i2) {
        ...
        float f2 = 16;
        CornerBasedShape copy$default = CornerBasedShape.copy$default(MaterialTheme.INSTANCE.getShapes(composer, 6).getLarge(), CornerSizeKt.m861CornerSize0680j_4(Dp.m4785constructorimpl(f2)), CornerSizeKt.m861CornerSize0680j_4(Dp.m4785constructorimpl(f2)), null, null, 12, null);
        composer.endReplaceableGroup();
        return copy$default;
    }

    /* renamed from: getHeaderHeight-D9Ej5fM  reason: not valid java name */
    public final float m1129getHeaderHeightD9Ej5fM() {
        return HeaderHeight;
    }

    /* renamed from: getPeekHeight-D9Ej5fM  reason: not valid java name */
    public final float m1130getPeekHeightD9Ej5fM() {
        return PeekHeight;
    }
}
