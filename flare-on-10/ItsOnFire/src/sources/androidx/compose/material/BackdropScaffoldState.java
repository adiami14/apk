...
/* loaded from: ItsOnFire.jar:androidx/compose/material/BackdropScaffoldState.class */
public final class BackdropScaffoldState extends SwipeableState<BackdropValue> {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/material/BackdropScaffoldState$Companion.class */
    ...
    public /* synthetic */ BackdropScaffoldState(BackdropValue backdropValue, AnimationSpec animationSpec, Function1 function1, SnackbarHostState snackbarHostState, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(backdropValue, (i2 & 2) != 0 ? SwipeableDefaults.INSTANCE.getAnimationSpec() : animationSpec, (i2 & 4) != 0 ? new Function1<BackdropValue, Boolean>() { // from class: androidx.compose.material.BackdropScaffoldState.1
            @Override // kotlin.jvm.functions.Function1
            @NotNull
        ...
        } : function1, (i2 & 8) != 0 ? new SnackbarHostState() : snackbarHostState);
    }
