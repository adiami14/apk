...
/* loaded from: ItsOnFire.jar:androidx/compose/material/BottomSheetScaffoldDefaults.class */
public final class BottomSheetScaffoldDefaults {
    ...
    private static final float SheetElevation = Dp.m4785constructorimpl(8);
    private static final float SheetPeekHeight = Dp.m4785constructorimpl(56);

    private BottomSheetScaffoldDefaults() {
    }

    /* renamed from: getSheetElevation-D9Ej5fM  reason: not valid java name */
    public final float m1169getSheetElevationD9Ej5fM() {
        return SheetElevation;
    }

    /* renamed from: getSheetPeekHeight-D9Ej5fM  reason: not valid java name */
    public final float m1170getSheetPeekHeightD9Ej5fM() {
