...
/* loaded from: ItsOnFire.jar:androidx/compose/material/ContentAlpha.class */
public final class ContentAlpha {
    ...
    private final float contentAlpha(float f2, float f3, Composer composer, int i2) {
        ...
        long m2424unboximpl = ((Color) composer.consume(ContentColorKt.getLocalContentColor())).m2424unboximpl();
        if (!MaterialTheme.INSTANCE.getColors(composer, 6).isLight() ? ColorKt.m2468luminance8_81llA(m2424unboximpl) >= 0.5d : ColorKt.m2468luminance8_81llA(m2424unboximpl) <= 0.5d) {
            f2 = f3;
        }
