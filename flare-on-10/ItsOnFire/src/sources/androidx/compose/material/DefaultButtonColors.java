...
/* loaded from: ItsOnFire.jar:androidx/compose/material/DefaultButtonColors.class */
final class DefaultButtonColors implements ButtonColors {
    ...
    public State<Color> backgroundColor(boolean z, @Nullable Composer composer, int i2) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2404boximpl(z ? this.backgroundColor : this.disabledBackgroundColor), composer, 0);
    ...
    public State<Color> contentColor(boolean z, @Nullable Composer composer, int i2) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2404boximpl(z ? this.contentColor : this.disabledContentColor), composer, 0);
        composer.endReplaceableGroup();
        return rememberUpdatedState;
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return Color.m2415equalsimpl0(this.backgroundColor, defaultButtonColors.backgroundColor) && Color.m2415equalsimpl0(this.contentColor, defaultButtonColors.contentColor) && Color.m2415equalsimpl0(this.disabledBackgroundColor, defaultButtonColors.disabledBackgroundColor) && Color.m2415equalsimpl0(this.disabledContentColor, defaultButtonColors.disabledContentColor);
    }

    public int hashCode() {
        return (((((Color.m2421hashCodeimpl(this.backgroundColor) * 31) + Color.m2421hashCodeimpl(this.contentColor)) * 31) + Color.m2421hashCodeimpl(this.disabledBackgroundColor)) * 31) + Color.m2421hashCodeimpl(this.disabledContentColor);
    }
}
