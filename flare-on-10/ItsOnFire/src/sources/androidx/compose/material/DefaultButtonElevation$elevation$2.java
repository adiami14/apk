...
/* loaded from: ItsOnFire.jar:androidx/compose/material/DefaultButtonElevation$elevation$2.class */
public final class DefaultButtonElevation$elevation$2 extends SuspendLambda implements Function2<u0, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i2 == 0) {
            ...
            Dp m4783boximpl = Dp.m4783boximpl(this.$target);
            this.label = 1;
            if (animatable.snapTo(m4783boximpl, this) == coroutine_suspended) {
