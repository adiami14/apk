...
/* loaded from: ItsOnFire.jar:androidx/compose/material/DefaultButtonElevation.class */
final class DefaultButtonElevation implements ButtonElevation {
    ...
    public State<Dp> elevation(boolean z, @NotNull InteractionSource interactionSource, @Nullable Composer composer, int i2) {
        ...
        SnapshotStateList snapshotStateList2 = (SnapshotStateList) snapshotStateList;
        EffectsKt.LaunchedEffect(interactionSource, new DefaultButtonElevation$elevation$1(interactionSource, snapshotStateList2, null), composer, (i2 >> 3) & 14);
        lastOrNull = CollectionsKt___CollectionsKt.lastOrNull((List<? extends Object>) snapshotStateList2);
        ...
        if (rememberedValue2 == companion.getEmpty()) {
            animatable = new Animatable(Dp.m4783boximpl(f2), VectorConvertersKt.getVectorConverter(Dp.Companion), null, 4, null);
        ...
        if (z) {
            ...
            EffectsKt.LaunchedEffect(Dp.m4783boximpl(f2), new DefaultButtonElevation$elevation$3(animatable2, this, f2, interaction, null), composer, 0);
        } else {
            composer.startReplaceableGroup(-1598807427);
            EffectsKt.LaunchedEffect(Dp.m4783boximpl(f2), new DefaultButtonElevation$elevation$2(animatable2, f2, null), composer, 0);
        }
        composer.endReplaceableGroup();
