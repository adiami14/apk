...
/* loaded from: ItsOnFire.jar:androidx/compose/material/DefaultCheckboxColors.class */
final class DefaultCheckboxColors implements CheckboxColors {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/material/DefaultCheckboxColors$WhenMappings.class */
    ...
    public State<Color> borderColor(boolean z, @NotNull ToggleableState state, @Nullable Composer composer, int i2) {
        ...
        if (z) {
            ...
            rememberUpdatedState = SingleValueAnimationKt.m202animateColorAsStateKTwxG1Y(j2, AnimationSpecKt.tween$default(state == ToggleableState.Off ? 100 : 50, 0, null, 6, null), null, composer, 0, 4);
        } else {
    ...
    public State<Color> checkmarkColor(@NotNull ToggleableState state, @Nullable Composer composer, int i2) {
        ...
        State<Color> m202animateColorAsStateKTwxG1Y = SingleValueAnimationKt.m202animateColorAsStateKTwxG1Y(state == toggleableState ? this.uncheckedCheckmarkColor : this.checkedCheckmarkColor, AnimationSpecKt.tween$default(state == toggleableState ? 100 : 50, 0, null, 6, null), null, composer, 0, 4);
        composer.endReplaceableGroup();
        return m202animateColorAsStateKTwxG1Y;
    }
}
