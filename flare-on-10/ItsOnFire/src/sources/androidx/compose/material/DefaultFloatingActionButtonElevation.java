...
/* loaded from: ItsOnFire.jar:androidx/compose/material/DefaultFloatingActionButtonElevation.class */
final class DefaultFloatingActionButtonElevation implements FloatingActionButtonElevation {
    ...
    public State<Dp> elevation(@NotNull InteractionSource interactionSource, @Nullable Composer composer, int i2) {
        ...
        EffectsKt.LaunchedEffect(interactionSource, new DefaultFloatingActionButtonElevation$elevation$1(interactionSource, snapshotStateList2, null), composer, i2 & 14);
        ...
        EffectsKt.LaunchedEffect(Dp.m4783boximpl(f2), new DefaultFloatingActionButtonElevation$elevation$2(animatable2, this, f2, interaction, null), composer, 0);
