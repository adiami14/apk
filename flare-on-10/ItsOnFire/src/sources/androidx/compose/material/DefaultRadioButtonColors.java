...
/* loaded from: ItsOnFire.jar:androidx/compose/material/DefaultRadioButtonColors.class */
final class DefaultRadioButtonColors implements RadioButtonColors {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return Color.m2415equalsimpl0(this.selectedColor, defaultRadioButtonColors.selectedColor) && Color.m2415equalsimpl0(this.unselectedColor, defaultRadioButtonColors.unselectedColor) && Color.m2415equalsimpl0(this.disabledColor, defaultRadioButtonColors.disabledColor);
    }

    public int hashCode() {
        return (((Color.m2421hashCodeimpl(this.selectedColor) * 31) + Color.m2421hashCodeimpl(this.unselectedColor)) * 31) + Color.m2421hashCodeimpl(this.disabledColor);
    }
    ...
    public State<Color> radioColor(boolean z, boolean z2, @Nullable Composer composer, int i2) {
        ...
        if (z) {
            ...
            rememberUpdatedState = SingleValueAnimationKt.m202animateColorAsStateKTwxG1Y(j2, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, composer, 48, 4);
        } else {
