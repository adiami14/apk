...
/* loaded from: ItsOnFire.jar:androidx/compose/material/DefaultTextFieldForExposedDropdownMenusColors.class */
final class DefaultTextFieldForExposedDropdownMenusColors implements TextFieldColorsWithIcons {
    ...
    private static final boolean m1290indicatorColor$lambda1(State<Boolean> state) {
        return state.getValue().booleanValue();
    }

    /* renamed from: labelColor$lambda-2  reason: not valid java name */
    private static final boolean m1291labelColor$lambda2(State<Boolean> state) {
        return state.getValue().booleanValue();
    }

    /* renamed from: trailingIconColor$lambda-0  reason: not valid java name */
    private static final boolean m1292trailingIconColor$lambda0(State<Boolean> state) {
        return state.getValue().booleanValue();
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return Color.m2415equalsimpl0(this.textColor, defaultTextFieldForExposedDropdownMenusColors.textColor) && Color.m2415equalsimpl0(this.disabledTextColor, defaultTextFieldForExposedDropdownMenusColors.disabledTextColor) && Color.m2415equalsimpl0(this.cursorColor, defaultTextFieldForExposedDropdownMenusColors.cursorColor) && Color.m2415equalsimpl0(this.errorCursorColor, defaultTextFieldForExposedDropdownMenusColors.errorCursorColor) && Color.m2415equalsimpl0(this.focusedIndicatorColor, defaultTextFieldForExposedDropdownMenusColors.focusedIndicatorColor) && Color.m2415equalsimpl0(this.unfocusedIndicatorColor, defaultTextFieldForExposedDropdownMenusColors.unfocusedIndicatorColor) && Color.m2415equalsimpl0(this.errorIndicatorColor, defaultTextFieldForExposedDropdownMenusColors.errorIndicatorColor) && Color.m2415equalsimpl0(this.disabledIndicatorColor, defaultTextFieldForExposedDropdownMenusColors.disabledIndicatorColor) && Color.m2415equalsimpl0(this.leadingIconColor, defaultTextFieldForExposedDropdownMenusColors.leadingIconColor) && Color.m2415equalsimpl0(this.disabledLeadingIconColor, defaultTextFieldForExposedDropdownMenusColors.disabledLeadingIconColor) && Color.m2415equalsimpl0(this.errorLeadingIconColor, defaultTextFieldForExposedDropdownMenusColors.errorLeadingIconColor) && Color.m2415equalsimpl0(this.trailingIconColor, defaultTextFieldForExposedDropdownMenusColors.trailingIconColor) && Color.m2415equalsimpl0(this.focusedTrailingIconColor, defaultTextFieldForExposedDropdownMenusColors.focusedTrailingIconColor) && Color.m2415equalsimpl0(this.disabledTrailingIconColor, defaultTextFieldForExposedDropdownMenusColors.disabledTrailingIconColor) && Color.m2415equalsimpl0(this.errorTrailingIconColor, defaultTextFieldForExposedDropdownMenusColors.errorTrailingIconColor) && Color.m2415equalsimpl0(this.backgroundColor, defaultTextFieldForExposedDropdownMenusColors.backgroundColor) && Color.m2415equalsimpl0(this.focusedLabelColor, defaultTextFieldForExposedDropdownMenusColors.focusedLabelColor) && Color.m2415equalsimpl0(this.unfocusedLabelColor, defaultTextFieldForExposedDropdownMenusColors.unfocusedLabelColor) && Color.m2415equalsimpl0(this.disabledLabelColor, defaultTextFieldForExposedDropdownMenusColors.disabledLabelColor) && Color.m2415equalsimpl0(this.errorLabelColor, defaultTextFieldForExposedDropdownMenusColors.errorLabelColor) && Color.m2415equalsimpl0(this.placeholderColor, defaultTextFieldForExposedDropdownMenusColors.placeholderColor) && Color.m2415equalsimpl0(this.disabledPlaceholderColor, defaultTextFieldForExposedDropdownMenusColors.disabledPlaceholderColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((((((((((((((((((((((Color.m2421hashCodeimpl(this.textColor) * 31) + Color.m2421hashCodeimpl(this.disabledTextColor)) * 31) + Color.m2421hashCodeimpl(this.cursorColor)) * 31) + Color.m2421hashCodeimpl(this.errorCursorColor)) * 31) + Color.m2421hashCodeimpl(this.focusedIndicatorColor)) * 31) + Color.m2421hashCodeimpl(this.unfocusedIndicatorColor)) * 31) + Color.m2421hashCodeimpl(this.errorIndicatorColor)) * 31) + Color.m2421hashCodeimpl(this.disabledIndicatorColor)) * 31) + Color.m2421hashCodeimpl(this.leadingIconColor)) * 31) + Color.m2421hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m2421hashCodeimpl(this.errorLeadingIconColor)) * 31) + Color.m2421hashCodeimpl(this.trailingIconColor)) * 31) + Color.m2421hashCodeimpl(this.focusedTrailingIconColor)) * 31) + Color.m2421hashCodeimpl(this.disabledTrailingIconColor)) * 31) + Color.m2421hashCodeimpl(this.errorTrailingIconColor)) * 31) + Color.m2421hashCodeimpl(this.backgroundColor)) * 31) + Color.m2421hashCodeimpl(this.focusedLabelColor)) * 31) + Color.m2421hashCodeimpl(this.unfocusedLabelColor)) * 31) + Color.m2421hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m2421hashCodeimpl(this.errorLabelColor)) * 31) + Color.m2421hashCodeimpl(this.placeholderColor)) * 31) + Color.m2421hashCodeimpl(this.disabledPlaceholderColor);
    }
    ...
    public State<Color> indicatorColor(boolean z, boolean z2, @NotNull InteractionSource interactionSource, @Nullable Composer composer, int i2) {
        ...
        long j2 = !z ? this.disabledIndicatorColor : z2 ? this.errorIndicatorColor : m1290indicatorColor$lambda1(FocusInteractionKt.collectIsFocusedAsState(interactionSource, composer, (i2 >> 6) & 14)) ? this.focusedIndicatorColor : this.unfocusedIndicatorColor;
        if (z) {
    ...
    public State<Color> labelColor(boolean z, boolean z2, @NotNull InteractionSource interactionSource, @Nullable Composer composer, int i2) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2404boximpl(!z ? this.disabledLabelColor : z2 ? this.errorLabelColor : m1291labelColor$lambda2(FocusInteractionKt.collectIsFocusedAsState(interactionSource, composer, (i2 >> 6) & 14)) ? this.focusedLabelColor : this.unfocusedLabelColor), composer, 0);
        composer.endReplaceableGroup();
        return rememberUpdatedState;
    }
    ...
    public State<Color> trailingIconColor(boolean z, boolean z2, @NotNull InteractionSource interactionSource, @Nullable Composer composer, int i2) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2404boximpl(!z ? this.disabledTrailingIconColor : z2 ? this.errorTrailingIconColor : m1292trailingIconColor$lambda0(FocusInteractionKt.collectIsFocusedAsState(interactionSource, composer, (i2 >> 6) & 14)) ? this.focusedTrailingIconColor : this.trailingIconColor), composer, 0);
        composer.endReplaceableGroup();
        return rememberUpdatedState;
    }
