...
/* loaded from: ItsOnFire.jar:androidx/compose/material/DrawerState.class */
public final class DrawerState {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/material/DrawerState$Companion.class */
    ...
    public /* synthetic */ DrawerState(DrawerValue drawerValue, Function1 function1, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(drawerValue, (i2 & 2) != 0 ? new Function1<DrawerValue, Boolean>() { // from class: androidx.compose.material.DrawerState.1
            @Override // kotlin.jvm.functions.Function1
            @NotNull
