...
/* loaded from: ItsOnFire.jar:androidx/compose/material/ElevationKt.class */
public final class ElevationKt {
    ...
    public static final Object m1336animateElevationrAjV9yQ(@NotNull Animatable<Dp, ?> animatable, float f2, @Nullable Interaction interaction, @Nullable Interaction interaction2, @NotNull Continuation<? super Unit> continuation) {
        ...
        if (incomingAnimationSpecForInteraction != null) {
            Object animateTo$default = Animatable.animateTo$default(animatable, Dp.m4783boximpl(f2), incomingAnimationSpecForInteraction, null, null, continuation, 12, null);
            coroutine_suspended2 = IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED();
            return animateTo$default == coroutine_suspended2 ? animateTo$default : Unit.INSTANCE;
        }
        Object snapTo = animatable.snapTo(Dp.m4783boximpl(f2), continuation);
    ...
    public static /* synthetic */ Object m1337animateElevationrAjV9yQ$default(Animatable animatable, float f2, Interaction interaction, Interaction interaction2, Continuation continuation, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            interaction = null;
        }
        if ((i2 & 4) != 0) {
        ...
        return m1336animateElevationrAjV9yQ(animatable, f2, interaction, interaction2, continuation);
    }
}
