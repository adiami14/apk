...
@JvmInline
/* loaded from: ItsOnFire.jar:androidx/compose/material/FabPosition.class */
public final class FabPosition {
    private final int value;
    @NotNull
    public static final Companion Companion = new Companion(null);
    private static final int Center = m1359constructorimpl(0);
    private static final int End = m1359constructorimpl(1);
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/material/FabPosition$Companion.class */
    public static final class Companion {
        ...
        public final int m1365getCenter5ygKITE() {
            return FabPosition.Center;
        }

        /* renamed from: getEnd-5ygKITE  reason: not valid java name */
        public final int m1366getEnd5ygKITE() {
    ...
    public static final /* synthetic */ FabPosition m1358boximpl(int i2) {
        return new FabPosition(i2);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m1359constructorimpl(int i2) {
        return i2;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m1360equalsimpl(int i2, Object obj) {
        return (obj instanceof FabPosition) && i2 == ((FabPosition) obj).m1364unboximpl();
    }
    ...
    public static String m1363toStringimpl(int i2) {
        return m1361equalsimpl0(i2, Center) ? "FabPosition.Center" : "FabPosition.End";
    }
