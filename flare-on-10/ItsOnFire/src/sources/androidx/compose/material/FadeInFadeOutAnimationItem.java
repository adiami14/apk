...
/* loaded from: ItsOnFire.jar:androidx/compose/material/FadeInFadeOutAnimationItem.class */
final class FadeInFadeOutAnimationItem<T> {
    ...
    public static /* synthetic */ FadeInFadeOutAnimationItem copy$default(FadeInFadeOutAnimationItem fadeInFadeOutAnimationItem, Object obj, Function3 function3, int i2, Object obj2) {
        T t2 = obj;
        if ((i2 & 1) != 0) {
            t2 = fadeInFadeOutAnimationItem.key;
        }
        Function3<Function2<? super Composer, ? super Integer, Unit>, Composer, Integer, Unit> function32 = function3;
        if ((i2 & 2) != 0) {
            function32 = fadeInFadeOutAnimationItem.transition;
        }
        return fadeInFadeOutAnimationItem.copy(t2, function32);
    }
