...
/* loaded from: ItsOnFire.jar:androidx/compose/material/FixedThreshold.class */
public final class FixedThreshold implements ThresholdConfig {
    ...
    private final float m1367component1D9Ej5fM() {
        return this.offset;
    }

    /* renamed from: copy-0680j_4$default  reason: not valid java name */
    public static /* synthetic */ FixedThreshold m1368copy0680j_4$default(FixedThreshold fixedThreshold, float f2, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            f2 = fixedThreshold.offset;
        }
        return fixedThreshold.m1369copy0680j_4(f2);
    }

    @Override // androidx.compose.material.ThresholdConfig
    public float computeThreshold(@NotNull Density density, float f2, float f3) {
        Intrinsics.checkNotNullParameter(density, "<this>");
        return f2 + (density.mo524toPx0680j_4(this.offset) * Math.signum(f3 - f2));
    }

    @NotNull
    /* renamed from: copy-0680j_4  reason: not valid java name */
    public final FixedThreshold m1369copy0680j_4(float f2) {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return (obj instanceof FixedThreshold) && Dp.m4790equalsimpl0(this.offset, ((FixedThreshold) obj).offset);
    }

    public int hashCode() {
        return Dp.m4791hashCodeimpl(this.offset);
    }

    @NotNull
    public String toString() {
        return "FixedThreshold(offset=" + ((Object) Dp.m4796toStringimpl(this.offset)) + ')';
    }
}
