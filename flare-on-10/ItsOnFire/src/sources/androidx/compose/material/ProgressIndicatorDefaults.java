...
/* loaded from: ItsOnFire.jar:androidx/compose/material/ProgressIndicatorDefaults.class */
public final class ProgressIndicatorDefaults {
    public static final int $stable = 0;
    public static final float IndicatorBackgroundOpacity = 0.24f;
    @NotNull
    public static final ProgressIndicatorDefaults INSTANCE = new ProgressIndicatorDefaults();
    private static final float StrokeWidth = Dp.m4785constructorimpl(4);
    @NotNull
    ...
    public final float m1452getStrokeWidthD9Ej5fM() {
        return StrokeWidth;
    }
}
