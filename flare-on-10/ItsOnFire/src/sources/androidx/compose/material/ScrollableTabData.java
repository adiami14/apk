...
/* loaded from: ItsOnFire.jar:androidx/compose/material/ScrollableTabData.class */
final class ScrollableTabData {
    ...
    private final int calculateTabOffset(TabPosition tabPosition, Density density, int i2, List<TabPosition> list) {
        ...
        int mo518roundToPx0680j_4 = density.mo518roundToPx0680j_4(((TabPosition) last).m1571getRightD9Ej5fM()) + i2;
        int maxValue = mo518roundToPx0680j_4 - this.scrollState.getMaxValue();
        coerceAtLeast = RangesKt___RangesKt.coerceAtLeast(mo518roundToPx0680j_4 - maxValue, 0);
        coerceIn = RangesKt___RangesKt.coerceIn(density.mo518roundToPx0680j_4(tabPosition.m1570getLeftD9Ej5fM()) - ((maxValue / 2) - (density.mo518roundToPx0680j_4(tabPosition.m1572getWidthD9Ej5fM()) / 2)), 0, coerceAtLeast);
        return coerceIn;
    }
