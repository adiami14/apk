...
/* loaded from: ItsOnFire.jar:androidx/compose/material/SwipeableDefaults.class */
public final class SwipeableDefaults {
    ...
    private static final float VelocityThreshold = Dp.m4785constructorimpl((float) androidx.appcompat.R.styleable.AppCompatTheme_windowMinWidthMinor);
    ...
    public final float m1541getVelocityThresholdD9Ej5fM() {
    ...
    public final ResistanceConfig resistanceConfig(@NotNull Set<Float> anchors, float f2, float f3) {
        ...
        if (anchors.size() <= 1) {
            ...
            m6298maxOrNull = CollectionsKt___CollectionsKt.m6298maxOrNull((Iterable<Float>) anchors);
            Intrinsics.checkNotNull(m6298maxOrNull);
            float floatValue = m6298maxOrNull.floatValue();
            m6306minOrNull = CollectionsKt___CollectionsKt.m6306minOrNull((Iterable<Float>) anchors);
            Intrinsics.checkNotNull(m6306minOrNull);
            resistanceConfig = new ResistanceConfig(floatValue - m6306minOrNull.floatValue(), f2, f3);
        }
