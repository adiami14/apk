...
/* loaded from: ItsOnFire.jar:androidx/compose/material/TextFieldColorsWithIcons.class */
public interface TextFieldColorsWithIcons extends TextFieldColors {

    @Metadata(k = 3, mv = {1, 6, 0}, xi = androidx.appcompat.R.styleable.AppCompatTheme_checkboxStyle)
    /* loaded from: ItsOnFire.jar:androidx/compose/material/TextFieldColorsWithIcons$DefaultImpls.class */
