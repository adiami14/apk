...
/* loaded from: ItsOnFire.jar:androidx/compose/material/Typography.class */
public final class Typography {
    ...
    public static /* synthetic */ Typography copy$default(Typography typography, TextStyle textStyle, TextStyle textStyle2, TextStyle textStyle3, TextStyle textStyle4, TextStyle textStyle5, TextStyle textStyle6, TextStyle textStyle7, TextStyle textStyle8, TextStyle textStyle9, TextStyle textStyle10, TextStyle textStyle11, TextStyle textStyle12, TextStyle textStyle13, int i2, Object obj) {
        ...
        if ((i2 & 2) != 0) {
            textStyle2 = typography.h2;
        }
        if ((i2 & 4) != 0) {
            textStyle3 = typography.h3;
        }
        if ((i2 & 8) != 0) {
            textStyle4 = typography.h4;
        }
        if ((i2 & 16) != 0) {
            textStyle5 = typography.h5;
        }
        if ((i2 & 32) != 0) {
            textStyle6 = typography.h6;
        }
        if ((i2 & 64) != 0) {
            textStyle7 = typography.subtitle1;
        }
        if ((i2 & 128) != 0) {
            textStyle8 = typography.subtitle2;
        }
        if ((i2 & 256) != 0) {
            textStyle9 = typography.body1;
        }
        if ((i2 & 512) != 0) {
            textStyle10 = typography.body2;
        }
        if ((i2 & 1024) != 0) {
            textStyle11 = typography.button;
        }
        if ((i2 & 2048) != 0) {
            textStyle12 = typography.caption;
        }
        if ((i2 & 4096) != 0) {
            textStyle13 = typography.overline;
        }
        return typography.copy(textStyle, textStyle2, textStyle3, textStyle4, textStyle5, textStyle6, textStyle7, textStyle8, textStyle9, textStyle10, textStyle11, textStyle12, textStyle13);
    }
