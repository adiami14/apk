...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/filled/DoneKt.class */
public final class DoneKt {
    ...
    public static final ImageVector getDone(@NotNull Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.Done", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
