...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/outlined/AccountBoxKt.class */
public final class AccountBoxKt {
    ...
    public static final ImageVector getAccountBox(@NotNull Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.AccountBox", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
