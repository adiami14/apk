...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/outlined/ArrowBackKt.class */
public final class ArrowBackKt {
    ...
    public static final ImageVector getArrowBack(@NotNull Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.ArrowBack", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
