...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/outlined/ArrowDropDownKt.class */
public final class ArrowDropDownKt {
    ...
    public static final ImageVector getArrowDropDown(@NotNull Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.ArrowDropDown", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
