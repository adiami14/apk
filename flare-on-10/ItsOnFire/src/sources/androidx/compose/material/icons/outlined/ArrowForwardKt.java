...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/outlined/ArrowForwardKt.class */
public final class ArrowForwardKt {
    ...
    public static final ImageVector getArrowForward(@NotNull Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.ArrowForward", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
