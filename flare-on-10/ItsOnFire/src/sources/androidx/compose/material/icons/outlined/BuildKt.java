...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/outlined/BuildKt.class */
public final class BuildKt {
    ...
    public static final ImageVector getBuild(@NotNull Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Build", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
