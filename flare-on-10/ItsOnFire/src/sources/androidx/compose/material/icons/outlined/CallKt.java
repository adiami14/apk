...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/outlined/CallKt.class */
public final class CallKt {
    ...
    public static final ImageVector getCall(@NotNull Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Call", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
