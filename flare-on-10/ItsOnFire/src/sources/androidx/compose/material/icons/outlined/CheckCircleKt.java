...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/outlined/CheckCircleKt.class */
public final class CheckCircleKt {
    ...
    public static final ImageVector getCheckCircle(@NotNull Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.CheckCircle", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
