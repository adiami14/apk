...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/outlined/CloseKt.class */
public final class CloseKt {
    ...
    public static final ImageVector getClose(@NotNull Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Close", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
