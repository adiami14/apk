...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/outlined/CreateKt.class */
public final class CreateKt {
    ...
    public static final ImageVector getCreate(@NotNull Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Create", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
