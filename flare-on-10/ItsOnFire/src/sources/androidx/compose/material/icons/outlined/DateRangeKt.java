...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/outlined/DateRangeKt.class */
public final class DateRangeKt {
    ...
    public static final ImageVector getDateRange(@NotNull Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.DateRange", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
