...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/outlined/EditKt.class */
public final class EditKt {
    ...
    public static final ImageVector getEdit(@NotNull Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Edit", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
