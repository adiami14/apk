...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/outlined/EmailKt.class */
public final class EmailKt {
    ...
    public static final ImageVector getEmail(@NotNull Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Email", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
