...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/outlined/FaceKt.class */
public final class FaceKt {
    ...
    public static final ImageVector getFace(@NotNull Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Face", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
