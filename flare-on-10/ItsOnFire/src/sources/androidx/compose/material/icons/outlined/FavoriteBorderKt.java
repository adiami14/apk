...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/outlined/FavoriteBorderKt.class */
public final class FavoriteBorderKt {
    ...
    public static final ImageVector getFavoriteBorder(@NotNull Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.FavoriteBorder", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
