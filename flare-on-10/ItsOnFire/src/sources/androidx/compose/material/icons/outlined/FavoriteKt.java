...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/outlined/FavoriteKt.class */
public final class FavoriteKt {
    ...
    public static final ImageVector getFavorite(@NotNull Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Favorite", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
