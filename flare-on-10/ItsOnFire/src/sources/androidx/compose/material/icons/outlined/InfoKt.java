...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/outlined/InfoKt.class */
public final class InfoKt {
    ...
    public static final ImageVector getInfo(@NotNull Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Info", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
