...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/outlined/KeyboardArrowDownKt.class */
public final class KeyboardArrowDownKt {
    ...
    public static final ImageVector getKeyboardArrowDown(@NotNull Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.KeyboardArrowDown", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
