...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/outlined/KeyboardArrowLeftKt.class */
public final class KeyboardArrowLeftKt {
    ...
    public static final ImageVector getKeyboardArrowLeft(@NotNull Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.KeyboardArrowLeft", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
