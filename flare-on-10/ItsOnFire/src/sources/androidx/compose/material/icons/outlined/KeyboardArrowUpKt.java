...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/outlined/KeyboardArrowUpKt.class */
public final class KeyboardArrowUpKt {
    ...
    public static final ImageVector getKeyboardArrowUp(@NotNull Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.KeyboardArrowUp", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
