...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/outlined/LocationOnKt.class */
public final class LocationOnKt {
    ...
    public static final ImageVector getLocationOn(@NotNull Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.LocationOn", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
