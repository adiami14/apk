...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/outlined/MailOutlineKt.class */
public final class MailOutlineKt {
    ...
    public static final ImageVector getMailOutline(@NotNull Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.MailOutline", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
