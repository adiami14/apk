...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/outlined/MenuKt.class */
public final class MenuKt {
    ...
    public static final ImageVector getMenu(@NotNull Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Menu", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
