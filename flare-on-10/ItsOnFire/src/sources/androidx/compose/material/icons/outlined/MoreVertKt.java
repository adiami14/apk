...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/outlined/MoreVertKt.class */
public final class MoreVertKt {
    ...
    public static final ImageVector getMoreVert(@NotNull Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.MoreVert", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
