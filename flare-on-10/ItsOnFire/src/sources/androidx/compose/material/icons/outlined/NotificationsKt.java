...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/outlined/NotificationsKt.class */
public final class NotificationsKt {
    ...
    public static final ImageVector getNotifications(@NotNull Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Notifications", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
