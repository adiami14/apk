...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/outlined/PersonKt.class */
public final class PersonKt {
    ...
    public static final ImageVector getPerson(@NotNull Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Person", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
