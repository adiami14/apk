...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/outlined/PhoneKt.class */
public final class PhoneKt {
    ...
    public static final ImageVector getPhone(@NotNull Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Phone", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
