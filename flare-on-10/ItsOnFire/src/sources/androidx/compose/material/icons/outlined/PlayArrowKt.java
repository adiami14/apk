...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/outlined/PlayArrowKt.class */
public final class PlayArrowKt {
    ...
    public static final ImageVector getPlayArrow(@NotNull Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.PlayArrow", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
