...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/outlined/RefreshKt.class */
public final class RefreshKt {
    ...
    public static final ImageVector getRefresh(@NotNull Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Refresh", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
