...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/outlined/SettingsKt.class */
public final class SettingsKt {
    ...
    public static final ImageVector getSettings(@NotNull Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Settings", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
