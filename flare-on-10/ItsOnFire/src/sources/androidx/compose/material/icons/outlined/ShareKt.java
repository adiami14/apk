...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/outlined/ShareKt.class */
public final class ShareKt {
    ...
    public static final ImageVector getShare(@NotNull Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Share", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
