...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/outlined/StarKt.class */
public final class StarKt {
    ...
    public static final ImageVector getStar(@NotNull Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Star", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
