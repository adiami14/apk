...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/outlined/ThumbUpKt.class */
public final class ThumbUpKt {
    ...
    public static final ImageVector getThumbUp(@NotNull Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.ThumbUp", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
