...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/outlined/WarningKt.class */
public final class WarningKt {
    ...
    public static final ImageVector getWarning(@NotNull Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Warning", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
