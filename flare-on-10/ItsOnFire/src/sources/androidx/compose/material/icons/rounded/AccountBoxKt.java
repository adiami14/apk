...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/rounded/AccountBoxKt.class */
public final class AccountBoxKt {
    ...
    public static final ImageVector getAccountBox(@NotNull Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.AccountBox", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
