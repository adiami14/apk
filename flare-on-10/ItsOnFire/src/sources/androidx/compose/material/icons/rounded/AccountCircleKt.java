...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/rounded/AccountCircleKt.class */
public final class AccountCircleKt {
    ...
    public static final ImageVector getAccountCircle(@NotNull Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.AccountCircle", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
