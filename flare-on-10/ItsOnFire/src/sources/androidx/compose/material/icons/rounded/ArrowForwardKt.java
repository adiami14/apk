...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/rounded/ArrowForwardKt.class */
public final class ArrowForwardKt {
    ...
    public static final ImageVector getArrowForward(@NotNull Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.ArrowForward", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
