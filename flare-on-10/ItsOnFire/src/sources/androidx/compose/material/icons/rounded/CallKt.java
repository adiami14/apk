...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/rounded/CallKt.class */
public final class CallKt {
    ...
    public static final ImageVector getCall(@NotNull Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Call", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
