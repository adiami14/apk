...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/rounded/CheckKt.class */
public final class CheckKt {
    ...
    public static final ImageVector getCheck(@NotNull Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Check", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
