...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/rounded/ClearKt.class */
public final class ClearKt {
    ...
    public static final ImageVector getClear(@NotNull Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Clear", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
