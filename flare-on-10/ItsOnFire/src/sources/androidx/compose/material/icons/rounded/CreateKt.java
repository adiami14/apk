...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/rounded/CreateKt.class */
public final class CreateKt {
    ...
    public static final ImageVector getCreate(@NotNull Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Create", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
