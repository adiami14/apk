...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/rounded/DateRangeKt.class */
public final class DateRangeKt {
    ...
    public static final ImageVector getDateRange(@NotNull Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.DateRange", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
