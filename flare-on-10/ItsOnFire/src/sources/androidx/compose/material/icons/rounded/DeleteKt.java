...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/rounded/DeleteKt.class */
public final class DeleteKt {
    ...
    public static final ImageVector getDelete(@NotNull Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Delete", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
