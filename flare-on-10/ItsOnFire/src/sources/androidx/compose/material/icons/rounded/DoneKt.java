...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/rounded/DoneKt.class */
public final class DoneKt {
    ...
    public static final ImageVector getDone(@NotNull Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Done", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
