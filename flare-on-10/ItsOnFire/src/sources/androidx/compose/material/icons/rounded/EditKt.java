...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/rounded/EditKt.class */
public final class EditKt {
    ...
    public static final ImageVector getEdit(@NotNull Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Edit", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
