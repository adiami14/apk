...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/rounded/ExitToAppKt.class */
public final class ExitToAppKt {
    ...
    public static final ImageVector getExitToApp(@NotNull Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.ExitToApp", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
