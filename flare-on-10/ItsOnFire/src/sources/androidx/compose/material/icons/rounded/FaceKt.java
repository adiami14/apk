...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/rounded/FaceKt.class */
public final class FaceKt {
    ...
    public static final ImageVector getFace(@NotNull Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Face", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
