...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/rounded/FavoriteBorderKt.class */
public final class FavoriteBorderKt {
    ...
    public static final ImageVector getFavoriteBorder(@NotNull Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.FavoriteBorder", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
