...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/rounded/FavoriteKt.class */
public final class FavoriteKt {
    ...
    public static final ImageVector getFavorite(@NotNull Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Favorite", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
