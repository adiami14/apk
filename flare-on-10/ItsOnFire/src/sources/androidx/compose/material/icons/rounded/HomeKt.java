...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/rounded/HomeKt.class */
public final class HomeKt {
    ...
    public static final ImageVector getHome(@NotNull Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Home", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
