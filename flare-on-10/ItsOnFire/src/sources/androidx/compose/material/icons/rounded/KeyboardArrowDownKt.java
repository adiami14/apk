...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/rounded/KeyboardArrowDownKt.class */
public final class KeyboardArrowDownKt {
    ...
    public static final ImageVector getKeyboardArrowDown(@NotNull Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.KeyboardArrowDown", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
