...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/rounded/KeyboardArrowLeftKt.class */
public final class KeyboardArrowLeftKt {
    ...
    public static final ImageVector getKeyboardArrowLeft(@NotNull Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.KeyboardArrowLeft", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
