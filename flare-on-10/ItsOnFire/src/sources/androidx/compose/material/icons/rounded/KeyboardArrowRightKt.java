...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/rounded/KeyboardArrowRightKt.class */
public final class KeyboardArrowRightKt {
    ...
    public static final ImageVector getKeyboardArrowRight(@NotNull Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.KeyboardArrowRight", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
