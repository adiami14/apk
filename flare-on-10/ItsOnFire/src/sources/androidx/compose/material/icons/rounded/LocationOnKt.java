...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/rounded/LocationOnKt.class */
public final class LocationOnKt {
    ...
    public static final ImageVector getLocationOn(@NotNull Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.LocationOn", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
