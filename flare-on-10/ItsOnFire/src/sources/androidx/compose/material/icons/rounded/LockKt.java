...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/rounded/LockKt.class */
public final class LockKt {
    ...
    public static final ImageVector getLock(@NotNull Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Lock", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
