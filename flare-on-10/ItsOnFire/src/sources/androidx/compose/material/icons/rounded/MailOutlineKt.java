...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/rounded/MailOutlineKt.class */
public final class MailOutlineKt {
    ...
    public static final ImageVector getMailOutline(@NotNull Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.MailOutline", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
