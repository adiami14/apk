...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/rounded/MoreVertKt.class */
public final class MoreVertKt {
    ...
    public static final ImageVector getMoreVert(@NotNull Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.MoreVert", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
