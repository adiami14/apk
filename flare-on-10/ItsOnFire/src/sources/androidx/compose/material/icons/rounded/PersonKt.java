...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/rounded/PersonKt.class */
public final class PersonKt {
    ...
    public static final ImageVector getPerson(@NotNull Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Person", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
