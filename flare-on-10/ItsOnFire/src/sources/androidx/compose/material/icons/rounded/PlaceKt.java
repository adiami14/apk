...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/rounded/PlaceKt.class */
public final class PlaceKt {
    ...
    public static final ImageVector getPlace(@NotNull Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Place", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
