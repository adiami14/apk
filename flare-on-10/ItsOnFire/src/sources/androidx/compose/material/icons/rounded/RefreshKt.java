...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/rounded/RefreshKt.class */
public final class RefreshKt {
    ...
    public static final ImageVector getRefresh(@NotNull Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Refresh", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
