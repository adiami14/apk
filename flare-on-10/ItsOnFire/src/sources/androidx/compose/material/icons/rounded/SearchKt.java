...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/rounded/SearchKt.class */
public final class SearchKt {
    ...
    public static final ImageVector getSearch(@NotNull Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Search", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
