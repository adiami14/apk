...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/rounded/SendKt.class */
public final class SendKt {
    ...
    public static final ImageVector getSend(@NotNull Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Send", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
