...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/rounded/SettingsKt.class */
public final class SettingsKt {
    ...
    public static final ImageVector getSettings(@NotNull Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Settings", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
