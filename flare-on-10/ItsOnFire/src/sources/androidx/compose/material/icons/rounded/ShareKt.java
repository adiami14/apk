...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/rounded/ShareKt.class */
public final class ShareKt {
    ...
    public static final ImageVector getShare(@NotNull Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Share", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
