...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/rounded/ShoppingCartKt.class */
public final class ShoppingCartKt {
    ...
    public static final ImageVector getShoppingCart(@NotNull Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.ShoppingCart", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
