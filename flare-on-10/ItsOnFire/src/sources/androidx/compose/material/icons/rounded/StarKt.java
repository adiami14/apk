...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/rounded/StarKt.class */
public final class StarKt {
    ...
    public static final ImageVector getStar(@NotNull Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Star", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
