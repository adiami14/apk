...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/sharp/AddKt.class */
public final class AddKt {
    ...
    public static final ImageVector getAdd(@NotNull Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.Add", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
