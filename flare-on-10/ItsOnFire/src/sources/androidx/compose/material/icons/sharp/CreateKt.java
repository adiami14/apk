...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/sharp/CreateKt.class */
public final class CreateKt {
    ...
    public static final ImageVector getCreate(@NotNull Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.Create", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
