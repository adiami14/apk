...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/sharp/DoneKt.class */
public final class DoneKt {
    ...
    public static final ImageVector getDone(@NotNull Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.Done", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
