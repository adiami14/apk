...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/sharp/ListKt.class */
public final class ListKt {
    ...
    public static final ImageVector getList(@NotNull Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.List", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
