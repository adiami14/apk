...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/twotone/CloseKt.class */
public final class CloseKt {
    ...
    public static final ImageVector getClose(@NotNull Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Close", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
