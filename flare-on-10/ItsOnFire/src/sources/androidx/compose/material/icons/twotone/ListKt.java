...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/twotone/ListKt.class */
public final class ListKt {
    ...
    public static final ImageVector getList(@NotNull Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.List", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
