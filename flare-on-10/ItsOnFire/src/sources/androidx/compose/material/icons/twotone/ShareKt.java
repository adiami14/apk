...
/* loaded from: ItsOnFire.jar:androidx/compose/material/icons/twotone/ShareKt.class */
public final class ShareKt {
    ...
    public static final ImageVector getShare(@NotNull Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Share", Dp.m4785constructorimpl(24.0f), Dp.m4785constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
        ...
        pathBuilder3.arcToRelative(1.0f, 1.0f, 0.0f, true, true, -2.0f, 0.0f);
        ImageVector.Builder.m2954addPathoIyEayM$default(builder, pathBuilder3.getNodes(), defaultFillType3, "", solidColor3, 0.3f, null, 0.3f, 1.0f, m2711getButtKaPHkGw3, m2722getBevelLxFBmk83, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
