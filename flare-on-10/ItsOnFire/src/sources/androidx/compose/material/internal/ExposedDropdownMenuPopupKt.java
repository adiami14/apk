...
/* loaded from: ItsOnFire.jar:androidx/compose/material/internal/ExposedDropdownMenuPopupKt.class */
public final class ExposedDropdownMenuPopupKt {
    ...
    @Composable
    public static final void ExposedDropdownMenuPopup(@Nullable Function0<Unit> function0, @NotNull final PopupPositionProvider popupPositionProvider, @NotNull final Function2<? super Composer, ? super Integer, Unit> content, @Nullable Composer composer, final int i2, final int i3) {
        int i4;
        int i5;
        int i6;
        ...
        if ((i3 & 2) != 0) {
            ...
            if ((i2 & R.styleable.AppCompatTheme_toolbarNavigationButtonStyle) == 0) {
                i5 = i4 | (startRestartGroup.changed(popupPositionProvider) ? 32 : 16);
            }
        }
        if ((i3 & 4) != 0) {
            i6 = i5 | 384;
        ...
        if (((i6 & 731) ^ 146) == 0 && startRestartGroup.getSkipping()) {
            ...
            UUID popupId = (UUID) RememberSaveableKt.m2016rememberSaveable(new Object[0], (Saver<Object, ? extends Object>) null, (String) null, (Function0<? extends Object>) new Function0<UUID>() { // from class: androidx.compose.material.internal.ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$popupId$1
                @Override // kotlin.jvm.functions.Function0
            ...
            PopupLayout popupLayout = rememberedValue;
            if (rememberedValue == Composer.Companion.getEmpty()) {
                Intrinsics.checkNotNullExpressionValue(popupId, "popupId");
                final PopupLayout popupLayout2 = new PopupLayout(function0, str, view, density, popupPositionProvider, popupId);
                popupLayout2.setContent(rememberCompositionContext, ComposableLambdaKt.composableLambdaInstance(-985530875, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.internal.ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$popupLayout$1$1$1
                    ...
                    public final void invoke(@Nullable Composer composer2, int i8) {
                        ...
                        Modifier alpha = AlphaKt.alpha(OnRemeasuredModifierKt.onSizeChanged(semantics$default, new Function1<IntSize, Unit>() { // from class: androidx.compose.material.internal.ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$popupLayout$1$1$1.2
                            ...
                            public /* bridge */ /* synthetic */ Unit invoke(IntSize intSize) {
                                m1902invokeozmzZPI(intSize.m4955unboximpl());
                                return Unit.INSTANCE;
                            }

                            /* renamed from: invoke-ozmzZPI  reason: not valid java name */
                            public final void m1902invokeozmzZPI(long j2) {
                                PopupLayout.this.m1907setPopupContentSizefhxjrPA(IntSize.m4943boximpl(j2));
                        ...
                        ComposableLambda composableLambda = ComposableLambdaKt.composableLambda(composer2, -819890245, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.internal.ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$popupLayout$1$1$1.3
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            /* JADX WARN: Multi-variable type inference failed */
                            {
                                super(2);
                            ...
                            public final void invoke(@Nullable Composer composer3, int i9) {
                                Function2 m1897ExposedDropdownMenuPopup$lambda0;
                                if (((i9 & 11) ^ 2) == 0 && composer3.getSkipping()) {
                                    composer3.skipToGroupEnd();
                                    return;
                                }
                                m1897ExposedDropdownMenuPopup$lambda0 = ExposedDropdownMenuPopupKt.m1897ExposedDropdownMenuPopup$lambda0(state);
                                m1897ExposedDropdownMenuPopup$lambda0.invoke(composer3, 0);
                            }
                        });
                        composer2.startReplaceableGroup(-968745991);
                        ...
                        Updater.m1996setimpl(m1989constructorimpl, exposedDropdownMenuPopupKt$SimpleStack$1, companion.getSetMeasurePolicy());
                        Updater.m1996setimpl(m1989constructorimpl, density2, companion.getSetDensity());
                        Updater.m1996setimpl(m1989constructorimpl, layoutDirection2, companion.getSetLayoutDirection());
                ...
                startRestartGroup.updateRememberedValue(popupLayout2);
            ...
            Modifier onGloballyPositioned = OnGloballyPositionedModifierKt.onGloballyPositioned(Modifier.Companion, new Function1<LayoutCoordinates, Unit>() { // from class: androidx.compose.material.internal.ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$5
                ...
                public final void invoke2(@NotNull LayoutCoordinates childCoordinates) {
                    ...
                    long mo3927getSizeYbymL2g = parentLayoutCoordinates.mo3927getSizeYbymL2g();
                    long positionInWindow = LayoutCoordinatesKt.positionInWindow(parentLayoutCoordinates);
                    roundToInt = MathKt__MathJVMKt.roundToInt(Offset.m2167getXimpl(positionInWindow));
                    roundToInt2 = MathKt__MathJVMKt.roundToInt(Offset.m2168getYimpl(positionInWindow));
                    PopupLayout.this.setParentBounds(IntRectKt.m4940IntRectVbeCjmY(IntOffsetKt.IntOffset(roundToInt, roundToInt2), mo3927getSizeYbymL2g));
                    PopupLayout.this.updatePosition();
                }
            });
            MeasurePolicy measurePolicy = new MeasurePolicy() { // from class: androidx.compose.material.internal.ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$6
                ...
                public final MeasureResult mo89measure3p2s80s(@NotNull MeasureScope Layout, @NotNull List<? extends Measurable> noName_0, long j2) {
                    ...
                    return MeasureScope.DefaultImpls.layout$default(Layout, 0, 0, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.internal.ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$6$measure$1
                        @Override // kotlin.jvm.functions.Function1
            ...
            startRestartGroup.startReplaceableGroup(952323942);
            startRestartGroup.endReplaceableGroup();
            startRestartGroup.endReplaceableGroup();
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.internal.ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$7
            ...
            public final void invoke(@Nullable Composer composer2, int i8) {
                ExposedDropdownMenuPopupKt.ExposedDropdownMenuPopup(function04, popupPositionProvider, content, composer2, i2 | 1, i3);
            }
        });
    }
    ...
    public static final Function2<Composer, Integer, Unit> m1897ExposedDropdownMenuPopup$lambda0(State<? extends Function2<? super Composer, ? super Integer, Unit>> state) {
