...
/* loaded from: ItsOnFire.jar:androidx/compose/material/ripple/AndroidRippleIndicationInstance.class */
public final class AndroidRippleIndicationInstance extends RippleIndicationInstance implements RememberObserver {
    ...
    private AndroidRippleIndicationInstance(boolean z, float f2, State<Color> state, State<RippleAlpha> state2, RippleContainer rippleContainer) {
        ...
        this.rippleSize = Size.Companion.m2248getZeroNHjbRc();
        this.rippleRadius = -1;
    ...
    public void addRipple(@NotNull PressInteraction.Press interaction, @NotNull u0 scope) {
        ...
        rippleHostView.m1920addRippleKOepWvA(interaction, this.bounded, this.rippleSize, this.rippleRadius, this.color.getValue().m2424unboximpl(), this.rippleAlpha.getValue().getPressedAlpha(), this.onInvalidateRipple);
    ...
    public void drawIndication(@NotNull ContentDrawScope contentDrawScope) {
        ...
        this.rippleSize = contentDrawScope.mo2841getSizeNHjbRc();
        if (Float.isNaN(this.radius)) {
            roundToInt = MathKt__MathJVMKt.roundToInt(RippleAnimationKt.m1916getRippleEndRadiuscSwnlzA(contentDrawScope, this.bounded, contentDrawScope.mo2841getSizeNHjbRc()));
            mo518roundToPx0680j_4 = roundToInt;
        } else {
            mo518roundToPx0680j_4 = contentDrawScope.mo518roundToPx0680j_4(this.radius);
        }
        this.rippleRadius = mo518roundToPx0680j_4;
        long m2424unboximpl = this.color.getValue().m2424unboximpl();
        float pressedAlpha = this.rippleAlpha.getValue().getPressedAlpha();
        contentDrawScope.drawContent();
        m1922drawStateLayerH2RKhps(contentDrawScope, this.radius, m2424unboximpl);
        ...
        rippleHostView.m1921updateRipplePropertiesbiQXAtU(contentDrawScope.mo2841getSizeNHjbRc(), this.rippleRadius, m2424unboximpl, pressedAlpha);
