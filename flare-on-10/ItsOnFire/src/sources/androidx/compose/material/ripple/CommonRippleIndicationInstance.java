...
/* loaded from: ItsOnFire.jar:androidx/compose/material/ripple/CommonRippleIndicationInstance.class */
public final class CommonRippleIndicationInstance extends RippleIndicationInstance implements RememberObserver {
    ...
    private final void m1912drawRipples4WTKRHQ(DrawScope drawScope, long j2) {
        for (Map.Entry<PressInteraction.Press, RippleAnimation> entry : this.ripples.entrySet()) {
            ...
            if (!(pressedAlpha == 0.0f)) {
                value.m1914draw4WTKRHQ(drawScope, Color.m2413copywmQWz5c$default(j2, pressedAlpha, 0.0f, 0.0f, 0.0f, 14, null));
            }
        }
    }
    ...
    public void addRipple(@NotNull PressInteraction.Press interaction, @NotNull u0 scope) {
        ...
        RippleAnimation rippleAnimation = new RippleAnimation(this.bounded ? Offset.m2156boximpl(interaction.m562getPressPositionF1C5BW0()) : null, this.radius, this.bounded, null);
    ...
    public void drawIndication(@NotNull ContentDrawScope contentDrawScope) {
        ...
        m1912drawRipples4WTKRHQ(contentDrawScope, m2424unboximpl);
    }
