...
/* loaded from: ItsOnFire.jar:androidx/compose/material/ripple/DebugRippleTheme.class */
public final class DebugRippleTheme implements RippleTheme {
    ...
    public long mo1389defaultColorWaAFU9c(@Nullable Composer composer, int i2) {
        ...
        long m1928defaultRippleColor5vOe2sY = RippleTheme.Companion.m1928defaultRippleColor5vOe2sY(Color.Companion.m2440getBlack0d7_KjU(), true);
    ...
    public RippleAlpha rippleAlpha(@Nullable Composer composer, int i2) {
        ...
        RippleAlpha m1927defaultRippleAlphaDxMtmZc = RippleTheme.Companion.m1927defaultRippleAlphaDxMtmZc(Color.Companion.m2440getBlack0d7_KjU(), true);
        composer.endReplaceableGroup();
