...
/* loaded from: ItsOnFire.jar:androidx/compose/material/ripple/Ripple.class */
public abstract class Ripple implements Indication {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof Ripple) {
            ...
            return this.bounded == ripple.bounded && Dp.m4790equalsimpl0(this.radius, ripple.radius) && Intrinsics.areEqual(this.color, ripple.color);
        }
        return false;
    }

    public int hashCode() {
        return (((Boolean.hashCode(this.bounded) * 31) + Dp.m4791hashCodeimpl(this.radius)) * 31) + this.color.hashCode();
    }
    ...
    public final IndicationInstance rememberUpdatedInstance(@NotNull InteractionSource interactionSource, @Nullable Composer composer, int i2) {
        ...
        long m2424unboximpl = (this.color.getValue().m2424unboximpl() > Color.Companion.m2450getUnspecified0d7_KjU() ? 1 : (this.color.getValue().m2424unboximpl() == Color.Companion.m2450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? this.color.getValue().m2424unboximpl() : rippleTheme.mo1389defaultColorWaAFU9c(composer, 0);
        composer.endReplaceableGroup();
        RippleIndicationInstance mo1911rememberUpdatedRippleInstance942rkJo = mo1911rememberUpdatedRippleInstance942rkJo(interactionSource, this.bounded, this.radius, SnapshotStateKt.rememberUpdatedState(Color.m2404boximpl(m2424unboximpl), composer, 0), SnapshotStateKt.rememberUpdatedState(rippleTheme.rippleAlpha(composer, 0), composer, 0), composer, (i2 & 14) | (458752 & (i2 << 12)));
        EffectsKt.LaunchedEffect(mo1911rememberUpdatedRippleInstance942rkJo, interactionSource, new Ripple$rememberUpdatedInstance$1(interactionSource, mo1911rememberUpdatedRippleInstance942rkJo, null), composer, ((i2 << 3) & androidx.appcompat.R.styleable.AppCompatTheme_toolbarNavigationButtonStyle) | 8);
        composer.endReplaceableGroup();
        return mo1911rememberUpdatedRippleInstance942rkJo;
    }

    @Composable
    @NotNull
    /* renamed from: rememberUpdatedRippleInstance-942rkJo */
    public abstract RippleIndicationInstance mo1911rememberUpdatedRippleInstance942rkJo(@NotNull InteractionSource interactionSource, boolean z, float f2, @NotNull State<Color> state, @NotNull State<RippleAlpha> state2, @Nullable Composer composer, int i2);
}
