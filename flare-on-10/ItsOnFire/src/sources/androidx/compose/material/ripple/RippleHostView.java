...
/* loaded from: ItsOnFire.jar:androidx/compose/material/ripple/RippleHostView.class */
public final class RippleHostView extends View {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/material/ripple/RippleHostView$Companion.class */
    ...
    private final void setRippleState(boolean z) {
        ...
        if (z || currentAnimationTimeMillis - longValue >= MinimumRippleStateChangeTime) {
            ...
            Runnable runnable2 = new Runnable() { // from class: androidx.compose.material.ripple.a
                ...
                public final void run() {
                    RippleHostView.m1919setRippleState$lambda2(RippleHostView.this);
                }
            };
    ...
    public static final void m1919setRippleState$lambda2(RippleHostView this$0) {
    ...
    public final void m1920addRippleKOepWvA(@NotNull PressInteraction.Press interaction, boolean z, long j2, int i2, long j3, float f2, @NotNull Function0<Unit> onInvalidateRipple) {
        float centerX;
        float centerY;
        ...
        m1921updateRipplePropertiesbiQXAtU(j2, i2, j3, f2);
        if (z) {
            centerX = Offset.m2167getXimpl(interaction.m562getPressPositionF1C5BW0());
            centerY = Offset.m2168getYimpl(interaction.m562getPressPositionF1C5BW0());
        } else {
    ...
    public final void m1921updateRipplePropertiesbiQXAtU(long j2, int i2, long j3, float f2) {
        UnprojectedRipple unprojectedRipple = this.ripple;
        if (unprojectedRipple == null) {
            return;
        }
        unprojectedRipple.trySetRadius(i2);
        unprojectedRipple.m1934setColorDxMtmZc(j3, f2);
        Rect androidRect = RectHelper_androidKt.toAndroidRect(SizeKt.m2260toRectuvyYCjk(j2));
