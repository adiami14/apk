...
/* loaded from: ItsOnFire.jar:androidx/compose/material/ripple/UnprojectedRipple.class */
public final class UnprojectedRipple extends RippleDrawable {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/material/ripple/UnprojectedRipple$Companion.class */
    ...
    @RequiresApi(23)
    /* loaded from: ItsOnFire.jar:androidx/compose/material/ripple/UnprojectedRipple$MRadiusHelper.class */
    ...
    private final long m1933calculateRippleColor5vOe2sY(long j2, float f2) {
        float coerceAtMost;
        coerceAtMost = RangesKt___RangesKt.coerceAtMost(f2, 1.0f);
        return Color.m2413copywmQWz5c$default(j2, coerceAtMost, 0.0f, 0.0f, 0.0f, 14, null);
    }
    ...
    public final void m1934setColorDxMtmZc(long j2, float f2) {
        long m1933calculateRippleColor5vOe2sY = m1933calculateRippleColor5vOe2sY(j2, f2);
        Color color = this.rippleColor;
        if (color == null ? false : Color.m2415equalsimpl0(color.m2424unboximpl(), m1933calculateRippleColor5vOe2sY)) {
            return;
        }
        this.rippleColor = Color.m2404boximpl(m1933calculateRippleColor5vOe2sY);
        setColor(ColorStateList.valueOf(ColorKt.m2470toArgb8_81llA(m1933calculateRippleColor5vOe2sY)));
    }
