...
/* loaded from: ItsOnFire.jar:androidx/compose/runtime/ActualJvm_jvmKt.class */
public final class ActualJvm_jvmKt {
    ...
    public static final <R> R m1939synchronized(@NotNull Object lock, @NotNull Function0<? extends R> block) {
        R invoke;
