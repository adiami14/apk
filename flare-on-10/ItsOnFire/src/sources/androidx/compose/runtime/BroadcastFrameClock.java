...
/* loaded from: ItsOnFire.jar:androidx/compose/runtime/BroadcastFrameClock.class */
public final class BroadcastFrameClock implements MonotonicFrameClock {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/runtime/BroadcastFrameClock$FrameAwaiter.class */
    public static final class FrameAwaiter<R> {
        ...
        public final void resume(long j2) {
            ...
            try {
                ...
                m5849constructorimpl = Result.m5849constructorimpl(getOnFrame().invoke(Long.valueOf(j2)));
            } catch (Throwable th) {
                Result.Companion companion2 = Result.Companion;
                m5849constructorimpl = Result.m5849constructorimpl(ResultKt.createFailure(th));
            }
            continuation.resumeWith(m5849constructorimpl);
        }
    }
    ...
    public final void fail(Throwable th) {
        synchronized (this.lock) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                Result.Companion companion = Result.Companion;
                continuation.resumeWith(Result.m5849constructorimpl(ResultKt.createFailure(th)));
            }
            this.awaiters.clear();
    ...
    /* JADX WARN: Type inference failed for: r0v11, types: [T, androidx.compose.runtime.BroadcastFrameClock$FrameAwaiter] */
    ...
    public <R> Object withFrameNanos(@NotNull Function1<? super Long, ? extends R> function1, @NotNull Continuation<? super R> continuation) {
        ...
        synchronized (this.lock) {
            ...
            if (th != null) {
                Result.Companion companion = Result.Companion;
                rVar.resumeWith(Result.m5849constructorimpl(ResultKt.createFailure(th)));
            } else {
                ...
                rVar.A(new Function1<Throwable, Unit>() { // from class: androidx.compose.runtime.BroadcastFrameClock$withFrameNanos$2$1
