...
/* loaded from: ItsOnFire.jar:androidx/compose/runtime/ComposerImpl.class */
public final class ComposerImpl implements Composer {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/runtime/ComposerImpl$CompositionContextHolder.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/runtime/ComposerImpl$CompositionContextImpl.class */
    ...
    private final int compoundKeyOf(int i2, int i3, int i4) {
        if (i2 != i3) {
            i4 = Integer.rotateLeft(compoundKeyOf(this.reader.parent(i2), i3, i4), 3) ^ groupCompoundKeyPart(this.reader, i2);
        }
        return i4;
    }
    ...
    private final PersistentMap<CompositionLocal<Object>, State<Object>> currentCompositionLocalScope() {
        if (getInserting() && this.hasProvider) {
            ...
            while (true) {
                ...
                if (i2 <= 0) {
                    break;
                } else if (this.writer.groupKey(i2) == 202 && Intrinsics.areEqual(this.writer.groupObjectKey(i2), ComposerKt.getCompositionLocalMap())) {
        ...
        if (this.slotTable.getGroupsSize() > 0) {
            ...
            while (true) {
                ...
                if (i3 <= 0) {
                    break;
                } else if (this.reader.groupKey(i3) == 202 && Intrinsics.areEqual(this.reader.groupObjectKey(i3), ComposerKt.getCompositionLocalMap())) {
    ...
    private final void doCompose(IdentityArrayMap<RecomposeScopeImpl, IdentityArraySet<Object>> identityArrayMap, final Function2<? super Composer, ? super Integer, Unit> function2) {
        ...
        try {
            ...
            if (list.size() > 1) {
                CollectionsKt__MutableCollectionsJVMKt.sortWith(list, new Comparator() { // from class: androidx.compose.runtime.ComposerImpl$doCompose$lambda_25$$inlined$sortBy$1
    ...
    private final void end(boolean z) {
                    ...
                    if (i9 < size) {
                        ...
                        if (keyInfo2 != keyInfo) {
                            ...
                            if (nodePositionOf != i8) {
                                ...
                                recordMoveNode(pending.getStartIndex() + nodePositionOf, i8 + pending.getStartIndex(), updatedNodeCountOf);
                        ...
                        i4 = i9 + 1;
                        i5 = i8 + pending.updatedNodeCountOf(keyInfo2);
                        list = used;
                    }
                    used = list;
                    i7 = i3;
        ...
        if (inserting) {
            ...
            if (i6 != updatedNodeCount(parent4)) {
                updateNodeCountOverrides(parent4, i6);
            }
            int i12 = i6;
            if (z) {
                i12 = 1;
    ...
    private final int groupCompoundKeyPart(SlotReader slotReader, int i2) {
        ...
        if (slotReader.hasObjectKey(i2)) {
            ...
            i3 = groupObjectKey == null ? 0 : groupObjectKey instanceof Enum ? ((Enum) groupObjectKey).ordinal() : groupObjectKey.hashCode();
        } else {
            int groupKey = slotReader.groupKey(i2);
            i3 = groupKey;
            if (groupKey == 207) {
                Object groupAux = slotReader.groupAux(i2);
                i3 = groupAux == null ? groupKey : Intrinsics.areEqual(groupAux, Composer.Companion.getEmpty()) ? groupKey : groupAux.hashCode();
            }
        }
        return i3;
    }
    ...
    private final int nodeIndexOf(int i2, int i3, int i4, int i5) {
        ...
        while (true) {
            i6 = parent;
            if (i6 == i4 || this.reader.isNode(i6)) {
                break;
            }
            parent = this.reader.parent(i6);
        }
        if (this.reader.isNode(i6)) {
            i5 = 0;
        }
        if (i6 == i3) {
            return i5;
        }
        int updatedNodeCount = updatedNodeCount(i6);
        int nodeCount = this.reader.nodeCount(i3);
        int i8 = i5;
        int i9 = i6;
        loop1: while (true) {
            i7 = i8;
            if (i8 < (updatedNodeCount - nodeCount) + i5) {
                if (i9 != i2) {
                    i9++;
                    while (true) {
                        i7 = i8;
                        ...
                        int groupSize = this.reader.groupSize(i9) + i9;
                        if (i2 < groupSize) {
                            break;
                        }
                        i8 += updatedNodeCount(i9);
                        i9 = groupSize;
                    }
                } else {
                    i7 = i8;
    ...
    private final <T> T resolveCompositionLocal(CompositionLocal<T> compositionLocal, PersistentMap<CompositionLocal<Object>, ? extends State<? extends Object>> persistentMap) {
        return ComposerKt.contains(persistentMap, compositionLocal) ? ComposerKt.getValueOf(persistentMap, compositionLocal) : compositionLocal.getDefaultValueHolder$runtime_release().getValue();
    }
    ...
    private final void start(int i2, Object obj, boolean z, Object obj2) {
        ...
        if (getInserting()) {
            ...
            if (z) {
                ...
                slotWriter2.startGroup(i2, obj4);
            }
            Pending pending = this.pending;
            if (pending != null) {
        ...
        if (pending2 != null) {
            KeyInfo next = pending2.getNext(i2, obj);
            if (next != null) {
                ...
                if (z) {
                    ...
                    slotWriter3.startData(i2, obj5, obj2);
                } else {
                    SlotWriter slotWriter4 = this.writer;
                    Object obj6 = obj;
                    if (obj == null) {
                        obj6 = Composer.Companion.getEmpty();
                    }
                    slotWriter4.startGroup(i2, obj6);
                }
    ...
    private final void updateNodeCount(int i2, int i3) {
        if (updatedNodeCount(i2) != i3) {
            ...
            int[] iArr2 = iArr;
            if (iArr == null) {
                iArr2 = new int[this.reader.getSize()];
    ...
    private final void updateNodeCountOverrides(int i2, int i3) {
        ...
        while (true) {
            ...
            int updatedNodeCount2 = updatedNodeCount(i2) + (i3 - updatedNodeCount);
            ...
            if (i4 >= 0) {
                ...
                while (true) {
                    int i7 = i6;
                    int i8 = i7 - 1;
                    Pending peek = this.pendingStack.peek(i7);
    ...
    public <V, T> void apply(final V v2, @NotNull final Function2<? super T, ? super V, Unit> block) {
        ...
        Function3<Applier<?>, SlotWriter, RememberManager, Unit> function3 = new Function3<Applier<?>, SlotWriter, RememberManager, Unit>() { // from class: androidx.compose.runtime.ComposerImpl$apply$operation$1
            ...
            public final void invoke2(@NotNull Applier<?> applier, @NotNull SlotWriter noName_1, @NotNull RememberManager noName_2) {
                ...
                Intrinsics.checkNotNullParameter(noName_1, "$noName_1");
                Intrinsics.checkNotNullParameter(noName_2, "$noName_2");
                block.invoke(applier.getCurrent(), v2);
            }
        };
        if (getInserting()) {
    ...
    public CompositionContext buildContext() {
        ...
        CompositionContextHolder compositionContextHolder2 = compositionContextHolder;
        if (compositionContextHolder == null) {
            compositionContextHolder2 = new CompositionContextHolder(new CompositionContextImpl(this, getCompoundKeyHash(), this.collectParameterInformation));
            updateValue(compositionContextHolder2);
        }
        compositionContextHolder2.getRef().updateCompositionLocalScope(currentCompositionLocalScope());
        endGroup();
    ...
    public final <T> T cache(boolean z, @NotNull Function0<? extends T> block) {
        ...
        if (nextSlot == Composer.Companion.getEmpty() || z) {
            nextSlot = block.invoke();
            updateValue(nextSlot);
        }
        return (T) nextSlot;
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:24:0x0073, code lost:
        if (r6.collectParameterInformation != false) goto L20;
     */
    @Override // androidx.compose.runtime.Composer
    ...
    */
    public androidx.compose.runtime.ScopeUpdateScope endRestartGroup() {
        /*
            r6 = this;
            r0 = r6
            androidx.compose.runtime.Stack<androidx.compose.runtime.RecomposeScopeImpl> r0 = r0.invalidateStack
        ...
        L31:
            r0 = r9
            r1 = r6
            androidx.compose.runtime.snapshots.Snapshot r1 = r1.snapshot
            int r1 = r1.getId()
            kotlin.jvm.functions.Function1 r0 = r0.end(r1)
            r10 = r0
            r0 = r10
            if (r0 != 0) goto L46
            goto L54
        L46:
            r0 = r6
            androidx.compose.runtime.ComposerImpl$endRestartGroup$1$1 r1 = new androidx.compose.runtime.ComposerImpl$endRestartGroup$1$1
            r2 = r1
            r3 = r10
            r4 = r6
            r2.<init>()
        ...
        L54:
            ...
            r10 = r0
            r0 = r9
            boolean r0 = r0.getSkipped$runtime_release()
            if (r0 != 0) goto Lb9
            r0 = r9
            ...
            r10 = r0
            r0 = r6
            boolean r0 = r0.collectParameterInformation
            if (r0 == 0) goto Lb9
        L76:
            r0 = r9
            ...
            if (r0 == 0) goto L99
            r0 = r6
            androidx.compose.runtime.SlotWriter r0 = r0.writer
            r10 = r0
            r0 = r10
            r1 = r10
            int r1 = r1.getParent()
    ...
    public final RecomposeScopeImpl getCurrentRecomposeScope$runtime_release() {
        ...
        return (this.childrenComposing == 0 && stack.isNotEmpty()) ? stack.peek() : null;
    }

    /* JADX WARN: Code restructure failed: missing block: B:11:0x0027, code lost:
        if ((r0 != null && r0.getDefaultsInvalid()) != false) goto L14;
     */
    @Override // androidx.compose.runtime.Composer
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    ...
    */
    public boolean getDefaultsInvalid() {
        /*
            r3 = this;
            r0 = r3
            boolean r0 = r0.providersInvalid
            r4 = r0
            r0 = 0
            r5 = r0
            r0 = r4
    ...
    /* JADX WARN: Code restructure failed: missing block: B:15:0x0034, code lost:
        if (((r0 == null || r0.getRequiresRecompose()) ? false : true) != false) goto L12;
     */
    @Override // androidx.compose.runtime.Composer
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    ...
    */
    ...
    public Object joinKey(@Nullable Object obj, @Nullable Object obj2) {
        ...
        JoinedKey joinedKey = key;
        if (key == null) {
            joinedKey = new JoinedKey(obj, obj2);
        }
        return joinedKey;
    }

    /* JADX WARN: Code restructure failed: missing block: B:7:0x0021, code lost:
        if (r2.reusing != false) goto L4;
     */
    @kotlin.PublishedApi
    @org.jetbrains.annotations.Nullable
    /*
    ...
    */
    public final java.lang.Object nextSlot() {
        ...
        L27:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.runtime.ComposerImpl.nextSlot():java.lang.Object");
    }
    ...
    public void startProviders(@NotNull final ProvidedValue<?>[] values) {
        ...
        PersistentMap<CompositionLocal<Object>, ? extends State<? extends Object>> persistentMap2 = (PersistentMap) ComposerKt.invokeComposableForResult(this, new Function2<Composer, Integer, PersistentMap<CompositionLocal<Object>, ? extends State<? extends Object>>>() { // from class: androidx.compose.runtime.ComposerImpl$startProviders$currentProviders$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(2);
        ...
        if (getInserting()) {
            ...
            persistentMap = (PersistentMap) groupGet;
            Object groupGet2 = this.reader.groupGet(1);
            if (groupGet2 == null) {
                throw new NullPointerException("null cannot be cast to non-null type androidx.compose.runtime.external.kotlinx.collections.immutable.PersistentMap<androidx.compose.runtime.CompositionLocal<kotlin.Any?>, androidx.compose.runtime.State<kotlin.Any?>>{ androidx.compose.runtime.ComposerKt.CompositionLocalMap }");
            }
            PersistentMap persistentMap3 = (PersistentMap) groupGet2;
            if (!getSkipping() || !Intrinsics.areEqual(persistentMap3, persistentMap2)) {
                PersistentMap<CompositionLocal<Object>, State<Object>> updateProviderMapGroup = updateProviderMapGroup(currentCompositionLocalScope, persistentMap2);
                z = !Intrinsics.areEqual(updateProviderMapGroup, persistentMap);
    ...
    public final void updateValue(@Nullable final Object obj) {
        ...
        int groupSlotIndex = this.reader.getGroupSlotIndex();
        if (obj instanceof RememberObserver) {
            this.abandonSet.add(obj);
        }
        final int i2 = groupSlotIndex - 1;
