...
/* loaded from: ItsOnFire.jar:androidx/compose/runtime/CompositionKt.class */
public final class CompositionKt {
    ...
    public static final CoroutineContext getRecomposeCoroutineContext(@NotNull ControlledComposition controlledComposition) {
        ...
        CoroutineContext recomposeContext = compositionImpl == null ? null : compositionImpl.getRecomposeContext();
        EmptyCoroutineContext emptyCoroutineContext = recomposeContext;
