...
/* loaded from: ItsOnFire.jar:androidx/compose/runtime/EffectsKt.class */
public final class EffectsKt {
    ...
    public static final void DisposableEffect(@NotNull Object[] keys, @NotNull Function1<? super DisposableEffectScope, ? extends DisposableEffectResult> effect, @Nullable Composer composer, int i2) {
        ...
        while (true) {
            ...
            i3++;
            z2 = z | composer.changed(copyOf[i3]);
        }
        Object rememberedValue = composer.rememberedValue();
    ...
    @Composable
    public static final void LaunchedEffect(@NotNull final Function2<? super u0, ? super Continuation<? super Unit>, ? extends Object> block, @Nullable Composer composer, final int i2) {
        Intrinsics.checkNotNullParameter(block, "block");
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.runtime.EffectsKt$LaunchedEffect$1
            ...
            public final void invoke(@Nullable Composer composer2, int i3) {
                EffectsKt.LaunchedEffect(block, composer2, i2 | 1);
            }
        });
    }
    ...
    public static final u0 createCompositionCoroutineScope(@NotNull CoroutineContext coroutineContext, @NotNull Composer composer) {
        ...
        if (coroutineContext.get(bVar) != null) {
            c2 = t2.c(null, 1, null);
            c0 c0Var = c2;
            c0Var.d(new IllegalArgumentException("CoroutineContext supplied to rememberCoroutineScope may not include a parent job"));
            plus = c0Var;
        } else {
            CoroutineContext applyCoroutineContext = composer.getApplyCoroutineContext();
            plus = applyCoroutineContext.plus(r2.a((n2) applyCoroutineContext.get(bVar))).plus(coroutineContext);
        }
        return v0.a(plus);
    }
    ...
    public static final u0 rememberCoroutineScope(@Nullable Function0<? extends CoroutineContext> function0, @Nullable Composer composer, int i2, int i3) {
        ...
        if (rememberedValue == Composer.Companion.getEmpty()) {
            compositionScopedCoroutineScopeCanceller = new CompositionScopedCoroutineScopeCanceller(createCompositionCoroutineScope(function0.invoke(), composer));
