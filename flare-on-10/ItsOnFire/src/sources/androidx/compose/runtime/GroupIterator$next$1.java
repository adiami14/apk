...
/* loaded from: ItsOnFire.jar:androidx/compose/runtime/GroupIterator$next$1.class */
public final class GroupIterator$next$1 implements CompositionGroup, Iterable<CompositionGroup>, KMappedMarker {
    ...
    public Iterable<Object> getData() {
        ...
        if (this.$group + 1 < this.this$0.getTable().getGroupsSize()) {
            dataAnchor2 = SlotTableKt.dataAnchor(this.this$0.getTable().getGroups(), this.$group + 1);
            slotsSize = dataAnchor2;
        } else {
            slotsSize = this.this$0.getTable().getSlotsSize();
        }
        return new GroupIterator$next$1$data$1(dataAnchor, slotsSize, this.this$0);
    }
