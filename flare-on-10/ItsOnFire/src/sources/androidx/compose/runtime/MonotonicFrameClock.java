...
/* loaded from: ItsOnFire.jar:androidx/compose/runtime/MonotonicFrameClock.class */
public interface MonotonicFrameClock extends CoroutineContext.Element {
    @NotNull
    public static final Key Key = Key.$$INSTANCE;

    @Metadata(k = 3, mv = {1, 6, 0}, xi = androidx.appcompat.R.styleable.AppCompatTheme_checkboxStyle)
    /* loaded from: ItsOnFire.jar:androidx/compose/runtime/MonotonicFrameClock$DefaultImpls.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/runtime/MonotonicFrameClock$Key.class */
