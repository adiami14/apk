...
/* loaded from: ItsOnFire.jar:androidx/compose/runtime/ProduceFrameSignal.class */
public final class ProduceFrameSignal {
    ...
    public final Object awaitFrameRequest(@NotNull Object obj, @NotNull Continuation<? super Unit> continuation) {
        ...
        synchronized (obj) {
            ...
            if (rVar != null) {
                ...
                rVar.resumeWith(Result.m5849constructorimpl(unit));
            }
            Object x = rVar2.x();
    ...
    public final Continuation<Unit> requestFrameLocked() {
        ...
        Continuation<Unit> continuation = null;
        if (obj5 instanceof Continuation) {
            obj4 = RecomposerKt.FramePending;
            this.pendingFrameContinuation = obj4;
            continuation = (Continuation) obj5;
        } else {
