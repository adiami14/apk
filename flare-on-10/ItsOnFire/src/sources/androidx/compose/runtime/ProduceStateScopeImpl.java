...
/* loaded from: ItsOnFire.jar:androidx/compose/runtime/ProduceStateScopeImpl.class */
public final class ProduceStateScopeImpl<T> implements ProduceStateScope<T>, MutableState<T> {
    ...
    /* JADX WARN: Type inference failed for: r7v0, types: [kotlin.coroutines.Continuation, kotlin.coroutines.Continuation<?>] */
    ...
    */
    public java.lang.Object awaitDispose(@org.jetbrains.annotations.NotNull kotlin.jvm.functions.Function0<kotlin.Unit> r6, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<?> r7) {
        /*
