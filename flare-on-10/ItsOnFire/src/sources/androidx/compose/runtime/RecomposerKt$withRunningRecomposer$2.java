...
/* loaded from: ItsOnFire.jar:androidx/compose/runtime/RecomposerKt$withRunningRecomposer$2.class */
public final class RecomposerKt$withRunningRecomposer$2<R> extends SuspendLambda implements Function2<u0, Continuation<? super R>, Object> {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/runtime/RecomposerKt$withRunningRecomposer$2$1.class */
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i2 == 0) {
            ...
            this.L$0 = recomposer;
            this.label = 1;
            Object invoke = function3.invoke(u0Var, recomposer, this);
            obj = invoke;
