...
/* loaded from: ItsOnFire.jar:androidx/compose/runtime/SnapshotMutableStateImpl.class */
public class SnapshotMutableStateImpl<T> implements StateObject, SnapshotMutableState<T> {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/runtime/SnapshotMutableStateImpl$StateStateRecord.class */
    ...
    public StateRecord mergeRecords(@NotNull StateRecord previous, @NotNull StateRecord current, @NotNull StateRecord applied) {
        ...
        if (!getPolicy().equivalent((T) stateStateRecord2.getValue(), (T) stateStateRecord3.getValue())) {
            ...
            if (merge != null) {
                current = stateStateRecord3.create();
                ((StateStateRecord) current).setValue(merge);
            } else {
                current = null;
            }
        }
    ...
    public String toString() {
        ...
        return "MutableState(value=" + stateStateRecord.getValue() + ")@" + hashCode();
    }
}
