...
/* loaded from: ItsOnFire.jar:androidx/compose/runtime/SnapshotMutationPolicy.class */
public interface SnapshotMutationPolicy<T> {

    @Metadata(k = 3, mv = {1, 6, 0}, xi = androidx.appcompat.R.styleable.AppCompatTheme_checkboxStyle)
    /* loaded from: ItsOnFire.jar:androidx/compose/runtime/SnapshotMutationPolicy$DefaultImpls.class */
