...
/* loaded from: ItsOnFire.jar:androidx/compose/runtime/collection/MutableVector.class */
public final class MutableVector<T> implements RandomAccess {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/runtime/collection/MutableVector$MutableVectorList.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/runtime/collection/MutableVector$SubList.class */
    public static final class SubList<T> implements List<T>, KMutableList {
        ...
        public T removeAt(int i2) {
            T remove = this.list.remove(i2 + this.start);
            this.end--;
            return remove;
        }
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/runtime/collection/MutableVector$VectorListIterator.class */
    ...
    public final List<T> asMutableList() {
        List<T> list = this.list;
        MutableVectorList mutableVectorList = list;
        if (list == null) {
            mutableVectorList = new MutableVectorList(this);
    ...
    public final T firstOrNull() {
        return isEmpty() ? null : getContent()[0];
    }
    ...
    public final <R> R fold(R r2, @NotNull Function2<? super R, ? super T, ? extends R> operation) {
        ...
        if (size > 0) {
            ...
            R r4 = r2;
            do {
                invoke = operation.invoke(r4, content[i3]);
                i2 = i3 + 1;
                i3 = i2;
                r4 = invoke;
            } while (i2 < size);
    ...
    public final <R> R foldIndexed(R r2, @NotNull Function3<? super Integer, ? super R, ? super T, ? extends R> operation) {
        ...
        if (size > 0) {
            ...
            T[] content = getContent();
            do {
                r3 = operation.invoke(Integer.valueOf(i3), r2, content[i3]);
                i2 = i3 + 1;
                i3 = i2;
                r2 = r3;
            } while (i2 < size);
    ...
    public final <R> R foldRight(R r2, @NotNull Function2<? super T, ? super R, ? extends R> operation) {
        ...
        if (size > 0) {
            ...
            T[] content = getContent();
            do {
                r3 = operation.invoke(content[i3], r2);
                i2 = i3 - 1;
                i3 = i2;
                r2 = r3;
            } while (i2 >= 0);
    ...
    public final <R> R foldRightIndexed(R r2, @NotNull Function3<? super Integer, ? super T, ? super R, ? extends R> operation) {
        ...
        if (size > 0) {
            ...
            T[] content = getContent();
            do {
                r3 = operation.invoke(Integer.valueOf(i3), content[i3], r2);
                i2 = i3 - 1;
                i3 = i2;
                r2 = r3;
            } while (i2 >= 0);
    ...
    public final /* synthetic */ <R> MutableVector<R> mapIndexedNotNull(Function2<? super Integer, ? super T, ? extends R> transform) {
        ...
        if (size > 0) {
            ...
            int i5 = 0;
            do {
                R invoke = transform.invoke(Integer.valueOf(i4), content[i4]);
                i3 = i5;
                if (invoke != null) {
                    objArr[i5] = invoke;
                    i3 = i5 + 1;
    ...
    public final /* synthetic */ <R> MutableVector<R> mapNotNull(Function1<? super T, ? extends R> transform) {
        ...
        if (size > 0) {
            ...
            int i5 = 0;
            do {
                R invoke = transform.invoke(content[i4]);
                i3 = i5;
                if (invoke != null) {
                    objArr[i5] = invoke;
                    i3 = i5 + 1;
    ...
    public final int sumBy(@NotNull Function1<? super T, Integer> selector) {
        ...
        if (size > 0) {
            ...
            int i5 = 0;
            do {
                i3 = i4 + selector.invoke(content[i5]).intValue();
                i2 = i5 + 1;
                i4 = i3;
                i5 = i2;
            } while (i2 < size);
