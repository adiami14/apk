...
/* loaded from: ItsOnFire.jar:androidx/compose/runtime/external/kotlinx/collections/immutable/ExtensionsKt.class */
public final class ExtensionsKt {
    ...
    public static final <E> PersistentSet<E> intersect(@NotNull PersistentSet<? extends E> persistentSet, @NotNull Iterable<? extends E> elements) {
        ...
        if (elements instanceof Collection) {
            build = persistentSet.retainAll((Collection) elements);
        } else {
    ...
    public static final <E> PersistentCollection<E> minus(@NotNull PersistentCollection<? extends E> persistentCollection, @NotNull Iterable<? extends E> elements) {
        ...
        Intrinsics.checkNotNullParameter(elements, "elements");
        if (elements instanceof Collection) {
            build = persistentCollection.removeAll((Collection) elements);
        } else {
        ...
        return (PersistentCollection<E>) build;
    }
    ...
    public static final <E> PersistentList<E> minus(@NotNull PersistentList<? extends E> persistentList, @NotNull Iterable<? extends E> elements) {
        ...
        Intrinsics.checkNotNullParameter(elements, "elements");
        if (elements instanceof Collection) {
            build = persistentList.removeAll((Collection) elements);
        } else {
            PersistentList.Builder<? extends E> builder = persistentList.builder();
            CollectionsKt__MutableCollectionsKt.removeAll(builder, elements);
            build = builder.build();
        }
        return (PersistentList<E>) build;
    }
    ...
    public static final <E> PersistentSet<E> minus(@NotNull PersistentSet<? extends E> persistentSet, @NotNull Iterable<? extends E> elements) {
        ...
        Intrinsics.checkNotNullParameter(elements, "elements");
        if (elements instanceof Collection) {
            build = persistentSet.removeAll((Collection) elements);
        } else {
            PersistentSet.Builder<? extends E> builder = persistentSet.builder();
            CollectionsKt__MutableCollectionsKt.removeAll(builder, elements);
            build = builder.build();
    ...
    public static final <E> PersistentCollection<E> plus(@NotNull PersistentCollection<? extends E> persistentCollection, @NotNull Iterable<? extends E> elements) {
        ...
        Intrinsics.checkNotNullParameter(elements, "elements");
        if (elements instanceof Collection) {
            build = persistentCollection.addAll((Collection) elements);
        } else {
            PersistentCollection.Builder<? extends E> builder = persistentCollection.builder();
    ...
    public static final <E> PersistentList<E> plus(@NotNull PersistentList<? extends E> persistentList, @NotNull Iterable<? extends E> elements) {
        ...
        Intrinsics.checkNotNullParameter(elements, "elements");
        if (elements instanceof Collection) {
            build = persistentList.addAll((Collection) elements);
        } else {
            PersistentList.Builder<? extends E> builder = persistentList.builder();
            CollectionsKt__MutableCollectionsKt.addAll(builder, elements);
            build = builder.build();
    ...
    public static final <E> PersistentSet<E> plus(@NotNull PersistentSet<? extends E> persistentSet, @NotNull Iterable<? extends E> elements) {
        ...
        Intrinsics.checkNotNullParameter(elements, "elements");
        if (elements instanceof Collection) {
            build = persistentSet.addAll((Collection) elements);
        } else {
            PersistentSet.Builder<? extends E> builder = persistentSet.builder();
            CollectionsKt__MutableCollectionsKt.addAll(builder, elements);
            build = builder.build();
    ...
    public static final <T> ImmutableList<T> toImmutableList(@NotNull Iterable<? extends T> iterable) {
        ...
        PersistentList persistentList = iterable instanceof ImmutableList ? (ImmutableList) iterable : null;
        PersistentList persistentList2 = persistentList;
        if (persistentList == null) {
            persistentList2 = toPersistentList(iterable);
        }
    ...
    public static final <K, V> ImmutableMap<K, V> toImmutableMap(@NotNull Map<K, ? extends V> map) {
        ...
        PersistentMap<K, V> persistentMap = map instanceof ImmutableMap ? (ImmutableMap) map : null;
        PersistentMap<K, V> persistentMap2 = persistentMap;
        if (persistentMap == null) {
            PersistentMap.Builder builder = map instanceof PersistentMap.Builder ? (PersistentMap.Builder) map : null;
            persistentMap2 = builder == null ? null : builder.build();
            if (persistentMap2 == null) {
                persistentMap2 = persistentMapOf().putAll((Map) map);
            }
        }
    ...
    public static final <T> ImmutableSet<T> toImmutableSet(@NotNull Iterable<? extends T> iterable) {
        Intrinsics.checkNotNullParameter(iterable, "<this>");
        PersistentSet persistentSet = iterable instanceof ImmutableSet ? (ImmutableSet) iterable : null;
        ...
        if (persistentSet == null) {
            ...
            persistentSet2 = builder == null ? null : builder.build();
            if (persistentSet2 == null) {
                persistentSet2 = plus(persistentSetOf(), (Iterable) iterable);
            }
        }
        return persistentSet2;
    }
    ...
    public static final <K, V> PersistentMap<K, V> toPersistentHashMap(@NotNull Map<K, ? extends V> map) {
        ...
        PersistentHashMap<K, V> persistentHashMap2 = persistentHashMap;
        if (persistentHashMap == null) {
            PersistentHashMapBuilder persistentHashMapBuilder = map instanceof PersistentHashMapBuilder ? (PersistentHashMapBuilder) map : null;
            persistentHashMap2 = persistentHashMapBuilder == null ? null : persistentHashMapBuilder.build();
            if (persistentHashMap2 == null) {
                persistentHashMap2 = PersistentHashMap.Companion.emptyOf$runtime_release().putAll((Map) map);
            }
        }
    ...
    public static final <T> PersistentSet<T> toPersistentHashSet(@NotNull Iterable<? extends T> iterable) {
        ...
        PersistentHashSet persistentHashSet2 = persistentHashSet;
        if (persistentHashSet == null) {
            ...
            persistentHashSet2 = persistentHashSetBuilder == null ? null : persistentHashSetBuilder.build();
            if (persistentHashSet2 == null) {
                persistentHashSet2 = plus(PersistentHashSet.Companion.emptyOf$runtime_release(), (Iterable) iterable);
            }
        }
    ...
    public static final <T> PersistentList<T> toPersistentList(@NotNull Iterable<? extends T> iterable) {
        ...
        PersistentList<T> persistentList2 = persistentList;
        if (persistentList == null) {
            PersistentList.Builder builder = iterable instanceof PersistentList.Builder ? (PersistentList.Builder) iterable : null;
            persistentList2 = builder == null ? null : builder.build();
            if (persistentList2 == null) {
                persistentList2 = plus(persistentListOf(), (Iterable) iterable);
            }
        }
        return persistentList2;
    }
    ...
    public static final <K, V> PersistentMap<K, V> toPersistentMap(@NotNull Map<K, ? extends V> map) {
        ...
        if (persistentOrderedMap == null) {
            ...
            PersistentMap<K, V> build = persistentOrderedMapBuilder == null ? null : persistentOrderedMapBuilder.build();
            persistentOrderedMap2 = build == null ? PersistentOrderedMap.Companion.emptyOf$runtime_release().putAll((Map) map) : build;
        }
    ...
    public static final <T> PersistentSet<T> toPersistentSet(@NotNull Iterable<? extends T> iterable) {
        ...
        if (persistentOrderedSet == null) {
            ...
            PersistentSet<T> build = persistentOrderedSetBuilder == null ? null : persistentOrderedSetBuilder.build();
            persistentOrderedSet2 = build == null ? plus(PersistentOrderedSet.Companion.emptyOf$runtime_release(), (Iterable) iterable) : build;
        }
