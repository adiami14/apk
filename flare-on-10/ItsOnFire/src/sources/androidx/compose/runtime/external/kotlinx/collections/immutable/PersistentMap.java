...
/* loaded from: ItsOnFire.jar:androidx/compose/runtime/external/kotlinx/collections/immutable/PersistentMap.class */
public interface PersistentMap<K, V> extends ImmutableMap<K, V> {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/runtime/external/kotlinx/collections/immutable/PersistentMap$Builder.class */
