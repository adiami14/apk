...
/* loaded from: ItsOnFire.jar:androidx/compose/runtime/external/kotlinx/collections/immutable/implementations/immutableList/PersistentVector.class */
public final class PersistentVector<E> extends AbstractPersistentList<E> implements PersistentList<E> {
    ...
    public PersistentVector(@NotNull Object[] root, @NotNull Object[] tail, int i2, int i3) {
        ...
        CommonFunctionsKt.m2010assert(size > coerceAtMost ? false : z);
    }
    ...
    private final Object[] insertIntoRoot(Object[] objArr, int i2, int i3, Object obj, ObjectRef objectRef) {
        ...
        if (obj2 != null) {
            ...
            for (int i5 = indexSegment + 1; i5 < 32 && copyOf2[i5] != null; i5++) {
                Object obj3 = objArr[i5];
                if (obj3 == null) {
                    throw new NullPointerException("null cannot be cast to non-null type kotlin.Array<kotlin.Any?>");
                }
                copyOf2[i5] = insertIntoRoot((Object[]) obj3, i4, 0, objectRef.getValue(), objectRef);
            }
            return copyOf2;
        }
        throw new NullPointerException("null cannot be cast to non-null type kotlin.Array<kotlin.Any?>");
    ...
    private final PersistentList<E> pullLastBufferFromRoot(Object[] objArr, int i2, int i3) {
        ...
        if (value != null) {
            ...
            if (pullLastBuffer[1] == null) {
                ...
                if (obj != null) {
                    return new PersistentVector((Object[]) obj, objArr3, i2, i3 - 5);
                }
                throw new NullPointerException("null cannot be cast to non-null type kotlin.Array<kotlin.Any?>");
            }
            return new PersistentVector(pullLastBuffer, objArr3, i2, i3);
        }
        throw new NullPointerException("null cannot be cast to non-null type kotlin.Array<kotlin.Any?>");
    }
    ...
    private final Object[] removeFromRootAt(Object[] objArr, int i2, int i3, ObjectRef objectRef) {
        ...
        if (i6 <= i4) {
            while (true) {
                ...
                copyOf2[i4] = removeFromRootAt((Object[]) obj, i5, 0, objectRef);
                if (i4 == i6) {
                    break;
                }
                i4--;
        ...
        if (obj2 != null) {
            copyOf2[indexSegment] = removeFromRootAt((Object[]) obj2, i5, i3, objectRef);
            return copyOf2;
        }
        throw new NullPointerException("null cannot be cast to non-null type kotlin.Array<kotlin.Any?>");
    }
