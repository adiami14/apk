...
/* loaded from: ItsOnFire.jar:androidx/compose/runtime/external/kotlinx/collections/immutable/implementations/immutableList/SmallPersistentVector.class */
public final class SmallPersistentVector<E> extends AbstractPersistentList<E> implements ImmutableList<E> {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/runtime/external/kotlinx/collections/immutable/implementations/immutableList/SmallPersistentVector$Companion.class */
    ...
    public SmallPersistentVector(@NotNull Object[] buffer) {
        ...
        this.buffer = buffer;
        CommonFunctionsKt.m2010assert(buffer.length <= 32);
    }
    ...
    public PersistentList<E> removeAll(@NotNull Function1<? super E, Boolean> predicate) {
        Object[] copyOfRange;
        SmallPersistentVector<E> smallPersistentVector;
        Object[] objArr;
        int i2;
        boolean z;
        int i3;
        ...
        while (true) {
            ...
            if (predicate.invoke(obj).booleanValue()) {
                ...
                if (z3) {
                    ...
                    objArr2 = Arrays.copyOf(objArr3, objArr3.length);
        ...
        if (size == size()) {
            ...
            smallPersistentVector = EMPTY;
        } else {
            copyOfRange = ArraysKt___ArraysJvmKt.copyOfRange(objArr2, 0, size);
            smallPersistentVector = new SmallPersistentVector<>(copyOfRange);
        }
