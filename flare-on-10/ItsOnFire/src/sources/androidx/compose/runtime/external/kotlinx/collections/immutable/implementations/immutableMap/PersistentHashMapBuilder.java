...
/* loaded from: ItsOnFire.jar:androidx/compose/runtime/external/kotlinx/collections/immutable/implementations/immutableMap/PersistentHashMapBuilder.class */
public final class PersistentHashMapBuilder<K, V> extends AbstractMutableMap<K, V> implements PersistentMap.Builder<K, V> {
    ...
    public void putAll(@NotNull Map<? extends K, ? extends V> from) {
        ...
        int size = size();
        this.node = this.node.mutablePutAll(persistentHashMap2.getNode$runtime_release(), 0, deltaCounter, this);
        int size2 = (persistentHashMap2.size() + size) - deltaCounter.getCount();
        if (size != size2) {
            setSize(size2);
        }
    }
    ...
    public V remove(Object obj) {
        ...
        TrieNode trieNode = mutableRemove;
        if (mutableRemove == null) {
            trieNode = TrieNode.Companion.getEMPTY$runtime_release();
        }
        this.node = trieNode;
        return this.operationResult;
    }
