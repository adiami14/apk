...
/* loaded from: ItsOnFire.jar:androidx/compose/runtime/external/kotlinx/collections/immutable/implementations/immutableMap/TrieNodeBaseIterator.class */
public abstract class TrieNodeBaseIterator<K, V, T> implements Iterator<T>, KMappedMarker {
    ...
    public final boolean hasNextNode() {
        CommonFunctionsKt.m2010assert(this.index >= this.dataSize);
