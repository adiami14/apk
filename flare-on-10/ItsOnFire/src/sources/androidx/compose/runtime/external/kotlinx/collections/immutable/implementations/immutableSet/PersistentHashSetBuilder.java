...
/* loaded from: ItsOnFire.jar:androidx/compose/runtime/external/kotlinx/collections/immutable/implementations/immutableSet/PersistentHashSetBuilder.class */
public final class PersistentHashSetBuilder<E> extends AbstractMutableSet<E> implements PersistentSet.Builder<E> {
    ...
    public boolean addAll(@NotNull Collection<? extends E> elements) {
        ...
        PersistentHashSet<E> persistentHashSet2 = persistentHashSet;
        ...
        if (persistentHashSet2 != null) {
            ...
            int size = size();
            TrieNode<E> mutableAddAll = this.node.mutableAddAll(persistentHashSet2.getNode$runtime_release(), 0, deltaCounter, this);
    ...
    public boolean containsAll(@NotNull Collection<? extends Object> elements) {
        ...
        if (elements instanceof PersistentHashSet) {
            TrieNode<E> trieNode3 = this.node;
            trieNode = ((PersistentHashSet) elements).getNode$runtime_release();
            trieNode2 = trieNode3;
        } else if (!(elements instanceof PersistentHashSetBuilder)) {
            return super.containsAll(elements);
        } else {
            TrieNode<E> trieNode4 = this.node;
            trieNode = ((PersistentHashSetBuilder) elements).node;
            trieNode2 = trieNode4;
        }
        return trieNode2.containsAll(trieNode, 0);
    }
    ...
    public boolean removeAll(@NotNull Collection<? extends Object> elements) {
        ...
        if (persistentHashSet2 != null) {
            ...
            DeltaCounter deltaCounter = new DeltaCounter(0, 1, null);
            int size = size();
            Object mutableRemoveAll = this.node.mutableRemoveAll(persistentHashSet2.getNode$runtime_release(), 0, deltaCounter, this);
    ...
    public boolean retainAll(@NotNull Collection<? extends Object> elements) {
        ...
        if (persistentHashSet2 != null) {
            ...
            DeltaCounter deltaCounter = new DeltaCounter(0, 1, null);
            int size = size();
            Object mutableRetainAll = this.node.mutableRetainAll(persistentHashSet2.getNode$runtime_release(), 0, deltaCounter, this);
