...
/* loaded from: ItsOnFire.jar:androidx/compose/runtime/external/kotlinx/collections/immutable/implementations/immutableSet/PersistentHashSetIterator.class */
public class PersistentHashSetIterator<E> implements Iterator<E>, KMappedMarker {
    ...
    private final void ensureNextElementIsReady() {
        ...
        if (i2 >= 0) {
            while (true) {
                ...
                int i4 = moveToNextNodeWithData;
                if (moveToNextNodeWithData == -1) {
                    i4 = moveToNextNodeWithData;
                    if (this.path.get(i2).hasNextCell()) {
                        this.path.get(i2).moveToNextCell();
                        i4 = moveToNextNodeWithData(i2);
                    }
                }
                if (i4 != -1) {
    ...
    public final E currentElement() {
        CommonFunctionsKt.m2010assert(hasNext());
