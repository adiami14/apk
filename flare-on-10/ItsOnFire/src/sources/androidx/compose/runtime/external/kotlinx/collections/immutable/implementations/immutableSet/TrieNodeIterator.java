...
/* loaded from: ItsOnFire.jar:androidx/compose/runtime/external/kotlinx/collections/immutable/implementations/immutableSet/TrieNodeIterator.class */
public final class TrieNodeIterator<E> {
    ...
    public final E currentElement() {
        CommonFunctionsKt.m2010assert(hasNextElement());
    ...
    public final void moveToNextCell() {
        CommonFunctionsKt.m2010assert(hasNextCell());
        this.index++;
    }
