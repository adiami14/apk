...
/* loaded from: ItsOnFire.jar:androidx/compose/runtime/external/kotlinx/collections/immutable/implementations/persistentOrderedMap/PersistentOrderedMap.class */
public final class PersistentOrderedMap<K, V> extends AbstractMap<K, V> implements PersistentMap<K, V> {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/runtime/external/kotlinx/collections/immutable/implementations/persistentOrderedMap/PersistentOrderedMap$Companion.class */
    ...
    public V get(Object obj) {
        ...
        return linkedValue == null ? null : linkedValue.getValue();
    }
    ...
    public PersistentOrderedMap<K, V> remove(K k2) {
        ...
        PersistentHashMap<K, LinkedValue<V>> persistentHashMap = remove;
        if (linkedValue.getHasPrevious()) {
            LinkedValue<V> linkedValue2 = remove.get(linkedValue.getPrevious());
            Intrinsics.checkNotNull(linkedValue2);
            persistentHashMap = remove.put((PersistentHashMap<K, LinkedValue<V>>) ((K) linkedValue.getPrevious()), (K) linkedValue2.withNext(linkedValue.getNext()));
        }
        PersistentHashMap<K, LinkedValue<V>> persistentHashMap2 = persistentHashMap;
        if (linkedValue.getHasNext()) {
            LinkedValue<V> linkedValue3 = persistentHashMap.get(linkedValue.getNext());
            Intrinsics.checkNotNull(linkedValue3);
            persistentHashMap2 = persistentHashMap.put((PersistentHashMap<K, LinkedValue<V>>) ((K) linkedValue.getNext()), (K) linkedValue3.withPrevious(linkedValue.getPrevious()));
        }
    ...
    public PersistentOrderedMap<K, V> remove(K k2, V v2) {
        ...
        if (Intrinsics.areEqual(linkedValue.getValue(), v2)) {
            persistentOrderedMap = remove((PersistentOrderedMap<K, V>) k2);
        }
