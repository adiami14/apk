...
/* loaded from: ItsOnFire.jar:androidx/compose/runtime/external/kotlinx/collections/immutable/implementations/persistentOrderedMap/PersistentOrderedMapBuilder.class */
public final class PersistentOrderedMapBuilder<K, V> extends AbstractMutableMap<K, V> implements PersistentMap.Builder<K, V> {
    ...
    public PersistentMap<K, V> build() {
        ...
        if (build == this.map.getHashMap$runtime_release()) {
            CommonFunctionsKt.m2010assert(this.firstKey == this.map.getFirstKey$runtime_release());
            CommonFunctionsKt.m2010assert(this.lastKey == this.map.getLastKey$runtime_release());
    ...
    public V put(K k2, V v2) {
        ...
        if (linkedValue != null) {
            ...
            CommonFunctionsKt.m2010assert(!linkedValue3.getHasNext());
    ...
    public final boolean remove(Object obj, Object obj2) {
        ...
        if (Intrinsics.areEqual(linkedValue.getValue(), obj2)) {
            remove(obj);
            z = true;
        }
        return z;
