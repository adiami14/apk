...
/* loaded from: ItsOnFire.jar:androidx/compose/runtime/external/kotlinx/collections/immutable/implementations/persistentOrderedSet/PersistentOrderedSet.class */
public final class PersistentOrderedSet<E> extends AbstractSet<E> implements PersistentSet<E> {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/runtime/external/kotlinx/collections/immutable/implementations/persistentOrderedSet/PersistentOrderedSet$Companion.class */
    ...
    public PersistentSet<E> remove(E e2) {
        ...
        PersistentHashMap<E, Links> persistentHashMap = remove;
        if (links.getHasPrevious()) {
            Links links2 = remove.get(links.getPrevious());
            Intrinsics.checkNotNull(links2);
            persistentHashMap = remove.put((PersistentHashMap<E, Links>) links.getPrevious(), (Object) links2.withNext(links.getNext()));
        }
        PersistentHashMap<E, Links> persistentHashMap2 = persistentHashMap;
        if (links.getHasNext()) {
            Links links3 = persistentHashMap.get(links.getNext());
            Intrinsics.checkNotNull(links3);
            persistentHashMap2 = persistentHashMap.put((PersistentHashMap<E, Links>) links.getNext(), (Object) links3.withPrevious(links.getPrevious()));
        }
        return new PersistentOrderedSet(!links.getHasPrevious() ? links.getNext() : this.firstElement, !links.getHasNext() ? links.getPrevious() : this.lastElement, persistentHashMap2);
    }
