...
/* loaded from: ItsOnFire.jar:androidx/compose/runtime/external/kotlinx/collections/immutable/internal/ListImplementation.class */
public final class ListImplementation {
    ...
    public static final int orderedHashCode$runtime_release(@NotNull Collection<?> c2) {
        ...
        while (true) {
            ...
            Object next = it.next();
            i2 = (i3 * 31) + (next == null ? 0 : next.hashCode());
        }
    }
}
