...
/* loaded from: ItsOnFire.jar:androidx/compose/runtime/internal/LiveLiteralKt.class */
public final class LiveLiteralKt {
    ...
    public static final void updateLiveLiteralValue(@NotNull String key, @Nullable Object obj) {
        ...
        Intrinsics.checkNotNullParameter(key, "key");
        HashMap<String, MutableState<Object>> hashMap = liveLiteralCache;
        MutableState<Object> mutableState2 = hashMap.get(key);
        ...
        MutableState<Object> mutableState3 = mutableState;
        if (z) {
