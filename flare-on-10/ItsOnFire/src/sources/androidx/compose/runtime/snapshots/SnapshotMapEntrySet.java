...
/* loaded from: ItsOnFire.jar:androidx/compose/runtime/snapshots/SnapshotMapEntrySet.class */
    ...
    public boolean containsAll(@NotNull Collection<? extends Object> elements) {
        ...
        if (!elements.isEmpty()) {
            ...
            while (true) {
                ...
                if (!it.hasNext()) {
                    break;
                } else if (!contains((Object) ((Map.Entry) it.next()))) {
                    z = false;
                    break;
                }
            }
    ...
    public boolean removeAll(@NotNull Collection<? extends Object> elements) {
        ...
        while (true) {
            while (true) {
                ...
                z = getMap().remove(((Map.Entry) it.next()).getKey()) != null || z2;
            }
        }
    }
