...
/* loaded from: ItsOnFire.jar:androidx/compose/runtime/snapshots/StateObject.class */
public interface StateObject {

    @Metadata(k = 3, mv = {1, 6, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
    /* loaded from: ItsOnFire.jar:androidx/compose/runtime/snapshots/StateObject$DefaultImpls.class */
