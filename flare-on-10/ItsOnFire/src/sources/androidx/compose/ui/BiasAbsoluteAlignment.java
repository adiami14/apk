...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/BiasAbsoluteAlignment.class */
public final class BiasAbsoluteAlignment implements Alignment {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/BiasAbsoluteAlignment$Horizontal.class */
    ...
    public long mo2047alignKFBX0sM(long j2, long j3, @NotNull LayoutDirection layoutDirection) {
        ...
        int roundToInt2;
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        long IntSize = IntSizeKt.IntSize(IntSize.m4951getWidthimpl(j3) - IntSize.m4951getWidthimpl(j2), IntSize.m4950getHeightimpl(j3) - IntSize.m4950getHeightimpl(j2));
        float m4951getWidthimpl = IntSize.m4951getWidthimpl(IntSize) / 2.0f;
        float m4950getHeightimpl = IntSize.m4950getHeightimpl(IntSize) / 2.0f;
        float f2 = 1;
        float f3 = this.horizontalBias;
        float f4 = this.verticalBias;
        roundToInt = MathKt__MathJVMKt.roundToInt(m4951getWidthimpl * (f3 + f2));
        roundToInt2 = MathKt__MathJVMKt.roundToInt(m4950getHeightimpl * (f2 + f4));
