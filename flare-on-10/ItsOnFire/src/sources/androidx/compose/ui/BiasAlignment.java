...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/BiasAlignment.class */
public final class BiasAlignment implements Alignment {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/BiasAlignment$Horizontal.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/BiasAlignment$Vertical.class */
    ...
    public long mo2047alignKFBX0sM(long j2, long j3, @NotNull LayoutDirection layoutDirection) {
        int roundToInt;
        int roundToInt2;
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        float m4951getWidthimpl = (IntSize.m4951getWidthimpl(j3) - IntSize.m4951getWidthimpl(j2)) / 2.0f;
        float m4950getHeightimpl = (IntSize.m4950getHeightimpl(j3) - IntSize.m4950getHeightimpl(j2)) / 2.0f;
        float f2 = layoutDirection == LayoutDirection.Ltr ? this.horizontalBias : (-1) * this.horizontalBias;
        float f3 = 1;
        float f4 = this.verticalBias;
        roundToInt = MathKt__MathJVMKt.roundToInt(m4951getWidthimpl * (f2 + f3));
        roundToInt2 = MathKt__MathJVMKt.roundToInt(m4950getHeightimpl * (f3 + f4));
