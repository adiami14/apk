...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/Modifier.class */
public interface Modifier {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/Modifier$Companion.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/Modifier$DefaultImpls.class */
    public static final class DefaultImpls {
        ...
        public static Modifier then(@NotNull Modifier modifier, @NotNull Modifier other) {
            ...
            if (other != Modifier.Companion) {
                modifier = new CombinedModifier(modifier, other);
            }
            return modifier;
        }
    }
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/Modifier$Element.class */
    public interface Element extends Modifier {

        @Metadata(k = 3, mv = {1, 6, 0}, xi = androidx.appcompat.R.styleable.AppCompatTheme_checkboxStyle)
        /* loaded from: ItsOnFire.jar:androidx/compose/ui/Modifier$Element$DefaultImpls.class */
        public static final class DefaultImpls {
