...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/ZIndexModifier.class */
final class ZIndexModifier extends InspectorValueInfo implements LayoutModifier {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (this.zIndex == zIndexModifier.zIndex) {
            z = true;
        }
        return z;
    }
    ...
    public MeasureResult mo105measure3p2s80s(@NotNull MeasureScope receiver, @NotNull Measurable measurable, long j2) {
        ...
        return MeasureScope.DefaultImpls.layout$default(receiver, mo3910measureBRTryo0.getWidth(), mo3910measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.ZIndexModifier$measure$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
