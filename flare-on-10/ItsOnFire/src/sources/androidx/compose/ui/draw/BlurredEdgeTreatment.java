...
@JvmInline
/* loaded from: ItsOnFire.jar:androidx/compose/ui/draw/BlurredEdgeTreatment.class */
public final class BlurredEdgeTreatment {
    @NotNull
    public static final Companion Companion = new Companion(null);
    @NotNull
    private static final Shape Rectangle = m2067constructorimpl(RectangleShapeKt.getRectangleShape());
    @NotNull
    private static final Shape Unbounded = m2067constructorimpl(null);
    @Nullable
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/draw/BlurredEdgeTreatment$Companion.class */
    ...
    public static final /* synthetic */ BlurredEdgeTreatment m2066boximpl(Shape shape) {
        return new BlurredEdgeTreatment(shape);
    }

    @NotNull
    /* renamed from: constructor-impl  reason: not valid java name */
    public static Shape m2067constructorimpl(@Nullable Shape shape) {
        return shape;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m2068equalsimpl(Shape shape, Object obj) {
        return (obj instanceof BlurredEdgeTreatment) && Intrinsics.areEqual(shape, ((BlurredEdgeTreatment) obj).m2072unboximpl());
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m2069equalsimpl0(Shape shape, Shape shape2) {
        return Intrinsics.areEqual(shape, shape2);
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m2070hashCodeimpl(Shape shape) {
        return shape == null ? 0 : shape.hashCode();
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m2071toStringimpl(Shape shape) {
        return "BlurredEdgeTreatment(shape=" + shape + ')';
    }

    public boolean equals(Object obj) {
        return m2068equalsimpl(this.shape, obj);
    }
    ...
    public int hashCode() {
        return m2070hashCodeimpl(this.shape);
    }

    public String toString() {
        return m2071toStringimpl(this.shape);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ Shape m2072unboximpl() {
        return this.shape;
    }
}
