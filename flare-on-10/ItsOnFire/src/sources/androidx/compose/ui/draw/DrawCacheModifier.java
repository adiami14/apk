...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/draw/DrawCacheModifier.class */
public interface DrawCacheModifier extends DrawModifier {

    @Metadata(k = 3, mv = {1, 6, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/draw/DrawCacheModifier$DefaultImpls.class */
