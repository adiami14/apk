...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/focus/FocusManagerImpl.class */
public final class FocusManagerImpl implements FocusManager {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/focus/FocusManagerImpl$WhenMappings.class */
    ...
    public boolean mo2105moveFocus3ESFkO8(int i2) {
        ModifiedFocusNode findActiveFocusNode = FocusTraversalKt.findActiveFocusNode(this.focusModifier.getFocusNode());
        if (findActiveFocusNode == null) {
            return false;
        }
        FocusRequester m2112customFocusSearchOMvw8 = FocusOrderModifierKt.m2112customFocusSearchOMvw8(findActiveFocusNode, i2, getLayoutDirection());
        boolean z = true;
        if (!Intrinsics.areEqual(m2112customFocusSearchOMvw8, FocusRequester.Companion.getDefault())) {
            m2112customFocusSearchOMvw8.requestFocus();
            return true;
        }
        ModifiedFocusNode m2121focusSearchOMvw8 = FocusTraversalKt.m2121focusSearchOMvw8(this.focusModifier.getFocusNode(), i2, getLayoutDirection());
        if (Intrinsics.areEqual(m2121focusSearchOMvw8, findActiveFocusNode)) {
            return false;
        }
        if (m2121focusSearchOMvw8 != null) {
            if (m2121focusSearchOMvw8.findParentFocusNode$ui_release() != null) {
                FocusTransactionsKt.requestFocus(m2121focusSearchOMvw8);
                return true;
            }
            throw new IllegalStateException("Move focus landed at the root.".toString());
        }
        boolean z2 = false;
        if (this.focusModifier.getFocusState().getHasFocus()) {
            z2 = false;
            if (!this.focusModifier.getFocusState().isFocused()) {
                ...
                if (!FocusDirection.m2091equalsimpl0(i2, companion.m2100getNextdhqQ8s())) {
                    z = FocusDirection.m2091equalsimpl0(i2, companion.m2102getPreviousdhqQ8s());
                }
                z2 = false;
                if (z) {
                    clearFocus(false);
