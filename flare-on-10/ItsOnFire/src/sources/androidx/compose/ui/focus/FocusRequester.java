...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/focus/FocusRequester.class */
public final class FocusRequester {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/focus/FocusRequester$Companion.class */
    public static final class Companion {
        ...
        /* loaded from: ItsOnFire.jar:androidx/compose/ui/focus/FocusRequester$Companion$FocusRequesterFactory.class */
    ...
    public final boolean captureFocus() {
        ...
        if (this.focusRequesterNodes.isNotEmpty()) {
            ...
            if (size > 0) {
                ...
                boolean z2 = false;
                do {
                    ModifiedFocusNode findFocusNode$ui_release = content[i3].findFocusNode$ui_release();
                    if (findFocusNode$ui_release == null) {
                        z = z2;
                    } else {
                        z = z2;
                        if (FocusTransactionsKt.captureFocus(findFocusNode$ui_release)) {
                            z = true;
                        }
                    }
                    i2 = i3 + 1;
            ...
            if (size > 0) {
                ...
                do {
                    ...
                    if (findFocusNode$ui_release == null) {
                        ...
                        z = z2;
                        if (FocusTransactionsKt.freeFocus(findFocusNode$ui_release)) {
                            z = true;
                        }
                    }
                    i2 = i3 + 1;
