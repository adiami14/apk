...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/geometry/RectKt.class */
public final class RectKt {
    @Stable
    @NotNull
    /* renamed from: Rect-0a9Yr6o  reason: not valid java name */
    public static final Rect m2206Rect0a9Yr6o(long j2, long j3) {
        return new Rect(Offset.m2167getXimpl(j2), Offset.m2168getYimpl(j2), Offset.m2167getXimpl(j3), Offset.m2168getYimpl(j3));
    }

    @Stable
    @NotNull
    /* renamed from: Rect-3MmeM6k  reason: not valid java name */
    public static final Rect m2207Rect3MmeM6k(long j2, float f2) {
        return new Rect(Offset.m2167getXimpl(j2) - f2, Offset.m2168getYimpl(j2) - f2, Offset.m2167getXimpl(j2) + f2, Offset.m2168getYimpl(j2) + f2);
    }

    @Stable
    @NotNull
    /* renamed from: Rect-tz77jQw  reason: not valid java name */
    public static final Rect m2208Recttz77jQw(long j2, long j3) {
        return new Rect(Offset.m2167getXimpl(j2), Offset.m2168getYimpl(j2), Offset.m2167getXimpl(j2) + Size.m2239getWidthimpl(j3), Offset.m2168getYimpl(j2) + Size.m2236getHeightimpl(j3));
    }
