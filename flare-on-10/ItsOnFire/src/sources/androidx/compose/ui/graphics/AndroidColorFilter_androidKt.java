...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/graphics/AndroidColorFilter_androidKt.class */
public final class AndroidColorFilter_androidKt {
    @NotNull
    /* renamed from: actualColorMatrixColorFilter-jHG-Opc  reason: not valid java name */
    public static final ColorFilter m2279actualColorMatrixColorFilterjHGOpc(@NotNull float[] colorMatrix) {
    ...
    public static final ColorFilter m2280actualLightingColorFilterOWjLjI(long j2, long j3) {
        return new ColorFilter(new LightingColorFilter(ColorKt.m2470toArgb8_81llA(j2), ColorKt.m2470toArgb8_81llA(j3)));
    }

    @NotNull
    /* renamed from: actualTintColorFilter-xETnrds  reason: not valid java name */
    public static final ColorFilter m2281actualTintColorFilterxETnrds(long j2, int i2) {
        return new ColorFilter(BlendModeColorFilterHelper.INSTANCE.m2361BlendModeColorFilterxETnrds(j2, i2));
    }
