...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/graphics/AndroidPath.class */
public final class AndroidPath implements Path {
    ...
    public void mo2306addPathUv8p0NA(@NotNull Path path, long j2) {
        Intrinsics.checkNotNullParameter(path, "path");
        android.graphics.Path path2 = this.internalPath;
        if (!(path instanceof AndroidPath)) {
            throw new UnsupportedOperationException("Unable to obtain android.graphics.Path");
        }
        path2.addPath(((AndroidPath) path).getInternalPath(), Offset.m2167getXimpl(j2), Offset.m2168getYimpl(j2));
    }
    ...
    public void addRoundRect(@NotNull RoundRect roundRect) {
        ...
        this.radii[0] = CornerRadius.m2141getXimpl(roundRect.m2219getTopLeftCornerRadiuskKHJgLs());
        this.radii[1] = CornerRadius.m2142getYimpl(roundRect.m2219getTopLeftCornerRadiuskKHJgLs());
        this.radii[2] = CornerRadius.m2141getXimpl(roundRect.m2220getTopRightCornerRadiuskKHJgLs());
        this.radii[3] = CornerRadius.m2142getYimpl(roundRect.m2220getTopRightCornerRadiuskKHJgLs());
        this.radii[4] = CornerRadius.m2141getXimpl(roundRect.m2218getBottomRightCornerRadiuskKHJgLs());
        this.radii[5] = CornerRadius.m2142getYimpl(roundRect.m2218getBottomRightCornerRadiuskKHJgLs());
        this.radii[6] = CornerRadius.m2141getXimpl(roundRect.m2217getBottomLeftCornerRadiuskKHJgLs());
        this.radii[7] = CornerRadius.m2142getYimpl(roundRect.m2217getBottomLeftCornerRadiuskKHJgLs());
    ...
    public int mo2307getFillTypeRgk1Os() {
        return this.internalPath.getFillType() == Path.FillType.EVEN_ODD ? PathFillType.Companion.m2643getEvenOddRgk1Os() : PathFillType.Companion.m2644getNonZeroRgk1Os();
    }
    ...
    public boolean mo2308opN5in7k0(@NotNull Path path1, @NotNull Path path2, int i2) {
        Intrinsics.checkNotNullParameter(path1, "path1");
        Intrinsics.checkNotNullParameter(path2, "path2");
        PathOperation.Companion companion = PathOperation.Companion;
        Path.Op op = PathOperation.m2649equalsimpl0(i2, companion.m2653getDifferenceb3I0S0c()) ? Path.Op.DIFFERENCE : PathOperation.m2649equalsimpl0(i2, companion.m2654getIntersectb3I0S0c()) ? Path.Op.INTERSECT : PathOperation.m2649equalsimpl0(i2, companion.m2655getReverseDifferenceb3I0S0c()) ? Path.Op.REVERSE_DIFFERENCE : PathOperation.m2649equalsimpl0(i2, companion.m2656getUnionb3I0S0c()) ? Path.Op.UNION : Path.Op.XOR;
    ...
    public void mo2309setFillTypeoQ8Xj4U(int i2) {
        this.internalPath.setFillType(PathFillType.m2639equalsimpl0(i2, PathFillType.Companion.m2643getEvenOddRgk1Os()) ? Path.FillType.EVEN_ODD : Path.FillType.WINDING);
    }

    @Override // androidx.compose.ui.graphics.Path
    /* renamed from: translate-k-4lQ0M  reason: not valid java name */
    public void mo2310translatek4lQ0M(long j2) {
        this.mMatrix.reset();
        this.mMatrix.setTranslate(Offset.m2167getXimpl(j2), Offset.m2168getYimpl(j2));
