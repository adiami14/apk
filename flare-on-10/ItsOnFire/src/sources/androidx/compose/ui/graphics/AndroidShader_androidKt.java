...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/graphics/AndroidShader_androidKt.class */
public final class AndroidShader_androidKt {
    @NotNull
    /* renamed from: ActualImageShader-F49vj9s  reason: not valid java name */
    public static final Shader m2313ActualImageShaderF49vj9s(@NotNull ImageBitmap image, int i2, int i3) {
        Intrinsics.checkNotNullParameter(image, "image");
        return new BitmapShader(AndroidImageBitmap_androidKt.asAndroidBitmap(image), AndroidTileMode_androidKt.m2318toAndroidTileMode0vamqd0(i2), AndroidTileMode_androidKt.m2318toAndroidTileMode0vamqd0(i3));
    }

    @NotNull
    /* renamed from: ActualLinearGradientShader-VjE6UOU  reason: not valid java name */
    public static final Shader m2314ActualLinearGradientShaderVjE6UOU(long j2, long j3, @NotNull List<Color> colors, @Nullable List<Float> list, int i2) {
        Intrinsics.checkNotNullParameter(colors, "colors");
        validateColorStops(colors, list);
        int countTransparentColors = countTransparentColors(colors);
        return new android.graphics.LinearGradient(Offset.m2167getXimpl(j2), Offset.m2168getYimpl(j2), Offset.m2167getXimpl(j3), Offset.m2168getYimpl(j3), makeTransparentColors(colors, countTransparentColors), makeTransparentStops(list, colors, countTransparentColors), AndroidTileMode_androidKt.m2318toAndroidTileMode0vamqd0(i2));
    }

    @NotNull
    /* renamed from: ActualRadialGradientShader-8uybcMk  reason: not valid java name */
    public static final Shader m2315ActualRadialGradientShader8uybcMk(long j2, float f2, @NotNull List<Color> colors, @Nullable List<Float> list, int i2) {
        Intrinsics.checkNotNullParameter(colors, "colors");
        validateColorStops(colors, list);
        int countTransparentColors = countTransparentColors(colors);
        return new android.graphics.RadialGradient(Offset.m2167getXimpl(j2), Offset.m2168getYimpl(j2), f2, makeTransparentColors(colors, countTransparentColors), makeTransparentStops(list, colors, countTransparentColors), AndroidTileMode_androidKt.m2318toAndroidTileMode0vamqd0(i2));
    }

    @NotNull
    /* renamed from: ActualSweepGradientShader-9KIMszo  reason: not valid java name */
    public static final Shader m2316ActualSweepGradientShader9KIMszo(long j2, @NotNull List<Color> colors, @Nullable List<Float> list) {
        Intrinsics.checkNotNullParameter(colors, "colors");
        validateColorStops(colors, list);
        int countTransparentColors = countTransparentColors(colors);
        return new android.graphics.SweepGradient(Offset.m2167getXimpl(j2), Offset.m2168getYimpl(j2), makeTransparentColors(colors, countTransparentColors), makeTransparentStops(list, colors, countTransparentColors));
    }
    ...
    public static final int[] makeTransparentColors(@NotNull List<Color> colors, int i2) {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            iArr[i3] = ColorKt.m2470toArgb8_81llA(colors.get(i3).m2424unboximpl());
        }
        return iArr;
    }
    ...
    public static final float[] makeTransparentStops(@Nullable List<Float> list, @NotNull List<Color> colors, int i2) {
        ...
        fArr2[0] = (list == null || (f2 = list.get(0)) == null) ? 0.0f : f2.floatValue();
        lastIndex = CollectionsKt__CollectionsKt.getLastIndex(colors);
        int i3 = 1;
        int i4 = 1;
        while (i3 < lastIndex) {
            int i5 = i3 + 1;
            long m2424unboximpl = colors.get(i3).m2424unboximpl();
            ...
            int i6 = i4 + 1;
            fArr2[i4] = floatValue;
            if (Color.m2416getAlphaimpl(m2424unboximpl) == 0.0f) {
                i4 = i6 + 1;
                fArr2[i6] = floatValue;
                i3 = i5;
            } else {
