...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/graphics/BlurEffect.class */
public final class BlurEffect extends RenderEffect {
    ...
    public /* synthetic */ BlurEffect(RenderEffect renderEffect, float f2, float f3, int i2, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this(renderEffect, f2, (i3 & 4) != 0 ? f2 : f3, (i3 & 8) != 0 ? TileMode.Companion.m2733getClamp3opZhB0() : i2, null);
    }
    ...
    public android.graphics.RenderEffect createRenderEffect() {
        return RenderEffectVerificationHelper.INSTANCE.m2674createBlurEffect8A3gB4(this.renderEffect, this.radiusX, this.radiusY, this.edgeTreatment);
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof BlurEffect) {
            ...
            if (this.radiusX == blurEffect.radiusX) {
                return ((this.radiusY > blurEffect.radiusY ? 1 : (this.radiusY == blurEffect.radiusY ? 0 : -1)) == 0) && TileMode.m2729equalsimpl0(this.edgeTreatment, blurEffect.edgeTreatment) && Intrinsics.areEqual(this.renderEffect, blurEffect.renderEffect);
            }
            return false;
        }
        return false;
    ...
    public int hashCode() {
        ...
        return ((((((renderEffect == null ? 0 : renderEffect.hashCode()) * 31) + Float.hashCode(this.radiusX)) * 31) + Float.hashCode(this.radiusY)) * 31) + TileMode.m2730hashCodeimpl(this.edgeTreatment);
    }

    @NotNull
    public String toString() {
        return "BlurEffect(renderEffect=" + this.renderEffect + ", radiusX=" + this.radiusX + ", radiusY=" + this.radiusY + ", edgeTreatment=" + ((Object) TileMode.m2731toStringimpl(this.edgeTreatment)) + ')';
    }
}
