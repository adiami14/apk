...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/graphics/Canvas.class */
public interface Canvas {

    @Metadata(k = 3, mv = {1, 6, 0}, xi = androidx.appcompat.R.styleable.AppCompatTheme_checkboxStyle)
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/graphics/Canvas$DefaultImpls.class */
    public static final class DefaultImpls {
        /* renamed from: clipPath-mtrdD-E$default  reason: not valid java name */
        public static /* synthetic */ void m2386clipPathmtrdDE$default(Canvas canvas, Path path, int i2, int i3, Object obj) {
            if (obj != null) {
            ...
            canvas.mo2264clipPathmtrdDE(path, i2);
        }

        /* renamed from: clipRect-N_I0leg$default  reason: not valid java name */
        public static /* synthetic */ void m2387clipRectN_I0leg$default(Canvas canvas, float f2, float f3, float f4, float f5, int i2, int i3, Object obj) {
            if (obj != null) {
            ...
            canvas.mo2265clipRectN_I0leg(f2, f3, f4, f5, i2);
        }

        /* renamed from: clipRect-mtrdD-E  reason: not valid java name */
        public static void m2388clipRectmtrdDE(@NotNull Canvas canvas, @NotNull Rect rect, int i2) {
            Intrinsics.checkNotNullParameter(canvas, "this");
            Intrinsics.checkNotNullParameter(rect, "rect");
            canvas.mo2265clipRectN_I0leg(rect.getLeft(), rect.getTop(), rect.getRight(), rect.getBottom(), i2);
        }

        /* renamed from: clipRect-mtrdD-E$default  reason: not valid java name */
        public static /* synthetic */ void m2389clipRectmtrdDE$default(Canvas canvas, Rect rect, int i2, int i3, Object obj) {
            if (obj != null) {
            ...
            canvas.mo2266clipRectmtrdDE(rect, i2);
        }
        ...
        public static /* synthetic */ void m2390drawImageRectHPBpro0$default(Canvas canvas, ImageBitmap imageBitmap, long j2, long j3, long j4, long j5, Paint paint, int i2, Object obj) {
            if (obj != null) {
                throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: drawImageRect-HPBpro0");
            }
            long m4917getZeronOccac = (i2 & 2) != 0 ? IntOffset.Companion.m4917getZeronOccac() : j2;
            long IntSize = (i2 & 4) != 0 ? IntSizeKt.IntSize(imageBitmap.getWidth(), imageBitmap.getHeight()) : j3;
            canvas.mo2270drawImageRectHPBpro0(imageBitmap, m4917getZeronOccac, IntSize, (i2 & 8) != 0 ? IntOffset.Companion.m4917getZeronOccac() : j4, (i2 & 16) != 0 ? IntSize : j5, paint);
        }
    ...
    void mo2264clipPathmtrdDE(@NotNull Path path, int i2);

    /* renamed from: clipRect-N_I0leg */
    void mo2265clipRectN_I0leg(float f2, float f3, float f4, float f5, int i2);

    /* renamed from: clipRect-mtrdD-E */
    void mo2266clipRectmtrdDE(@NotNull Rect rect, int i2);

    /* renamed from: concat-58bKbWc */
    void mo2267concat58bKbWc(@NotNull float[] fArr);
    ...
    void mo2268drawCircle9KIMszo(long j2, float f2, @NotNull Paint paint);

    /* renamed from: drawImage-d-4ec7I */
    void mo2269drawImaged4ec7I(@NotNull ImageBitmap imageBitmap, long j2, @NotNull Paint paint);

    /* renamed from: drawImageRect-HPBpro0 */
    void mo2270drawImageRectHPBpro0(@NotNull ImageBitmap imageBitmap, long j2, long j3, long j4, long j5, @NotNull Paint paint);

    /* renamed from: drawLine-Wko1d7g */
    void mo2271drawLineWko1d7g(long j2, long j3, @NotNull Paint paint);
    ...
    void mo2272drawPointsO7TthRY(int i2, @NotNull List<Offset> list, @NotNull Paint paint);

    /* renamed from: drawRawPoints-O7TthRY */
    void mo2273drawRawPointsO7TthRY(int i2, @NotNull float[] fArr, @NotNull Paint paint);
    ...
    void mo2274drawVerticesTPEHhCM(@NotNull Vertices vertices, int i2, @NotNull Paint paint);
