...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/graphics/ColorFilter.class */
public final class ColorFilter {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/graphics/ColorFilter$Companion.class */
    public static final class Companion {
        ...
        public static /* synthetic */ ColorFilter m2456tintxETnrds$default(Companion companion, long j2, int i2, int i3, Object obj) {
            if ((i3 & 2) != 0) {
                i2 = BlendMode.Companion.m2356getSrcIn0nO6VwU();
            }
            return companion.m2459tintxETnrds(j2, i2);
        }

        @Stable
        @NotNull
        /* renamed from: colorMatrix-jHG-Opc  reason: not valid java name */
        public final ColorFilter m2457colorMatrixjHGOpc(@NotNull float[] colorMatrix) {
            Intrinsics.checkNotNullParameter(colorMatrix, "colorMatrix");
            return AndroidColorFilter_androidKt.m2279actualColorMatrixColorFilterjHGOpc(colorMatrix);
        }

        @Stable
        @NotNull
        /* renamed from: lighting--OWjLjI  reason: not valid java name */
        public final ColorFilter m2458lightingOWjLjI(long j2, long j3) {
            return AndroidColorFilter_androidKt.m2280actualLightingColorFilterOWjLjI(j2, j3);
        }

        @Stable
        @NotNull
        /* renamed from: tint-xETnrds  reason: not valid java name */
        public final ColorFilter m2459tintxETnrds(long j2, int i2) {
            return AndroidColorFilter_androidKt.m2281actualTintColorFilterxETnrds(j2, i2);
        }
    }
