...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/graphics/ImageBitmap.class */
public interface ImageBitmap {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/graphics/ImageBitmap$Companion.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/graphics/ImageBitmap$DefaultImpls.class */
    public static final class DefaultImpls {
        public static /* synthetic */ void readPixels$default(ImageBitmap imageBitmap, int[] iArr, int i2, int i3, int i4, int i5, int i6, int i7, int i8, Object obj) {
            ...
            imageBitmap.readPixels(iArr, i9, i3, width, (i8 & 16) != 0 ? imageBitmap.getHeight() : i5, (i8 & 32) != 0 ? 0 : i6, (i8 & 64) != 0 ? width : i7);
        }
    }
