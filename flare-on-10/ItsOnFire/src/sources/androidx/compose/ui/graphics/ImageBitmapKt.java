...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/graphics/ImageBitmapKt.class */
public final class ImageBitmapKt {
    @NotNull
    /* renamed from: ImageBitmap-x__-hDU  reason: not valid java name */
    public static final ImageBitmap m2584ImageBitmapx__hDU(int i2, int i3, int i4, boolean z, @NotNull ColorSpace colorSpace) {
        Intrinsics.checkNotNullParameter(colorSpace, "colorSpace");
        return AndroidImageBitmap_androidKt.m2283ActualImageBitmapx__hDU(i2, i3, i4, z, colorSpace);
    }

    /* renamed from: ImageBitmap-x__-hDU$default  reason: not valid java name */
    public static /* synthetic */ ImageBitmap m2585ImageBitmapx__hDU$default(int i2, int i3, int i4, boolean z, ColorSpace colorSpace, int i5, Object obj) {
        if ((i5 & 4) != 0) {
            i4 = ImageBitmapConfig.Companion.m2580getArgb8888_sVssgQ();
        }
        if ((i5 & 8) != 0) {
            z = true;
        }
        ...
        return m2584ImageBitmapx__hDU(i2, i3, i4, z, colorSpace);
    }
