...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/graphics/MatrixKt.class */
public final class MatrixKt {
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: dot-p89u6pk  reason: not valid java name */
    public static final float m2612dotp89u6pk(float[] fArr, int i2, float[] fArr2, int i3) {
        int i4 = i2 * 4;
    ...
    public static final boolean m2613isIdentity58bKbWc(@NotNull float[] isIdentity) {
