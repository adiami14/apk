...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/graphics/OffsetEffect.class */
public final class OffsetEffect extends RenderEffect {
    ...
    public android.graphics.RenderEffect createRenderEffect() {
        return RenderEffectVerificationHelper.INSTANCE.m2675createOffsetEffectUv8p0NA(this.renderEffect, this.offset);
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof OffsetEffect) {
            ...
            return Intrinsics.areEqual(this.renderEffect, offsetEffect.renderEffect) && Offset.m2164equalsimpl0(this.offset, offsetEffect.offset);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return ((renderEffect == null ? 0 : renderEffect.hashCode()) * 31) + Offset.m2169hashCodeimpl(this.offset);
    }

    @NotNull
    public String toString() {
        return "OffsetEffect(renderEffect=" + this.renderEffect + ", offset=" + ((Object) Offset.m2175toStringimpl(this.offset)) + ')';
    }
}
