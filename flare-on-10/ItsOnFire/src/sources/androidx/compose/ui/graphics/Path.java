...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/graphics/Path.class */
public interface Path {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/graphics/Path$Companion.class */
    public static final class Companion {
        ...
        public final Path m2630combinexh6zSI8(int i2, @NotNull Path path1, @NotNull Path path2) {
            Intrinsics.checkNotNullParameter(path1, "path1");
            Intrinsics.checkNotNullParameter(path2, "path2");
            Path Path = AndroidPath_androidKt.Path();
            if (Path.mo2308opN5in7k0(path1, path2, i2)) {
                return Path;
            }
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/graphics/Path$DefaultImpls.class */
    public static final class DefaultImpls {
        /* renamed from: addPath-Uv8p0NA$default  reason: not valid java name */
        public static /* synthetic */ void m2631addPathUv8p0NA$default(Path path, Path path2, long j2, int i2, Object obj) {
            if (obj != null) {
            ...
            path.mo2306addPathUv8p0NA(path2, j2);
        }
    ...
    void mo2306addPathUv8p0NA(@NotNull Path path, long j2);
    ...
    boolean mo2308opN5in7k0(@NotNull Path path, @NotNull Path path2, int i2);
    ...
    void mo2309setFillTypeoQ8Xj4U(int i2);

    /* renamed from: translate-k-4lQ0M */
    void mo2310translatek4lQ0M(long j2);
}
