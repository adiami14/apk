...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/graphics/PathEffect.class */
public interface PathEffect {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/graphics/PathEffect$Companion.class */
    public static final class Companion {
        ...
        public final PathEffect m2634stampedPathEffect7aD1DOk(@NotNull Path shape, float f2, float f3, int i2) {
            Intrinsics.checkNotNullParameter(shape, "shape");
            return AndroidPathEffect_androidKt.m2311actualStampedPathEffect7aD1DOk(shape, f2, f3, i2);
        }
    }
}
