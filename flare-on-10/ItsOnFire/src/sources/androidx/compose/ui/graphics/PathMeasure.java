...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/graphics/PathMeasure.class */
public interface PathMeasure {

    @Metadata(k = 3, mv = {1, 6, 0}, xi = androidx.appcompat.R.styleable.AppCompatTheme_checkboxStyle)
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/graphics/PathMeasure$DefaultImpls.class */
