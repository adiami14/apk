...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/graphics/RectangleShapeKt.class */
public final class RectangleShapeKt {
    ...
    private static final Shape RectangleShape = new Shape() { // from class: androidx.compose.ui.graphics.RectangleShapeKt$RectangleShape$1
        ...
        public Outline.Rectangle mo426createOutlinePq9zytI(long j2, @NotNull LayoutDirection layoutDirection, @NotNull Density density) {
            Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
            Intrinsics.checkNotNullParameter(density, "density");
            return new Outline.Rectangle(SizeKt.m2260toRectuvyYCjk(j2));
        }
