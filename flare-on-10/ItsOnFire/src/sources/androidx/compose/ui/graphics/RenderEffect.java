...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/graphics/RenderEffect.class */
public abstract class RenderEffect {
    ...
    public final android.graphics.RenderEffect asAndroidRenderEffect() {
        ...
        android.graphics.RenderEffect renderEffect2 = renderEffect;
        if (renderEffect == null) {
            renderEffect2 = createRenderEffect();
            this.internalRenderEffect = renderEffect2;
        }
