...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/graphics/RenderEffectKt.class */
public final class RenderEffectKt {
    @Stable
    @NotNull
    /* renamed from: BlurEffect-3YTHUZs  reason: not valid java name */
    public static final BlurEffect m2671BlurEffect3YTHUZs(float f2, float f3, int i2) {
        return new BlurEffect(null, f2, f3, i2, null);
    }

    /* renamed from: BlurEffect-3YTHUZs$default  reason: not valid java name */
    public static /* synthetic */ BlurEffect m2672BlurEffect3YTHUZs$default(float f2, float f3, int i2, int i3, Object obj) {
        if ((i3 & 4) != 0) {
            i2 = TileMode.Companion.m2733getClamp3opZhB0();
        }
        return m2671BlurEffect3YTHUZs(f2, f3, i2);
    }
