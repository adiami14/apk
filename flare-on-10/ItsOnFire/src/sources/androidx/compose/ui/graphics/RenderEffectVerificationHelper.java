...
@RequiresApi(31)
/* loaded from: ItsOnFire.jar:androidx/compose/ui/graphics/RenderEffectVerificationHelper.class */
final class RenderEffectVerificationHelper {
    ...
    public final android.graphics.RenderEffect m2674createBlurEffect8A3gB4(@Nullable RenderEffect renderEffect, float f2, float f3, int i2) {
        android.graphics.RenderEffect createBlurEffect = renderEffect == null ? android.graphics.RenderEffect.createBlurEffect(f2, f3, AndroidTileMode_androidKt.m2318toAndroidTileMode0vamqd0(i2)) : android.graphics.RenderEffect.createBlurEffect(f2, f3, renderEffect.asAndroidRenderEffect(), AndroidTileMode_androidKt.m2318toAndroidTileMode0vamqd0(i2));
    ...
    public final android.graphics.RenderEffect m2675createOffsetEffectUv8p0NA(@Nullable RenderEffect renderEffect, long j2) {
        android.graphics.RenderEffect createOffsetEffect;
        String str;
        float m2167getXimpl = Offset.m2167getXimpl(j2);
        if (renderEffect == null) {
            createOffsetEffect = android.graphics.RenderEffect.createOffsetEffect(m2167getXimpl, Offset.m2168getYimpl(j2));
            str = "{\n            android.gr…et.x, offset.y)\n        }";
        } else {
            createOffsetEffect = android.graphics.RenderEffect.createOffsetEffect(m2167getXimpl, Offset.m2168getYimpl(j2), renderEffect.asAndroidRenderEffect());
            str = "{\n            android.gr…)\n            )\n        }";
        }
