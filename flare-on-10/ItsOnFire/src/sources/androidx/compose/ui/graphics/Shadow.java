...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/graphics/Shadow.class */
public final class Shadow {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/graphics/Shadow$Companion.class */
    ...
    public /* synthetic */ Shadow(long j2, long j3, float f2, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this((i2 & 1) != 0 ? ColorKt.Color(4278190080L) : j2, (i2 & 2) != 0 ? Offset.Companion.m2183getZeroF1C5BW0() : j3, (i2 & 4) != 0 ? 0.0f : f2, null);
    }
    ...
    public static /* synthetic */ Shadow m2685copyqcb84PM$default(Shadow shadow, long j2, long j3, float f2, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            j2 = shadow.m2689getColor0d7_KjU();
        }
        if ((i2 & 2) != 0) {
            j3 = shadow.m2690getOffsetF1C5BW0();
        }
        if ((i2 & 4) != 0) {
            f2 = shadow.blurRadius;
        }
        return shadow.m2688copyqcb84PM(j2, j3, f2);
    }
    ...
    public static /* synthetic */ void m2686getColor0d7_KjU$annotations() {
    }

    @Stable
    /* renamed from: getOffset-F1C5BW0$annotations  reason: not valid java name */
    public static /* synthetic */ void m2687getOffsetF1C5BW0$annotations() {
    }

    @NotNull
    /* renamed from: copy-qcb84PM  reason: not valid java name */
    public final Shadow m2688copyqcb84PM(long j2, long j3, float f2) {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof Shadow) {
            ...
            if (Color.m2415equalsimpl0(m2689getColor0d7_KjU(), shadow.m2689getColor0d7_KjU()) && Offset.m2164equalsimpl0(m2690getOffsetF1C5BW0(), shadow.m2690getOffsetF1C5BW0())) {
    ...
    public final long m2689getColor0d7_KjU() {
        return this.color;
    }

    /* renamed from: getOffset-F1C5BW0  reason: not valid java name */
    public final long m2690getOffsetF1C5BW0() {
        return this.offset;
    }

    public int hashCode() {
        return (((Color.m2421hashCodeimpl(m2689getColor0d7_KjU()) * 31) + Offset.m2169hashCodeimpl(m2690getOffsetF1C5BW0())) * 31) + Float.hashCode(this.blurRadius);
    }

    @NotNull
    public String toString() {
        return "Shadow(color=" + ((Object) Color.m2422toStringimpl(m2689getColor0d7_KjU())) + ", offset=" + ((Object) Offset.m2175toStringimpl(m2690getOffsetF1C5BW0())) + ", blurRadius=" + this.blurRadius + ')';
    }
}
