...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/graphics/colorspace/ColorSpaces.class */
    ...
    public final ColorSpace match(@NotNull float[] toXYZD50, @NotNull TransferParameters function) {
        ...
        while (i2 < length) {
            ...
            if (ColorModel.m2773equalsimpl0(colorSpace.m2783getModelxdoWZVw(), ColorModel.Companion.m2780getRgbxdoWZVw())) {
                ...
                i2 = i3;
                if (ColorSpaceKt.compare(toXYZD50, rgb.getTransform$ui_graphics_release())) {
                    i2 = i3;
                    if (ColorSpaceKt.compare(function, rgb.getTransferParameters())) {
                        return colorSpace;
                    }
                } else {
                    continue;
