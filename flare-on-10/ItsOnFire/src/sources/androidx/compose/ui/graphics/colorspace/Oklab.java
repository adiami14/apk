...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/graphics/colorspace/Oklab.class */
public final class Oklab extends ColorSpace {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/graphics/colorspace/Oklab$Companion.class */
    ...
    public Oklab(@NotNull String name, int i2) {
        super(name, ColorModel.Companion.m2779getLabxdoWZVw(), i2, null);
