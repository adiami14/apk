...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/graphics/colorspace/TransferParameters.class */
public final class TransferParameters {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:63:0x010b, code lost:
        if ((r7 == 0.0d) != false) goto L71;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public TransferParameters(double r7, double r9, double r11, double r13, double r15, double r17, double r19) {
        /*
    ...
    public static /* synthetic */ TransferParameters copy$default(TransferParameters transferParameters, double d2, double d3, double d4, double d5, double d6, double d7, double d8, int i2, Object obj) {
        ...
        if ((i2 & 2) != 0) {
            d3 = transferParameters.f36a;
        }
        if ((i2 & 4) != 0) {
            d4 = transferParameters.f37b;
        }
        if ((i2 & 8) != 0) {
            d5 = transferParameters.f38c;
        }
        if ((i2 & 16) != 0) {
            d6 = transferParameters.f39d;
        }
        if ((i2 & 32) != 0) {
            d7 = transferParameters.f40e;
        }
        if ((i2 & 64) != 0) {
            d8 = transferParameters.f41f;
        }
