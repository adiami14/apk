...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/graphics/drawscope/DrawScopeKt.class */
public final class DrawScopeKt {
    /* renamed from: clipPath-KD09W0M  reason: not valid java name */
    public static final void m2911clipPathKD09W0M(@NotNull DrawScope clipPath, @NotNull Path path, int i2, @NotNull Function1<? super DrawScope, Unit> block) {
        ...
        drawContext.getTransform().mo2850clipPathmtrdDE(path, i2);
    ...
    public static /* synthetic */ void m2912clipPathKD09W0M$default(DrawScope clipPath, Path path, int i2, Function1 block, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = ClipOp.Companion.m2402getIntersectrtfAjoo();
        }
        Intrinsics.checkNotNullParameter(clipPath, "$this$clipPath");
        Intrinsics.checkNotNullParameter(path, "path");
        Intrinsics.checkNotNullParameter(block, "block");
    ...
    public static final void m2913clipRectrOu3jXo(@NotNull DrawScope clipRect, float f2, float f3, float f4, float f5, int i2, @NotNull Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(clipRect, "$this$clipRect");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext drawContext = clipRect.getDrawContext();
        long mo2847getSizeNHjbRc = drawContext.mo2847getSizeNHjbRc();
        drawContext.getCanvas().save();
        drawContext.getTransform().mo2851clipRectN_I0leg(f2, f3, f4, f5, i2);
    ...
    public static /* synthetic */ void m2914clipRectrOu3jXo$default(DrawScope clipRect, float f2, float f3, float f4, float f5, int i2, Function1 block, int i3, Object obj) {
        if ((i3 & 1) != 0) {
            f2 = 0.0f;
        }
        if ((i3 & 2) != 0) {
        ...
        if ((i3 & 4) != 0) {
            f4 = Size.m2239getWidthimpl(clipRect.mo2841getSizeNHjbRc());
        }
        if ((i3 & 8) != 0) {
            f5 = Size.m2236getHeightimpl(clipRect.mo2841getSizeNHjbRc());
        }
        if ((i3 & 16) != 0) {
            i2 = ClipOp.Companion.m2402getIntersectrtfAjoo();
        }
    ...
    public static final void m2915rotateRg1IO4c(@NotNull DrawScope rotate, float f2, long j2, @NotNull Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(rotate, "$this$rotate");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext drawContext = rotate.getDrawContext();
        long mo2847getSizeNHjbRc = drawContext.mo2847getSizeNHjbRc();
        drawContext.getCanvas().save();
        drawContext.getTransform().mo2854rotateUv8p0NA(f2, j2);
        block.invoke(rotate);
        drawContext.getCanvas().restore();
        drawContext.mo2848setSizeuvyYCjk(mo2847getSizeNHjbRc);
    }
    ...
    public static /* synthetic */ void m2916rotateRg1IO4c$default(DrawScope rotate, float f2, long j2, Function1 block, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            j2 = rotate.mo2840getCenterF1C5BW0();
        }
        Intrinsics.checkNotNullParameter(rotate, "$this$rotate");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext drawContext = rotate.getDrawContext();
    ...
    public static final void m2917rotateRadRg1IO4c(@NotNull DrawScope rotateRad, float f2, long j2, @NotNull Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(rotateRad, "$this$rotateRad");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext drawContext = rotateRad.getDrawContext();
        long mo2847getSizeNHjbRc = drawContext.mo2847getSizeNHjbRc();
        drawContext.getCanvas().save();
        drawContext.getTransform().mo2854rotateUv8p0NA(DegreesKt.degrees(f2), j2);
    ...
    public static /* synthetic */ void m2918rotateRadRg1IO4c$default(DrawScope rotateRad, float f2, long j2, Function1 block, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            j2 = rotateRad.mo2840getCenterF1C5BW0();
        }
        Intrinsics.checkNotNullParameter(rotateRad, "$this$rotateRad");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext drawContext = rotateRad.getDrawContext();
    ...
    public static final void m2919scaleFgt4K4Q(@NotNull DrawScope scale, float f2, float f3, long j2, @NotNull Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(scale, "$this$scale");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext drawContext = scale.getDrawContext();
        long mo2847getSizeNHjbRc = drawContext.mo2847getSizeNHjbRc();
        drawContext.getCanvas().save();
        drawContext.getTransform().mo2855scale0AR0LA0(f2, f3, j2);
        block.invoke(scale);
        drawContext.getCanvas().restore();
        drawContext.mo2848setSizeuvyYCjk(mo2847getSizeNHjbRc);
    }
    ...
    public static /* synthetic */ void m2920scaleFgt4K4Q$default(DrawScope scale, float f2, float f3, long j2, Function1 block, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            j2 = scale.mo2840getCenterF1C5BW0();
        }
        Intrinsics.checkNotNullParameter(scale, "$this$scale");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext drawContext = scale.getDrawContext();
    ...
    public static final void m2921scaleRg1IO4c(@NotNull DrawScope scale, float f2, long j2, @NotNull Function1<? super DrawScope, Unit> block) {
        Intrinsics.checkNotNullParameter(scale, "$this$scale");
        Intrinsics.checkNotNullParameter(block, "block");
        DrawContext drawContext = scale.getDrawContext();
        long mo2847getSizeNHjbRc = drawContext.mo2847getSizeNHjbRc();
        drawContext.getCanvas().save();
        drawContext.getTransform().mo2855scale0AR0LA0(f2, f2, j2);
        block.invoke(scale);
        drawContext.getCanvas().restore();
        drawContext.mo2848setSizeuvyYCjk(mo2847getSizeNHjbRc);
    }
    ...
    public static /* synthetic */ void m2922scaleRg1IO4c$default(DrawScope scale, float f2, long j2, Function1 block, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            j2 = scale.mo2840getCenterF1C5BW0();
        }
        Intrinsics.checkNotNullParameter(scale, "$this$scale");
