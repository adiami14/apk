...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/graphics/drawscope/DrawTransformKt.class */
public final class DrawTransformKt {
    ...
    public static final void m2928rotateRad0AR0LA0(@NotNull DrawTransform rotateRad, float f2, long j2) {
        Intrinsics.checkNotNullParameter(rotateRad, "$this$rotateRad");
        rotateRad.mo2854rotateUv8p0NA(DegreesKt.degrees(f2), j2);
    }

    /* renamed from: rotateRad-0AR0LA0$default  reason: not valid java name */
    public static /* synthetic */ void m2929rotateRad0AR0LA0$default(DrawTransform rotateRad, float f2, long j2, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            j2 = rotateRad.mo2852getCenterF1C5BW0();
        }
        Intrinsics.checkNotNullParameter(rotateRad, "$this$rotateRad");
        rotateRad.mo2854rotateUv8p0NA(DegreesKt.degrees(f2), j2);
    }
    ...
    public static final void m2930scale0AR0LA0(@NotNull DrawTransform scale, float f2, long j2) {
        Intrinsics.checkNotNullParameter(scale, "$this$scale");
        scale.mo2855scale0AR0LA0(f2, f2, j2);
    }

    /* renamed from: scale-0AR0LA0$default  reason: not valid java name */
    public static /* synthetic */ void m2931scale0AR0LA0$default(DrawTransform scale, float f2, long j2, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            j2 = scale.mo2852getCenterF1C5BW0();
        }
        Intrinsics.checkNotNullParameter(scale, "$this$scale");
        scale.mo2855scale0AR0LA0(f2, f2, j2);
    }
