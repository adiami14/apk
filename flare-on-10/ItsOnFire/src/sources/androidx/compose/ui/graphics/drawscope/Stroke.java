...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/graphics/drawscope/Stroke.class */
public final class Stroke extends DrawStyle {
    @NotNull
    public static final Companion Companion = new Companion(null);
    private static final int DefaultCap = StrokeCap.Companion.m2711getButtKaPHkGw();
    private static final int DefaultJoin = StrokeJoin.Companion.m2723getMiterLxFBmk8();
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/graphics/drawscope/Stroke$Companion.class */
    public static final class Companion {
        ...
        public final int m2936getDefaultCapKaPHkGw() {
            return Stroke.DefaultCap;
        }

        /* renamed from: getDefaultJoin-LxFBmk8  reason: not valid java name */
        public final int m2937getDefaultJoinLxFBmk8() {
    ...
    public /* synthetic */ Stroke(float f2, float f3, int i2, int i3, PathEffect pathEffect, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? 0.0f : f2, (i4 & 2) != 0 ? 4.0f : f3, (i4 & 4) != 0 ? StrokeCap.Companion.m2711getButtKaPHkGw() : i2, (i4 & 8) != 0 ? StrokeJoin.Companion.m2723getMiterLxFBmk8() : i3, (i4 & 16) != 0 ? null : pathEffect, null);
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof Stroke) {
            ...
            if (this.width == stroke.width) {
                return ((this.miter > stroke.miter ? 1 : (this.miter == stroke.miter ? 0 : -1)) == 0) && StrokeCap.m2707equalsimpl0(m2934getCapKaPHkGw(), stroke.m2934getCapKaPHkGw()) && StrokeJoin.m2718equalsimpl0(m2935getJoinLxFBmk8(), stroke.m2935getJoinLxFBmk8()) && Intrinsics.areEqual(this.pathEffect, stroke.pathEffect);
            }
            return false;
        }
        return false;
    ...
    public final int m2934getCapKaPHkGw() {
        return this.cap;
    }

    /* renamed from: getJoin-LxFBmk8  reason: not valid java name */
    public final int m2935getJoinLxFBmk8() {
        return this.join;
    }
    ...
    public int hashCode() {
        ...
        int m2708hashCodeimpl = StrokeCap.m2708hashCodeimpl(m2934getCapKaPHkGw());
        int m2719hashCodeimpl = StrokeJoin.m2719hashCodeimpl(m2935getJoinLxFBmk8());
        PathEffect pathEffect = this.pathEffect;
        return (((((((hashCode * 31) + hashCode2) * 31) + m2708hashCodeimpl) * 31) + m2719hashCodeimpl) * 31) + (pathEffect == null ? 0 : pathEffect.hashCode());
    }

    @NotNull
    public String toString() {
        return "Stroke(width=" + this.width + ", miter=" + this.miter + ", cap=" + ((Object) StrokeCap.m2709toStringimpl(m2934getCapKaPHkGw())) + ", join=" + ((Object) StrokeJoin.m2720toStringimpl(m2935getJoinLxFBmk8())) + ", pathEffect=" + this.pathEffect + ')';
    }
}
