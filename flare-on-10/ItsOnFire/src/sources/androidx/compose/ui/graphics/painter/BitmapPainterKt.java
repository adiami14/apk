...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/graphics/painter/BitmapPainterKt.class */
public final class BitmapPainterKt {
    @NotNull
    /* renamed from: BitmapPainter-QZhYCtY  reason: not valid java name */
    public static final BitmapPainter m2942BitmapPainterQZhYCtY(@NotNull ImageBitmap image, long j2, long j3, int i2) {
        Intrinsics.checkNotNullParameter(image, "image");
        BitmapPainter bitmapPainter = new BitmapPainter(image, j2, j3, null);
        bitmapPainter.m2941setFilterQualityvDHp3xo$ui_graphics_release(i2);
        return bitmapPainter;
    }

    /* renamed from: BitmapPainter-QZhYCtY$default  reason: not valid java name */
    public static /* synthetic */ BitmapPainter m2943BitmapPainterQZhYCtY$default(ImageBitmap imageBitmap, long j2, long j3, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            j2 = IntOffset.Companion.m4917getZeronOccac();
        }
        if ((i3 & 4) != 0) {
            j3 = IntSizeKt.IntSize(imageBitmap.getWidth(), imageBitmap.getHeight());
        }
        if ((i3 & 8) != 0) {
            i2 = FilterQuality.Companion.m2502getLowfv9h1I();
        }
        return m2942BitmapPainterQZhYCtY(imageBitmap, j2, j3, i2);
    }
}
