...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/graphics/painter/ColorPainter.class */
public final class ColorPainter extends Painter {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return (obj instanceof ColorPainter) && Color.m2415equalsimpl0(m2944getColor0d7_KjU(), ((ColorPainter) obj).m2944getColor0d7_KjU());
    }

    /* renamed from: getColor-0d7_KjU  reason: not valid java name */
    public final long m2944getColor0d7_KjU() {
        return this.color;
    }
    ...
    public int hashCode() {
        return Color.m2421hashCodeimpl(m2944getColor0d7_KjU());
    }

    @Override // androidx.compose.ui.graphics.painter.Painter
    public void onDraw(@NotNull DrawScope drawScope) {
        Intrinsics.checkNotNullParameter(drawScope, "<this>");
        DrawScope.DefaultImpls.m2893drawRectnJ9OG0$default(drawScope, m2944getColor0d7_KjU(), 0L, 0L, this.alpha, null, this.colorFilter, 0, 86, null);
    }

    @NotNull
    public String toString() {
        return "ColorPainter(color=" + ((Object) Color.m2422toStringimpl(m2944getColor0d7_KjU())) + ')';
    }
}
