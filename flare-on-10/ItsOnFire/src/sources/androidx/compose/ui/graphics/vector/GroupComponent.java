...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/graphics/vector/GroupComponent.class */
public final class GroupComponent extends VNode {
    ...
    private final void updateMatrix() {
        ...
        if (fArr == null) {
            fArr = Matrix.m2589constructorimpl$default(null, 1, null);
            this.groupMatrix = fArr;
        } else {
            Matrix.m2598resetimpl(fArr);
        }
        float f2 = this.translationX;
        Matrix.m2609translateimpl$default(fArr, this.pivotX + f2, this.pivotY + this.translationY, 0.0f, 4, null);
        Matrix.m2601rotateZimpl(fArr, this.rotation);
        Matrix.m2602scaleimpl(fArr, this.scaleX, this.scaleY, 1.0f);
        Matrix.m2609translateimpl$default(fArr, -this.pivotX, -this.pivotY, 0.0f, 4, null);
    }
    ...
    public void draw(@NotNull DrawScope drawScope) {
        ...
        float[] fArr = this.groupMatrix;
        if (fArr != null) {
            transform.mo2856transform58bKbWc(fArr);
        }
        Path path = this.clipPath;
        if (getWillClipPath() && path != null) {
            DrawTransform.DefaultImpls.m2923clipPathmtrdDE$default(transform, path, 0, 2, null);
        }
