...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/graphics/vector/ImageVectorKt.class */
public final class ImageVectorKt {
    ...
    public static final ImageVector.Builder m2956pathR_LF3I(@NotNull ImageVector.Builder path, @NotNull String name, @Nullable Brush brush, float f2, @Nullable Brush brush2, float f3, float f4, int i2, int i3, float f5, int i4, @NotNull Function1<? super PathBuilder, Unit> pathBuilder) {
        ...
        return ImageVector.Builder.m2954addPathoIyEayM$default(path, pathBuilder2.getNodes(), i4, name, brush, f2, brush2, f3, f4, i2, i3, f5, 0.0f, 0.0f, 0.0f, 14336, null);
    }

    /* renamed from: path-R_LF-3I$default  reason: not valid java name */
    public static /* synthetic */ ImageVector.Builder m2957pathR_LF3I$default(ImageVector.Builder path, String str, Brush brush, float f2, Brush brush2, float f3, float f4, int i2, int i3, float f5, int i4, Function1 pathBuilder, int i5, Object obj) {
        if ((i5 & 1) != 0) {
            str = "";
        }
        if ((i5 & 2) != 0) {
        ...
        if ((i5 & 512) != 0) {
            i4 = VectorKt.getDefaultFillType();
        }
        Intrinsics.checkNotNullParameter(path, "$this$path");
        String name = str;
        Intrinsics.checkNotNullParameter(name, "name");
        ...
        PathBuilder pathBuilder2 = new PathBuilder();
        pathBuilder.invoke(pathBuilder2);
        return ImageVector.Builder.m2954addPathoIyEayM$default(path, pathBuilder2.getNodes(), i4, str, brush, f2, brush2, f3, f4, i2, i3, f5, 0.0f, 0.0f, 0.0f, 14336, null);
    }
}
