...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/graphics/vector/PathParser.class */
public final class PathParser {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/graphics/vector/PathParser$ExtractFloatResult.class */
    public static final class ExtractFloatResult {
        ...
        public int hashCode() {
            int hashCode = Integer.hashCode(this.endPosition);
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/graphics/vector/PathParser$PathPoint.class */
    ...
    private final void arcToBezier(Path path, double d2, double d3, double d4, double d5, double d6, double d7, double d8, double d9, double d10) {
        ...
        while (i2 < ceil) {
            ...
            double d24 = (d2 + ((d4 * cos) * cos3)) - (d14 * sin3);
            double d25 = d3 + (d4 * sin * cos3) + (d16 * sin3);
            double d26 = (d13 * sin3) - (d14 * cos3);
            double d27 = (sin3 * d15) + (cos3 * d16);
            double d28 = d23 - d20;
            double tan = Math.tan(d28 / 2);
            double sin4 = (Math.sin(d28) * (Math.sqrt(d11 + ((3.0d * tan) * tan)) - 1)) / 3;
            path.cubicTo((float) (d21 + (d22 * sin4)), (float) (d19 + (d18 * sin4)), (float) (d24 - (sin4 * d26)), (float) (d25 - (sin4 * d27)), (float) d24, (float) d25);
            i2++;
            d19 = d25;
            d21 = d24;
            d20 = d23;
    ...
    private final void drawArc(Path path, double d2, double d3, double d4, double d5, double d6, double d7, double d8, boolean z, boolean z2) {
        ...
        double d24 = atan22;
        if (z2 != (i2 >= 0)) {
            d24 = i2 > 0 ? atan22 - 6.283185307179586d : atan22 + 6.283185307179586d;
        }
        double d25 = d9 * d6;
        double d26 = d10 * d7;
        arcToBezier(path, (d25 * cos) - (d26 * sin), (d25 * sin) + (d26 * cos), d6, d7, d2, d3, radians, atan2, d24);
    }

    /* JADX WARN: Code restructure failed: missing block: B:20:0x0063, code lost:
        if (r8 == false) goto L23;
     */
    /* JADX WARN: Removed duplicated region for block: B:42:0x00b6 A[LOOP:0: B:3:0x001b->B:42:0x00b6, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:46:0x00bc A[EDGE_INSN: B:46:0x00bc->B:43:0x00bc ?: BREAK  , SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    private final void extract(java.lang.String r4, int r5, androidx.compose.ui.graphics.vector.PathParser.ExtractFloatResult r6) {
        /*
            r3 = this;
            r0 = r6
            r1 = 0
            r0.setEndWithNegativeOrDot(r1)
            r0 = 0
            r7 = r0
            r0 = r7
            r8 = r0
    ...
    public final PathParser parsePathString(@NotNull String pathData) {
        ...
        while (true) {
            i2 = i4;
            if (i2 >= pathData.length()) {
                break;
            }
            int nextStart = nextStart(pathData, i2);
            String substring = pathData.substring(i3, nextStart);
            Intrinsics.checkNotNullExpressionValue(substring, "this as java.lang.String…ing(startIndex, endIndex)");
            int length = substring.length() - 1;
            int i5 = 0;
            boolean z = false;
            while (i5 <= length) {
                boolean z2 = Intrinsics.compare((int) substring.charAt(!z ? i5 : length), 32) <= 0;
                if (z) {
                    if (!z2) {
                        break;
                    }
        ...
        if (i2 - i3 == 1 && i3 < pathData.length()) {
            addNode(pathData.charAt(i3), new float[0]);
        }
        return this;
    }
    ...
    public final Path toPath(@NotNull Path target) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (pathNode2 instanceof PathNode.Close) {
                ...
                relativeReflectiveCurveTo((PathNode.RelativeReflectiveCurveTo) pathNode2, pathNode3.isCurve(), target);
            } else if (pathNode2 instanceof PathNode.ReflectiveCurveTo) {
                Intrinsics.checkNotNull(pathNode3);
                reflectiveCurveTo((PathNode.ReflectiveCurveTo) pathNode2, pathNode3.isCurve(), target);
                ...
                Intrinsics.checkNotNull(pathNode3);
                relativeReflectiveQuadTo((PathNode.RelativeReflectiveQuadTo) pathNode2, pathNode3.isQuad(), target);
            } else if (pathNode2 instanceof PathNode.ReflectiveQuadTo) {
                Intrinsics.checkNotNull(pathNode3);
                reflectiveQuadTo((PathNode.ReflectiveQuadTo) pathNode2, pathNode3.isQuad(), target);
