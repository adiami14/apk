...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/graphics/vector/VectorComponent.class */
public final class VectorComponent extends VNode {
    ...
    public VectorComponent() {
        ...
        this.previousDrawSize = Size.Companion.m2247getUnspecifiedNHjbRc();
    ...
    public final void draw(@NotNull DrawScope drawScope, float f2, @Nullable ColorFilter colorFilter) {
        ...
        if (this.isDirty || !Size.m2235equalsimpl0(this.previousDrawSize, drawScope.mo2841getSizeNHjbRc())) {
            this.root.setScaleX(Size.m2239getWidthimpl(drawScope.mo2841getSizeNHjbRc()) / this.viewportWidth);
            this.root.setScaleY(Size.m2236getHeightimpl(drawScope.mo2841getSizeNHjbRc()) / this.viewportHeight);
            this.cacheDrawScope.m2947drawCachedImageCJJARo(IntSizeKt.IntSize((int) Math.ceil(Size.m2239getWidthimpl(drawScope.mo2841getSizeNHjbRc())), (int) Math.ceil(Size.m2236getHeightimpl(drawScope.mo2841getSizeNHjbRc()))), drawScope, drawScope.getLayoutDirection(), this.drawVectorBlock);
            this.isDirty = false;
            this.previousDrawSize = drawScope.mo2841getSizeNHjbRc();
        }
