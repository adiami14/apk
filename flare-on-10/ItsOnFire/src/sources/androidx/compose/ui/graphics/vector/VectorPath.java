...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/graphics/vector/VectorPath.class */
public final class VectorPath extends VectorNode {
        ...
        if (Intrinsics.areEqual(this.name, vectorPath.name) && Intrinsics.areEqual(this.fill, vectorPath.fill)) {
            if ((this.fillAlpha == vectorPath.fillAlpha) && Intrinsics.areEqual(this.stroke, vectorPath.stroke)) {
                if (this.strokeAlpha == vectorPath.strokeAlpha) {
                    if ((this.strokeLineWidth == vectorPath.strokeLineWidth) && StrokeCap.m2707equalsimpl0(m3020getStrokeLineCapKaPHkGw(), vectorPath.m3020getStrokeLineCapKaPHkGw()) && StrokeJoin.m2718equalsimpl0(m3021getStrokeLineJoinLxFBmk8(), vectorPath.m3021getStrokeLineJoinLxFBmk8())) {
                        if (this.strokeLineMiter == vectorPath.strokeLineMiter) {
                            if (this.trimPathStart == vectorPath.trimPathStart) {
                                if (this.trimPathEnd == vectorPath.trimPathEnd) {
                                    return ((this.trimPathOffset > vectorPath.trimPathOffset ? 1 : (this.trimPathOffset == vectorPath.trimPathOffset ? 0 : -1)) == 0) && PathFillType.m2639equalsimpl0(m3019getPathFillTypeRgk1Os(), vectorPath.m3019getPathFillTypeRgk1Os()) && Intrinsics.areEqual(this.pathData, vectorPath.pathData);
                                }
                                return false;
                            }
                            return false;
    ...
    public final int m3019getPathFillTypeRgk1Os() {
    ...
    public final int m3020getStrokeLineCapKaPHkGw() {
        return this.strokeLineCap;
    }

    /* renamed from: getStrokeLineJoin-LxFBmk8  reason: not valid java name */
    public final int m3021getStrokeLineJoinLxFBmk8() {
    ...
    public int hashCode() {
        ...
        int i2 = 0;
        int hashCode3 = brush == null ? 0 : brush.hashCode();
        int hashCode4 = Float.hashCode(this.fillAlpha);
        Brush brush2 = this.stroke;
        if (brush2 != null) {
            i2 = brush2.hashCode();
        }
        return (((((((((((((((((((((((((hashCode * 31) + hashCode2) * 31) + hashCode3) * 31) + hashCode4) * 31) + i2) * 31) + Float.hashCode(this.strokeAlpha)) * 31) + Float.hashCode(this.strokeLineWidth)) * 31) + StrokeCap.m2708hashCodeimpl(m3020getStrokeLineCapKaPHkGw())) * 31) + StrokeJoin.m2719hashCodeimpl(m3021getStrokeLineJoinLxFBmk8())) * 31) + Float.hashCode(this.strokeLineMiter)) * 31) + Float.hashCode(this.trimPathStart)) * 31) + Float.hashCode(this.trimPathEnd)) * 31) + Float.hashCode(this.trimPathOffset)) * 31) + PathFillType.m2640hashCodeimpl(m3019getPathFillTypeRgk1Os());
    }
}
