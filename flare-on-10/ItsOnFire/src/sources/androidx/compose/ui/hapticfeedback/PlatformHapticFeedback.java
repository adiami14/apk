...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/hapticfeedback/PlatformHapticFeedback.class */
public final class PlatformHapticFeedback implements HapticFeedback {
    ...
    public void mo3045performHapticFeedbackCdsT49E(int i2) {
        View view;
        int i3;
        HapticFeedbackType.Companion companion = HapticFeedbackType.Companion;
        if (HapticFeedbackType.m3050equalsimpl0(i2, companion.m3054getLongPress5zf0vsI())) {
            view = this.view;
            i3 = 0;
        } else if (!HapticFeedbackType.m3050equalsimpl0(i2, companion.m3055getTextHandleMove5zf0vsI())) {
            return;
        } else {
            view = this.view;
            i3 = 9;
