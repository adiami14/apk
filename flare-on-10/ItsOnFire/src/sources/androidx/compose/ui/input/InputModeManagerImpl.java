...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/input/InputModeManagerImpl.class */
public final class InputModeManagerImpl implements InputModeManager {
    ...
    private InputModeManagerImpl(int i2, Function1<? super InputMode, Boolean> function1) {
        ...
        mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(InputMode.m3060boximpl(i2), null, 2, null);
    ...
    public int mo3069getInputModeaOaMEAU() {
        return ((InputMode) this.inputMode$delegate.getValue()).m3066unboximpl();
    }

    @Override // androidx.compose.ui.input.InputModeManager
    @ExperimentalComposeUiApi
    /* renamed from: requestInputMode-iuPiT84 */
    public boolean mo3070requestInputModeiuPiT84(int i2) {
        return this.onRequestInputModeChange.invoke(InputMode.m3060boximpl(i2)).booleanValue();
    }

    /* renamed from: setInputMode-iuPiT84  reason: not valid java name */
    public void m3071setInputModeiuPiT84(int i2) {
        this.inputMode$delegate.setValue(InputMode.m3060boximpl(i2));
    }
}
