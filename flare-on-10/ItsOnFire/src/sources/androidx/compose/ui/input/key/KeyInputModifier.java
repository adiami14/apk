...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/input/key/KeyInputModifier.class */
public final class KeyInputModifier implements Modifier.Element {
    ...
    public final boolean m3679processKeyInputZmokQxo(@NotNull android.view.KeyEvent keyEvent) {
        ...
        if (modifiedKeyInputNode != null) {
            return modifiedKeyInputNode.m4090propagatePreviewKeyEventZmokQxo(keyEvent) ? true : modifiedKeyInputNode.m4089propagateKeyEventZmokQxo(keyEvent);
        }
