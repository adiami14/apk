...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/input/pointer/HistoricalChange.class */
public final class HistoricalChange {
    ...
    public final long m3719getPositionF1C5BW0() {
    ...
    public String toString() {
        return "HistoricalChange(uptimeMillis=" + this.uptimeMillis + ", position=" + ((Object) Offset.m2175toStringimpl(m3719getPositionF1C5BW0())) + ')';
    }
}
