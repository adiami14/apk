...
@RequiresApi(29)
/* loaded from: ItsOnFire.jar:androidx/compose/ui/input/pointer/MotionEventHelper.class */
final class MotionEventHelper {
    ...
    public final long m3724toRawOffsetdBAh8RU(@NotNull MotionEvent motionEvent, int i2) {
