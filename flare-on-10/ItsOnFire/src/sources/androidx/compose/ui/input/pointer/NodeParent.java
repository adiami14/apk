...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/input/pointer/NodeParent.class */
public class NodeParent {
    ...
    public boolean buildCache(@NotNull Map<PointerId, PointerInputChange> changes, @NotNull LayoutCoordinates parentCoordinates, @NotNull InternalPointerEvent internalPointerEvent, boolean z) {
        ...
        if (size > 0) {
            ...
            boolean z3 = false;
            do {
                z2 = content[i3].buildCache(changes, parentCoordinates, internalPointerEvent, z) || z3;
                i2 = i3 + 1;
                i3 = i2;
                z3 = z2;
            } while (i2 < size);
    ...
    public boolean dispatchFinalEventPass(@NotNull InternalPointerEvent internalPointerEvent) {
        ...
        boolean z2 = false;
        do {
            z = content[i3].dispatchFinalEventPass(internalPointerEvent) || z2;
            i2 = i3 + 1;
            i3 = i2;
            z2 = z;
        } while (i2 < size);
    ...
    public boolean dispatchMainEventPass(@NotNull Map<PointerId, PointerInputChange> changes, @NotNull LayoutCoordinates parentCoordinates, @NotNull InternalPointerEvent internalPointerEvent, boolean z) {
        ...
        if (size > 0) {
            ...
            boolean z3 = false;
            do {
                z2 = content[i3].dispatchMainEventPass(changes, parentCoordinates, internalPointerEvent, z) || z3;
                i2 = i3 + 1;
                i3 = i2;
                z3 = z2;
            } while (i2 < size);
