...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/input/pointer/PointerInputModifier.class */
public interface PointerInputModifier extends Modifier.Element {

    @Metadata(k = 3, mv = {1, 6, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/input/pointer/PointerInputModifier$DefaultImpls.class */
