...
@JvmInline
/* loaded from: ItsOnFire.jar:androidx/compose/ui/input/pointer/PointerType.class */
public final class PointerType {
    private final int value;
    @NotNull
    public static final Companion Companion = new Companion(null);
    private static final int Unknown = m3853constructorimpl(0);
    private static final int Touch = m3853constructorimpl(1);
    private static final int Mouse = m3853constructorimpl(2);
    private static final int Stylus = m3853constructorimpl(3);
    private static final int Eraser = m3853constructorimpl(4);
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/input/pointer/PointerType$Companion.class */
    ...
    public static final /* synthetic */ PointerType m3852boximpl(int i2) {
        return new PointerType(i2);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m3853constructorimpl(int i2) {
        return i2;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m3854equalsimpl(int i2, Object obj) {
        return (obj instanceof PointerType) && i2 == ((PointerType) obj).m3858unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m3855equalsimpl0(int i2, int i3) {
        return i2 == i3;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m3856hashCodeimpl(int i2) {
        return Integer.hashCode(i2);
    }

    @NotNull
    /* renamed from: toString-impl  reason: not valid java name */
    public static String m3857toStringimpl(int i2) {
