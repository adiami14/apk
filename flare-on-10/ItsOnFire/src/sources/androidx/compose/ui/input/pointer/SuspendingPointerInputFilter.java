...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/input/pointer/SuspendingPointerInputFilter.class */
public final class SuspendingPointerInputFilter extends PointerInputFilter implements PointerInputModifier, PointerInputScope, Density {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/input/pointer/SuspendingPointerInputFilter$PointerEventHandlerCoroutine.class */
    public final class PointerEventHandlerCoroutine<R> implements AwaitPointerEventScope, Density, Continuation<R> {
        ...
        public long mo3703getExtendedTouchPaddingNHjbRc() {
            return this.this$0.mo3817getExtendedTouchPaddingNHjbRc();
        }
        ...
        public long mo3704getSizeYbymL2g() {
        ...
        public final void offerPointerEvent(@NotNull PointerEvent event, @NotNull PointerEventPass pass) {
            ...
            qVar.resumeWith(Result.m5849constructorimpl(event));
        }
        ...
        /* JADX WARN: Type inference failed for: r0v17, types: [j.n2] */
        /* JADX WARN: Type inference failed for: r0v33, types: [j.n2] */
        /* JADX WARN: Type inference failed for: r0v39, types: [j.n2] */
        /* JADX WARN: Type inference failed for: r0v9, types: [j.n2] */
        @Override // androidx.compose.ui.input.pointer.AwaitPointerEventScope
        ...
        */
        ...
        /*
            ...
            To view partially-correct add '--show-bad-code' argument
        */
        public <T> java.lang.Object withTimeoutOrNull(long r7, @org.jetbrains.annotations.NotNull kotlin.jvm.functions.Function2<? super androidx.compose.ui.input.pointer.AwaitPointerEventScope, ? super kotlin.coroutines.Continuation<? super T>, ? extends java.lang.Object> r9, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super T> r10) {
            /*
                r6 = this;
                r0 = r10
                boolean r0 = r0 instanceof androidx.compose.ui.input.pointer.SuspendingPointerInputFilter$PointerEventHandlerCoroutine$withTimeoutOrNull$1
                if (r0 == 0) goto L31
                r0 = r10
            ...
            L3d:
                ...
                if (r0 != r1) goto L66
                r0 = r11
                kotlin.ResultKt.throwOnFailure(r0)     // Catch: androidx.compose.ui.input.pointer.PointerEventTimeoutCancellationException -> L93
                r0 = r11
                r9 = r0
                goto L96
            L66:
            ...
            L71:
                ...
                r0 = r10
                r1 = 1
                r0.label = r1     // Catch: androidx.compose.ui.input.pointer.PointerEventTimeoutCancellationException -> L93
                r0 = r6
                r1 = r7
                r2 = r9
                r3 = r10
                java.lang.Object r0 = r0.withTimeout(r1, r2, r3)     // Catch: androidx.compose.ui.input.pointer.PointerEventTimeoutCancellationException -> L93
                r10 = r0
                r0 = r10
                r9 = r0
                r0 = r10
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/input/pointer/SuspendingPointerInputFilter$WhenMappings.class */
    ...
    public SuspendingPointerInputFilter(@NotNull ViewConfiguration viewConfiguration, @NotNull Density density) {
        ...
        this.boundsSize = IntSize.Companion.m4956getZeroYbymL2g();
        this.coroutineScope = e2.f468j;
    }
    ...
    private final void dispatchPointerEvent(PointerEvent pointerEvent, PointerEventPass pointerEventPass) {
        ...
        try {
            int i4 = WhenMappings.$EnumSwitchMapping$0[pointerEventPass.ordinal()];
            if (i4 == 1 || i4 == 2) {
                ...
                if (size > 0) {
                    ...
                    do {
                        content[i5].offerPointerEvent(pointerEvent, pointerEventPass);
                        i2 = i5 + 1;
                        i5 = i2;
                    } while (i2 < size);
                }
                ...
                if (size2 > 0) {
                    ...
                    do {
                        content2[i6].offerPointerEvent(pointerEvent, pointerEventPass);
                        i3 = i6 - 1;
                        i6 = i3;
                    } while (i3 >= 0);
                }
    ...
    public <R> Object awaitPointerEventScope(@NotNull Function2<? super AwaitPointerEventScope, ? super Continuation<? super R>, ? extends Object> function2, @NotNull Continuation<? super R> continuation) {
        ...
        r rVar = new r(intercepted, 1);
        rVar.E();
        final PointerEventHandlerCoroutine pointerEventHandlerCoroutine = new PointerEventHandlerCoroutine(this, rVar);
        synchronized (this.pointerHandlers) {
            ...
            Result.Companion companion = Result.Companion;
            createCoroutine.resumeWith(Result.m5849constructorimpl(Unit.INSTANCE));
        }
        rVar.A(new Function1<Throwable, Unit>() { // from class: androidx.compose.ui.input.pointer.SuspendingPointerInputFilter$awaitPointerEventScope$2$2
    ...
    @Override // androidx.compose.ui.input.pointer.PointerInputScope
    /* renamed from: getExtendedTouchPadding-NH-jbRc */
    public long mo3817getExtendedTouchPaddingNHjbRc() {
        long mo525toSizeXkaWNTQ = mo525toSizeXkaWNTQ(getViewConfiguration().mo4060getMinimumTouchTargetSizeMYxV2XQ());
        long m3815getSizeYbymL2g = m3815getSizeYbymL2g();
        return SizeKt.Size(Math.max(0.0f, Size.m2239getWidthimpl(mo525toSizeXkaWNTQ) - IntSize.m4951getWidthimpl(m3815getSizeYbymL2g)) / 2.0f, Math.max(0.0f, Size.m2236getHeightimpl(mo525toSizeXkaWNTQ) - IntSize.m4950getHeightimpl(m3815getSizeYbymL2g)) / 2.0f);
    }
    ...
    public void onCancel() {
        ...
        for (int i3 = 0; i3 < size2; i3++) {
            ...
            PointerInputChange m3787copyEzrO64$default = PointerInputChange.m3787copyEzrO64$default(pointerInputChange, 0L, 0L, 0L, false, pointerInputChange.getUptimeMillis(), pointerInputChange.m3794getPositionF1C5BW0(), pointerInputChange.getPressed(), new ConsumedData(false, pointerInputChange.getPressed(), 1, null), 0, 263, null);
            if (m3787copyEzrO64$default != null) {
                arrayList.add(m3787copyEzrO64$default);
            }
        }
    ...
    public void mo3816onPointerEventH0pRuoY(@NotNull PointerEvent pointerEvent, @NotNull PointerEventPass pass, long j2) {
        boolean z;
