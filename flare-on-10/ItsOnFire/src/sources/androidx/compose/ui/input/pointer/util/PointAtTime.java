...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/input/pointer/util/PointAtTime.class */
final class PointAtTime {
    ...
    public static /* synthetic */ PointAtTime m3878copy3MmeM6k$default(PointAtTime pointAtTime, long j2, long j3, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return pointAtTime.m3880copy3MmeM6k(j2, j3);
    }

    /* renamed from: component1-F1C5BW0  reason: not valid java name */
    public final long m3879component1F1C5BW0() {
        return this.point;
    }
    ...
    public final PointAtTime m3880copy3MmeM6k(long j2, long j3) {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof PointAtTime) {
            ...
            return Offset.m2164equalsimpl0(this.point, pointAtTime.point) && this.time == pointAtTime.time;
        }
        return false;
    }

    /* renamed from: getPoint-F1C5BW0  reason: not valid java name */
    public final long m3881getPointF1C5BW0() {
        return this.point;
    }
    ...
    public int hashCode() {
        return (Offset.m2169hashCodeimpl(this.point) * 31) + Long.hashCode(this.time);
    }

    @NotNull
    public String toString() {
        return "PointAtTime(point=" + ((Object) Offset.m2175toStringimpl(this.point)) + ", time=" + this.time + ')';
    }
}
