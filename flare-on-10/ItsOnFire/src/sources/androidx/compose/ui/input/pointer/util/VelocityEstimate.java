...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/input/pointer/util/VelocityEstimate.class */
final class VelocityEstimate {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/input/pointer/util/VelocityEstimate$Companion.class */
    ...
    static {
        ...
        None = new VelocityEstimate(companion.m2183getZeroF1C5BW0(), 1.0f, 0L, companion.m2183getZeroF1C5BW0(), null);
    }
    ...
    public static /* synthetic */ VelocityEstimate m3883copyPZAlG8E$default(VelocityEstimate velocityEstimate, long j2, float f2, long j3, long j4, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            j2 = velocityEstimate.pixelsPerSecond;
        }
        if ((i2 & 2) != 0) {
            f2 = velocityEstimate.confidence;
        }
        if ((i2 & 4) != 0) {
            j3 = velocityEstimate.durationMillis;
        }
        if ((i2 & 8) != 0) {
            j4 = velocityEstimate.offset;
        }
        return velocityEstimate.m3886copyPZAlG8E(j2, f2, j3, j4);
    }

    /* renamed from: component1-F1C5BW0  reason: not valid java name */
    public final long m3884component1F1C5BW0() {
    ...
    public final VelocityEstimate m3886copyPZAlG8E(long j2, float f2, long j3, long j4) {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof VelocityEstimate) {
            ...
            return Offset.m2164equalsimpl0(this.pixelsPerSecond, velocityEstimate.pixelsPerSecond) && Intrinsics.areEqual((Object) Float.valueOf(this.confidence), (Object) Float.valueOf(velocityEstimate.confidence)) && this.durationMillis == velocityEstimate.durationMillis && Offset.m2164equalsimpl0(this.offset, velocityEstimate.offset);
        }
        return false;
    }
    ...
    public final long m3887getOffsetF1C5BW0() {
        return this.offset;
    }

    /* renamed from: getPixelsPerSecond-F1C5BW0  reason: not valid java name */
    public final long m3888getPixelsPerSecondF1C5BW0() {
        return this.pixelsPerSecond;
    }

    public int hashCode() {
        return (((((Offset.m2169hashCodeimpl(this.pixelsPerSecond) * 31) + Float.hashCode(this.confidence)) * 31) + Long.hashCode(this.durationMillis)) * 31) + Offset.m2169hashCodeimpl(this.offset);
    }

    @NotNull
    public String toString() {
        return "VelocityEstimate(pixelsPerSecond=" + ((Object) Offset.m2175toStringimpl(this.pixelsPerSecond)) + ", confidence=" + this.confidence + ", durationMillis=" + this.durationMillis + ", offset=" + ((Object) Offset.m2175toStringimpl(this.offset)) + ')';
    }
}
