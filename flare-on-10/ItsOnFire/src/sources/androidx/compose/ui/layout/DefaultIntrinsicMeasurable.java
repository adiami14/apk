...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/layout/DefaultIntrinsicMeasurable.class */
public final class DefaultIntrinsicMeasurable implements Measurable {
    ...
    public Placeable mo3910measureBRTryo0(long j2) {
        if (this.widthHeight == IntrinsicWidthHeight.Width) {
            ...
            return new FixedSizeIntrinsicsPlaceable(intrinsicMinMax == intrinsicMinMax2 ? intrinsicMeasurable.maxIntrinsicWidth(Constraints.m4751getMaxHeightimpl(j2)) : intrinsicMeasurable.minIntrinsicWidth(Constraints.m4751getMaxHeightimpl(j2)), Constraints.m4751getMaxHeightimpl(j2));
        }
        ...
        return new FixedSizeIntrinsicsPlaceable(Constraints.m4752getMaxWidthimpl(j2), intrinsicMinMax3 == intrinsicMinMax4 ? intrinsicMeasurable2.maxIntrinsicHeight(Constraints.m4752getMaxWidthimpl(j2)) : intrinsicMeasurable2.minIntrinsicHeight(Constraints.m4752getMaxWidthimpl(j2)));
    }
