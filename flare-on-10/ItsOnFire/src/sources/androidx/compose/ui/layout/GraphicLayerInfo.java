...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/layout/GraphicLayerInfo.class */
public interface GraphicLayerInfo {

    @Metadata(k = 3, mv = {1, 6, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/layout/GraphicLayerInfo$DefaultImpls.class */
