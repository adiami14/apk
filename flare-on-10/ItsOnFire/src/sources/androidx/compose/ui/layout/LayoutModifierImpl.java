...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/layout/LayoutModifierImpl.class */
final class LayoutModifierImpl extends InspectorValueInfo implements LayoutModifier {
    ...
    public MeasureResult mo105measure3p2s80s(@NotNull MeasureScope receiver, @NotNull Measurable measurable, long j2) {
        ...
        return this.measureBlock.invoke(receiver, measurable, Constraints.m4740boximpl(j2));
    }
