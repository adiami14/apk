...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/layout/MeasuringIntrinsics.class */
final class MeasuringIntrinsics {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/layout/MeasuringIntrinsics$DefaultIntrinsicMeasurable.class */
    public static final class DefaultIntrinsicMeasurable implements Measurable {
        ...
        public Placeable mo3910measureBRTryo0(long j2) {
            if (this.widthHeight == IntrinsicWidthHeight.Width) {
                ...
                return new EmptyPlaceable(intrinsicMinMax == intrinsicMinMax2 ? intrinsicMeasurable.maxIntrinsicWidth(Constraints.m4751getMaxHeightimpl(j2)) : intrinsicMeasurable.minIntrinsicWidth(Constraints.m4751getMaxHeightimpl(j2)), Constraints.m4751getMaxHeightimpl(j2));
            }
            ...
            return new EmptyPlaceable(Constraints.m4752getMaxWidthimpl(j2), intrinsicMinMax3 == intrinsicMinMax4 ? intrinsicMeasurable2.maxIntrinsicHeight(Constraints.m4752getMaxWidthimpl(j2)) : intrinsicMeasurable2.minIntrinsicHeight(Constraints.m4752getMaxWidthimpl(j2)));
        }
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/layout/MeasuringIntrinsics$EmptyPlaceable.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/layout/MeasuringIntrinsics$IntrinsicMinMax.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/layout/MeasuringIntrinsics$IntrinsicWidthHeight.class */
    ...
    public final int maxHeight$ui_release(@NotNull LayoutModifier modifier, @NotNull IntrinsicMeasureScope instrinsicMeasureScope, @NotNull IntrinsicMeasurable intrinsicMeasurable, int i2) {
        ...
        return modifier.mo105measure3p2s80s(new IntrinsicsMeasureScope(instrinsicMeasureScope, instrinsicMeasureScope.getLayoutDirection()), new DefaultIntrinsicMeasurable(intrinsicMeasurable, IntrinsicMinMax.Max, IntrinsicWidthHeight.Height), ConstraintsKt.Constraints$default(0, i2, 0, 0, 13, null)).getHeight();
    }
    ...
    public final int maxWidth$ui_release(@NotNull LayoutModifier modifier, @NotNull IntrinsicMeasureScope instrinsicMeasureScope, @NotNull IntrinsicMeasurable intrinsicMeasurable, int i2) {
        ...
        Intrinsics.checkNotNullParameter(instrinsicMeasureScope, "instrinsicMeasureScope");
        Intrinsics.checkNotNullParameter(intrinsicMeasurable, "intrinsicMeasurable");
        return modifier.mo105measure3p2s80s(new IntrinsicsMeasureScope(instrinsicMeasureScope, instrinsicMeasureScope.getLayoutDirection()), new DefaultIntrinsicMeasurable(intrinsicMeasurable, IntrinsicMinMax.Max, IntrinsicWidthHeight.Width), ConstraintsKt.Constraints$default(0, 0, 0, i2, 7, null)).getWidth();
    }
    ...
    public final int minHeight$ui_release(@NotNull LayoutModifier modifier, @NotNull IntrinsicMeasureScope instrinsicMeasureScope, @NotNull IntrinsicMeasurable intrinsicMeasurable, int i2) {
        ...
        Intrinsics.checkNotNullParameter(instrinsicMeasureScope, "instrinsicMeasureScope");
        Intrinsics.checkNotNullParameter(intrinsicMeasurable, "intrinsicMeasurable");
        return modifier.mo105measure3p2s80s(new IntrinsicsMeasureScope(instrinsicMeasureScope, instrinsicMeasureScope.getLayoutDirection()), new DefaultIntrinsicMeasurable(intrinsicMeasurable, IntrinsicMinMax.Min, IntrinsicWidthHeight.Height), ConstraintsKt.Constraints$default(0, i2, 0, 0, 13, null)).getHeight();
    }
    ...
    public final int minWidth$ui_release(@NotNull LayoutModifier modifier, @NotNull IntrinsicMeasureScope instrinsicMeasureScope, @NotNull IntrinsicMeasurable intrinsicMeasurable, int i2) {
        ...
        Intrinsics.checkNotNullParameter(instrinsicMeasureScope, "instrinsicMeasureScope");
        Intrinsics.checkNotNullParameter(intrinsicMeasurable, "intrinsicMeasurable");
        return modifier.mo105measure3p2s80s(new IntrinsicsMeasureScope(instrinsicMeasureScope, instrinsicMeasureScope.getLayoutDirection()), new DefaultIntrinsicMeasurable(intrinsicMeasurable, IntrinsicMinMax.Min, IntrinsicWidthHeight.Width), ConstraintsKt.Constraints$default(0, 0, 0, i2, 7, null)).getWidth();
    }
}
