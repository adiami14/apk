...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/layout/OnGloballyPositionedModifier.class */
public interface OnGloballyPositionedModifier extends Modifier.Element {

    @Metadata(k = 3, mv = {1, 6, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/layout/OnGloballyPositionedModifier$DefaultImpls.class */
