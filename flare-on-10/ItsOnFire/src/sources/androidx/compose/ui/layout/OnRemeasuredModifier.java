...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/layout/OnRemeasuredModifier.class */
public interface OnRemeasuredModifier extends Modifier.Element {

    @Metadata(k = 3, mv = {1, 6, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/layout/OnRemeasuredModifier$DefaultImpls.class */
    ...
    void mo3951onRemeasuredozmzZPI(long j2);
}
