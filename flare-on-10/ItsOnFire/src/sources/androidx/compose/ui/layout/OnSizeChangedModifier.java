...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/layout/OnSizeChangedModifier.class */
final class OnSizeChangedModifier extends InspectorValueInfo implements OnRemeasuredModifier {
    ...
    public void mo3951onRemeasuredozmzZPI(long j2) {
        if (IntSize.m4949equalsimpl0(this.previousSize, j2)) {
            return;
        }
        this.onSizeChanged.invoke(IntSize.m4943boximpl(j2));
