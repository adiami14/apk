...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/layout/ParentDataModifier.class */
public interface ParentDataModifier extends Modifier.Element {

    @Metadata(k = 3, mv = {1, 6, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/layout/ParentDataModifier$DefaultImpls.class */
