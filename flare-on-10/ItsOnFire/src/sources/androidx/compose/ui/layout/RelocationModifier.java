...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/layout/RelocationModifier.class */
public interface RelocationModifier extends Modifier.Element {

    @Metadata(k = 3, mv = {1, 6, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/layout/RelocationModifier$DefaultImpls.class */
