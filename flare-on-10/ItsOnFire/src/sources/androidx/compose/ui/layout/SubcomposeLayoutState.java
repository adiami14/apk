...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/layout/SubcomposeLayoutState.class */
public final class SubcomposeLayoutState {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/layout/SubcomposeLayoutState$NodeState.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/layout/SubcomposeLayoutState$PrecomposedSlotHandle.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/layout/SubcomposeLayoutState$Scope.class */
    public final class Scope implements SubcomposeMeasureScope {
        ...
        public int mo517roundToPxR2X_6o(long j2) {
            return SubcomposeMeasureScope.DefaultImpls.m4005roundToPxR2X_6o(this, j2);
        }
        ...
        public int mo518roundToPx0680j_4(float f2) {
            return SubcomposeMeasureScope.DefaultImpls.m4006roundToPx0680j_4(this, f2);
        }
        ...
        public float mo519toDpGaN1DYA(long j2) {
            return SubcomposeMeasureScope.DefaultImpls.m4007toDpGaN1DYA(this, j2);
        }
        ...
        public float mo520toDpu2uoSUM(float f2) {
            return SubcomposeMeasureScope.DefaultImpls.m4008toDpu2uoSUM(this, f2);
        }
        ...
        public float mo521toDpu2uoSUM(int i2) {
            return SubcomposeMeasureScope.DefaultImpls.m4009toDpu2uoSUM((SubcomposeMeasureScope) this, i2);
        }
        ...
        public long mo522toDpSizekrfVVM(long j2) {
            return SubcomposeMeasureScope.DefaultImpls.m4010toDpSizekrfVVM(this, j2);
        }
        ...
        public float mo523toPxR2X_6o(long j2) {
            return SubcomposeMeasureScope.DefaultImpls.m4011toPxR2X_6o(this, j2);
        }
        ...
        public float mo524toPx0680j_4(float f2) {
            return SubcomposeMeasureScope.DefaultImpls.m4012toPx0680j_4(this, f2);
        }
        ...
        public long mo525toSizeXkaWNTQ(long j2) {
            return SubcomposeMeasureScope.DefaultImpls.m4013toSizeXkaWNTQ(this, j2);
        }
        ...
        public long mo526toSp0xMU5do(float f2) {
            return SubcomposeMeasureScope.DefaultImpls.m4014toSp0xMU5do(this, f2);
        }
        ...
        public long mo527toSpkPz2Gy4(float f2) {
            return SubcomposeMeasureScope.DefaultImpls.m4015toSpkPz2Gy4(this, f2);
        }
        ...
        public long mo528toSpkPz2Gy4(int i2) {
            return SubcomposeMeasureScope.DefaultImpls.m4016toSpkPz2Gy4((SubcomposeMeasureScope) this, i2);
        }
    }
    ...
    public final MeasurePolicy createMeasurePolicy(final Function2<? super SubcomposeMeasureScope, ? super Constraints, ? extends MeasureResult> function2) {
        ...
        return new LayoutNode.NoIntrinsicsMeasurePolicy(str) { // from class: androidx.compose.ui.layout.SubcomposeLayoutState$createMeasurePolicy$1
            ...
            public MeasureResult mo89measure3p2s80s(@NotNull MeasureScope receiver, @NotNull List<? extends Measurable> measurables, long j2) {
                ...
                final MeasureResult invoke = function22.invoke(scope4, Constraints.m4740boximpl(j2));
    ...
    public final void disposeAfterIndex(int i2) {
        ...
        if (i5 > 0) {
            ...
            for (int i6 = i2; i6 < i2 + i5; i6++) {
                disposeNode(getRoot().getFoldedChildren$ui_release().get(i6));
            }
            getRoot().removeAt$ui_release(i2, i5);
            root.ignoreRemeasureRequests = false;
        }
    ...
    private final void subcompose(final LayoutNode layoutNode, final NodeState nodeState) {
        layoutNode.withNoSnapshotReadObservation$ui_release(new Function0<Unit>() { // from class: androidx.compose.ui.layout.SubcomposeLayoutState$subcompose$2
            ...
            public final void invoke2() {
                ...
                subcomposeInto = subcomposeLayoutState.subcomposeInto(composition, layoutNode2, compositionContext$ui_release, ComposableLambdaKt.composableLambdaInstance(-985539783, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.layout.SubcomposeLayoutState$subcompose$2$1$1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    ...
    private final void subcompose(LayoutNode layoutNode, Object obj, Function2<? super Composer, ? super Integer, Unit> function2) {
        ...
        if (nodeState == null) {
            nodeState2 = new NodeState(obj, ComposableSingletons$SubcomposeLayoutKt.INSTANCE.m3897getLambda1$ui_release(), null, 4, null);
            map.put(layoutNode, nodeState2);
        }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:5:0x000d, code lost:
        if (r4.isDisposed() != false) goto L8;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public final androidx.compose.runtime.Composition subcomposeInto(androidx.compose.runtime.Composition r4, androidx.compose.ui.node.LayoutNode r5, androidx.compose.runtime.CompositionContext r6, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r7) {
        /*
            r3 = this;
            r0 = r4
            if (r0 == 0) goto L10
        ...
        L10:
            r0 = r5
            r1 = r6
            androidx.compose.runtime.Composition r0 = androidx.compose.ui.platform.Wrapper_androidKt.createSubcomposition(r0, r1)
            r8 = r0
        L17:
            r0 = r8
            r1 = r7
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.layout.SubcomposeLayoutState.subcomposeInto(androidx.compose.runtime.Composition, androidx.compose.ui.node.LayoutNode, androidx.compose.runtime.CompositionContext, kotlin.jvm.functions.Function2):androidx.compose.runtime.Composition");
    }
    ...
    public final PrecomposedSlotHandle precompose(@Nullable final Object obj, @NotNull Function2<? super Composer, ? super Integer, Unit> content) {
        ...
        if (!this.slotIdToNode.containsKey(obj)) {
            ...
            if (layoutNode == null) {
                if (this.reusableCount > 0) {
                    ...
                    move(getRoot().getFoldedChildren$ui_release().indexOf(layoutNode2), getRoot().getFoldedChildren$ui_release().size(), 1);
                } else {
                    layoutNode2 = createNodeAt(getRoot().getFoldedChildren$ui_release().size());
                }
        ...
        return new PrecomposedSlotHandle() { // from class: androidx.compose.ui.layout.SubcomposeLayoutState$precompose$1
            ...
            public void dispose() {
                ...
                LayoutNode layoutNode3 = (LayoutNode) map2.remove(obj);
                if (layoutNode3 != null) {
                    int indexOf = SubcomposeLayoutState.this.getRoot().getFoldedChildren$ui_release().indexOf(layoutNode3);
                    if (!(indexOf != -1)) {
                        throw new IllegalStateException("Check failed.".toString());
                    }
                    ...
                    if (i2 < i3) {
                        ...
                        SubcomposeLayoutState.this.move(indexOf, (size - i6) - i7, 1);
                        SubcomposeLayoutState subcomposeLayoutState = SubcomposeLayoutState.this;
                        ...
                        root.ignoreRemeasureRequests = true;
                        subcomposeLayoutState2.disposeNode(layoutNode3);
        ...
        if (layoutState$ui_release == LayoutNode.LayoutState.Measuring || layoutState$ui_release == LayoutNode.LayoutState.LayingOut) {
            ...
            if (layoutNode == null) {
                ...
                if (layoutNode2 != null) {
                    ...
                    layoutNode2 = this.reusableCount > 0 ? takeNodeFromReusables(obj) : createNodeAt(this.currentIndex);
                }
                map.put(obj, layoutNode2);
            }
            LayoutNode layoutNode3 = layoutNode2;
            int indexOf = getRoot().getFoldedChildren$ui_release().indexOf(layoutNode3);
