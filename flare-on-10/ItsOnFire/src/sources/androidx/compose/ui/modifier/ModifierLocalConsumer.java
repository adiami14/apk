...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/modifier/ModifierLocalConsumer.class */
public interface ModifierLocalConsumer extends Modifier.Element {

    @Metadata(k = 3, mv = {1, 6, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/modifier/ModifierLocalConsumer$DefaultImpls.class */
