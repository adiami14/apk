...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/modifier/ModifierLocalProvider.class */
public interface ModifierLocalProvider<T> extends Modifier.Element {

    @Metadata(k = 3, mv = {1, 6, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/modifier/ModifierLocalProvider$DefaultImpls.class */
