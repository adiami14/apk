...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/node/DelegatingLayoutNodeWrapper.class */
public class DelegatingLayoutNodeWrapper<T extends Modifier.Element> extends LayoutNodeWrapper {
    ...
    public ModifiedKeyInputNode findLastKeyInputWrapper() {
        ...
        if (findPreviousKeyInputWrapper == this) {
            findPreviousKeyInputWrapper = null;
        }
    ...
    public void mo4029hitTestM_7yMNQ(long j2, @NotNull HitTestResult<PointerInputFilter> hitTestResult, boolean z, boolean z2) {
        Intrinsics.checkNotNullParameter(hitTestResult, "hitTestResult");
        boolean m4083withinLayerBoundsk4lQ0M = m4083withinLayerBoundsk4lQ0M(j2);
        if (!m4083withinLayerBoundsk4lQ0M) {
            if (!z) {
                return;
            }
            float m4076distanceInMinimumTouchTargettz77jQw = m4076distanceInMinimumTouchTargettz77jQw(j2, m4078getMinimumTouchTargetSizeNHjbRc());
            if (!((Float.isInfinite(m4076distanceInMinimumTouchTargettz77jQw) || Float.isNaN(m4076distanceInMinimumTouchTargettz77jQw)) ? false : true)) {
                return;
            }
        }
        getWrapped$ui_release().mo4029hitTestM_7yMNQ(getWrapped$ui_release().m4077fromParentPositionMKHz9U(j2), hitTestResult, z, z2 && m4083withinLayerBoundsk4lQ0M);
    }

    /* renamed from: hitTestInMinimumTouchTarget-7362WCg  reason: not valid java name */
    public final <T> void m4030hitTestInMinimumTouchTarget7362WCg(long j2, @NotNull HitTestResult<T> hitTestResult, boolean z, boolean z2, final boolean z3, T t2, @NotNull final Function1<? super Boolean, Unit> block) {
        Intrinsics.checkNotNullParameter(hitTestResult, "hitTestResult");
        Intrinsics.checkNotNullParameter(block, "block");
        boolean z4 = true;
        if (!m4083withinLayerBoundsk4lQ0M(j2)) {
            if (z2) {
                float m4076distanceInMinimumTouchTargettz77jQw = m4076distanceInMinimumTouchTargettz77jQw(j2, m4078getMinimumTouchTargetSizeNHjbRc());
                if (Float.isInfinite(m4076distanceInMinimumTouchTargettz77jQw) || Float.isNaN(m4076distanceInMinimumTouchTargettz77jQw)) {
                    z4 = false;
                }
                if (z4 && hitTestResult.isHitInMinimumTouchTargetBetter(m4076distanceInMinimumTouchTargettz77jQw, false)) {
                    hitTestResult.hitInMinimumTouchTarget(t2, m4076distanceInMinimumTouchTargettz77jQw, false, new Function0<Unit>() { // from class: androidx.compose.ui.node.DelegatingLayoutNodeWrapper$hitTestInMinimumTouchTarget$1
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        ...
        } else if (m4080isPointerInBoundsk4lQ0M(j2)) {
            hitTestResult.hit(t2, z3, new Function0<Unit>() { // from class: androidx.compose.ui.node.DelegatingLayoutNodeWrapper$hitTestInMinimumTouchTarget$2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(0);
            ...
            float m4076distanceInMinimumTouchTargettz77jQw2 = !z2 ? Float.POSITIVE_INFINITY : m4076distanceInMinimumTouchTargettz77jQw(j2, m4078getMinimumTouchTargetSizeNHjbRc());
            if (((Float.isInfinite(m4076distanceInMinimumTouchTargettz77jQw2) || Float.isNaN(m4076distanceInMinimumTouchTargettz77jQw2)) ? false : true) && hitTestResult.isHitInMinimumTouchTargetBetter(m4076distanceInMinimumTouchTargettz77jQw2, z3)) {
                hitTestResult.hitInMinimumTouchTarget(t2, m4076distanceInMinimumTouchTargettz77jQw2, z3, new Function0<Unit>() { // from class: androidx.compose.ui.node.DelegatingLayoutNodeWrapper$hitTestInMinimumTouchTarget$3
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    /* JADX WARN: Multi-variable type inference failed */
                    {
                        super(0);
                ...
                hitTestResult.speculativeHit(t2, m4076distanceInMinimumTouchTargettz77jQw2, z3, new Function0<Unit>() { // from class: androidx.compose.ui.node.DelegatingLayoutNodeWrapper$hitTestInMinimumTouchTarget$4
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    /* JADX WARN: Multi-variable type inference failed */
                    {
                        super(0);
    ...
    public void mo4031hitTestSemantics9KIMszo(long j2, @NotNull HitTestResult<SemanticsWrapper> hitSemanticsWrappers, boolean z) {
        ...
        getWrapped$ui_release().mo4031hitTestSemantics9KIMszo(getWrapped$ui_release().m4077fromParentPositionMKHz9U(j2), hitSemanticsWrappers, z && m4083withinLayerBoundsk4lQ0M);
    }
    ...
    public Placeable mo3910measureBRTryo0(long j2) {
        LayoutNodeWrapper.m4072access$setMeasurementConstraintsBRTryo0(this, j2);
        final Placeable mo3910measureBRTryo0 = getWrapped$ui_release().mo3910measureBRTryo0(j2);
        setMeasureResult$ui_release(new MeasureResult(this) { // from class: androidx.compose.ui.node.DelegatingLayoutNodeWrapper$measure$1$1
            ...
            public void placeChildren() {
                long m3956getApparentToRealOffsetnOccac;
                Placeable.PlacementScope.Companion companion = Placeable.PlacementScope.Companion;
                Placeable placeable = mo3910measureBRTryo0;
                m3956getApparentToRealOffsetnOccac = this.this$0.m3956getApparentToRealOffsetnOccac();
                Placeable.PlacementScope.m3962place70tqf50$default(companion, placeable, IntOffsetKt.IntOffset(-IntOffset.m4907getXimpl(m3956getApparentToRealOffsetnOccac), -IntOffset.m4908getYimpl(m3956getApparentToRealOffsetnOccac)), 0.0f, 2, null);
            }
        });
        return this;
    }
    ...
    public void mo3911placeAtf8xVGno(long j2, float f2, @Nullable Function1<? super GraphicsLayerScope, Unit> function1) {
        ...
        onPlaced();
        Placeable.PlacementScope.Companion companion = Placeable.PlacementScope.Companion;
        int m4951getWidthimpl = IntSize.m4951getWidthimpl(m3957getMeasuredSizeYbymL2g());
        LayoutDirection layoutDirection = getMeasureScope().getLayoutDirection();
        int parentWidth = companion.getParentWidth();
        LayoutDirection parentLayoutDirection = companion.getParentLayoutDirection();
        Placeable.PlacementScope.parentWidth = m4951getWidthimpl;
