...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/node/DrawEntity.class */
public final class DrawEntity implements OwnerScope {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/node/DrawEntity$Companion.class */
    ...
    public DrawEntity(@NotNull LayoutNodeWrapper layoutNodeWrapper, @NotNull DrawModifier modifier) {
        ...
        this.buildCacheParams = new BuildDrawCacheParams() { // from class: androidx.compose.ui.node.DrawEntity$buildCacheParams$1
            ...
            public long mo2075getSizeNHjbRc() {
                return IntSizeKt.m4961toSizeozmzZPI(DrawEntity.this.getLayoutNodeWrapper().mo3927getSizeYbymL2g());
            }
        };
    ...
    private final long m4044getSizeYbymL2g() {
        return this.layoutNodeWrapper.mo3927getSizeYbymL2g();
    }

    private final DrawCacheModifier updateCacheDrawModifier() {
        DrawModifier drawModifier = this.modifier;
        return drawModifier instanceof DrawCacheModifier ? (DrawCacheModifier) drawModifier : null;
    }

    public final void draw(@NotNull Canvas canvas) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        long m4961toSizeozmzZPI = IntSizeKt.m4961toSizeozmzZPI(m4044getSizeYbymL2g());
        ...
        drawParams2.m2846setSizeuvyYCjk(m4961toSizeozmzZPI);
        canvas.save();
