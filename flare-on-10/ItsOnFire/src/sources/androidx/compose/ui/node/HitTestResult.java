...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/node/HitTestResult.class */
public final class HitTestResult<T> implements List<T>, KMappedMarker {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/node/HitTestResult$HitTestResultIterator.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/node/HitTestResult$SubList.class */
    public final class SubList implements List<T>, KMappedMarker {
        ...
        public int indexOf(Object obj) {
            ...
            if (i2 <= i3) {
                while (!Intrinsics.areEqual(((HitTestResult) this.this$0).values[i2], obj)) {
                    if (i2 == i3) {
                        return -1;
                    }
                    i2++;
    ...
    private final long m4046findBestHitDistanceptXAw2c() {
        long DistanceAndInLayer;
        int lastIndex;
        DistanceAndInLayer = HitTestResultKt.DistanceAndInLayer(Float.POSITIVE_INFINITY, false);
        long j2 = DistanceAndInLayer;
        int i2 = this.hitDepth + 1;
        lastIndex = CollectionsKt__CollectionsKt.getLastIndex(this);
        long j3 = j2;
        if (i2 <= lastIndex) {
            while (true) {
                long m4035constructorimpl = DistanceAndInLayer.m4035constructorimpl(this.distanceFromEdgeAndInLayer[i2]);
                j3 = j2;
                if (DistanceAndInLayer.m4034compareToS_HNhKs(m4035constructorimpl, j2) < 0) {
                    j3 = m4035constructorimpl;
                }
                if (DistanceAndInLayer.m4038getDistanceimpl(j3) < 0.0f && DistanceAndInLayer.m4040isInLayerimpl(j3)) {
                    return j3;
                }
                if (i2 == lastIndex) {
                    break;
    ...
    public final boolean hasHit() {
        long m4046findBestHitDistanceptXAw2c = m4046findBestHitDistanceptXAw2c();
        return DistanceAndInLayer.m4038getDistanceimpl(m4046findBestHitDistanceptXAw2c) < 0.0f && DistanceAndInLayer.m4040isInLayerimpl(m4046findBestHitDistanceptXAw2c);
    }
    ...
    public int indexOf(Object obj) {
        ...
        if (lastIndex >= 0) {
            int i2 = 0;
            while (!Intrinsics.areEqual(this.values[i2], obj)) {
                if (i2 == lastIndex) {
                    return -1;
                }
                i2++;
    ...
    public final boolean isHitInMinimumTouchTargetBetter(float f2, boolean z) {
        ...
        DistanceAndInLayer = HitTestResultKt.DistanceAndInLayer(f2, z);
        return DistanceAndInLayer.m4034compareToS_HNhKs(m4046findBestHitDistanceptXAw2c(), DistanceAndInLayer) > 0;
    }
    ...
    public final void speculativeHit(T t2, float f2, boolean z, @NotNull Function0<Unit> childHitTest) {
        ...
        if (i5 < lastIndex3 && DistanceAndInLayer.m4034compareToS_HNhKs(m4046findBestHitDistanceptXAw2c, m4046findBestHitDistanceptXAw2c()) > 0) {
