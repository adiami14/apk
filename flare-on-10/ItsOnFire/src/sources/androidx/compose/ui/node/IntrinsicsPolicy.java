...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/node/IntrinsicsPolicy.class */
public final class IntrinsicsPolicy {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/node/IntrinsicsPolicy$Companion.class */
    ...
    private final MeasurePolicy measurePolicyFromState() {
        MutableState<MeasurePolicy> mutableStateOf$default;
        MutableState<MeasurePolicy> mutableState = this.measurePolicyState;
        MutableState<MeasurePolicy> mutableState2 = mutableState;
        ...
        this.measurePolicyState = mutableState2;
