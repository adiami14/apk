...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/node/ModifierLocalConsumerNode.class */
public final class ModifierLocalConsumerNode extends DelegatingLayoutNodeWrapper<ModifierLocalConsumer> implements ModifierLocalReadScope {
    ...
    @NotNull
    private static final Function1<ModifierLocalConsumerNode, Unit> onReadValuesChanged = new Function1<ModifierLocalConsumerNode, Unit>() { // from class: androidx.compose.ui.node.ModifierLocalConsumerNode$Companion$onReadValuesChanged$1
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/node/ModifierLocalConsumerNode$Companion.class */
    ...
    public final void notifyConsumerOfChanges() {
        if (isAttached()) {
            LayoutNodeKt.requireOwner(getLayoutNode$ui_release()).getSnapshotObserver().observeReads$ui_release(this, onReadValuesChanged, new Function0<Unit>() { // from class: androidx.compose.ui.node.ModifierLocalConsumerNode$notifyConsumerOfChanges$1
                {
                    super(0);
                }
                ...
                public final void invoke2() {
                    ModifierLocalConsumerNode.this.getModifier().onModifierLocalsUpdated(ModifierLocalConsumerNode.this);
                }
            });
        }
    }
