...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/node/ModifierLocalProviderNode.class */
public final class ModifierLocalProviderNode<T> extends DelegatingLayoutNodeWrapper<ModifierLocalProvider<T>> {
    ...
    public <V> V onModifierLocalRead(@NotNull ModifierLocal<V> modifierLocal) {
        ...
        return (V) (Intrinsics.areEqual(getModifier().getKey(), modifierLocal) ? getModifier().getValue() : super.onModifierLocalRead(modifierLocal));
    }
}
