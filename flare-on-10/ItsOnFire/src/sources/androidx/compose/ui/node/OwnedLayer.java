...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/node/OwnedLayer.class */
public interface OwnedLayer {
    ...
    boolean mo4101isInLayerk4lQ0M(long j2);

    void mapBounds(@NotNull MutableRect mutableRect, boolean z);

    /* renamed from: mapOffset-8S9VItk  reason: not valid java name */
    long mo4102mapOffset8S9VItk(long j2, boolean z);

    /* renamed from: move--gyyYBs  reason: not valid java name */
    void mo4103movegyyYBs(long j2);

    /* renamed from: resize-ozmzZPI  reason: not valid java name */
    void mo4104resizeozmzZPI(long j2);
    ...
    void mo4105updateLayerPropertiesYPkPJjM(float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, float f11, long j2, @NotNull Shape shape, boolean z, @Nullable RenderEffect renderEffect, @NotNull LayoutDirection layoutDirection, @NotNull Density density);
}
