...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/platform/AndroidUiFrameClock.class */
public final class AndroidUiFrameClock implements MonotonicFrameClock {
    ...
    public <R> Object withFrameNanos(@NotNull final Function1<? super Long, ? extends R> function1, @NotNull Continuation<? super R> continuation) {
        ...
        if (androidUiDispatcher == null || !Intrinsics.areEqual(androidUiDispatcher.getChoreographer(), getChoreographer())) {
            ...
            rVar.A(new Function1<Throwable, Unit>() { // from class: androidx.compose.ui.platform.AndroidUiFrameClock$withFrameNanos$2$2
            ...
            final AndroidUiDispatcher androidUiDispatcher2 = androidUiDispatcher;
            rVar.A(new Function1<Throwable, Unit>() { // from class: androidx.compose.ui.platform.AndroidUiFrameClock$withFrameNanos$2$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
