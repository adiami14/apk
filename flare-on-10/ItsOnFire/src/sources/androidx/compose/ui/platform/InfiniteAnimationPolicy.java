...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/platform/InfiniteAnimationPolicy.class */
public interface InfiniteAnimationPolicy extends CoroutineContext.Element {
    @NotNull
    public static final Key Key = Key.$$INSTANCE;

    @Metadata(k = 3, mv = {1, 6, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/platform/InfiniteAnimationPolicy$DefaultImpls.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/platform/InfiniteAnimationPolicy$Key.class */
