...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/platform/InspectableValue.class */
public interface InspectableValue {

    @Metadata(k = 3, mv = {1, 6, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/platform/InspectableValue$DefaultImpls.class */
