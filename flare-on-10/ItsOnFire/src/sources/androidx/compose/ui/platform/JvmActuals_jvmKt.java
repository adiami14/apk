...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/platform/JvmActuals_jvmKt.class */
public final class JvmActuals_jvmKt {
    ...
    public static final String simpleIdentityToString(@NotNull Object obj, @Nullable String str) {
        ...
        String str2 = str;
        if (str == null) {
            str2 = obj.getClass().isAnonymousClass() ? obj.getClass().getName() : obj.getClass().getSimpleName();
        }
    ...
    public static final <R> R m4229synchronized(@NotNull Object lock, @NotNull Function0<? extends R> block) {
        R invoke;
