...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/platform/MutableSpanStyle.class */
public final class MutableSpanStyle {
    ...
    public final long m4234getBackground0d7_KjU() {
        return this.background;
    }

    @Nullable
    /* renamed from: getBaselineShift-5SSeXJ0  reason: not valid java name */
    public final BaselineShift m4235getBaselineShift5SSeXJ0() {
        return this.baselineShift;
    }

    /* renamed from: getColor-0d7_KjU  reason: not valid java name */
    public final long m4236getColor0d7_KjU() {
        return this.color;
    }
    ...
    public final long m4237getFontSizeXSAIIZE() {
        return this.fontSize;
    }

    @Nullable
    /* renamed from: getFontStyle-4Lr2A7w  reason: not valid java name */
    public final FontStyle m4238getFontStyle4Lr2A7w() {
        return this.fontStyle;
    }

    @Nullable
    /* renamed from: getFontSynthesis-ZQGJjVo  reason: not valid java name */
    public final FontSynthesis m4239getFontSynthesisZQGJjVo() {
    ...
    public final long m4240getLetterSpacingXSAIIZE() {
    ...
    public final void m4241setBackground8_81llA(long j2) {
        this.background = j2;
    }

    /* renamed from: setBaselineShift-_isdbwI  reason: not valid java name */
    public final void m4242setBaselineShift_isdbwI(@Nullable BaselineShift baselineShift) {
        this.baselineShift = baselineShift;
    }

    /* renamed from: setColor-8_81llA  reason: not valid java name */
    public final void m4243setColor8_81llA(long j2) {
        this.color = j2;
    }
    ...
    public final void m4244setFontSizeR2X_6o(long j2) {
        this.fontSize = j2;
    }

    /* renamed from: setFontStyle-mLjRB2g  reason: not valid java name */
    public final void m4245setFontStylemLjRB2g(@Nullable FontStyle fontStyle) {
        this.fontStyle = fontStyle;
    }

    /* renamed from: setFontSynthesis-tDdu0R4  reason: not valid java name */
    public final void m4246setFontSynthesistDdu0R4(@Nullable FontSynthesis fontSynthesis) {
        this.fontSynthesis = fontSynthesis;
    }
    ...
    public final void m4247setLetterSpacingR2X_6o(long j2) {
    ...
    public final SpanStyle toSpanStyle() {
        return new SpanStyle(m4236getColor0d7_KjU(), m4237getFontSizeXSAIIZE(), this.fontWeight, m4238getFontStyle4Lr2A7w(), m4239getFontSynthesisZQGJjVo(), this.fontFamily, this.fontFeatureSettings, m4240getLetterSpacingXSAIIZE(), m4235getBaselineShift5SSeXJ0(), this.textGeometricTransform, this.localeList, m4234getBackground0d7_KjU(), this.textDecoration, this.shadow, null);
    }
}
