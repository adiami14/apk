...
@RequiresApi(23)
/* loaded from: ItsOnFire.jar:androidx/compose/ui/platform/RenderNodeApi23.class */
public final class RenderNodeApi23 implements DeviceRenderNode {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/platform/RenderNodeApi23$Companion.class */
    ...
    public void record(@NotNull CanvasHolder canvasHolder, @Nullable Path path, @NotNull Function1<? super androidx.compose.ui.graphics.Canvas, Unit> drawBlock) {
        ...
        if (path != null) {
            androidCanvas.save();
            Canvas.DefaultImpls.m2386clipPathmtrdDE$default(androidCanvas, path, 0, 2, null);
        }
