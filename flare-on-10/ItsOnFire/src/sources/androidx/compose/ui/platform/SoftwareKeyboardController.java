...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/platform/SoftwareKeyboardController.class */
public interface SoftwareKeyboardController {

    @Metadata(k = 3, mv = {1, 6, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/platform/SoftwareKeyboardController$DefaultImpls.class */
