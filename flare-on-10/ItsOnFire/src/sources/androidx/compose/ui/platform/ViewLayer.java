...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/platform/ViewLayer.class */
public final class ViewLayer extends View implements OwnedLayer, GraphicLayerInfo {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/platform/ViewLayer$Companion.class */
    ...
    @RequiresApi(29)
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/platform/ViewLayer$UniqueDrawingIdApi29.class */
    public static final class UniqueDrawingIdApi29 {
        ...
        @RequiresApi(29)
        /* loaded from: ItsOnFire.jar:androidx/compose/ui/platform/ViewLayer$UniqueDrawingIdApi29$Companion.class */
        public static final class Companion {
            private Companion() {
            }
    ...
    public ViewLayer(@NotNull AndroidComposeView ownerView, @NotNull DrawChildContainer container, @NotNull Function1<? super Canvas, Unit> drawBlock, @NotNull Function0<Unit> invalidateParentLayer) {
        ...
        this.mTransformOrigin = TransformOrigin.Companion.m2753getCenterSzJe1aQ();
    ...
    private final Path getManualClipPath() {
        return (!getClipToOutline() || this.outlineResolver.getOutlineClipSupported()) ? null : this.outlineResolver.getClipPath();
    }
    ...
    public boolean mo4101isInLayerk4lQ0M(long j2) {
        ...
        if (0.0f > m2167getXimpl || m2167getXimpl >= getWidth() || 0.0f > m2168getYimpl || m2168getYimpl >= getHeight()) {
            z = false;
        }
        return z;
    }
    ...
    public void mapBounds(@NotNull MutableRect rect, boolean z) {
        ...
        if (!z) {
            androidx.compose.ui.graphics.Matrix.m2597mapimpl(this.matrixCache.m4231calculateMatrixGrdbGEg(this), rect);
            return;
        }
        float[] m4230calculateInverseMatrixbWbORWo = this.matrixCache.m4230calculateInverseMatrixbWbORWo(this);
    ...
    public long mo4102mapOffset8S9VItk(long j2, boolean z) {
        ...
        if (z) {
            ...
            m2595mapMKHz9U = androidx.compose.ui.graphics.Matrix.m2595mapMKHz9U(this.matrixCache.m4231calculateMatrixGrdbGEg(this), j2);
        }
    ...
    public void mo4103movegyyYBs(long j2) {
        ...
        if (m4907getXimpl != getLeft()) {
            offsetLeftAndRight(m4907getXimpl - getLeft());
            this.matrixCache.invalidate();
        }
        int m4908getYimpl = IntOffset.m4908getYimpl(j2);
        if (m4908getYimpl != getTop()) {
            offsetTopAndBottom(m4908getYimpl - getTop());
            this.matrixCache.invalidate();
        }
    }
    ...
    public void mo4104resizeozmzZPI(long j2) {
        ...
        if (m4951getWidthimpl == getWidth() && m4950getHeightimpl == getHeight()) {
            return;
        }
        float f2 = m4951getWidthimpl;
        setPivotX(TransformOrigin.m2748getPivotFractionXimpl(this.mTransformOrigin) * f2);
        float f3 = m4950getHeightimpl;
        setPivotY(TransformOrigin.m2749getPivotFractionYimpl(this.mTransformOrigin) * f3);
        this.outlineResolver.m4250updateuvyYCjk(SizeKt.Size(f2, f3));
        updateOutlineResolver();
        layout(getLeft(), getTop(), getLeft() + m4951getWidthimpl, getTop() + m4950getHeightimpl);
        resetClipBounds();
        this.matrixCache.invalidate();
    }
    ...
    public void mo4105updateLayerPropertiesYPkPJjM(float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, float f11, long j2, @NotNull Shape shape, boolean z, @Nullable RenderEffect renderEffect, @NotNull LayoutDirection layoutDirection, @NotNull Density density) {
        ...
        setRotationX(f8);
        setRotationY(f9);
        setPivotX(TransformOrigin.m2748getPivotFractionXimpl(this.mTransformOrigin) * getWidth());
        setPivotY(TransformOrigin.m2749getPivotFractionYimpl(this.mTransformOrigin) * getHeight());
