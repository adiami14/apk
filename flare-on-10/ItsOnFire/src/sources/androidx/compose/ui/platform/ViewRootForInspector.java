...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/platform/ViewRootForInspector.class */
public interface ViewRootForInspector {

    @Metadata(k = 3, mv = {1, 6, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/platform/ViewRootForInspector$DefaultImpls.class */
