...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/platform/WindowRecomposer_androidKt.class */
public final class WindowRecomposer_androidKt {
    ...
    public static final Recomposer createLifecycleAwareViewTreeRecomposer(final View view) {
        ...
        if (lifecycleOwner != null) {
            ...
            lifecycleOwner.getLifecycle().addObserver(new LifecycleEventObserver() { // from class: androidx.compose.ui.platform.WindowRecomposer_androidKt$createLifecycleAwareViewTreeRecomposer$2
                ...
                /* loaded from: ItsOnFire.jar:androidx/compose/ui/platform/WindowRecomposer_androidKt$createLifecycleAwareViewTreeRecomposer$2$WhenMappings.class */
    ...
    public static final CompositionContext findViewTreeCompositionContext(@NotNull View view) {
        ...
        while (true) {
            ...
            if (compositionContext != null || !(viewParent instanceof View)) {
                break;
            }
            compositionContext = getCompositionContext((View) viewParent);
    ...
    public static final CompositionContext getCompositionContext(@NotNull View view) {
        ...
        return tag instanceof CompositionContext ? (CompositionContext) tag : null;
    }
    ...
    public static final Recomposer getWindowRecomposer(@NotNull View view) {
        ...
        if (compositionContext == null) {
            recomposer = WindowRecomposerPolicy.INSTANCE.createAndInstallWindowRecomposer$ui_release(contentChild);
        } else if (!(compositionContext instanceof Recomposer)) {
