...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/platform/Wrapper_androidKt.class */
public final class Wrapper_androidKt {
    ...
    private static final Composition doSetContent(AndroidComposeView androidComposeView, CompositionContext compositionContext, Function2<? super Composer, ? super Integer, Unit> function2) {
        ...
        if (wrappedComposition == null) {
            wrappedComposition2 = new WrappedComposition(androidComposeView, Composition);
            androidComposeView.getView().setTag(i2, wrappedComposition2);
        }
        wrappedComposition2.setContent(function2);
        return wrappedComposition2;
    }
    ...
    private static final boolean inspectionWanted(AndroidComposeView androidComposeView) {
        boolean z = true;
        if (!(!WrapperVerificationHelperMethods.INSTANCE.attributeSourceResourceMap(androidComposeView).isEmpty())) {
            z = false;
        }
        return z;
    }
    ...
    public static final Composition setContent(@NotNull AbstractComposeView abstractComposeView, @NotNull CompositionContext parent, @NotNull Function2<? super Composer, ? super Integer, Unit> content) {
        ...
        return doSetContent(androidComposeView2, parent, content);
    }
}
