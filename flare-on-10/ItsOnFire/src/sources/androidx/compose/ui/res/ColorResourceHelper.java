...
@RequiresApi(23)
/* loaded from: ItsOnFire.jar:androidx/compose/ui/res/ColorResourceHelper.class */
final class ColorResourceHelper {
    ...
    public final long m4285getColorWaAFU9c(@NotNull Context context, @ColorRes int i2) {
