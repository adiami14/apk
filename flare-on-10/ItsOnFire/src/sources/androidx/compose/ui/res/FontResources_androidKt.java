...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/res/FontResources_androidKt.class */
    ...
    private static final Typeface fontResourceFromContext(Context context, FontFamily fontFamily) {
        ...
        if ((fontFamily instanceof SystemFontFamily) || (fontFamily instanceof LoadedFontFamily)) {
            synchronized (cacheLock) {
                ...
                if (typeface2 == null) {
                    typeface3 = AndroidTypeface_androidKt.Typeface$default(context, fontFamily, null, 4, null);
                    map.put(fontFamily, typeface3);
                }
                typeface = typeface3;
            }
            return typeface;
