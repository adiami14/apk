...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/res/PrimitiveResources_androidKt.class */
public final class PrimitiveResources_androidKt {
    ...
    public static final float dimensionResource(@DimenRes int i2, @Nullable Composer composer, int i3) {
        return Dp.m4785constructorimpl(((Context) composer.consume(AndroidCompositionLocals_androidKt.getLocalContext())).getResources().getDimension(i2) / ((Density) composer.consume(CompositionLocalsKt.getLocalDensity())).getDensity());
    }
