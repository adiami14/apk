...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/semantics/SemanticsConfiguration.class */
    ...
    public final void collapsePeer$ui_release(@NotNull SemanticsConfiguration peer) {
        ...
        for (Map.Entry<SemanticsPropertyKey<?>, Object> entry : peer.props.entrySet()) {
            ...
            if (!this.props.containsKey(key)) {
                ...
                String str = label;
                if (label == null) {
                    str = ((AccessibilityAction) value).getLabel();
                }
                Function action = accessibilityAction.getAction();
                Function function = action;
                if (action == null) {
                    function = ((AccessibilityAction) value).getAction();
                }
