...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/semantics/SemanticsNode.class */
public final class SemanticsNode {
    ...
    private final void emitFakeNodes(List<SemanticsNode> list) {
        ...
        if (role != null && this.unmergedConfig.isMergingSemanticsOfDescendants() && (!list.isEmpty())) {
            list.add(m4326fakeSemanticsNodeypyhhiA(role, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.ui.semantics.SemanticsNode$emitFakeNodes$fakeNode$1
                {
                    super(1);
                }
                ...
                public final void invoke2(@NotNull SemanticsPropertyReceiver fakeSemanticsNode) {
                    ...
                    SemanticsPropertiesKt.m4346setRolekuIjeqM(fakeSemanticsNode, Role.this.m4313unboximpl());
                }
            }));
        }
        ...
        if (semanticsConfiguration.contains(semanticsProperties.getContentDescription()) && (!list.isEmpty()) && this.unmergedConfig.isMergingSemanticsOfDescendants()) {
            ...
            if (str != null) {
                ...
                list.add(0, m4326fakeSemanticsNodeypyhhiA(null, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.ui.semantics.SemanticsNode$emitFakeNodes$fakeNode$2
                    ...
                    public final void invoke2(@NotNull SemanticsPropertyReceiver fakeSemanticsNode) {
                        Intrinsics.checkNotNullParameter(fakeSemanticsNode, "$this$fakeSemanticsNode");
                        SemanticsPropertiesKt.setContentDescription(fakeSemanticsNode, str2);
                    }
                }));
            }
        }
    ...
    private final SemanticsNode m4326fakeSemanticsNodeypyhhiA(Role role, Function1<? super SemanticsPropertyReceiver, Unit> function1) {
        ...
        if (role != null) {
            roleFakeNodeId = SemanticsNodeKt.roleFakeNodeId(this);
            i2 = roleFakeNodeId;
        } else {
            contentDescriptionFakeNodeId = SemanticsNodeKt.contentDescriptionFakeNodeId(this);
            i2 = contentDescriptionFakeNodeId;
        }
        SemanticsNode semanticsNode = new SemanticsNode(new SemanticsWrapper(innerLayoutNodeWrapper$ui_release, new SemanticsModifierCore(i2, false, false, function1)), false);
    ...
    */
    public final androidx.compose.ui.semantics.SemanticsWrapper findWrapperToGetBounds$ui_release() {
        /*
            r2 = this;
            r0 = r2
            ...
            androidx.compose.ui.semantics.SemanticsWrapper r0 = androidx.compose.ui.semantics.SemanticsNodeKt.getOuterMergingSemantics(r0)
            r3 = r0
            r0 = r3
            r4 = r0
            r0 = r3
        ...
        L18:
            r0 = r2
            androidx.compose.ui.semantics.SemanticsWrapper r0 = r0.outerSemanticsNodeWrapper
            r4 = r0
        L1d:
            r0 = r4
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.semantics.SemanticsNode.findWrapperToGetBounds$ui_release():androidx.compose.ui.semantics.SemanticsWrapper");
    }
    ...
    public final SemanticsNode getParent() {
        ...
        if (this.mergingEnabled) {
            findClosestParentNode2 = SemanticsNodeKt.findClosestParentNode(this.layoutNode, new Function1<LayoutNode, Boolean>() { // from class: androidx.compose.ui.semantics.SemanticsNode$parent$1
                @Override // kotlin.jvm.functions.Function1
                @NotNull
        ...
        if (layoutNode == null) {
            ...
            layoutNode2 = findClosestParentNode;
        }
        SemanticsWrapper outerSemantics = layoutNode2 == null ? null : SemanticsNodeKt.getOuterSemantics(layoutNode2);
    ...
    public final long m4327getPositionInRootF1C5BW0() {
        return !this.layoutNode.isAttached() ? Offset.Companion.m2183getZeroF1C5BW0() : LayoutCoordinatesKt.positionInRoot(findWrapperToGetBounds$ui_release());
    }

    /* renamed from: getPositionInWindow-F1C5BW0  reason: not valid java name */
    public final long m4328getPositionInWindowF1C5BW0() {
        return !this.layoutNode.isAttached() ? Offset.Companion.m2183getZeroF1C5BW0() : LayoutCoordinatesKt.positionInWindow(findWrapperToGetBounds$ui_release());
    }
    ...
    public final RootForTest getRoot() {
        ...
        return owner$ui_release == null ? null : owner$ui_release.getRootForTest();
    }

    /* renamed from: getSize-YbymL2g  reason: not valid java name */
    public final long m4329getSizeYbymL2g() {
        return findWrapperToGetBounds$ui_release().mo3927getSizeYbymL2g();
    }
