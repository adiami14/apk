...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/semantics/SemanticsNodeKt.class */
public final class SemanticsNodeKt {
    ...
    public static final SemanticsWrapper getOuterMergingSemantics(@NotNull LayoutNode layoutNode) {
        ...
        while (true) {
            LayoutNodeWrapper layoutNodeWrapper = outerLayoutNodeWrapper$ui_release;
            if (layoutNodeWrapper == null) {
                semanticsWrapper = null;
                break;
            }
            if (layoutNodeWrapper instanceof SemanticsWrapper) {
                SemanticsWrapper semanticsWrapper2 = (SemanticsWrapper) layoutNodeWrapper;
                if (semanticsWrapper2.getModifier().getSemanticsConfiguration().isMergingSemanticsOfDescendants()) {
                    semanticsWrapper = semanticsWrapper2;
                    break;
                }
            }
            outerLayoutNodeWrapper$ui_release = layoutNodeWrapper.getWrapped$ui_release();
        }
