...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/semantics/SemanticsPropertiesKt.class */
public final class SemanticsPropertiesKt {
    ...
    public static final <T extends Function<? extends Boolean>> SemanticsPropertyKey<AccessibilityAction<T>> ActionPropertyKey(@NotNull String name) {
        ...
        return new SemanticsPropertyKey<>(name, new Function2<AccessibilityAction<T>, AccessibilityAction<T>, AccessibilityAction<T>>() { // from class: androidx.compose.ui.semantics.SemanticsPropertiesKt$ActionPropertyKey$1
            ...
            /* JADX WARN: Type inference failed for: r3v0, types: [kotlin.Function] */
            @Nullable
            public final AccessibilityAction<T> invoke(@Nullable AccessibilityAction<T> accessibilityAction, @NotNull AccessibilityAction<T> childValue) {
                ...
                T action = accessibilityAction == null ? null : accessibilityAction.getAction();
                T t2 = action;
                if (action == null) {
                    t2 = childValue.getAction();
                }
                return new AccessibilityAction<>(str, t2);
            }
    ...
    public static final int getImeAction(@NotNull SemanticsPropertyReceiver semanticsPropertyReceiver) {
        Intrinsics.checkNotNullParameter(semanticsPropertyReceiver, "<this>");
        return ((ImeAction) imeAction$delegate.getValue(semanticsPropertyReceiver, $$delegatedProperties[11])).m4562unboximpl();
    }

    public static final int getLiveRegion(@NotNull SemanticsPropertyReceiver semanticsPropertyReceiver) {
        Intrinsics.checkNotNullParameter(semanticsPropertyReceiver, "<this>");
        return ((LiveRegionMode) liveRegion$delegate.getValue(semanticsPropertyReceiver, $$delegatedProperties[3])).m4300unboximpl();
    }
    ...
    public static final int getRole(@NotNull SemanticsPropertyReceiver semanticsPropertyReceiver) {
        Intrinsics.checkNotNullParameter(semanticsPropertyReceiver, "<this>");
        return ((Role) role$delegate.getValue(semanticsPropertyReceiver, $$delegatedProperties[7])).m4313unboximpl();
    }
    ...
    public static final long getTextSelectionRange(@NotNull SemanticsPropertyReceiver semanticsPropertyReceiver) {
        Intrinsics.checkNotNullParameter(semanticsPropertyReceiver, "<this>");
        return ((TextRange) textSelectionRange$delegate.getValue(semanticsPropertyReceiver, $$delegatedProperties[10])).m4479unboximpl();
    }
    ...
    public static final void m4344setImeAction4L7nppU(@NotNull SemanticsPropertyReceiver imeAction, int i2) {
        Intrinsics.checkNotNullParameter(imeAction, "$this$imeAction");
        imeAction$delegate.setValue(imeAction, $$delegatedProperties[11], ImeAction.m4556boximpl(i2));
    }

    /* renamed from: setLiveRegion-hR3wRGc  reason: not valid java name */
    public static final void m4345setLiveRegionhR3wRGc(@NotNull SemanticsPropertyReceiver liveRegion, int i2) {
        Intrinsics.checkNotNullParameter(liveRegion, "$this$liveRegion");
        liveRegion$delegate.setValue(liveRegion, $$delegatedProperties[3], LiveRegionMode.m4294boximpl(i2));
    }
    ...
    public static final void m4346setRolekuIjeqM(@NotNull SemanticsPropertyReceiver role, int i2) {
        Intrinsics.checkNotNullParameter(role, "$this$role");
        role$delegate.setValue(role, $$delegatedProperties[7], Role.m4307boximpl(i2));
    }
    ...
    public static final void m4347setTextSelectionRangeFDrldGo(@NotNull SemanticsPropertyReceiver textSelectionRange, long j2) {
        Intrinsics.checkNotNullParameter(textSelectionRange, "$this$textSelectionRange");
        textSelectionRange$delegate.setValue(textSelectionRange, $$delegatedProperties[10], TextRange.m4463boximpl(j2));
    }
