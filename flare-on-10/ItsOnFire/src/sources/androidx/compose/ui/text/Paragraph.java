...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/text/Paragraph.class */
public interface Paragraph {

    @Metadata(k = 3, mv = {1, 6, 0}, xi = androidx.appcompat.R.styleable.AppCompatTheme_checkboxStyle)
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/text/Paragraph$DefaultImpls.class */
    public static final class DefaultImpls {
        ...
        public static /* synthetic */ void m4362paintRPmYEkk$default(Paragraph paragraph, Canvas canvas, long j2, Shadow shadow, TextDecoration textDecoration, int i2, Object obj) {
            if (obj != null) {
            ...
            paragraph.mo4361paintRPmYEkk(canvas, j2, shadow, textDecoration);
        }
    }
    ...
    int mo4359getOffsetForPositionk4lQ0M(long j2);
    ...
    long mo4360getWordBoundaryjx7JFs(int i2);

    boolean isLineEllipsized(int i2);

    /* renamed from: paint-RPmYEkk  reason: not valid java name */
    void mo4361paintRPmYEkk(@NotNull Canvas canvas, long j2, @Nullable Shadow shadow, @Nullable TextDecoration textDecoration);
}
