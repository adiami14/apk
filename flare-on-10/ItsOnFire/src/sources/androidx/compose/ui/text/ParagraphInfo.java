...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/text/ParagraphInfo.class */
public final class ParagraphInfo {
    ...
    public final Rect toGlobal(@NotNull Rect rect) {
        ...
        return rect.m2205translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
    }

    @NotNull
    public final Path toGlobal(@NotNull Path path) {
        Intrinsics.checkNotNullParameter(path, "<this>");
        path.mo2310translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
        return path;
    }

    /* renamed from: toGlobal-GEjPoXI  reason: not valid java name */
    public final long m4363toGlobalGEjPoXI(long j2) {
        return TextRangeKt.TextRange(toGlobalIndex(TextRange.m4475getStartimpl(j2)), toGlobalIndex(TextRange.m4470getEndimpl(j2)));
    }
    ...
    public final long m4364toLocalMKHz9U(long j2) {
        return OffsetKt.Offset(Offset.m2167getXimpl(j2), Offset.m2168getYimpl(j2) - this.top);
    }
