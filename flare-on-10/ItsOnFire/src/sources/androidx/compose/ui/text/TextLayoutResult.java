...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/text/TextLayoutResult.class */
public final class TextLayoutResult {
    ...
    public static /* synthetic */ TextLayoutResult m4454copyO0kMr_c$default(TextLayoutResult textLayoutResult, TextLayoutInput textLayoutInput, long j2, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            textLayoutInput = textLayoutResult.layoutInput;
        }
        if ((i2 & 2) != 0) {
            j2 = textLayoutResult.m4457getSizeYbymL2g();
        }
        return textLayoutResult.m4455copyO0kMr_c(textLayoutInput, j2);
    }
    ...
    public final TextLayoutResult m4455copyO0kMr_c(@NotNull TextLayoutInput layoutInput, long j2) {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof TextLayoutResult) {
            ...
            if (Intrinsics.areEqual(this.layoutInput, textLayoutResult.layoutInput) && Intrinsics.areEqual(this.multiParagraph, textLayoutResult.multiParagraph) && IntSize.m4949equalsimpl0(m4457getSizeYbymL2g(), textLayoutResult.m4457getSizeYbymL2g())) {
    ...
    public final boolean getDidOverflowHeight() {
        return this.multiParagraph.getDidExceedMaxLines() || ((float) IntSize.m4950getHeightimpl(m4457getSizeYbymL2g())) < this.multiParagraph.getHeight();
    }

    public final boolean getDidOverflowWidth() {
        return ((float) IntSize.m4951getWidthimpl(m4457getSizeYbymL2g())) < this.multiParagraph.getWidth();
    }
    ...
    public final int m4456getOffsetForPositionk4lQ0M(long j2) {
        return this.multiParagraph.m4356getOffsetForPositionk4lQ0M(j2);
    }
    ...
    public final long m4457getSizeYbymL2g() {
        return this.size;
    }

    /* renamed from: getWordBoundary--jx7JFs  reason: not valid java name */
    public final long m4458getWordBoundaryjx7JFs(int i2) {
        return this.multiParagraph.m4357getWordBoundaryjx7JFs(i2);
    }

    public int hashCode() {
        return (((((((((this.layoutInput.hashCode() * 31) + this.multiParagraph.hashCode()) * 31) + IntSize.m4952hashCodeimpl(m4457getSizeYbymL2g())) * 31) + Float.hashCode(this.firstBaseline)) * 31) + Float.hashCode(this.lastBaseline)) * 31) + this.placeholderRects.hashCode();
    }
    ...
    public String toString() {
        return "TextLayoutResult(layoutInput=" + this.layoutInput + ", multiParagraph=" + this.multiParagraph + ", size=" + ((Object) IntSize.m4954toStringimpl(m4457getSizeYbymL2g())) + ", firstBaseline=" + this.firstBaseline + ", lastBaseline=" + this.lastBaseline + ", placeholderRects=" + this.placeholderRects + ')';
    }
}
