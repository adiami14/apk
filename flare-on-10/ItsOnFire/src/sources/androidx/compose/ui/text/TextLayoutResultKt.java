...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/text/TextLayoutResultKt.class */
public final class TextLayoutResultKt {
    ...
    public static final TextLayoutResult m4459createTextLayoutResultH0pRuoY(@NotNull TextLayoutInput layoutInput, @NotNull MultiParagraph multiParagraph, long j2) {
    ...
    public static /* synthetic */ TextLayoutResult m4460createTextLayoutResultH0pRuoY$default(TextLayoutInput textLayoutInput, MultiParagraph multiParagraph, long j2, int i2, Object obj) {
        List emptyList;
        if ((i2 & 1) != 0) {
            ...
            textLayoutInput = new TextLayoutInput(annotatedString, textStyle, emptyList, 1, false, TextOverflow.Companion.m4734getClipgIe3tQ8(), DensityKt.Density$default(1.0f, 0.0f, 2, null), LayoutDirection.Ltr, new Font.ResourceLoader() { // from class: androidx.compose.ui.text.TextLayoutResultKt$createTextLayoutResult$1
        ...
        if ((i2 & 2) != 0) {
            multiParagraph = new MultiParagraph(textLayoutInput.getText(), textLayoutInput.getStyle(), null, 0, false, 0.0f, textLayoutInput.getDensity(), textLayoutInput.getResourceLoader(), 28, null);
        }
        if ((i2 & 4) != 0) {
            j2 = IntSize.Companion.m4956getZeroYbymL2g();
        }
        return m4459createTextLayoutResultH0pRuoY(textLayoutInput, multiParagraph, j2);
    }
}
