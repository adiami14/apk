...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/text/TextRangeKt.class */
public final class TextRangeKt {
    ...
    public static final long TextRange(int i2, int i3) {
        return TextRange.m4464constructorimpl(packWithCheck(i2, i3));
    }

    /* renamed from: constrain-8ffj60Q  reason: not valid java name */
    public static final long m4481constrain8ffj60Q(long j2, int i2, int i3) {
        int coerceIn;
        int coerceIn2;
        coerceIn = RangesKt___RangesKt.coerceIn(TextRange.m4475getStartimpl(j2), i2, i3);
        coerceIn2 = RangesKt___RangesKt.coerceIn(TextRange.m4470getEndimpl(j2), i2, i3);
        return (coerceIn == TextRange.m4475getStartimpl(j2) && coerceIn2 == TextRange.m4470getEndimpl(j2)) ? j2 : TextRange(coerceIn, coerceIn2);
    }
    ...
    public static final String m4482substringFDrldGo(@NotNull CharSequence substring, long j2) {
        Intrinsics.checkNotNullParameter(substring, "$this$substring");
        return substring.subSequence(TextRange.m4473getMinimpl(j2), TextRange.m4472getMaximpl(j2)).toString();
    }
}
