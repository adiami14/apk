...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/text/android/LayoutCompat.class */
public final class LayoutCompat {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/text/android/LayoutCompat$BreakStrategy.class */
    ...
    @kotlin.annotation.Retention(AnnotationRetention.SOURCE)
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/text/android/LayoutCompat$HyphenationFrequency.class */
    ...
    @kotlin.annotation.Retention(AnnotationRetention.SOURCE)
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/text/android/LayoutCompat$JustificationMode.class */
    ...
    @kotlin.annotation.Retention(AnnotationRetention.SOURCE)
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/text/android/LayoutCompat$TextDirection.class */
    ...
    @kotlin.annotation.Retention(AnnotationRetention.SOURCE)
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/text/android/LayoutCompat$TextLayoutAlignment.class */
