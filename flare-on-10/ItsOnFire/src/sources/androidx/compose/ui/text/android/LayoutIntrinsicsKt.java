...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/text/android/LayoutIntrinsicsKt.class */
public final class LayoutIntrinsicsKt {
    public static final float minIntrinsicWidth(@NotNull CharSequence text, @NotNull TextPaint paint) {
        ...
        PriorityQueue<Pair> priorityQueue = new PriorityQueue(10, new Comparator() { // from class: androidx.compose.ui.text.android.a
            ...
            public final int compare(Object obj, Object obj2) {
                int m4501minIntrinsicWidth$lambda0;
                m4501minIntrinsicWidth$lambda0 = LayoutIntrinsicsKt.m4501minIntrinsicWidth$lambda0((Pair) obj, (Pair) obj2);
                return m4501minIntrinsicWidth$lambda0;
            }
        });
        while (true) {
            int i3 = i2;
            ...
            if (priorityQueue.size() < 10) {
                pair = new Pair(Integer.valueOf(i3), Integer.valueOf(next));
            } else {
                ...
                if (pair2 == null) {
                    ...
                    i2 = next;
                    if (((Number) pair2.getSecond()).intValue() - ((Number) pair2.getFirst()).intValue() < next - i3) {
                        priorityQueue.poll();
                        pair = new Pair(Integer.valueOf(i3), Integer.valueOf(next));
                    }
                }
    ...
    public static final int m4501minIntrinsicWidth$lambda0(Pair pair, Pair pair2) {
        ...
        if (!(f2 == 0.0f) && (charSequence instanceof Spanned)) {
            ...
            if (textPaint.getLetterSpacing() == 0.0f) {
                ...
                if (!SpannedExtensionsKt.hasSpan(spanned, LetterSpacingSpanPx.class)) {
                    if (SpannedExtensionsKt.hasSpan(spanned, LetterSpacingSpanEm.class)) {
                        z = true;
                    }
                }
            }
