...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/text/android/selection/WordIterator.class */
public final class WordIterator {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/text/android/selection/WordIterator$Companion.class */
    ...
    private final int getBeginning(int i2, boolean z) {
        ...
        if (this.iterator.isBoundary(i2)) {
            preceding = i2;
            if (isAfterLetterOrDigit(i2)) {
                if (!z) {
                    preceding = i2;
        ...
        preceding = this.iterator.preceding(i2);
        return preceding;
    }
    ...
    private final int getEnd(int i2, boolean z) {
        ...
        following = this.iterator.following(i2);
        return following;
    }
