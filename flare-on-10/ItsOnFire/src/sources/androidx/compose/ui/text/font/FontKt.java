...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/text/font/FontKt.class */
public final class FontKt {
    @Stable
    @NotNull
    /* renamed from: Font-RetOiIg  reason: not valid java name */
    public static final Font m4521FontRetOiIg(int i2, @NotNull FontWeight weight, int i3) {
        Intrinsics.checkNotNullParameter(weight, "weight");
        return new ResourceFont(i2, weight, i3, null);
    }

    /* renamed from: Font-RetOiIg$default  reason: not valid java name */
    public static /* synthetic */ Font m4522FontRetOiIg$default(int i2, FontWeight fontWeight, int i3, int i4, Object obj) {
        if ((i4 & 2) != 0) {
            fontWeight = FontWeight.Companion.getNormal();
        }
        if ((i4 & 4) != 0) {
            i3 = FontStyle.Companion.m4535getNormal_LCdwA();
        }
        return m4521FontRetOiIg(i2, fontWeight, i3);
    }
