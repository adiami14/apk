...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/text/font/FontListFontFamily.class */
public final class FontListFontFamily extends FileBasedFontFamily implements List<Font>, KMappedMarker {
    ...
    public FontListFontFamily(@NotNull List<? extends Font> fonts) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            Font font = (Font) obj;
            if (hashSet.add(new Pair(font.getWeight(), FontStyle.m4527boximpl(font.mo4512getStyle_LCdwA())))) {
                arrayList.add(obj);
            }
        }
