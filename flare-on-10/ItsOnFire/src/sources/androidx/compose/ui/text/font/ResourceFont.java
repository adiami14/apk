...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/text/font/ResourceFont.class */
public final class ResourceFont implements Font {
    ...
    public /* synthetic */ ResourceFont(int i2, FontWeight fontWeight, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(i2, (i4 & 2) != 0 ? FontWeight.Companion.getNormal() : fontWeight, (i4 & 4) != 0 ? FontStyle.Companion.m4535getNormal_LCdwA() : i3, null);
    }
    ...
    public static /* synthetic */ ResourceFont m4551copyRetOiIg$default(ResourceFont resourceFont, int i2, FontWeight fontWeight, int i3, int i4, Object obj) {
        if ((i4 & 1) != 0) {
        ...
        if ((i4 & 4) != 0) {
            i3 = resourceFont.mo4512getStyle_LCdwA();
        }
        return resourceFont.m4552copyRetOiIg(i2, fontWeight, i3);
    }

    @NotNull
    /* renamed from: copy-RetOiIg  reason: not valid java name */
    public final ResourceFont m4552copyRetOiIg(int i2, @NotNull FontWeight weight, int i3) {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof ResourceFont) {
            ...
            return this.resId == resourceFont.resId && Intrinsics.areEqual(getWeight(), resourceFont.getWeight()) && FontStyle.m4530equalsimpl0(mo4512getStyle_LCdwA(), resourceFont.mo4512getStyle_LCdwA());
        }
        return false;
    }
    ...
    public int mo4512getStyle_LCdwA() {
        return this.style;
    }
    ...
    public int hashCode() {
        return (((this.resId * 31) + getWeight().hashCode()) * 31) + FontStyle.m4531hashCodeimpl(mo4512getStyle_LCdwA());
    }

    @NotNull
    public String toString() {
        return "ResourceFont(resId=" + this.resId + ", weight=" + getWeight() + ", style=" + ((Object) FontStyle.m4532toStringimpl(mo4512getStyle_LCdwA())) + ')';
    }
}
