...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/text/input/GapBuffer.class */
public final class GapBuffer {
    ...
    private final void delete(int i2, int i3) {
        ...
        if (i2 < i4 && i3 <= i4) {
            ...
            this.gapStart += gapLength - i6;
            this.gapEnd = i3 + gapLength2;
        }
    }
    ...
    private final void makeSureAvailableSpace(int i2) {
        ...
        do {
            i3 *= 2;
        } while (i3 - this.capacity < i2 - gapLength);
