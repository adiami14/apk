...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/text/input/OffsetMapping.class */
public interface OffsetMapping {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/text/input/OffsetMapping$Companion.class */
