...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/text/input/SetComposingTextCommand.class */
public final class SetComposingTextCommand implements EditCommand {
    ...
    public void applyTo(@NotNull EditingBuffer buffer) {
        ...
        if (buffer.hasComposition$ui_text_release()) {
            ...
            if (getText().length() > 0) {
                i2 = compositionStart$ui_text_release;
                buffer.setComposition$ui_text_release(i2, getText().length() + i2);
            }
        } else {
        ...
        coerceIn = RangesKt___RangesKt.coerceIn(i3 > 0 ? i4 - 1 : i4 - getText().length(), 0, buffer.getLength$ui_text_release());
