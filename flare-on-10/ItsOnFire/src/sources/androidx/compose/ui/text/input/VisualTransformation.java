...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/text/input/VisualTransformation.class */
public interface VisualTransformation {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/text/input/VisualTransformation$Companion.class */
    public static final class Companion {
        ...
        private static final VisualTransformation None = new VisualTransformation() { // from class: androidx.compose.ui.text.input.c
            ...
            public final TransformedText filter(AnnotatedString annotatedString) {
                TransformedText m4629None$lambda0;
                m4629None$lambda0 = VisualTransformation.Companion.m4629None$lambda0(annotatedString);
                return m4629None$lambda0;
            }
        };
        ...
        public static final TransformedText m4629None$lambda0(AnnotatedString text) {
