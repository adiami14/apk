...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/text/platform/AndroidDefaultTypeface.class */
public final class AndroidDefaultTypeface implements AndroidTypeface {
    ...
    public Typeface mo4633getNativeTypefacePYhJU0U(@NotNull FontWeight fontWeight, int i2, int i3) {
        ...
        return typefaceAdapterHelperMethods.create(DEFAULT, fontWeight.getWeight(), FontStyle.m4530equalsimpl0(i2, FontStyle.Companion.m4534getItalic_LCdwA()));
    }
}
