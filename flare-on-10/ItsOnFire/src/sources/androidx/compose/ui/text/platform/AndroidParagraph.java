...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/text/platform/AndroidParagraph.class */
public final class AndroidParagraph implements Paragraph {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/text/platform/AndroidParagraph$WhenMappings.class */
    ...
    public AndroidParagraph(@NotNull AndroidParagraphIntrinsics paragraphIntrinsics, int i2, boolean z, float f2) {
        ...
        m4641toLayoutAlignAMY3VfE = AndroidParagraph_androidKt.m4641toLayoutAlignAMY3VfE(style.m4494getTextAlignbuA522U());
        TextAlign m4494getTextAlignbuA522U = style.m4494getTextAlignbuA522U();
        this.layout = new TextLayout(paragraphIntrinsics.getCharSequence$ui_text_release(), getWidth(), getTextPaint$ui_text_release(), m4641toLayoutAlignAMY3VfE, z ? TextUtils.TruncateAt.END : null, paragraphIntrinsics.getTextDirectionHeuristic$ui_text_release(), 1.0f, 0.0f, false, i2, 0, 0, m4494getTextAlignbuA522U == null ? false : TextAlign.m4693equalsimpl0(m4494getTextAlignbuA522U.m4696unboximpl(), TextAlign.Companion.m4699getJustifye0LSkKk()) ? 1 : 0, null, null, paragraphIntrinsics.getLayoutIntrinsics$ui_text_release(), 28032, null);
        ...
        if (charSequence$ui_text_release instanceof Spanned) {
            ...
            while (true) {
                ...
                if (i4 < length) {
                    ...
                    ?? r24 = this.layout.getLineEllipsisCount(lineForOffset) > 0 && spanEnd > this.layout.getLineEllipsisOffset(lineForOffset);
                    ?? r27 = spanEnd > this.layout.getLineEnd(lineForOffset);
                    if (r24 == true || r27 == true) {
                        rect = null;
                    } else {
    ...
    public Rect getCursorRect(int i2) {
        ...
        if (i2 >= 0) {
            z = false;
            if (i2 <= getCharSequence$ui_text_release().length()) {
                z = true;
            }
        }
        if (z) {
    ...
    public int mo4359getOffsetForPositionk4lQ0M(long j2) {
        return this.layout.getOffsetForHorizontal(this.layout.getLineForVertical((int) Offset.m2168getYimpl(j2)), Offset.m2167getXimpl(j2));
    }
    ...
    public long mo4360getWordBoundaryjx7JFs(int i2) {
    ...
    public void mo4361paintRPmYEkk(@NotNull Canvas canvas, long j2, @Nullable Shadow shadow, @Nullable TextDecoration textDecoration) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        getTextPaint$ui_text_release().m4643setColor8_81llA(j2);
