...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/text/platform/AndroidParagraphIntrinsics.class */
public final class AndroidParagraphIntrinsics implements ParagraphIntrinsics {
    ...
    public AndroidParagraphIntrinsics(@NotNull String text, @NotNull TextStyle style, @NotNull List<AnnotatedString.Range<SpanStyle>> spanStyles, @NotNull List<AnnotatedString.Range<Placeholder>> placeholders, @NotNull TypefaceAdapter typefaceAdapter, @NotNull Density density) {
        ...
        int m4638resolveTextDirectionHeuristics9GRLPo0 = AndroidParagraphIntrinsics_androidKt.m4638resolveTextDirectionHeuristics9GRLPo0(style.m4495getTextDirectionmmuk1to(), style.getLocaleList());
        this.textDirectionHeuristic = m4638resolveTextDirectionHeuristics9GRLPo0;
        ...
        this.layoutIntrinsics = new LayoutIntrinsics(createCharSequence, androidTextPaint, m4638resolveTextDirectionHeuristics9GRLPo0);
    }
