...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/text/platform/AndroidTypefaceCache.class */
public final class AndroidTypefaceCache {
    ...
    public final String getKey(@NotNull Context context, @NotNull Font font) {
        ...
        if (font instanceof ResourceFont) {
            ...
            str = Intrinsics.stringPlus("res:", obj);
        } else if (font instanceof AndroidAssetFont) {
            str = Intrinsics.stringPlus("asset:", ((AndroidAssetFont) font).getPath());
        } else if (font instanceof AndroidFileFont) {
            str = null;
        } else if (!(font instanceof AndroidFileDescriptorFont)) {
