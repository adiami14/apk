...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/tooling/preview/PreviewParameterProvider.class */
public interface PreviewParameterProvider<T> {

    @Metadata(k = 3, mv = {1, 6, 0}, xi = androidx.appcompat.R.styleable.AppCompatTheme_checkboxStyle)
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/tooling/preview/PreviewParameterProvider$DefaultImpls.class */
