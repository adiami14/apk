...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/unit/IntRect.class */
public final class IntRect {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/unit/IntRect$Companion.class */
    ...
    public static /* synthetic */ void m4926getSizeYbymL2g$annotations() {
    }
    ...
    public final boolean m4927containsgyyYBs(long j2) {
        return IntOffset.m4907getXimpl(j2) >= this.left && IntOffset.m4907getXimpl(j2) < this.right && IntOffset.m4908getYimpl(j2) >= this.top && IntOffset.m4908getYimpl(j2) < this.bottom;
    }
    ...
    public final IntRect m4938translategyyYBs(long j2) {
        return new IntRect(this.left + IntOffset.m4907getXimpl(j2), this.top + IntOffset.m4908getYimpl(j2), this.right + IntOffset.m4907getXimpl(j2), this.bottom + IntOffset.m4908getYimpl(j2));
    }
}
