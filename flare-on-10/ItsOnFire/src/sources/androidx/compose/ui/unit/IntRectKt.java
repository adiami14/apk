...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/unit/IntRectKt.class */
public final class IntRectKt {
    @Stable
    @NotNull
    /* renamed from: IntRect-E1MhUcY  reason: not valid java name */
    public static final IntRect m4939IntRectE1MhUcY(long j2, long j3) {
        return new IntRect(IntOffset.m4907getXimpl(j2), IntOffset.m4908getYimpl(j2), IntOffset.m4907getXimpl(j3), IntOffset.m4908getYimpl(j3));
    }

    @Stable
    @NotNull
    /* renamed from: IntRect-VbeCjmY  reason: not valid java name */
    public static final IntRect m4940IntRectVbeCjmY(long j2, long j3) {
        return new IntRect(IntOffset.m4907getXimpl(j2), IntOffset.m4908getYimpl(j2), IntOffset.m4907getXimpl(j2) + IntSize.m4951getWidthimpl(j3), IntOffset.m4908getYimpl(j2) + IntSize.m4950getHeightimpl(j3));
    }

    @Stable
    @NotNull
    /* renamed from: IntRect-ar5cAso  reason: not valid java name */
    public static final IntRect m4941IntRectar5cAso(long j2, int i2) {
        return new IntRect(IntOffset.m4907getXimpl(j2) - i2, IntOffset.m4908getYimpl(j2) - i2, IntOffset.m4907getXimpl(j2) + i2, IntOffset.m4908getYimpl(j2) + i2);
    }
