...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/viewinterop/AndroidViewHolder$onCommitAffectingUpdate$1.class */
public final class AndroidViewHolder$onCommitAffectingUpdate$1 extends Lambda implements Function1<AndroidViewHolder, Unit> {
    ...
    public static final void m5032invoke$lambda0(Function0 tmp0) {
    ...
    public final void invoke2(@NotNull AndroidViewHolder it) {
        ...
        handler.post(new Runnable() { // from class: androidx.compose.ui.viewinterop.a
            ...
            public final void run() {
                AndroidViewHolder$onCommitAffectingUpdate$1.m5032invoke$lambda0(Function0.this);
            }
        });
    }
}
