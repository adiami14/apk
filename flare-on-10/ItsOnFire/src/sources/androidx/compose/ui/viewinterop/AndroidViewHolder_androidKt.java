...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/viewinterop/AndroidViewHolder_androidKt.class */
public final class AndroidViewHolder_androidKt {
    ...
    public static final void layoutAccordingTo(View view, LayoutNode layoutNode) {
        ...
        roundToInt = MathKt__MathJVMKt.roundToInt(Offset.m2167getXimpl(positionInRoot));
        roundToInt2 = MathKt__MathJVMKt.roundToInt(Offset.m2168getYimpl(positionInRoot));
