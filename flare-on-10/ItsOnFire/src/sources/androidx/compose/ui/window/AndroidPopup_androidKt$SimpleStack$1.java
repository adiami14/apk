...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/window/AndroidPopup_androidKt$SimpleStack$1.class */
    ...
    public final MeasureResult mo89measure3p2s80s(@NotNull MeasureScope Layout, @NotNull List<? extends Measurable> measurables, long j2) {
        ...
        if (size != 0) {
            ...
            if (size != 1) {
                ...
                layout$default = MeasureScope.DefaultImpls.layout$default(Layout, i4, i5, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.window.AndroidPopup_androidKt$SimpleStack$1$measure$3
