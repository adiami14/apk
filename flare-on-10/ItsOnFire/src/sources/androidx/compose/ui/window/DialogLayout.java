...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/window/DialogLayout.class */
public final class DialogLayout extends AbstractComposeView implements DialogWindowProvider {
    ...
    public DialogLayout(@NotNull Context context, @NotNull Window window) {
        ...
        this.window = window;
        mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(ComposableSingletons$AndroidDialog_androidKt.INSTANCE.m5057getLambda1$ui_release(), null, 2, null);
    ...
    public void Content(@Nullable Composer composer, final int i2) {
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.window.DialogLayout$Content$4
            ...
            public final void invoke(@Nullable Composer composer2, int i3) {
                DialogLayout.this.Content(composer2, i2 | 1);
            }
        });
    }
