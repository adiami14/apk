...
/* loaded from: ItsOnFire.jar:androidx/compose/ui/window/DialogWrapper.class */
final class DialogWrapper extends Dialog implements ViewRootForInspector {
    ...
    /* loaded from: ItsOnFire.jar:androidx/compose/ui/window/DialogWrapper$WhenMappings.class */
    ...
    public DialogWrapper(@NotNull Function0<Unit> onDismissRequest, @NotNull DialogProperties properties, @NotNull View composeView, @NotNull LayoutDirection layoutDirection, @NotNull Density density, @NotNull UUID dialogId) {
        ...
        float m4785constructorimpl = Dp.m4785constructorimpl(30);
        this.maxSupportedElevation = m4785constructorimpl;
        ...
        dialogLayout.setElevation(density.mo524toPx0680j_4(m4785constructorimpl));
