...
/* loaded from: ItsOnFire.jar:androidx/concurrent/futures/CallbackToFutureAdapter.class */
public final class CallbackToFutureAdapter {

    /* loaded from: ItsOnFire.jar:androidx/concurrent/futures/CallbackToFutureAdapter$Completer.class */
    public static final class Completer<T> {
        ...
        public boolean set(T t2) {
            ...
            SafeFuture<T> safeFuture = this.future;
            if (safeFuture == null || !safeFuture.set(t2)) {
                z = false;
            }
            if (z) {
    ...
    /* loaded from: ItsOnFire.jar:androidx/concurrent/futures/CallbackToFutureAdapter$FutureGarbageCollectedException.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/concurrent/futures/CallbackToFutureAdapter$Resolver.class */
    public interface Resolver<T> {
        @Nullable
        Object attachCompleter(@NonNull Completer<T> completer) throws Exception;
    }

    /* loaded from: ItsOnFire.jar:androidx/concurrent/futures/CallbackToFutureAdapter$SafeFuture.class */
