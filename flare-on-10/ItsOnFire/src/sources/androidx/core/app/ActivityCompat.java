...
/* loaded from: ItsOnFire.jar:androidx/core/app/ActivityCompat.class */
public class ActivityCompat extends ContextCompat {
    private static PermissionCompatDelegate sDelegate;

    /* renamed from: androidx.core.app.ActivityCompat$1  reason: invalid class name */
    /* loaded from: ItsOnFire.jar:androidx/core/app/ActivityCompat$1.class */
    ...
    @RequiresApi(16)
    /* loaded from: ItsOnFire.jar:androidx/core/app/ActivityCompat$Api16Impl.class */
    ...
    @RequiresApi(21)
    /* loaded from: ItsOnFire.jar:androidx/core/app/ActivityCompat$Api21Impl.class */
    ...
    @RequiresApi(22)
    /* loaded from: ItsOnFire.jar:androidx/core/app/ActivityCompat$Api22Impl.class */
    ...
    @RequiresApi(23)
    /* loaded from: ItsOnFire.jar:androidx/core/app/ActivityCompat$Api23Impl.class */
    ...
    @RequiresApi(28)
    /* loaded from: ItsOnFire.jar:androidx/core/app/ActivityCompat$Api28Impl.class */
    ...
    @RequiresApi(30)
    /* loaded from: ItsOnFire.jar:androidx/core/app/ActivityCompat$Api30Impl.class */
    ...
    @RequiresApi(31)
    /* loaded from: ItsOnFire.jar:androidx/core/app/ActivityCompat$Api31Impl.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/core/app/ActivityCompat$OnRequestPermissionsResultCallback.class */
    public interface OnRequestPermissionsResultCallback {
        void onRequestPermissionsResult(int i2, @NonNull String[] strArr, @NonNull int[] iArr);
    }

    /* loaded from: ItsOnFire.jar:androidx/core/app/ActivityCompat$PermissionCompatDelegate.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/core/app/ActivityCompat$RequestPermissionsRequestCodeValidator.class */
    public interface RequestPermissionsRequestCodeValidator {
        void validateRequestPermissionsRequestCode(int i2);
    }

    @RequiresApi(21)
    /* loaded from: ItsOnFire.jar:androidx/core/app/ActivityCompat$SharedElementCallback21Impl.class */
