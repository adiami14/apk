...
/* loaded from: ItsOnFire.jar:androidx/core/app/ActivityOptionsCompat.class */
public class ActivityOptionsCompat {
    public static final String EXTRA_USAGE_TIME_REPORT = "android.activity.usage_time";
    public static final String EXTRA_USAGE_TIME_REPORT_PACKAGES = "android.usage_time_packages";

    @RequiresApi(16)
    /* loaded from: ItsOnFire.jar:androidx/core/app/ActivityOptionsCompat$ActivityOptionsCompatImpl.class */
    ...
    @RequiresApi(16)
    /* loaded from: ItsOnFire.jar:androidx/core/app/ActivityOptionsCompat$Api16Impl.class */
    ...
    @RequiresApi(21)
    /* loaded from: ItsOnFire.jar:androidx/core/app/ActivityOptionsCompat$Api21Impl.class */
    ...
    @RequiresApi(23)
    /* loaded from: ItsOnFire.jar:androidx/core/app/ActivityOptionsCompat$Api23Impl.class */
    ...
    @RequiresApi(24)
    /* loaded from: ItsOnFire.jar:androidx/core/app/ActivityOptionsCompat$Api24Impl.class */
    ...
    public static ActivityOptionsCompat makeSceneTransitionAnimation(@NonNull Activity activity, @Nullable androidx.core.util.Pair<View, String>... pairArr) {
        ...
        if (pairArr != null) {
            ...
            while (true) {
                ...
                pairArr3[i2] = Pair.create(pair.first, pair.second);
                i2++;
            }
        }
