...
@Deprecated
/* loaded from: ItsOnFire.jar:androidx/core/app/JobIntentService.class */
public abstract class JobIntentService extends Service {
    ...
    /* loaded from: ItsOnFire.jar:androidx/core/app/JobIntentService$CommandProcessor.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/core/app/JobIntentService$CompatJobEngine.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/core/app/JobIntentService$CompatWorkEnqueuer.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/core/app/JobIntentService$CompatWorkItem.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/core/app/JobIntentService$GenericWorkItem.class */
    ...
    @RequiresApi(26)
    /* loaded from: ItsOnFire.jar:androidx/core/app/JobIntentService$JobServiceEngineImpl.class */
    public static final class JobServiceEngineImpl extends JobServiceEngine implements CompatJobEngine {
        ...
        /* loaded from: ItsOnFire.jar:androidx/core/app/JobIntentService$JobServiceEngineImpl$WrapperWorkItem.class */
    ...
    @RequiresApi(26)
    /* loaded from: ItsOnFire.jar:androidx/core/app/JobIntentService$JobWorkEnqueuer.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/core/app/JobIntentService$WorkEnqueuer.class */
    ...
    public static WorkEnqueuer getWorkEnqueuer(Context context, ComponentName componentName, boolean z, int i2) {
        ...
        JobWorkEnqueuer jobWorkEnqueuer = workEnqueuer;
        if (workEnqueuer == null) {
            if (!z) {
                throw new IllegalArgumentException("Can't be here without a job id");
            }
            jobWorkEnqueuer = new JobWorkEnqueuer(context, componentName, i2);
