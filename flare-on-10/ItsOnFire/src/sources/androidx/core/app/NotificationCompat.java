...
/* loaded from: ItsOnFire.jar:androidx/core/app/NotificationCompat.class */
public class NotificationCompat {
    ...
    /* loaded from: ItsOnFire.jar:androidx/core/app/NotificationCompat$Action.class */
    public static class Action {
        ...
        /* loaded from: ItsOnFire.jar:androidx/core/app/NotificationCompat$Action$Builder.class */
        ...
        /* loaded from: ItsOnFire.jar:androidx/core/app/NotificationCompat$Action$Extender.class */
        ...
        /* loaded from: ItsOnFire.jar:androidx/core/app/NotificationCompat$Action$SemanticAction.class */
        public @interface SemanticAction {
        }

        /* loaded from: ItsOnFire.jar:androidx/core/app/NotificationCompat$Action$WearableExtender.class */
        public static final class WearableExtender implements Extender {
            ...
            private void setFlag(int i2, boolean z) {
                this.mFlags = z ? i2 | this.mFlags : i2 & this.mFlags;
            }

            @NonNull
            /* renamed from: clone */
            public WearableExtender m5084clone() {
    ...
    @Retention(RetentionPolicy.SOURCE)
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    /* loaded from: ItsOnFire.jar:androidx/core/app/NotificationCompat$BadgeIconType.class */
    public @interface BadgeIconType {
    }

    /* loaded from: ItsOnFire.jar:androidx/core/app/NotificationCompat$BigPictureStyle.class */
    public static class BigPictureStyle extends Style {
        ...
        @RequiresApi(16)
        /* loaded from: ItsOnFire.jar:androidx/core/app/NotificationCompat$BigPictureStyle$Api16Impl.class */
        ...
        @RequiresApi(23)
        /* loaded from: ItsOnFire.jar:androidx/core/app/NotificationCompat$BigPictureStyle$Api23Impl.class */
        ...
        @RequiresApi(31)
        /* loaded from: ItsOnFire.jar:androidx/core/app/NotificationCompat$BigPictureStyle$Api31Impl.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/core/app/NotificationCompat$BigTextStyle.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/core/app/NotificationCompat$BubbleMetadata.class */
    public static final class BubbleMetadata {
        ...
        @RequiresApi(29)
        /* loaded from: ItsOnFire.jar:androidx/core/app/NotificationCompat$BubbleMetadata$Api29Impl.class */
        ...
        @RequiresApi(30)
        /* loaded from: ItsOnFire.jar:androidx/core/app/NotificationCompat$BubbleMetadata$Api30Impl.class */
        ...
        /* loaded from: ItsOnFire.jar:androidx/core/app/NotificationCompat$BubbleMetadata$Builder.class */
        public static final class Builder {
            private PendingIntent mDeleteIntent;
            private int mDesiredHeight;
            @DimenRes
    ...
    /* loaded from: ItsOnFire.jar:androidx/core/app/NotificationCompat$Builder.class */
    public static class Builder {
        ...
        private void setFlag(int i2, boolean z) {
            ...
            notification.flags = z ? i2 | notification.flags : i2 & notification.flags;
        }
    ...
    /* loaded from: ItsOnFire.jar:androidx/core/app/NotificationCompat$CarExtender.class */
    public static final class CarExtender implements Extender {
        ...
        @Deprecated
        /* loaded from: ItsOnFire.jar:androidx/core/app/NotificationCompat$CarExtender$UnreadConversation.class */
        public static class UnreadConversation {
            ...
            /* loaded from: ItsOnFire.jar:androidx/core/app/NotificationCompat$CarExtender$UnreadConversation$Builder.class */
            public static class Builder {
        ...
        private static UnreadConversation getUnreadConversationFromBundle(@Nullable Bundle bundle) {
            ...
            if (stringArray != null) {
                if (stringArray.length != 1) {
                    ...
                    if (remoteInput != null) {
                        remoteInput2 = new RemoteInput(remoteInput.getResultKey(), remoteInput.getLabel(), remoteInput.getChoices(), remoteInput.getAllowFreeFormInput(), remoteInput.getEditChoicesBeforeSending(), remoteInput.getExtras(), null);
                    }
    ...
    /* loaded from: ItsOnFire.jar:androidx/core/app/NotificationCompat$DecoratedCustomViewStyle.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/core/app/NotificationCompat$Extender.class */
    public interface Extender {
        @NonNull
        Builder extend(@NonNull Builder builder);
    }
    ...
    @Retention(RetentionPolicy.SOURCE)
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    /* loaded from: ItsOnFire.jar:androidx/core/app/NotificationCompat$GroupAlertBehavior.class */
    public @interface GroupAlertBehavior {
    }

    /* loaded from: ItsOnFire.jar:androidx/core/app/NotificationCompat$InboxStyle.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/core/app/NotificationCompat$MessagingStyle.class */
    public static class MessagingStyle extends Style {
        ...
        /* loaded from: ItsOnFire.jar:androidx/core/app/NotificationCompat$MessagingStyle$Message.class */
    ...
    @Retention(RetentionPolicy.SOURCE)
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    /* loaded from: ItsOnFire.jar:androidx/core/app/NotificationCompat$NotificationVisibility.class */
    public @interface NotificationVisibility {
    }

    @Retention(RetentionPolicy.SOURCE)
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    /* loaded from: ItsOnFire.jar:androidx/core/app/NotificationCompat$ServiceNotificationBehavior.class */
    public @interface ServiceNotificationBehavior {
    }

    @Retention(RetentionPolicy.SOURCE)
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    /* loaded from: ItsOnFire.jar:androidx/core/app/NotificationCompat$StreamType.class */
    public @interface StreamType {
    }

    /* loaded from: ItsOnFire.jar:androidx/core/app/NotificationCompat$Style.class */
    public static abstract class Style {
        ...
        private Bitmap createIconWithBackground(int i2, int i3, int i4, int i5) {
            ...
            Bitmap createColoredBitmap = createColoredBitmap(i6, i7, i3);
    ...
    /* loaded from: ItsOnFire.jar:androidx/core/app/NotificationCompat$WearableExtender.class */
    public static final class WearableExtender implements Extender {
        ...
        @NonNull
        /* renamed from: clone */
        public WearableExtender m5085clone() {
            WearableExtender wearableExtender = new WearableExtender();
    ...
    public static Action getActionCompatFromAction(@NonNull Notification.Action action) {
        ...
        if (remoteInputs == null) {
            ...
            for (int i3 = 0; i3 < remoteInputs.length; i3++) {
                ...
                remoteInputArr[i3] = new RemoteInput(remoteInput.getResultKey(), remoteInput.getLabel(), remoteInput.getChoices(), remoteInput.getAllowFreeFormInput(), remoteInput.getEditChoicesBeforeSending(), remoteInput.getExtras(), null);
            }
        }
        ...
        if (i4 >= 31) {
            isAuthenticationRequired = action.isAuthenticationRequired();
            z = isAuthenticationRequired;
        }
        if (action.getIcon() != null || (i2 = action.icon) == 0) {
            return new Action(action.getIcon() != null ? IconCompat.createFromIconOrNullIfZeroResId(action.getIcon()) : null, action.title, action.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z2, semanticAction, z3, isContextual, z);
        }
        return new Action(i2, action.title, action.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z2, semanticAction, z3, isContextual, z);
    }
