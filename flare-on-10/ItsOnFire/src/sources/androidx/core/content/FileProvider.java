...
/* loaded from: ItsOnFire.jar:androidx/core/content/FileProvider.class */
public class FileProvider extends ContentProvider {
    ...
    @RequiresApi(21)
    /* loaded from: ItsOnFire.jar:androidx/core/content/FileProvider$Api21Impl.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/core/content/FileProvider$PathStrategy.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/core/content/FileProvider$SimplePathStrategy.class */
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] strArr, @Nullable String str, @Nullable String[] strArr2, @Nullable String str2) {
        ...
        while (true) {
            int i6 = i5;
            if (i4 >= length) {
                String[] copyOf = copyOf(strArr4, i6);
