...
/* loaded from: ItsOnFire.jar:androidx/core/content/pm/PackageInfoCompat.class */
public final class PackageInfoCompat {

    @RequiresApi(28)
    /* loaded from: ItsOnFire.jar:androidx/core/content/pm/PackageInfoCompat$Api28Impl.class */
            ...
            if (!z || map.size() == signatures.size()) {
                ...
                if (map.containsValue(1)) {
                    ...
                    while (true) {
                        ...
                        bArr4[i2] = computeSHA256Digest(signatures.get(i2).toByteArray());
                        i2++;
                    }
                }
                ...
                if (it.hasNext()) {
                    ...
                    if (intValue2 == 0) {
                        ...
                        return byteArrayContains(bArr3, next);
                    } else {
