...
/* loaded from: ItsOnFire.jar:androidx/core/content/pm/ShortcutInfoCompatSaver.class */
public abstract class ShortcutInfoCompatSaver<T> {

    @RestrictTo({RestrictTo.Scope.LIBRARY})
    /* loaded from: ItsOnFire.jar:androidx/core/content/pm/ShortcutInfoCompatSaver$NoopImpl.class */
