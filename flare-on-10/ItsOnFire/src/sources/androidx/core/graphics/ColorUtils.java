...
/* loaded from: ItsOnFire.jar:androidx/core/graphics/ColorUtils.class */
public final class ColorUtils {
    ...
    @RequiresApi(26)
    /* loaded from: ItsOnFire.jar:androidx/core/graphics/ColorUtils$Api26Impl.class */
    public static class Api26Impl {
        ...
        public static Color compositeColors(Color color, Color color2) {
            ...
            for (int i2 = 0; i2 < componentCount; i2++) {
                components2[i2] = (components[i2] * f4) + (components2[i2] * f3);
            }
