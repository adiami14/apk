...
@RequiresApi(31)
/* loaded from: ItsOnFire.jar:androidx/core/os/ContinuationOutcomeReceiver.class */
final class ContinuationOutcomeReceiver<R, E extends Throwable> extends AtomicBoolean implements OutcomeReceiver {
    ...
    public void onError(@NotNull E error) {
        ...
        if (compareAndSet(false, true)) {
            ...
            continuation.resumeWith(Result.m5849constructorimpl(ResultKt.createFailure(error)));
        }
    }
    ...
    public void onResult(R r2) {
        if (compareAndSet(false, true)) {
            Continuation<R> continuation = this.continuation;
            Result.Companion companion = Result.Companion;
            continuation.resumeWith(Result.m5849constructorimpl(r2));
        }
    }
