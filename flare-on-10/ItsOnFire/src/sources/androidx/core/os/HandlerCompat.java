...
/* loaded from: ItsOnFire.jar:androidx/core/os/HandlerCompat.class */
public final class HandlerCompat {
    private static final String TAG = "HandlerCompat";

    @RequiresApi(28)
    /* loaded from: ItsOnFire.jar:androidx/core/os/HandlerCompat$Api28Impl.class */
    ...
    @RequiresApi(29)
    /* loaded from: ItsOnFire.jar:androidx/core/os/HandlerCompat$Api29Impl.class */
