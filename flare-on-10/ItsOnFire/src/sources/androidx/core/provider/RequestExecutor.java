...
/* loaded from: ItsOnFire.jar:androidx/core/provider/RequestExecutor.class */
class RequestExecutor {

    /* loaded from: ItsOnFire.jar:androidx/core/provider/RequestExecutor$DefaultThreadFactory.class */
    public static class DefaultThreadFactory implements ThreadFactory {
        private int mPriority;
        private String mThreadName;

        /* loaded from: ItsOnFire.jar:androidx/core/provider/RequestExecutor$DefaultThreadFactory$ProcessPriorityThread.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/core/provider/RequestExecutor$HandlerExecutor.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/core/provider/RequestExecutor$ReplyRunnable.class */
