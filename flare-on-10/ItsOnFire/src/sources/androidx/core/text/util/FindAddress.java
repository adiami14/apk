...
/* loaded from: ItsOnFire.jar:androidx/core/text/util/FindAddress.class */
class FindAddress {
    ...
    /* loaded from: ItsOnFire.jar:androidx/core/text/util/FindAddress$ZipRange.class */
    ...
    */
    ...
    private static boolean isValidZipCode(String str, MatchResult matchResult) {
        ...
        if (sZipCodeRe.matcher(str).matches()) {
            z = false;
            if (sStateZipCodeRanges[i2].matches(str)) {
                z = true;
            }
        }
        return z;
