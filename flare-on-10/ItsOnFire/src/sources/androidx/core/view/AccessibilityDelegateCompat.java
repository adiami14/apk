...
/* loaded from: ItsOnFire.jar:androidx/core/view/AccessibilityDelegateCompat.class */
public class AccessibilityDelegateCompat {
    private static final View.AccessibilityDelegate DEFAULT_DELEGATE = new View.AccessibilityDelegate();
    private final View.AccessibilityDelegate mBridge;
    private final View.AccessibilityDelegate mOriginalDelegate;

    /* loaded from: ItsOnFire.jar:androidx/core/view/AccessibilityDelegateCompat$AccessibilityDelegateAdapter.class */
    ...
    @RequiresApi(16)
    /* loaded from: ItsOnFire.jar:androidx/core/view/AccessibilityDelegateCompat$Api16Impl.class */
    ...
    public boolean performAccessibilityAction(@NonNull View view, int i2, @Nullable Bundle bundle) {
        ...
        if (!z2) {
            z3 = z2;
            if (i2 == R.id.accessibility_action_clickable_span) {
                z3 = z2;
                if (bundle != null) {
