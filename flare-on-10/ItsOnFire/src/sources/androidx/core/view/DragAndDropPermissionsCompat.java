...
/* loaded from: ItsOnFire.jar:androidx/core/view/DragAndDropPermissionsCompat.class */
public final class DragAndDropPermissionsCompat {
    private final DragAndDropPermissions mDragAndDropPermissions;

    @RequiresApi(24)
    /* loaded from: ItsOnFire.jar:androidx/core/view/DragAndDropPermissionsCompat$Api24Impl.class */
