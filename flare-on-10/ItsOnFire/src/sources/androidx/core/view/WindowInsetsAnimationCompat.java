...
/* loaded from: ItsOnFire.jar:androidx/core/view/WindowInsetsAnimationCompat.class */
public final class WindowInsetsAnimationCompat {
    private static final boolean DEBUG = false;
    private static final String TAG = "WindowInsetsAnimCompat";
    private Impl mImpl;

    /* loaded from: ItsOnFire.jar:androidx/core/view/WindowInsetsAnimationCompat$BoundsCompat.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/core/view/WindowInsetsAnimationCompat$Callback.class */
    public static abstract class Callback {
        ...
        /* loaded from: ItsOnFire.jar:androidx/core/view/WindowInsetsAnimationCompat$Callback$DispatchMode.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/core/view/WindowInsetsAnimationCompat$Impl.class */
    ...
    @RequiresApi(21)
    /* loaded from: ItsOnFire.jar:androidx/core/view/WindowInsetsAnimationCompat$Impl21.class */
    public static class Impl21 extends Impl {

        @RequiresApi(21)
        /* loaded from: ItsOnFire.jar:androidx/core/view/WindowInsetsAnimationCompat$Impl21$Impl21OnApplyWindowInsetsListener.class */
        ...
        public static void dispatchOnProgress(@NonNull View view, @NonNull WindowInsetsCompat windowInsetsCompat, @NonNull List<WindowInsetsAnimationCompat> list) {
            ...
            if (view instanceof ViewGroup) {
                ViewGroup viewGroup = (ViewGroup) view;
                for (int i2 = 0; i2 < viewGroup.getChildCount(); i2++) {
                    dispatchOnProgress(viewGroup.getChildAt(i2), windowInsetsCompat2, list);
                }
            }
        }
        ...
        public static WindowInsetsCompat interpolateInsets(WindowInsetsCompat windowInsetsCompat, WindowInsetsCompat windowInsetsCompat2, float f2, int i2) {
            ...
            while (true) {
                ...
                if ((i2 & i4) == 0) {
                    insetInsets = windowInsetsCompat.getInsets(i4);
                } else {
                    Insets insets2 = windowInsetsCompat.getInsets(i4);
                    float f3 = insets2.left - windowInsetsCompat2.getInsets(i4).left;
                    float f4 = 1.0f - f2;
                    insetInsets = WindowInsetsCompat.insetInsets(insets2, (int) ((f3 * f4) + 0.5d), (int) (((insets2.top - insets.top) * f4) + 0.5d), (int) (((insets2.right - insets.right) * f4) + 0.5d), (int) (((insets2.bottom - insets.bottom) * f4) + 0.5d));
                }
    ...
    @RequiresApi(30)
    /* loaded from: ItsOnFire.jar:androidx/core/view/WindowInsetsAnimationCompat$Impl30.class */
    public static class Impl30 extends Impl {
        @NonNull
        private final WindowInsetsAnimation mWrapped;

        @RequiresApi(30)
        /* loaded from: ItsOnFire.jar:androidx/core/view/WindowInsetsAnimationCompat$Impl30$ProxyCallback.class */
