...
/* loaded from: ItsOnFire.jar:androidx/core/view/accessibility/AccessibilityNodeInfoCompat.class */
public class AccessibilityNodeInfoCompat {
    ...
    /* loaded from: ItsOnFire.jar:androidx/core/view/accessibility/AccessibilityNodeInfoCompat$AccessibilityActionCompat.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/core/view/accessibility/AccessibilityNodeInfoCompat$CollectionInfoCompat.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/core/view/accessibility/AccessibilityNodeInfoCompat$CollectionItemInfoCompat.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/core/view/accessibility/AccessibilityNodeInfoCompat$RangeInfoCompat.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/core/view/accessibility/AccessibilityNodeInfoCompat$TouchDelegateInfoCompat.class */
    ...
    private boolean getBooleanProperty(int i2) {
        ...
        if ((extras.getInt(BOOLEAN_PROPERTY_KEY, 0) & i2) == i2) {
            z = true;
        }
        return z;
    }
    ...
    private void setBooleanProperty(int i2, boolean z) {
        Bundle extras = getExtras();
        if (extras != null) {
            extras.putInt(BOOLEAN_PROPERTY_KEY, (z ? i2 : 0) | (extras.getInt(BOOLEAN_PROPERTY_KEY, 0) & i2));
        }
    }
