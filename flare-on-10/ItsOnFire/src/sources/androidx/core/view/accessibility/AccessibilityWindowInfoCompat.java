...
/* loaded from: ItsOnFire.jar:androidx/core/view/accessibility/AccessibilityWindowInfoCompat.class */
public class AccessibilityWindowInfoCompat {
    ...
    @RequiresApi(21)
    /* loaded from: ItsOnFire.jar:androidx/core/view/accessibility/AccessibilityWindowInfoCompat$Api21Impl.class */
    ...
    @RequiresApi(24)
    /* loaded from: ItsOnFire.jar:androidx/core/view/accessibility/AccessibilityWindowInfoCompat$Api24Impl.class */
    ...
    public static AccessibilityWindowInfoCompat obtain(@Nullable AccessibilityWindowInfoCompat accessibilityWindowInfoCompat) {
        return accessibilityWindowInfoCompat == null ? null : wrapNonNullInstance(Api21Impl.obtain((AccessibilityWindowInfo) accessibilityWindowInfoCompat.mInfo));
    }
