...
/* loaded from: ItsOnFire.jar:androidx/core/view/inputmethod/EditorInfoCompat.class */
public final class EditorInfoCompat {
    ...
    @RequiresApi(30)
    /* loaded from: ItsOnFire.jar:androidx/core/view/inputmethod/EditorInfoCompat$Api30Impl.class */
    ...
    private static void trimLongSurroundingText(EditorInfo editorInfo, CharSequence charSequence, int i2, int i3) {
        ...
        CharSequence concat = i5 != i4 ? TextUtils.concat(charSequence.subSequence(i9, i9 + i8), charSequence.subSequence(i3, i10 + i3)) : charSequence.subSequence(i9, i8 + i5 + i10 + i9);
        int i11 = i8 + 0;
        setSurroundingText(editorInfo, concat, i11, i5 + i11);
    }
}
