...
/* loaded from: ItsOnFire.jar:androidx/core/view/inputmethod/InputConnectionCompat.class */
public final class InputConnectionCompat {
    ...
    /* loaded from: ItsOnFire.jar:androidx/core/view/inputmethod/InputConnectionCompat$2.class */
    ...
    @RequiresApi(25)
    /* loaded from: ItsOnFire.jar:androidx/core/view/inputmethod/InputConnectionCompat$Api25Impl.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/core/view/inputmethod/InputConnectionCompat$OnCommitContentListener.class */
    ...
    public static boolean handlePerformPrivateCommand(@Nullable String str, @Nullable Bundle bundle, @NonNull OnCommitContentListener onCommitContentListener) {
        ...
        try {
            ...
            int i2 = bundle.getInt(objArr != null ? COMMIT_CONTENT_FLAGS_INTEROP_KEY : COMMIT_CONTENT_FLAGS_KEY);
            Bundle bundle2 = (Bundle) bundle.getParcelable(objArr != null ? COMMIT_CONTENT_OPTS_INTEROP_KEY : COMMIT_CONTENT_OPTS_KEY);
            boolean z = false;
            if (uri != null) {
                z = false;
                if (clipDescription != null) {
                    z = onCommitContentListener.onCommitContent(new InputContentInfoCompat(uri, clipDescription, uri2), i2, bundle2);
                }
            }
    ...
    public static /* synthetic */ boolean lambda$createOnCommitContentListenerUsingPerformReceiveContent$0(View view, InputContentInfoCompat inputContentInfoCompat, int i2, Bundle bundle) {
        ...
        if ((i2 & 1) != 0) {
            try {
                ...
                bundle3.putParcelable(EXTRA_INPUT_CONTENT_INFO, inputContentInfo);
                bundle2 = bundle3;
            } catch (Exception e2) {
