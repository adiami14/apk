...
/* loaded from: ItsOnFire.jar:androidx/core/widget/CheckedTextViewCompat.class */
public final class CheckedTextViewCompat {
    private static final String TAG = "CheckedTextViewCompat";

    /* loaded from: ItsOnFire.jar:androidx/core/widget/CheckedTextViewCompat$Api14Impl.class */
    ...
    @RequiresApi(16)
    /* loaded from: ItsOnFire.jar:androidx/core/widget/CheckedTextViewCompat$Api16Impl.class */
    ...
    @RequiresApi(21)
    /* loaded from: ItsOnFire.jar:androidx/core/widget/CheckedTextViewCompat$Api21Impl.class */
