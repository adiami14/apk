...
/* loaded from: ItsOnFire.jar:androidx/emoji2/text/ConcurrencyHelpers.class */
class ConcurrencyHelpers {
    private static final int FONT_LOAD_TIMEOUT_SECONDS = 15;

    @RequiresApi(28)
    /* loaded from: ItsOnFire.jar:androidx/emoji2/text/ConcurrencyHelpers$Handler28Impl.class */
