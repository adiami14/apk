...
/* loaded from: ItsOnFire.jar:androidx/emoji2/text/EmojiCompatInitializer.class */
public class EmojiCompatInitializer implements Initializer<Boolean> {
    private static final long STARTUP_THREAD_CREATION_DELAY_MS = 500;
    private static final String S_INITIALIZER_THREAD_NAME = "EmojiCompatInitializer";

    @RequiresApi(19)
    /* loaded from: ItsOnFire.jar:androidx/emoji2/text/EmojiCompatInitializer$BackgroundDefaultConfig.class */
    ...
    @RequiresApi(19)
    /* loaded from: ItsOnFire.jar:androidx/emoji2/text/EmojiCompatInitializer$BackgroundDefaultLoader.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/emoji2/text/EmojiCompatInitializer$LoadEmojiCompatRunnable.class */
