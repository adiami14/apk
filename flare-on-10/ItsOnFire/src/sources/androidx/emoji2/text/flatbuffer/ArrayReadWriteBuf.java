...
/* loaded from: ItsOnFire.jar:androidx/emoji2/text/flatbuffer/ArrayReadWriteBuf.class */
public class ArrayReadWriteBuf implements ReadWriteBuf {
    ...
    public long getLong(int i2) {
        ...
        long j6 = bArr[i6];
        int i8 = i7 + 1;
        return (bArr[i8 + 1] << 56) | (j2 & 255) | ((j3 & 255) << 8) | ((j4 & 255) << 16) | ((j5 & 255) << 24) | ((j6 & 255) << 32) | ((bArr[i7] & 255) << 40) | ((255 & bArr[i8]) << 48);
    }
