...
/* loaded from: ItsOnFire.jar:androidx/emoji2/text/flatbuffer/FlatBufferBuilder.class */
public class FlatBufferBuilder {
    ...
    /* loaded from: ItsOnFire.jar:androidx/emoji2/text/flatbuffer/FlatBufferBuilder$ByteBufferBackedInputStream.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/emoji2/text/flatbuffer/FlatBufferBuilder$ByteBufferFactory.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/emoji2/text/flatbuffer/FlatBufferBuilder$HeapByteBufferFactory.class */
    ...
    public FlatBufferBuilder(int i2, ByteBufferFactory byteBufferFactory, ByteBuffer byteBuffer, Utf8 utf8) {
        ...
        if (byteBuffer != null) {
            ...
            this.bb = byteBufferFactory.newByteBuffer(i3);
        }
        this.utf8 = utf8;
    ...
    public int endTable() {
        ...
        if (i2 != 0) {
            ...
            if (i10 == iArr.length) {
                this.vtables = Arrays.copyOf(iArr, i10 * 2);
            }
    ...
    public void prep(int i2, int i3) {
        ...
        int capacity = ((this.bb.capacity() - this.space) + i3 + 1) & (i2 - 1);
        while (this.space < capacity + i2 + i3) {
