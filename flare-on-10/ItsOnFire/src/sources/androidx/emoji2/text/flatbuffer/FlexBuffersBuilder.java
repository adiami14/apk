...
/* loaded from: ItsOnFire.jar:androidx/emoji2/text/flatbuffer/FlexBuffersBuilder.class */
public class FlexBuffersBuilder {
    ...
    /* loaded from: ItsOnFire.jar:androidx/emoji2/text/flatbuffer/FlexBuffersBuilder$Value.class */
    public static class Value {
        ...
        public static int elemWidth(int i2, int i3, long j2, int i4, int i5) {
            ...
            while (true) {
                ...
                int widthUInBits = FlexBuffersBuilder.widthUInBits((int) (((paddingBytes(i4, i7) + i4) + (i5 * i7)) - j2));
    ...
    private int align(int i2) {
        int i3 = 1 << i2;
        for (int paddingBytes = Value.paddingBytes(this.bb.writePosition(), i3); paddingBytes != 0; paddingBytes--) {
            this.bb.put((byte) 0);
        }
        return i3;
    }
    ...
    private Value createVector(int i2, int i3, int i4, boolean z, boolean z2, Value value) {
        ...
        while (i9 < this.stack.size()) {
            int max2 = Math.max(max, this.stack.get(i9).elemWidth(this.bb.writePosition(), i9 + i5));
            int i10 = i8;
            if (z) {
                i10 = i8;
                if (i9 == i3) {
                    i10 = this.stack.get(i9).type;
        ...
        int writePosition = this.bb.writePosition();
        for (int i11 = i3; i11 < this.stack.size(); i11++) {
            writeAny(this.stack.get(i11), align);
        }
        if (!z) {
            while (i3 < this.stack.size()) {
                this.bb.put(this.stack.get(i3).storedPackedType(max));
                i3++;
            }
        }
        if (value != null) {
        ...
        return new Value(i2, i6, max, writePosition);
    }
