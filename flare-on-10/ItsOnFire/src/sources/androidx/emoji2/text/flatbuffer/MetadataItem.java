...
/* loaded from: ItsOnFire.jar:androidx/emoji2/text/flatbuffer/MetadataItem.class */
public final class MetadataItem extends Table {

    /* loaded from: ItsOnFire.jar:androidx/emoji2/text/flatbuffer/MetadataItem$Vector.class */
    ...
    public int codepoints(int i2) {
        ...
        return __offset != 0 ? this.bb.getInt(__vector(__offset) + (i2 * 4)) : 0;
    }
