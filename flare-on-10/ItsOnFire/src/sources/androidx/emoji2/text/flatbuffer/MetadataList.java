...
/* loaded from: ItsOnFire.jar:androidx/emoji2/text/flatbuffer/MetadataList.class */
public final class MetadataList extends Table {

    /* loaded from: ItsOnFire.jar:androidx/emoji2/text/flatbuffer/MetadataList$Vector.class */
    ...
    public MetadataItem list(MetadataItem metadataItem, int i2) {
        ...
        return __offset != 0 ? metadataItem.__assign(__indirect(__vector(__offset) + (i2 * 4)), this.bb) : null;
    }
