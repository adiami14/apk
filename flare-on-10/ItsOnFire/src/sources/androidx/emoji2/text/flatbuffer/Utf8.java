...
/* loaded from: ItsOnFire.jar:androidx/emoji2/text/flatbuffer/Utf8.class */
public abstract class Utf8 {
    private static Utf8 DEFAULT;

    /* loaded from: ItsOnFire.jar:androidx/emoji2/text/flatbuffer/Utf8$DecodeUtil.class */
    public static class DecodeUtil {
        public static void handleFourBytes(byte b2, byte b3, byte b4, byte b5, char[] cArr, int i2) throws IllegalArgumentException {
            if (isNotTrailingByte(b3) || (((b2 << 28) + (b3 + R.styleable.AppCompatTheme_toolbarNavigationButtonStyle)) >> 30) != 0 || isNotTrailingByte(b4) || isNotTrailingByte(b5)) {
        ...
        private static char lowSurrogate(int i2) {
            return (char) ((i2 & 1023) + CharCompanionObject.MIN_LOW_SURROGATE);
        }
    ...
    /* loaded from: ItsOnFire.jar:androidx/emoji2/text/flatbuffer/Utf8$UnpairedSurrogateException.class */
