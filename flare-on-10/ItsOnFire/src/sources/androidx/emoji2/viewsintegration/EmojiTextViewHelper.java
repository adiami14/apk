...
/* loaded from: ItsOnFire.jar:androidx/emoji2/viewsintegration/EmojiTextViewHelper.class */
public final class EmojiTextViewHelper {
    private final HelperInternal mHelper;

    /* loaded from: ItsOnFire.jar:androidx/emoji2/viewsintegration/EmojiTextViewHelper$HelperInternal.class */
    ...
    @RequiresApi(19)
    /* loaded from: ItsOnFire.jar:androidx/emoji2/viewsintegration/EmojiTextViewHelper$HelperInternal19.class */
        ...
        private InputFilter[] removeEmojiInputFilterIfPresent(@NonNull InputFilter[] inputFilterArr) {
            ...
            while (true) {
                ...
                if (emojiInputFilterPositionArray.indexOfKey(i2) < 0) {
                    inputFilterArr2[i4] = inputFilterArr[i2];
                    i5 = i4 + 1;
                }
                i2++;
                i3 = i5;
    ...
    @RequiresApi(19)
    /* loaded from: ItsOnFire.jar:androidx/emoji2/viewsintegration/EmojiTextViewHelper$SkippingHelper19.class */
