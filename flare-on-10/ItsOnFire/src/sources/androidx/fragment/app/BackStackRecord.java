...
/* loaded from: ItsOnFire.jar:androidx/fragment/app/BackStackRecord.class */
            ...
            if (i5 != 1) {
                if (i5 == 2) {
                    ...
                    if (fragment6 == fragment2) {
                        this.mOps.add(i4, new FragmentTransaction.Op(9, fragment6));
                        i2 = i4 + 1;
                        fragment = null;
                    }
                } else if (i5 != 7) {
                ...
                if (i6 != i4) {
                    for (int i8 = i2; i8 < i3; i8++) {
                        ...
                        for (int i9 = 0; i9 < size2; i9++) {
                            Fragment fragment2 = backStackRecord.mOps.get(i9).mFragment;
