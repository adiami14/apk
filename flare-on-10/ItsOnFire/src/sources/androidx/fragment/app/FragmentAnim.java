...
/* loaded from: ItsOnFire.jar:androidx/fragment/app/FragmentAnim.class */
public class FragmentAnim {

    /* loaded from: ItsOnFire.jar:androidx/fragment/app/FragmentAnim$AnimationOrAnimator.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/fragment/app/FragmentAnim$EndViewTransitionAnimation.class */
    ...
    public static AnimationOrAnimator loadAnimation(@NonNull Context context, @NonNull Fragment fragment, boolean z, boolean z2) {
        ...
        if (viewGroup2 == null || viewGroup2.getLayoutTransition() == null) {
            ...
            if (nextAnim == 0) {
                i3 = nextAnim;
                if (nextTransition != 0) {
                    i3 = transitToAnimResourceId(nextTransition, z);
                }
            }
            if (i3 != 0) {
    ...
    private static int transitToAnimResourceId(int i2, boolean z) {
        return i2 != 4097 ? i2 != 4099 ? i2 != 8194 ? -1 : z ? R.animator.fragment_close_enter : R.animator.fragment_close_exit : z ? R.animator.fragment_fade_enter : R.animator.fragment_fade_exit : z ? R.animator.fragment_open_enter : R.animator.fragment_open_exit;
    }
}
