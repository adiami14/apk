...
/* loaded from: ItsOnFire.jar:androidx/fragment/app/FragmentManager.class */
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    /* loaded from: ItsOnFire.jar:androidx/fragment/app/FragmentManager$BackStackEntry.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/fragment/app/FragmentManager$FragmentIntentSenderContract.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/fragment/app/FragmentManager$FragmentLifecycleCallbacks.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/fragment/app/FragmentManager$LaunchedFragmentInfo.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/fragment/app/FragmentManager$LifecycleAwareResultListener.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/fragment/app/FragmentManager$OnBackStackChangedListener.class */
    public interface OnBackStackChangedListener {
        @MainThread
        void onBackStackChanged();
    }

    /* loaded from: ItsOnFire.jar:androidx/fragment/app/FragmentManager$OpGenerator.class */
    public interface OpGenerator {
        boolean generateOps(@NonNull ArrayList<BackStackRecord> arrayList, @NonNull ArrayList<Boolean> arrayList2);
    }

    /* loaded from: ItsOnFire.jar:androidx/fragment/app/FragmentManager$PopBackStackState.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/fragment/app/FragmentManager$StartEnterTransitionListener.class */
    ...
    private void executeOpsTogether(@NonNull ArrayList<BackStackRecord> arrayList, @NonNull ArrayList<Boolean> arrayList2, int i2, int i3) {
        ...
        if (USE_STATE_MANAGER) {
            ...
            if (z) {
                ...
                i4 = postponePostponableTransactions(arrayList, arrayList2, i2, i3, arraySet);
            ...
            if (i4 == i2 || !z) {
                ...
                if (this.mCurState >= 1) {
                    FragmentTransition.startTransitions(this.mHost.getContext(), this.mContainer, arrayList, arrayList2, i2, i4, true, this.mFragmentTransitionCallback);
                }
                arrayList2 = arrayList2;
                moveToState(this.mCurState, true);
            }
    ...
    private int postponePostponableTransactions(@NonNull ArrayList<BackStackRecord> arrayList, @NonNull ArrayList<Boolean> arrayList2, int i2, int i3, @NonNull ArraySet<Fragment> arraySet) {
        ...
        while (true) {
            ...
            int i7 = i6;
            if (backStackRecord.isPostponed() && !backStackRecord.interactsWith(arrayList, i4 + 1, i3)) {
    ...
    */
    public void attachController(@androidx.annotation.NonNull androidx.fragment.app.FragmentHostCallback<?> r9, @androidx.annotation.NonNull androidx.fragment.app.FragmentContainer r10, @androidx.annotation.Nullable final androidx.fragment.app.Fragment r11) {
        /*
    ...
    public void launchStartIntentSenderForResult(@NonNull Fragment fragment, @SuppressLint({"UnknownNullness"}) IntentSender intentSender, int i2, @Nullable Intent intent, int i3, int i4, int i5, @Nullable Bundle bundle) throws IntentSender.SendIntentException {
        ...
        IntentSenderRequest build = new IntentSenderRequest.Builder(intentSender).setFillInIntent(intent).setFlags(i4, i3).build();
        this.mLaunchedFragments.addLast(new LaunchedFragmentInfo(fragment.mWho, i2));
        if (isLoggingEnabled(2)) {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public void moveToState(@androidx.annotation.NonNull androidx.fragment.app.Fragment r7, int r8) {
        /*
        ...
        if (arrayList != null) {
            ...
            if (size > 0) {
                ...
                while (true) {
                    ...
                    backStackStateArr2[i2] = new BackStackState(this.mBackStack.get(i2));
                    if (isLoggingEnabled(2)) {
