...
/* loaded from: ItsOnFire.jar:androidx/fragment/app/ListFragment.class */
public class ListFragment extends Fragment {
    ...
    /* JADX WARN: Type inference failed for: r0v11, types: [android.widget.TextView, java.lang.CharSequence] */
    /* JADX WARN: Type inference failed for: r0v3, types: [boolean, android.view.View] */
    ...
    private void ensureList() {
        ...
        ?? r0 = view instanceof ListView;
        if (r0 != 0) {
            this.mList = (ListView) r0;
        } else {
            TextView textView = (TextView) r0.findViewById(INTERNAL_EMPTY_ID);
            ...
            this.mProgressContainer = textView.findViewById(INTERNAL_PROGRESS_CONTAINER_ID);
            this.mListContainer = textView.findViewById(INTERNAL_LIST_CONTAINER_ID);
            ?? r02 = textView.findViewById(16908298) instanceof ListView;
            if (r02 == 0) {
            ...
            ListView listView = (ListView) r02;
            this.mList = listView;
            View view2 = this.mEmptyView;
            TextView textView2 = view2;
            if (view2 == null) {
                if (this.mEmptyText != null) {
                    ?? r03 = this.mStandardEmptyView;
                    r03.setText(r03);
                    listView = this.mList;
                    textView2 = this.mStandardEmptyView;
                }
            }
