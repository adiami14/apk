...
/* loaded from: ItsOnFire.jar:androidx/lifecycle/Lifecycling.class */
    ...
    private static int resolveObserverCallbackType(Class<?> cls) {
        ...
        if (generatedConstructor != null) {
            ...
            if (isLifecycleParent(superclass)) {
                ...
                arrayList2 = new ArrayList(sClassToAdapters.get(superclass));
            }
            ...
            while (i2 < length) {
                ...
                } else if (getObserverConstructorType(cls2) == 1) {
                    return 1;
                } else {
                    arrayList = arrayList2;
                    if (arrayList2 == null) {
