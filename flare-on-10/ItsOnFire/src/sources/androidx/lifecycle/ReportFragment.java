...
/* loaded from: ItsOnFire.jar:androidx/lifecycle/ReportFragment.class */
public class ReportFragment extends Fragment {
    private static final String REPORT_FRAGMENT_TAG = "androidx.lifecycle.LifecycleDispatcher.report_fragment_tag";
    private ActivityInitializationListener mProcessListener;

    /* loaded from: ItsOnFire.jar:androidx/lifecycle/ReportFragment$ActivityInitializationListener.class */
    ...
    @RequiresApi(29)
    /* loaded from: ItsOnFire.jar:androidx/lifecycle/ReportFragment$LifecycleCallbacks.class */
