...
/* loaded from: ItsOnFire.jar:androidx/lifecycle/ViewModelProvider.class */
public class ViewModelProvider {
    private static final String DEFAULT_KEY = "androidx.lifecycle.ViewModelProvider.DefaultKey";
    private final Factory mFactory;
    private final ViewModelStore mViewModelStore;

    /* loaded from: ItsOnFire.jar:androidx/lifecycle/ViewModelProvider$AndroidViewModelFactory.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/lifecycle/ViewModelProvider$Factory.class */
    public interface Factory {
        @NonNull
        <T extends ViewModel> T create(@NonNull Class<T> cls);
    }

    /* loaded from: ItsOnFire.jar:androidx/lifecycle/ViewModelProvider$KeyedFactory.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/lifecycle/ViewModelProvider$NewInstanceFactory.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/lifecycle/ViewModelProvider$OnRequeryFactory.class */
