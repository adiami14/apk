...
/* loaded from: ItsOnFire.jar:androidx/lifecycle/WithLifecycleStateKt.class */
public final class WithLifecycleStateKt {
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r0v2, types: [androidx.lifecycle.WithLifecycleStateKt$suspendWithStateAtLeastUnchecked$$inlined$suspendCancellableCoroutine$lambda$1, androidx.lifecycle.LifecycleObserver] */
    @PublishedApi
    @Nullable
    public static final <R> Object suspendWithStateAtLeastUnchecked(@NotNull final Lifecycle lifecycle, @NotNull final Lifecycle.State state, final boolean z, @NotNull final o0 o0Var, @NotNull final Function0<? extends R> function0, @NotNull Continuation<? super R> continuation) {
        ...
        rVar.E();
        final ?? r0 = new LifecycleEventObserver() { // from class: androidx.lifecycle.WithLifecycleStateKt$suspendWithStateAtLeastUnchecked$$inlined$suspendCancellableCoroutine$lambda$1
            ...
            public void onStateChanged(@NotNull LifecycleOwner source, @NotNull Lifecycle.Event event) {
                ...
                if (event != Lifecycle.Event.upTo(state)) {
                    if (event == Lifecycle.Event.ON_DESTROY) {
                        ...
                        qVar.resumeWith(Result.m5849constructorimpl(ResultKt.createFailure(lifecycleDestroyedException)));
                        return;
                    }
                    return;
                }
                ...
                try {
                    ...
                    m5849constructorimpl = Result.m5849constructorimpl(function02.invoke());
                } catch (Throwable th) {
                    Result.Companion companion3 = Result.Companion;
                    m5849constructorimpl = Result.m5849constructorimpl(ResultKt.createFailure(th));
                }
                qVar2.resumeWith(m5849constructorimpl);
            }
        };
        if (z) {
        ...
        rVar.A(new Function1<Throwable, Unit>() { // from class: androidx.lifecycle.WithLifecycleStateKt$suspendWithStateAtLeastUnchecked$$inlined$suspendCancellableCoroutine$lambda$3
            ...
            public final void invoke2(@Nullable Throwable th) {
                ...
                if (o0Var2.isDispatchNeeded(emptyCoroutineContext)) {
                    o0Var.dispatch(emptyCoroutineContext, new Runnable() { // from class: androidx.lifecycle.WithLifecycleStateKt$suspendWithStateAtLeastUnchecked$$inlined$suspendCancellableCoroutine$lambda$3.1
                        @Override // java.lang.Runnable
                        public final void run() {
    ...
    public static final <R> Object withCreated(@NotNull Lifecycle lifecycle, @NotNull Function0<? extends R> function0, @NotNull Continuation<? super R> continuation) {
        R suspendWithStateAtLeastUnchecked;
        ...
        if (!isDispatchNeeded) {
            ...
            if (lifecycle.getCurrentState().compareTo(state) >= 0) {
                suspendWithStateAtLeastUnchecked = function0.invoke();
                return suspendWithStateAtLeastUnchecked;
            }
        }
        suspendWithStateAtLeastUnchecked = suspendWithStateAtLeastUnchecked(lifecycle, state, isDispatchNeeded, q2, new WithLifecycleStateKt$withStateAtLeastUnchecked$2(function0), continuation);
        return suspendWithStateAtLeastUnchecked;
    }
