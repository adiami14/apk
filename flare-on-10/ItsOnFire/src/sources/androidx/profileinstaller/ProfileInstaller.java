...
/* loaded from: ItsOnFire.jar:androidx/profileinstaller/ProfileInstaller.class */
public class ProfileInstaller {
    ...
    /* loaded from: ItsOnFire.jar:androidx/profileinstaller/ProfileInstaller$DiagnosticCode.class */
    public @interface DiagnosticCode {
    }

    /* loaded from: ItsOnFire.jar:androidx/profileinstaller/ProfileInstaller$DiagnosticsCallback.class */
    ...
    @Retention(RetentionPolicy.SOURCE)
    @RestrictTo({RestrictTo.Scope.LIBRARY})
    /* loaded from: ItsOnFire.jar:androidx/profileinstaller/ProfileInstaller$ResultCode.class */
