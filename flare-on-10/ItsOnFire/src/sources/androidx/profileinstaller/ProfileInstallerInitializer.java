...
/* loaded from: ItsOnFire.jar:androidx/profileinstaller/ProfileInstallerInitializer.class */
public class ProfileInstallerInitializer implements Initializer<Result> {
    private static final int DELAY_MS = 5000;

    @RequiresApi(16)
    /* loaded from: ItsOnFire.jar:androidx/profileinstaller/ProfileInstallerInitializer$Choreographer16Impl.class */
    ...
    @RequiresApi(28)
    /* loaded from: ItsOnFire.jar:androidx/profileinstaller/ProfileInstallerInitializer$Handler28Impl.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/profileinstaller/ProfileInstallerInitializer$Result.class */
