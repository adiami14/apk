...
/* loaded from: ItsOnFire.jar:androidx/vectordrawable/graphics/drawable/VectorDrawableCompat.class */
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    /* loaded from: ItsOnFire.jar:androidx/vectordrawable/graphics/drawable/VectorDrawableCompat$VClipPath.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/vectordrawable/graphics/drawable/VectorDrawableCompat$VFullPath.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/vectordrawable/graphics/drawable/VectorDrawableCompat$VGroup.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/vectordrawable/graphics/drawable/VectorDrawableCompat$VObject.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/vectordrawable/graphics/drawable/VectorDrawableCompat$VPath.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/vectordrawable/graphics/drawable/VectorDrawableCompat$VPathRenderer.class */
    ...
    /* loaded from: ItsOnFire.jar:androidx/vectordrawable/graphics/drawable/VectorDrawableCompat$VectorDrawableCompatState.class */
    ...
    @RequiresApi(24)
    /* loaded from: ItsOnFire.jar:androidx/vectordrawable/graphics/drawable/VectorDrawableCompat$VectorDrawableDelegateState.class */
        ...
        while (true) {
            ...
            if (eventType == 2) {
                ...
                if (SHAPE_PATH.equals(name)) {
                    ...
                    vFullPath2.inflate(resources, attributeSet, theme, xmlPullParser);
                    vGroup.mChildren.add(vFullPath2);
                    if (vFullPath2.getPathName() != null) {
                        vPathRenderer.mVGTargetsMap.put(vFullPath2.getPathName(), vFullPath2);
                    }
                    z3 = false;
                ...
                i2 = vectorDrawableCompatState.mChangingConfigurations;
                z = z3;
                i3 = vFullPath.mChangingConfigurations;
                vectorDrawableCompatState.mChangingConfigurations = i3 | i2;
                z2 = z;
            } else {
                z2 = z;
