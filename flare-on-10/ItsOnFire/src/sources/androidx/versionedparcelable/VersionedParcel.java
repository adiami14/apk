...
/* loaded from: ItsOnFire.jar:androidx/versionedparcelable/VersionedParcel.class */
public abstract class VersionedParcel {
    ...
    /* loaded from: ItsOnFire.jar:androidx/versionedparcelable/VersionedParcel$ParcelException.class */
    ...
    public Exception readException(Exception exc, int i2) {
        ...
        if (readField(i2) && (readExceptionCode = readExceptionCode()) != 0) {
    ...
    public <T> void writeArray(T[] tArr) {
        ...
        if (length > 0) {
            ...
            if (type == 1) {
                for (T t2 : tArr) {
                    writeVersionedParcelable((VersionedParcelable) t2);
                }
                return;
            }
            if (type == 2) {
                for (T t3 : tArr) {
                    writeParcelable((Parcelable) t3);
                }
                return;
            }
            if (type == 3) {
                for (T t4 : tArr) {
                    writeSerializable((Serializable) t4);
                }
                return;
            }
            if (type == 4) {
                for (T t5 : tArr) {
                    writeString((String) t5);
                }
                return;
            }
            if (type != 5) {
