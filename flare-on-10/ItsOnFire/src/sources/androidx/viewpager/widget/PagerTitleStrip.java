...
@ViewPager.DecorView
/* loaded from: ItsOnFire.jar:androidx/viewpager/widget/PagerTitleStrip.class */
public class PagerTitleStrip extends ViewGroup {
    ...
    /* loaded from: ItsOnFire.jar:androidx/viewpager/widget/PagerTitleStrip$PageListener.class */
    public class PageListener extends DataSetObserver implements ViewPager.OnPageChangeListener, ViewPager.OnAdapterChangeListener {
        ...
        public void onPageScrolled(int i2, float f2, int i3) {
            ...
            PagerTitleStrip.this.updateTextPositions(i4, f2, false);
        }
    ...
    /* loaded from: ItsOnFire.jar:androidx/viewpager/widget/PagerTitleStrip$SingleLineAllCapsTransform.class */
    ...
    public void updateTextPositions(int i2, float f2, boolean z) {
        ...
        int i9 = ((width - i8) - ((int) (((width - (paddingLeft + i7)) - i8) * f4))) - i7;
        ...
        if (i14 == 16) {
            ...
            textView.layout(i9, i5, i10, textView.getMeasuredHeight() + i5);
        ...
        textView4.layout(i9, i5, i10, textView4.getMeasuredHeight() + i5);
