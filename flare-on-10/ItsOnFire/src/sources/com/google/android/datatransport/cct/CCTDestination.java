...
/* loaded from: ItsOnFire.jar:com/google/android/datatransport/cct/CCTDestination.class */
public final class CCTDestination implements EncodedDestination {
    ...
    public byte[] asByteArray() {
        ...
        return String.format("%s%s%s%s", EXTRAS_VERSION_MARKER, str2, EXTRAS_DELIMITER, str3).getBytes(Charset.forName("UTF-8"));
    }
