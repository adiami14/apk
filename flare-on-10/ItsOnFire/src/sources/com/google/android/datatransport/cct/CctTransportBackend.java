...
/* loaded from: ItsOnFire.jar:com/google/android/datatransport/cct/CctTransportBackend.class */
public final class CctTransportBackend implements TransportBackend {
    ...
    /* loaded from: ItsOnFire.jar:com/google/android/datatransport/cct/CctTransportBackend$HttpRequest.class */
    ...
    /* loaded from: ItsOnFire.jar:com/google/android/datatransport/cct/CctTransportBackend$HttpResponse.class */
    ...
    public BackendResponse send(BackendRequest backendRequest) {
        ...
        try {
            HttpResponse httpResponse = (HttpResponse) Retries.retry(5, new HttpRequest(url2, requestBody, str), new Function() { // from class: com.google.android.datatransport.cct.a
            ...
            return i2 == 200 ? BackendResponse.ok(httpResponse.nextRequestMillis) : (i2 >= 500 || i2 == 404) ? BackendResponse.transientError() : i2 == 400 ? BackendResponse.invalidPayload() : BackendResponse.fatalError();
