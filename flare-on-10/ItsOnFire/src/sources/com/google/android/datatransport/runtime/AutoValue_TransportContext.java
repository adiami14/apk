...
/* loaded from: ItsOnFire.jar:com/google/android/datatransport/runtime/AutoValue_TransportContext.class */
final class AutoValue_TransportContext extends TransportContext {
    private final String backendName;
    private final byte[] extras;
    private final Priority priority;

    /* loaded from: ItsOnFire.jar:com/google/android/datatransport/runtime/AutoValue_TransportContext$Builder.class */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:17:0x0054, code lost:
        if (r3.priority.equals(r0.getPriority()) != false) goto L16;
     */
    /*
    ...
    */
    ...
    public int hashCode() {
        ...
        return this.priority.hashCode() ^ ((((hashCode ^ 1000003) * 1000003) ^ Arrays.hashCode(this.extras)) * 1000003);
    }
}
