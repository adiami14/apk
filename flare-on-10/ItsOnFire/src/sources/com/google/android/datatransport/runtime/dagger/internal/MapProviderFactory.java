...
/* loaded from: ItsOnFire.jar:com/google/android/datatransport/runtime/dagger/internal/MapProviderFactory.class */
public final class MapProviderFactory<K, V> extends AbstractMapFactory<K, V, c<V>> implements Lazy<Map<K, c<V>>> {

    /* loaded from: ItsOnFire.jar:com/google/android/datatransport/runtime/dagger/internal/MapProviderFactory$Builder.class */
