...
/* loaded from: ItsOnFire.jar:com/google/android/datatransport/runtime/firebase/transport/ClientMetrics.class */
public final class ClientMetrics {
    ...
    /* loaded from: ItsOnFire.jar:com/google/android/datatransport/runtime/firebase/transport/ClientMetrics$Builder.class */
    ...
    public GlobalMetrics getGlobalMetrics() {
        ...
        if (globalMetrics == null) {
            globalMetrics2 = GlobalMetrics.getDefaultInstance();
        }
    ...
    public TimeWindow getWindow() {
        ...
        if (timeWindow == null) {
            timeWindow2 = TimeWindow.getDefaultInstance();
        }
        return timeWindow2;
    }
