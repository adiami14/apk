...
/* loaded from: ItsOnFire.jar:com/google/android/datatransport/runtime/scheduling/persistence/AutoValue_PersistedEvent.class */
public final class AutoValue_PersistedEvent extends PersistedEvent {
    ...
    public int hashCode() {
        long j2 = this.id;
        int i2 = (int) (j2 ^ (j2 >>> 32));
        return this.event.hashCode() ^ ((((i2 ^ 1000003) * 1000003) ^ this.transportContext.hashCode()) * 1000003);
    }
