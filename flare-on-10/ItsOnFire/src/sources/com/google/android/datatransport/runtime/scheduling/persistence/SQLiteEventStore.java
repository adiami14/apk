...
@h.f
@WorkerThread
/* loaded from: ItsOnFire.jar:com/google/android/datatransport/runtime/scheduling/persistence/SQLiteEventStore.class */
public class SQLiteEventStore implements EventStore, SynchronizationGuard, ClientHealthMetricsStore {
    ...
    /* loaded from: ItsOnFire.jar:com/google/android/datatransport/runtime/scheduling/persistence/SQLiteEventStore$Function.class */
    public interface Function<T, U> {
        U apply(T t2);
    }

    /* loaded from: ItsOnFire.jar:com/google/android/datatransport/runtime/scheduling/persistence/SQLiteEventStore$Metadata.class */
    ...
    /* loaded from: ItsOnFire.jar:com/google/android/datatransport/runtime/scheduling/persistence/SQLiteEventStore$Producer.class */
    ...
    public ClientMetrics loadClientMetrics() {
        ...
        return (ClientMetrics) inTransaction(new Function() { // from class: com.google.android.datatransport.runtime.scheduling.persistence.v
            ...
            public final Object apply(Object obj) {
                ...
                lambda$loadClientMetrics$20 = SQLiteEventStore.this.lambda$loadClientMetrics$20(r5, hashMap, newBuilder, (SQLiteDatabase) obj);
        ...
        if (iterable.iterator().hasNext()) {
            ...
            inTransaction(new Function() { // from class: com.google.android.datatransport.runtime.scheduling.persistence.q
                ...
                public final Object apply(Object obj) {
                    ...
                    lambda$recordFailure$4 = SQLiteEventStore.this.lambda$recordFailure$4(str, r6, (SQLiteDatabase) obj);
