...
/* loaded from: ItsOnFire.jar:com/google/android/gms/cloudmessaging/zzm.class */
public final class zzm implements ServiceConnection {
    ...
    public final void zza(int i2, @Nullable String str) {
        synchronized (this) {
            zzb(i2, str, null);
        }
    }

    public final void zzb(int i2, @Nullable String str, @Nullable Throwable th) {
        synchronized (this) {
            if (Log.isLoggable("MessengerIpcClient", 3)) {
