...
/* loaded from: ItsOnFire.jar:com/google/android/gms/common/GoogleApiAvailability.class */
            ...
            if (PlatformVersion.isAtLeastO()) {
                ...
                if (str2 == null) {
                    ...
                    if (notificationChannel2 == null) {
                        ...
                        if (!zab2.contentEquals(notificationChannel2.getName())) {
                            notificationChannel2.setName(zab2);
