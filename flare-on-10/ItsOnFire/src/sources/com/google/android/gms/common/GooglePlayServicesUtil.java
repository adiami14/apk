...
/* loaded from: ItsOnFire.jar:com/google/android/gms/common/GooglePlayServicesUtil.class */
public final class GooglePlayServicesUtil extends GooglePlayServicesUtilLight {
    ...
    public static Dialog getErrorDialog(int i2, @NonNull Activity activity, int i3, @Nullable DialogInterface.OnCancelListener onCancelListener) {
        ...
        return GoogleApiAvailability.getInstance().getErrorDialog(activity, i4, i3, onCancelListener);
    }
    ...
    public static boolean showErrorDialogFragment(int i2, @NonNull Activity activity, @Nullable Fragment fragment, int i3, @Nullable DialogInterface.OnCancelListener onCancelListener) {
        ...
        Dialog zaa = googleApiAvailability.zaa(activity, i4, zag.zac(fragment, GoogleApiAvailability.getInstance().getErrorResolutionIntent(activity, i4, GoogleApiAvailabilityLight.TRACKING_SOURCE_DIALOG), i3), onCancelListener);
        if (zaa == null) {
            return false;
        }
