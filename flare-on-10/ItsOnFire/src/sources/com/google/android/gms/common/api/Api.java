...
/* loaded from: ItsOnFire.jar:com/google/android/gms/common/api/Api.class */
public final class Api<O extends ApiOptions> {
    ...
    @VisibleForTesting
    @KeepForSdk
    /* loaded from: ItsOnFire.jar:com/google/android/gms/common/api/Api$AbstractClientBuilder.class */
    ...
    @KeepForSdk
    /* loaded from: ItsOnFire.jar:com/google/android/gms/common/api/Api$AnyClient.class */
    public interface AnyClient {
    }

    @KeepForSdk
    /* loaded from: ItsOnFire.jar:com/google/android/gms/common/api/Api$AnyClientKey.class */
    public static class AnyClientKey<C extends AnyClient> {
    }

    /* loaded from: ItsOnFire.jar:com/google/android/gms/common/api/Api$ApiOptions.class */
    public interface ApiOptions {
        @NonNull
        public static final NoOptions NO_OPTIONS = new NoOptions(null);

        /* loaded from: ItsOnFire.jar:com/google/android/gms/common/api/Api$ApiOptions$HasAccountOptions.class */
        public interface HasAccountOptions extends HasOptions, NotRequiredOptions {
            @NonNull
            Account getAccount();
        }

        /* loaded from: ItsOnFire.jar:com/google/android/gms/common/api/Api$ApiOptions$HasGoogleSignInAccountOptions.class */
        public interface HasGoogleSignInAccountOptions extends HasOptions {
            @Nullable
            GoogleSignInAccount getGoogleSignInAccount();
        }

        /* loaded from: ItsOnFire.jar:com/google/android/gms/common/api/Api$ApiOptions$HasOptions.class */
        public interface HasOptions extends ApiOptions {
        }

        /* loaded from: ItsOnFire.jar:com/google/android/gms/common/api/Api$ApiOptions$NoOptions.class */
        ...
        /* loaded from: ItsOnFire.jar:com/google/android/gms/common/api/Api$ApiOptions$NotRequiredOptions.class */
        public interface NotRequiredOptions extends ApiOptions {
        }

        /* loaded from: ItsOnFire.jar:com/google/android/gms/common/api/Api$ApiOptions$Optional.class */
    ...
    @VisibleForTesting
    @KeepForSdk
    /* loaded from: ItsOnFire.jar:com/google/android/gms/common/api/Api$BaseClientBuilder.class */
    ...
    @KeepForSdk
    /* loaded from: ItsOnFire.jar:com/google/android/gms/common/api/Api$Client.class */
    ...
    @VisibleForTesting
    @KeepForSdk
    /* loaded from: ItsOnFire.jar:com/google/android/gms/common/api/Api$ClientKey.class */
