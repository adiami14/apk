...
@KeepName
/* loaded from: ItsOnFire.jar:com/google/android/gms/common/api/GoogleApiActivity.class */
            ...
            try {
                ...
                if (extras.getBoolean("notify_manager", true)) {
                    ...
                    if (Build.FINGERPRINT.contains("generic")) {
                        str = sb2.concat(" This may occur when resolving Google Play services connection issues on emulators with Google APIs but not Google Play Store.");
                    }
