...
/* loaded from: ItsOnFire.jar:com/google/android/gms/common/api/internal/zaae.class */
public final class zaae extends zap {
    ...
    public static void zad(Activity activity, GoogleApiManager googleApiManager, ApiKey<?> apiKey) {
        ...
        if (zaaeVar == null) {
            zaaeVar2 = new zaae(fragment, googleApiManager, GoogleApiAvailability.getInstance());
        }
        Preconditions.checkNotNull(apiKey, "ApiKey cannot be null");
        zaaeVar2.zad.add(apiKey);
        googleApiManager.zaC(zaaeVar2);
    }
