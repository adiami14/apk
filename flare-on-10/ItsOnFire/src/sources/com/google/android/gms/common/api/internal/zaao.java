...
/* loaded from: ItsOnFire.jar:com/google/android/gms/common/api/internal/zaao.class */
    ...
    public final void zaa() {
        ...
        if (arrayList.isEmpty()) {
            ...
            while (true) {
                ...
                int zab = zalVar.zab(context3, (Api.Client) arrayList2.get(i3));
                i3++;
                i2 = zab;
                if (zab == 0) {
                    i2 = zab;
            ...
            while (true) {
                ...
                int zab2 = zalVar.zab(context, (Api.Client) arrayList.get(i4));
                i4++;
                i2 = zab2;
                if (zab2 != 0) {
                    i2 = zab2;
