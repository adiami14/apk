...
@KeepForSdk
/* loaded from: ItsOnFire.jar:com/google/android/gms/common/data/EntityBuffer.class */
    ...
    public final T get(int i2) {
        ...
        if (i2 >= 0) {
            if (i2 == this.zab.size()) {
                ...
                i3 = (i2 == this.zab.size() - 1 ? ((DataHolder) Preconditions.checkNotNull(this.mDataHolder)).getCount() : this.zab.get(i2 + 1).intValue()) - this.zab.get(i2).intValue();
                if (i3 == 1) {
                    int zaa2 = zaa(i2);
                    int windowIndex = ((DataHolder) Preconditions.checkNotNull(this.mDataHolder)).getWindowIndex(zaa2);
                    String childDataMarkerColumn = getChildDataMarkerColumn();
                    i3 = (childDataMarkerColumn == null || this.mDataHolder.getString(childDataMarkerColumn, zaa2, windowIndex) != null) ? 1 : 0;
                }
            }
        }
