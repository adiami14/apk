...
@KeepForSdk
/* loaded from: ItsOnFire.jar:com/google/android/gms/common/internal/PendingResultUtil.class */
public class PendingResultUtil {
    private static final zas zaa = new zao();

    @KeepForSdk
    /* loaded from: ItsOnFire.jar:com/google/android/gms/common/internal/PendingResultUtil$ResultConverter.class */
