...
/* loaded from: ItsOnFire.jar:com/google/android/gms/internal/measurement/zzae.class */
public final class zzae implements Iterable, zzap, zzal {
    ...
    public final void zzp(int i2) {
        ...
        while (true) {
            int i5 = i3 + 1;
            if (i5 > ((Integer) this.zza.lastKey()).intValue()) {
                return;
            }
            ...
            i3 = i5;
            if (zzapVar != null) {
                this.zza.put(Integer.valueOf(i5 - 1), zzapVar);
