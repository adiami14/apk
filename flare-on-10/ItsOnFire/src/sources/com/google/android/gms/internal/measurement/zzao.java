...
/* loaded from: ItsOnFire.jar:com/google/android/gms/internal/measurement/zzao.class */
    ...
    public final zzap zza(zzg zzgVar, List list) {
        ...
        for (zzap zzapVar2 : this.zzb) {
            ...
            if (zzb instanceof zzaq) {
                zzapVar3 = zza.zzb(zzapVar2);
            }
            if (zzapVar3 instanceof zzag) {
                return ((zzag) zzapVar3).zzb();
            }
        }
        return zzap.zzf;
    }
