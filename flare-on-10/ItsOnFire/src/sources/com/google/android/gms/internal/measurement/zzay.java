...
/* loaded from: ItsOnFire.jar:com/google/android/gms/internal/measurement/zzay.class */
public final class zzay extends zzaw {
    ...
    private static boolean zzd(zzap zzapVar, zzap zzapVar2) {
        ...
        if (i2 == 0 && doubleValue2 == 0.0d) {
            return false;
        }
        return !(i2 == 0 && doubleValue2 == 0.0d) && Double.compare(doubleValue, doubleValue2) < 0;
    }
