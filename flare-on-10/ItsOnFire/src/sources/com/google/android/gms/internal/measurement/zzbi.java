...
/* loaded from: ItsOnFire.jar:com/google/android/gms/internal/measurement/zzbi.class */
    ...
    public final zzap zza(String str, zzg zzgVar, List list) {
        ...
        if (ordinal == 0) {
            ...
            if ((zzb instanceof zzal) || (zzb instanceof zzat) || (zzb2 instanceof zzal) || (zzb2 instanceof zzat)) {
                zzatVar = new zzat(String.valueOf(zzb.zzi()).concat(String.valueOf(zzb2.zzi())));
            } else {
                zzatVar = new zzah(Double.valueOf(zzb.zzh().doubleValue() + zzb2.zzh().doubleValue()));
            }
            return zzatVar;
        } else if (ordinal == 21) {
