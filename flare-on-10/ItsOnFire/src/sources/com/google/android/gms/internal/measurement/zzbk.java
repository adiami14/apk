...
/* loaded from: ItsOnFire.jar:com/google/android/gms/internal/measurement/zzbk.class */
    ...
    public final zzap zza(String str, zzg zzgVar, List list) {
        ...
        if (ordinal == 3) {
            ...
            if ((zzb11 instanceof zzae) && zzh.zzk(zzb12)) {
                zzahVar = ((zzae) zzb11).zze(zzb12.zzh().intValue());
            } else if (zzb11 instanceof zzal) {
                zzahVar = ((zzal) zzb11).zzf(zzb12.zzi());
            } else {
                if (zzb11 instanceof zzat) {
                    if ("length".equals(zzb12.zzi())) {
                        zzahVar = new zzah(Double.valueOf(zzb11.zzi().length()));
                    } else if (zzh.zzk(zzb12) && zzb12.zzh().doubleValue() < zzb11.zzi().length()) {
                        zzahVar = new zzat(String.valueOf(zzb11.zzi().charAt(zzb12.zzh().intValue())));
                    }
                }
                zzahVar = zzap.zzf;
            }
