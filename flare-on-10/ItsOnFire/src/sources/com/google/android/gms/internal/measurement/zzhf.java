...
/* loaded from: ItsOnFire.jar:com/google/android/gms/internal/measurement/zzhf.class */
public final class zzhf implements zzhk {
    ...
    public static zzhf zza(ContentResolver contentResolver, Uri uri, Runnable runnable) {
        ...
        synchronized (zzhf.class) {
            try {
                Map map = zzb;
                zzhf zzhfVar2 = (zzhf) map.get(uri);
                zzhfVar = zzhfVar2;
                if (zzhfVar2 == null) {
                    try {
                        zzhfVar = new zzhf(contentResolver, uri, runnable);
                        try {
                            map.put(uri, zzhfVar);
