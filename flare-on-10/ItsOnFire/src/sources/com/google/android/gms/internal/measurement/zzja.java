...
/* loaded from: ItsOnFire.jar:com/google/android/gms/internal/measurement/zzja.class */
                ...
                if (size == list.size()) {
                    if (list instanceof RandomAccess) {
                        ...
                        while (true) {
                            ...
                            if (i2 >= size) {
                                break;
                            } else if (!zzih.zza(get(i2), list.get(i2))) {
                                break;
                            } else {
                                i2++;
                            }
                        ...
                        while (true) {
                            if (it.hasNext()) {
                                if (!it2.hasNext()) {
                                    break;
                                } else if (!zzih.zza(it.next(), it2.next())) {
                                    break;
                                }
                            } else if (!it2.hasNext()) {
                                z = true;
