...
/* loaded from: ItsOnFire.jar:com/google/android/gms/internal/measurement/zzlb.class */
    ...
    public static zzlb zzbC(Class cls) {
        ...
        if (zzlbVar == null) {
            try {
                ...
                zzlbVar2 = (zzlb) map.get(cls);
            } catch (ClassNotFoundException e2) {
                throw new IllegalStateException("Class initialization cannot fail.", e2);
            }
        }
        zzlb zzlbVar3 = zzlbVar2;
        if (zzlbVar2 == null) {
            zzlbVar3 = (zzlb) ((zzlb) zznu.zze(cls)).zzl(6, null, null);
            if (zzlbVar3 == null) {
                throw new IllegalStateException();
            }
            map.put(cls, zzlbVar3);
        }
        return zzlbVar3;
    }
