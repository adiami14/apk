...
/* loaded from: ItsOnFire.jar:com/google/android/gms/internal/measurement/zzmk.class */
public final class zzmk {
    ...
    private static void zzd(zzmi zzmiVar, StringBuilder sb, int i2) {
        ...
        for (Method method3 : zzmiVar.getClass().getDeclaredMethods()) {
                    ...
                    if (method5 == null) {
                        if (zzbK2 instanceof Boolean) {
                            ...
                            if (zzbK2 instanceof String) {
                                ...
                                zzb(sb, i2, substring2, zzbK2);
                            } else if (zzbK2 != ((zzmi) zzbK2).zzbV()) {
                                zzb(sb, i2, substring2, zzbK2);
                            }
                            if (!zzbK2.equals(zzkaVar)) {
                                zzb(sb, i2, substring2, zzbK2);
                            }
                        } else if (Double.doubleToRawLongBits(((Double) zzbK2).doubleValue()) != 0) {
                            zzb(sb, i2, substring2, zzbK2);
                        }
