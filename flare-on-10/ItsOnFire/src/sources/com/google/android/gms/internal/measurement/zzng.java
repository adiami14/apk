...
/* loaded from: ItsOnFire.jar:com/google/android/gms/internal/measurement/zzng.class */
public class zzng extends AbstractMap {
    ...
    private final int zzk(Comparable comparable) {
        ...
        while (i3 <= i2) {
            int i4 = (i3 + i2) / 2;
            int compareTo2 = comparable.compareTo(((zzna) this.zzb.get(i4)).zza());
            if (compareTo2 < 0) {
                i2 = i4 - 1;
