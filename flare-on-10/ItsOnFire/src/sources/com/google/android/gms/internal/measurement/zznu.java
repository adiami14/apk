...
/* loaded from: ItsOnFire.jar:com/google/android/gms/internal/measurement/zznu.class */
final class zznu {
    ...
    static {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.measurement.zznu.m5523clinit():void");
    }
    ...
    public static Unsafe zzg() {
        Unsafe unsafe;
        try {
            unsafe = (Unsafe) AccessController.doPrivileged(new zznq());
        } catch (Throwable th) {
            unsafe = null;
        }
        return unsafe;
