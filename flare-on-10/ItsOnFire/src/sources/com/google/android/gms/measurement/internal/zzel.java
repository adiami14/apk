...
@VisibleForTesting
/* loaded from: ItsOnFire.jar:com/google/android/gms/measurement/internal/zzel.class */
    ...
    public final SQLiteDatabase getWritableDatabase() throws SQLiteException {
        try {
            ...
            try {
                ...
                this.zza.zzt.zzaA().zzd().zzb("Failed to open local database. Events will bypass local storage", e4);
                return null;
            }
        }
    }
