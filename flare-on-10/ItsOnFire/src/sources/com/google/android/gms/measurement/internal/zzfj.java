...
import j.y0;
/* loaded from: ItsOnFire.jar:com/google/android/gms/measurement/internal/zzfj.class */
                ...
                if (string == null || string.isEmpty()) {
                    ...
                    if (zzs == null) {
                        ...
                        if (zzflVar.zza.zzJ()) {
                            ...
                            zzflVar.zza.zzq().zzF(y0.f624c, Constants.ScionAnalytics.EVENT_FIREBASE_CAMPAIGN, zzs, str);
                        }
                    }
                }
            }
