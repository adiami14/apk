...
/* loaded from: ItsOnFire.jar:com/google/android/gms/measurement/internal/zzgv.class */
public final class zzgv extends zzei {
    ...
    public final byte[] zzu(zzau zzauVar, String str) {
        ...
        try {
            ...
            this.zza.zzaA().zzc().zzd("Log and bundle processed. event, size, time_ms", this.zza.zzi().zzd(zzauVar.zza), Integer.valueOf(bArr2.length), Long.valueOf((this.zza.zzax().nanoTime() / 1000000) - nanoTime));
            return bArr2;
        } catch (InterruptedException | ExecutionException e2) {
    ...
    public final void zzv(zzau zzauVar, zzq zzqVar) {
        ...
        if (zzcVar != null) {
            try {
                ...
                if (zzcVar.zze(new com.google.android.gms.internal.measurement.zzaa(str4, zzauVar.zzd, zzt))) {
                    zzau zzauVar2 = zzauVar;
                    if (zzcVar.zzg()) {
                        this.zza.zzaA().zzj().zzb("EES edited event", zzauVar.zza);
                        zzauVar2 = this.zza.zzu().zzj(zzcVar.zza().zzb());
                    }
                    zzA(zzauVar2, zzqVar);
                    if (zzcVar.zzf()) {
            ...
            } catch (com.google.android.gms.internal.measurement.zzd e2) {
