...
/* loaded from: ItsOnFire.jar:com/google/android/gms/measurement/internal/zzhb.class */
public final class zzhb {
    ...
    public final zzhb zzd(zzhb zzhbVar) {
        ...
        EnumMap enumMap = new EnumMap(zzha.class);
        for (zzha zzhaVar : zzha.values()) {
            Boolean bool2 = (Boolean) this.zzb.get(zzhaVar);
            Boolean bool3 = (Boolean) zzhbVar.zzb.get(zzhaVar);
            if (bool2 == null) {
                bool = bool3;
            } else {
                bool = bool2;
    ...
    public final zzhb zze(zzhb zzhbVar) {
        ...
        for (zzha zzhaVar : zzha.values()) {
            ...
            Boolean bool2 = bool;
            if (bool == null) {
                bool2 = (Boolean) zzhbVar.zzb.get(zzhaVar);
            }
            enumMap.put((EnumMap) zzhaVar, (zzha) bool2);
        }
