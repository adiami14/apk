...
/* loaded from: ItsOnFire.jar:com/google/android/gms/measurement/internal/zzkb.class */
            ...
            try {
                ...
                if (zzi2 > 0) {
                    try {
                        ...
                        if (zzkaVar2 != null) {
                            info = null;
                            if (elapsedRealtime < zzkaVar2.zzc + zzi2) {
                ...
                this.zzt.zzaA().zzc().zzb("Unable to get advertising id", e3);
