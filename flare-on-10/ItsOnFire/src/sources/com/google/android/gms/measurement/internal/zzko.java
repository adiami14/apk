...
/* loaded from: ItsOnFire.jar:com/google/android/gms/measurement/internal/zzko.class */
public final class zzko {
    ...
    public final void zzc(long j2, boolean z) {
        ...
        if (this.zza.zzt.zzJ()) {
            ...
            this.zza.zzt.zzq().zzY(y0.f624c, "_sid", valueOf, j2);
            ...
            this.zza.zzt.zzq().zzH(y0.f624c, "_s", j2, bundle);
            zzos.zzc();
            if (this.zza.zzt.zzf().zzs(null, zzeg.zzae)) {
                ...
                this.zza.zzt.zzq().zzH(y0.f624c, "_ssr", j2, bundle2);
            }
        }
    }
}
