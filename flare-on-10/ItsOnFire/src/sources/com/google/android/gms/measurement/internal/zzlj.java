...
/* loaded from: ItsOnFire.jar:com/google/android/gms/measurement/internal/zzlj.class */
public final class zzlj extends zzku {
    ...
    private final void zzE(StringBuilder sb, int i2, List list) {
        ...
        while (it.hasNext()) {
            ...
            if (zzfxVar != null) {
                ...
                Double d2 = null;
                if (zzfxVar.zzu()) {
                    d2 = Double.valueOf(zzfxVar.zza());
                }
                zzJ(sb, i3, "double_value", d2);
                if (zzfxVar.zzc() > 0) {
    ...
    public static List zzs(BitSet bitSet) {
        ...
        for (int i3 = 0; i3 < length; i3++) {
            long j2 = 0;
            int i4 = 0;
            while (i4 < 64 && (i2 = (i3 * 64) + i4) < bitSet.length()) {
                long j3 = j2;
                if (bitSet.get(i2)) {
                    j3 = j2 | (1 << i4);
                }
    ...
    public static boolean zzw(List list, int i2) {
        return i2 < list.size() * 64 && ((1 << (i2 % 64)) & ((Long) list.get(i2 / 64)).longValue()) != 0;
    }
    ...
    public final zzau zzj(com.google.android.gms.internal.measurement.zzaa zzaaVar) {
        ...
        return new zzau(str, new zzas(zzh), obj2, zzaaVar.zza());
    }
    ...
    public final List zzr(List list, List list2) {
        ...
        while (true) {
            int i2 = size2;
            if (i2 < 0 || ((Long) arrayList.get(i2)).longValue() != 0) {
                break;
            }
            size = i2;
            size2 = i2 - 1;
