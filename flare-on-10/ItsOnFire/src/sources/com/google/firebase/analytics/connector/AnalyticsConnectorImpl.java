...
/* loaded from: ItsOnFire.jar:com/google/firebase/analytics/connector/AnalyticsConnectorImpl.class */
public class AnalyticsConnectorImpl implements AnalyticsConnector {
    ...
    public void logEvent(@NonNull String str, @NonNull String str2, @NonNull Bundle bundle) {
        ...
        if (zzc.zzd(str) && zzc.zzb(str2, bundle2) && zzc.zza(str, str2, bundle2)) {
    ...
    /* JADX WARN: Type inference failed for: r0v20, types: [com.google.firebase.analytics.connector.internal.zze] */
    @Override // com.google.firebase.analytics.connector.AnalyticsConnector
    @NonNull
    @KeepForSdk
    @WorkerThread
    public AnalyticsConnector.AnalyticsConnectorHandle registerAnalyticsConnectorListener(@NonNull final String str, @NonNull AnalyticsConnector.AnalyticsConnectorListener analyticsConnectorListener) {
        ...
        if (zzc.zzd(str) && !zzc(str)) {
            ...
            zzg zzeVar = AppMeasurement.FIAM_ORIGIN.equals(str) ? new zze(appMeasurementSdk, analyticsConnectorListener) : "clx".equals(str) ? new zzg(appMeasurementSdk, analyticsConnectorListener) : null;
            if (zzeVar != null) {
