...
/* loaded from: ItsOnFire.jar:com/google/firebase/components/ComponentRuntime.class */
public class ComponentRuntime implements ComponentContainer, ComponentLoader {
    ...
    /* loaded from: ItsOnFire.jar:com/google/firebase/components/ComponentRuntime$Builder.class */
    ...
    public <T> Provider<T> getProvider(Qualified<T> qualified) {
        ...
        synchronized (this) {
            ...
            provider = (Provider<T>) this.lazyInstanceMap.get(qualified);
        }
        return provider;
    }
