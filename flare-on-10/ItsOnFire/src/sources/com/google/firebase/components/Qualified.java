...
/* loaded from: ItsOnFire.jar:com/google/firebase/components/Qualified.class */
public final class Qualified<T> {
    private final Class<? extends Annotation> qualifier;
    private final Class<T> type;

    /* loaded from: ItsOnFire.jar:com/google/firebase/components/Qualified$Unqualified.class */
