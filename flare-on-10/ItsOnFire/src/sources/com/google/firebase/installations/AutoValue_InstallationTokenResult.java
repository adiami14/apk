...
/* loaded from: ItsOnFire.jar:com/google/firebase/installations/AutoValue_InstallationTokenResult.class */
final class AutoValue_InstallationTokenResult extends InstallationTokenResult {
    private final String token;
    private final long tokenCreationTimestamp;
    private final long tokenExpirationTimestamp;

    /* loaded from: ItsOnFire.jar:com/google/firebase/installations/AutoValue_InstallationTokenResult$Builder.class */
    ...
    public int hashCode() {
        ...
        return ((int) (j3 ^ (j3 >>> 32))) ^ ((((hashCode ^ 1000003) * 1000003) ^ i2) * 1000003);
    }
