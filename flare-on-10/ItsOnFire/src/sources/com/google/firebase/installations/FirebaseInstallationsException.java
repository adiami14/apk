...
/* loaded from: ItsOnFire.jar:com/google/firebase/installations/FirebaseInstallationsException.class */
public class FirebaseInstallationsException extends FirebaseException {
    @NonNull
    private final Status status;

    /* loaded from: ItsOnFire.jar:com/google/firebase/installations/FirebaseInstallationsException$Status.class */
    public enum Status {
        BAD_CONFIG,
        UNAVAILABLE,
        TOO_MANY_REQUESTS
