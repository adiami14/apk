...
@AutoValue
/* loaded from: ItsOnFire.jar:com/google/firebase/installations/local/PersistedInstallationEntry.class */
public abstract class PersistedInstallationEntry {
    @NonNull
    public static PersistedInstallationEntry INSTANCE = builder().build();

    @AutoValue.Builder
    /* loaded from: ItsOnFire.jar:com/google/firebase/installations/local/PersistedInstallationEntry$Builder.class */
