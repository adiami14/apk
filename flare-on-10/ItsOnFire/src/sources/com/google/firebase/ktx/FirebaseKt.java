...
/* loaded from: ItsOnFire.jar:com/google/firebase/ktx/FirebaseKt.class */
public final class FirebaseKt {
    ...
    private static final /* synthetic */ <T extends Annotation> Component<o0> coroutineDispatcher() {
        ...
        Component<o0> build = add.factory(new ComponentFactory() { // from class: com.google.firebase.ktx.FirebaseKt$coroutineDispatcher$1
