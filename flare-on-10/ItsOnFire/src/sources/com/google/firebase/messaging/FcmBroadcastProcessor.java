...
@KeepForSdk
/* loaded from: ItsOnFire.jar:com/google/firebase/messaging/FcmBroadcastProcessor.class */
public class FcmBroadcastProcessor {
    ...
    public Task<Integer> startMessagingService(final Context context, final Intent intent) {
        ...
        return (!z2 || z) ? Tasks.call(this.executor, new Callable() { // from class: com.google.firebase.messaging.c
