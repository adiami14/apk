...
/* loaded from: ItsOnFire.jar:com/google/firebase/messaging/MessagingAnalytics.class */
public class MessagingAnalytics {
    ...
    public static String getMessageId(Bundle bundle) {
        ...
        String str = string;
        if (string == null) {
            str = bundle.getString(Constants.MessagePayloadKeys.MSGID_SERVER);
        }
        return str;
    }
    ...
    public static int getPriority(Bundle bundle) {
        ...
        if (string == null) {
            ...
            str = bundle.getString(Constants.MessagePayloadKeys.PRIORITY_V19);
        }
    ...
    public static void logToScion(String str, Bundle bundle) {
        try {
            ...
            if (composerId != null) {
                bundle3.putString(Constants.ScionAnalytics.PARAM_COMPOSER_ID, composerId);
            }
            ...
            if (analyticsConnector != null) {
                analyticsConnector.logEvent("fcm", str, bundle3);
            } else {
