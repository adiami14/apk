...
/* loaded from: ItsOnFire.jar:com/google/firebase/messaging/RequestDeduplicator.class */
public class RequestDeduplicator {
    private final Executor executor;
    @GuardedBy("this")
    private final Map<String, Task<String>> getTokenRequests = new ArrayMap();

    /* loaded from: ItsOnFire.jar:com/google/firebase/messaging/RequestDeduplicator$GetTokenRequest.class */
