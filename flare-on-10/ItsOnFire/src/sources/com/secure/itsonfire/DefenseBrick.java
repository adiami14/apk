...
/* loaded from: ItsOnFire.jar:com/secure/itsonfire/DefenseBrick.class */
public final class DefenseBrick {
    ...
    public DefenseBrick(int i2, int i3, int i4, int i5, int i6) {
        ...
        float f5 = (i3 * i8) + 1;
        float f6 = i4;
        this.position = new RectF(f5 + (f2 * f6) + f2 + (f2 * f6), (i2 * i7) + 1 + f4, (((i3 * i8) + i8) - 1) + (f2 * f6) + f2 + (f2 * f6), (((i2 * i7) + i7) - 1) + f4);
    }
