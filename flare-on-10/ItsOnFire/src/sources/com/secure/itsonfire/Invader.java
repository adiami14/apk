...
/* loaded from: ItsOnFire.jar:com/secure/itsonfire/Invader.class */
public final class Invader {
    ...
    /* loaded from: ItsOnFire.jar:com/secure/itsonfire/Invader$Companion.class */
    ...
    public Invader(@NotNull Context context, int i2, int i3, int i4, int i5) {
        ...
        float f5 = 100;
        float f6 = i2;
        this.position = new RectF((f4 + f3) * f2, (((i6 / 4) + f3) * f6) + f5, (f2 * (i6 + f3)) + f3, f5 + (f6 * (f3 + (i6 / 4))) + this.height);
        this.speed = 40.0f;
        this.left = 1;
        this.right = 2;
        this.shipMoving = 2;
        ...
        Bitmap decodeResource = BitmapFactory.decodeResource(context.getResources(), d.b.f373c);
        Intrinsics.checkNotNullExpressionValue(decodeResource, "decodeResource(\n        …     R.drawable.invader1)");
        companion.setBitmap1(decodeResource);
        Bitmap decodeResource2 = BitmapFactory.decodeResource(context.getResources(), d.b.f374d);
    ...
    public final boolean takeAim(float f2, float f3, int i2) {
        ...
        boolean z = true;
        if (((f4 <= f5 || f4 >= this.width + f5) && (f2 <= f5 || f2 >= f5 + this.width)) || random.nextInt((numberOfInvaders * 100) / i2) != 0) {
            if (random.nextInt(numberOfInvaders * TextFieldImplKt.AnimationDuration) != 0) {
                z = false;
            }
            return z;
        }
