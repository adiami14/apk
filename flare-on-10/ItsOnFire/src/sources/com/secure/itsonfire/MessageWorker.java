...
/* loaded from: ItsOnFire.jar:com/secure/itsonfire/MessageWorker.class */
public final class MessageWorker extends FirebaseMessagingService {
    ...
    public void onMessageReceived(@NotNull RemoteMessage remoteMessage) {
        ...
        String str = remoteMessage.getData().get(getString(d.e.f401v));
        if (str != null) {
            NotificationManager notificationManager = (NotificationManager) getSystemService("notification");
            NotificationChannel notificationChannel = new NotificationChannel(getString(d.e.C), getString(d.e.y), 4);
            notificationChannel.setDescription(getString(d.e.B));
            Intrinsics.checkNotNull(notificationManager);
            notificationManager.createNotificationChannel(notificationChannel);
            NotificationCompat.Builder builder = new NotificationCompat.Builder(this, getString(d.e.C));
            builder.setSmallIcon(17301595);
            builder.setContentTitle(getString(d.e.N));
            builder.setWhen(System.currentTimeMillis());
            builder.setContentText(getString(d.e.f386g));
    ...
    public void onNewToken(@NotNull String token) {
        ...
        String str = getString(d.e.f387h) + token;
