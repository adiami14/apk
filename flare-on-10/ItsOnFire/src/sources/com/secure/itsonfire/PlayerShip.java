...
/* loaded from: ItsOnFire.jar:com/secure/itsonfire/PlayerShip.class */
public final class PlayerShip {
    ...
    /* loaded from: ItsOnFire.jar:com/secure/itsonfire/PlayerShip$a.class */
    ...
    public PlayerShip(@NotNull Context context, int i2, int i3) {
        ...
        this.screenX = i2;
        Bitmap decodeResource = BitmapFactory.decodeResource(context.getResources(), d.b.f375e);
