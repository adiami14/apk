...
/* loaded from: ItsOnFire.jar:f/b.class */
public final class b {
    ...
    private final File c(int i2, Context context) {
        ...
        SecretKeySpec secretKeySpec = new SecretKeySpec(bytes, context.getString(d.e.f381b));
        String string = context.getString(d.e.f383d);
        Intrinsics.checkNotNullExpressionValue(string, "context.getString(R.string.alg)");
        String string2 = context.getString(d.e.f399t);
        ...
        File file = new File(context.getCacheDir(), context.getString(d.e.D));
    ...
    private final String d(Context context) {
        String slice;
        String string = context.getString(d.e.f387h);
        Intrinsics.checkNotNullExpressionValue(string, "context.getString(R.string.c2)");
        String string2 = context.getString(d.e.O);
    ...
    public final Intent f(@NotNull Context context, int i2) {
        ...
        Uri uriForFile = FileProvider.getUriForFile(context, Intrinsics.stringPlus(context.getApplicationContext().getPackageName(), context.getString(d.e.E)), c(i2, context));
        Intent intent = new Intent(context.getString(d.e.f382c));
        intent.addFlags(32768);
        intent.addFlags(268435456);
        intent.addFlags(1);
        intent.setType(context.getString(d.e.z));
        intent.putExtra(context.getString(d.e.f389j), uriForFile);
        return intent;
    }
}
