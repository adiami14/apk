...
public abstract class a<T> extends v2 implements n2, Continuation<T>, u0 {
    ...
    public a(@NotNull CoroutineContext coroutineContext, boolean z, boolean z2) {
        ...
        this.f429k = coroutineContext.plus(this);
    }
