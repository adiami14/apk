...
/* loaded from: ItsOnFire.jar:j/b3.class */
public final class b3 extends AbstractCoroutineContextElement implements n2 {
    @NotNull

    /* renamed from: j  reason: collision with root package name */
    public static final b3 f446j = new b3();
    @NotNull

    /* renamed from: k  reason: collision with root package name */
    public static final String f447k = "NonCancellable can be used only as an argument for 'withContext', direct usages of its API are prohibited";

    public b3() {
        super(n2.f531b);
    }

    @Deprecated(level = DeprecationLevel.WARNING, message = f447k)
