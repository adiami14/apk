...
/* loaded from: ItsOnFire.jar:j/e.class */
public final class e<T> {

    /* renamed from: b  reason: collision with root package name */
    public static final /* synthetic */ AtomicIntegerFieldUpdater f459b = AtomicIntegerFieldUpdater.newUpdater(e.class, "notCompletedCount");
    @NotNull

    /* renamed from: a  reason: collision with root package name */
    public final c1<T>[] f460a;
    @NotNull
    ...
    /* loaded from: ItsOnFire.jar:j/e$a.class */
    public final class a extends u2 {
        ...
        public final q<List<? extends T>> f461n;
        ...
        public void g0(@Nullable Throwable th) {
            ...
            if (e.f459b.decrementAndGet(e.this) == 0) {
                q<List<? extends T>> qVar = this.f461n;
                c1[] c1VarArr = e.this.f460a;
                ArrayList arrayList = new ArrayList(c1VarArr.length);
                for (c1 c1Var : c1VarArr) {
                    arrayList.add(c1Var.g());
                }
                Result.Companion companion = Result.Companion;
                qVar.resumeWith(Result.m5849constructorimpl(arrayList));
            }
        }
    ...
    /* loaded from: ItsOnFire.jar:j/e$b.class */
    public final class b extends o {
        @NotNull

        /* renamed from: j  reason: collision with root package name */
        public final e<T>.a[] f464j;
        ...
        public String toString() {
            return "DisposeHandlersOnCancel[" + this.f464j + ']';
        }
    }
    ...
    public final Object b(@NotNull Continuation<? super List<? extends T>> continuation) {
        ...
        rVar.E();
        int length = this.f460a.length;
        a[] aVarArr = new a[length];
        for (int i2 = 0; i2 < length; i2++) {
            c1 c1Var = this.f460a[i2];
            c1Var.start();
            a aVar = new a(rVar);
