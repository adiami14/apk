...
/* loaded from: ItsOnFire.jar:j/h.class */
public final class h<T> extends a<T> {
    @NotNull

    /* renamed from: l  reason: collision with root package name */
    public final Thread f485l;
    @Nullable

    /* renamed from: m  reason: collision with root package name */
    public final t1 f486m;
    ...
    public void g0(@Nullable Object obj) {
        Unit unit;
        if (Intrinsics.areEqual(Thread.currentThread(), this.f485l)) {
            return;
        }
        Thread thread = this.f485l;
        b b2 = c.b();
        if (b2 != null) {
            b2.g(thread);
            unit = Unit.INSTANCE;
