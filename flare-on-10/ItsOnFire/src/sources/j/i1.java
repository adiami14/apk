...
/* loaded from: ItsOnFire.jar:j/i1.class */
public final class i1<T> extends q.n0<T> {

    /* renamed from: m  reason: collision with root package name */
    public static final /* synthetic */ AtomicIntegerFieldUpdater f491m = AtomicIntegerFieldUpdater.newUpdater(i1.class, "_decision");
    @NotNull
    ...
    public final boolean A1() {
        ...
        } while (!f491m.compareAndSet(this, 0, 1));
        return true;
    }
    ...
    public void s1(@Nullable Object obj) {
        ...
        intercepted = IntrinsicsKt__IntrinsicsJvmKt.intercepted(this.f2081l);
        q.m.g(intercepted, k0.a(obj, this.f2081l), null, 2, null);
    }
    ...
    public final boolean z1() {
        ...
        } while (!f491m.compareAndSet(this, 0, 2));
        return true;
    }
}
