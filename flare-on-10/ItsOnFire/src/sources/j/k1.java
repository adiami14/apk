...
/* loaded from: ItsOnFire.jar:j/k1.class */
public final class k1 {
    ...
    public static final int f506d = 4;

    /* renamed from: e  reason: collision with root package name */
    public static final int f507e = -1;

    public static final <T> void a(@NotNull j1<? super T> j1Var, int i2) {
        Continuation<? super T> g2 = j1Var.g();
        boolean z = i2 == 4;
        if (z || !(g2 instanceof q.l) || c(i2) != c(j1Var.f493l)) {
            e(j1Var, g2, z);
            return;
        }
        o0 o0Var = ((q.l) g2).f2066m;
    ...
    public static final <T> void e(@NotNull j1<? super T> j1Var, @NotNull Continuation<? super T> continuation, boolean z) {
        ...
        Object m5849constructorimpl = Result.m5849constructorimpl(i2);
        if (!z) {
            continuation.resumeWith(m5849constructorimpl);
            return;
        }
        q.l lVar = (q.l) continuation;
        Continuation<T> continuation2 = lVar.f2067n;
        Object obj = lVar.f2069p;
        CoroutineContext context = continuation2.getContext();
        Object c2 = q.w0.c(context, obj);
        c4<?> g2 = c2 != q.w0.f2100a ? n0.g(continuation2, context, c2) : null;
        try {
            lVar.f2067n.resumeWith(m5849constructorimpl);
