...
/* loaded from: ItsOnFire.jar:j/l2.class */
public final class l2 extends p2 {

    /* renamed from: o  reason: collision with root package name */
    public static final /* synthetic */ AtomicIntegerFieldUpdater f514o = AtomicIntegerFieldUpdater.newUpdater(l2.class, "_invoked");
    @NotNull
    private volatile /* synthetic */ int _invoked = 0;
    @NotNull

    /* renamed from: n  reason: collision with root package name */
    public final Function1<Throwable, Unit> f515n;
    ...
    public void g0(@Nullable Throwable th) {
        if (f514o.compareAndSet(this, 0, 1)) {
            this.f515n.invoke(th);
        }
    }
