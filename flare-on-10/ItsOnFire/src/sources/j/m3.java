...
/* loaded from: ItsOnFire.jar:j/m3.class */
public final class m3<T, R> extends u2 {
    @NotNull

    /* renamed from: n  reason: collision with root package name */
    public final t.f<R> f522n;
    @NotNull

    /* renamed from: o  reason: collision with root package name */
    public final Function2<T, Continuation<? super R>, Object> f523o;
    ...
    public m3(@NotNull t.f<? super R> fVar, @NotNull Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2) {
        this.f522n = fVar;
        this.f523o = function2;
    }

    @Override // j.g0
    public void g0(@Nullable Throwable th) {
        if (this.f522n.i()) {
            h0().g1(this.f522n, this.f523o);
        }
    }
