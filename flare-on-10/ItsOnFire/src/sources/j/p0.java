...
/* loaded from: ItsOnFire.jar:j/p0.class */
public interface p0 extends CoroutineContext.Element {
    @NotNull

    /* renamed from: a  reason: collision with root package name */
    public static final b f538a = b.f539j;

    @Metadata(k = 3, mv = {1, 6, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
    /* loaded from: ItsOnFire.jar:j/p0$a.class */
    ...
    /* loaded from: ItsOnFire.jar:j/p0$b.class */
    public static final class b implements CoroutineContext.Key<p0> {

        /* renamed from: j  reason: collision with root package name */
        public static final /* synthetic */ b f539j = new b();
    }
