...
/* loaded from: ItsOnFire.jar:j/t0.class */
public final class t0 extends AbstractCoroutineContextElement {
    @NotNull

    /* renamed from: k  reason: collision with root package name */
    public static final a f557k = new a(null);
    @NotNull
    ...
    /* loaded from: ItsOnFire.jar:j/t0$a.class */
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return (obj instanceof t0) && Intrinsics.areEqual(this.f558j, ((t0) obj).f558j);
    }

    public int hashCode() {
        return this.f558j.hashCode();
    }
    ...
    public String toString() {
        return "CoroutineName(" + this.f558j + ')';
    }
