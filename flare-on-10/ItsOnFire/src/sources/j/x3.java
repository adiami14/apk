...
/* loaded from: ItsOnFire.jar:j/x3.class */
public final class x3 implements Function1<Throwable, Unit> {

    /* renamed from: m  reason: collision with root package name */
    public static final /* synthetic */ AtomicIntegerFieldUpdater f618m = AtomicIntegerFieldUpdater.newUpdater(x3.class, "_state");
    @NotNull

    /* renamed from: j  reason: collision with root package name */
    public final n2 f619j;
    @Nullable
    ...
    public final Thread f620k = Thread.currentThread();
    ...
    public final void a() {
        while (true) {
            ...
            } else if (f618m.compareAndSet(this, i2, 1)) {
                p1 p1Var = this.f621l;
                if (p1Var != null) {
                    p1Var.dispose();
                    return;
    ...
    public void c(@Nullable Throwable th) {
        ...
        } while (!f618m.compareAndSet(this, i2, 2));
        this.f620k.interrupt();
        this._state = 3;
    }

    public final void d() {
        int i2;
        this.f621l = this.f619j.r(true, true, this);
        do {
            i2 = this._state;
            if (i2 != 0) {
                if (i2 == 2 || i2 == 3) {
        ...
        } while (!f618m.compareAndSet(this, i2, 0));
    }
