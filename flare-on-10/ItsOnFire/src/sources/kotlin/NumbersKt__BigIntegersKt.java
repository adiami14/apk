...
/* loaded from: ItsOnFire.jar:kotlin/NumbersKt__BigIntegersKt.class */
class NumbersKt__BigIntegersKt extends NumbersKt__BigDecimalsKt {
    ...
    public static /* synthetic */ BigDecimal toBigDecimal$default(BigInteger bigInteger, int i2, MathContext UNLIMITED, int i3, Object obj) {
        if ((i3 & 1) != 0) {
            i2 = 0;
        }
        if ((i3 & 2) != 0) {
        ...
        Intrinsics.checkNotNullParameter(mathContext, "mathContext");
        return new BigDecimal(bigInteger, i2, UNLIMITED);
    }
