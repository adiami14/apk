...
/* loaded from: ItsOnFire.jar:kotlin/UByteArrayKt.class */
public final class UByteArrayKt {
    ...
    private static final byte[] UByteArray(int i2, Function1<? super Integer, UByte> init) {
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            bArr[i3] = init.invoke(Integer.valueOf(i3)).m5918unboximpl();
        }
        return UByteArray.m5921constructorimpl(bArr);
    }
    ...
    private static final byte[] m5937ubyteArrayOfGBYM_sE(byte... elements) {
