...
/* loaded from: ItsOnFire.jar:kotlin/ULongArrayKt.class */
public final class ULongArrayKt {
    ...
    private static final long[] ULongArray(int i2, Function1<? super Integer, ULong> init) {
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            jArr[i3] = init.invoke(Integer.valueOf(i3)).m6076unboximpl();
        }
        return ULongArray.m6079constructorimpl(jArr);
    }
    ...
    private static final long[] m6095ulongArrayOfQwZRm1k(long... elements) {
