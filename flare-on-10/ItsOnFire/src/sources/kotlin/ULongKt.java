...
/* loaded from: ItsOnFire.jar:kotlin/ULongKt.class */
public final class ULongKt {
    @SinceKotlin(version = "1.5")
    @WasExperimental(markerClass = {ExperimentalUnsignedTypes.class})
    @InlineOnly
    private static final long toULong(byte b2) {
        return ULong.m6025constructorimpl(b2);
    }
    ...
    private static final long toULong(int i2) {
        return ULong.m6025constructorimpl(i2);
    }
    ...
    private static final long toULong(long j2) {
        return ULong.m6025constructorimpl(j2);
    }
    ...
    private static final long toULong(short s2) {
        return ULong.m6025constructorimpl(s2);
    }
}
