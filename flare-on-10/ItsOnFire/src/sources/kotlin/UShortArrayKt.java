...
/* loaded from: ItsOnFire.jar:kotlin/UShortArrayKt.class */
public final class UShortArrayKt {
    ...
    private static final short[] UShortArray(int i2, Function1<? super Integer, UShort> init) {
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            sArr[i3] = init.invoke(Integer.valueOf(i3)).m6182unboximpl();
        }
        return UShortArray.m6185constructorimpl(sArr);
    }
    ...
    private static final short[] m6201ushortArrayOfrL5Bavg(short... elements) {
