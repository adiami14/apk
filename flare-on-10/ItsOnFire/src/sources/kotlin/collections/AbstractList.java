...
/* loaded from: ItsOnFire.jar:kotlin/collections/AbstractList.class */
public abstract class AbstractList<E> extends AbstractCollection<E> implements List<E>, KMappedMarker {
    ...
    /* loaded from: ItsOnFire.jar:kotlin/collections/AbstractList$Companion.class */
    public static final class Companion {
        ...
        public final int orderedHashCode$kotlin_stdlib(@NotNull Collection<?> c2) {
            ...
            while (true) {
                ...
                Object next = it.next();
                i2 = (i3 * 31) + (next != null ? next.hashCode() : 0);
            }
        }
    }
    ...
    /* loaded from: ItsOnFire.jar:kotlin/collections/AbstractList$IteratorImpl.class */
    ...
    /* loaded from: ItsOnFire.jar:kotlin/collections/AbstractList$ListIteratorImpl.class */
    ...
    /* loaded from: ItsOnFire.jar:kotlin/collections/AbstractList$SubList.class */
    ...
    public int indexOf(E e2) {
        ...
        while (true) {
            if (!it.hasNext()) {
                i2 = -1;
                break;
            } else if (Intrinsics.areEqual(it.next(), e2)) {
                break;
            } else {
                i2++;
            }
    ...
    public int lastIndexOf(E e2) {
        ...
        while (true) {
            if (!listIterator.hasPrevious()) {
                i2 = -1;
                break;
            } else if (Intrinsics.areEqual(listIterator.previous(), e2)) {
