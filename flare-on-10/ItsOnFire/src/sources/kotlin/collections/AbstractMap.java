...
/* loaded from: ItsOnFire.jar:kotlin/collections/AbstractMap.class */
public abstract class AbstractMap<K, V> implements Map<K, V>, KMappedMarker {
    ...
    /* loaded from: ItsOnFire.jar:kotlin/collections/AbstractMap$Companion.class */
    public static final class Companion {
        ...
        public final boolean entryEquals$kotlin_stdlib(@NotNull Map.Entry<?, ?> e2, @Nullable Object obj) {
            ...
            if (obj instanceof Map.Entry) {
                ...
                boolean z = false;
                if (Intrinsics.areEqual(e2.getKey(), entry.getKey())) {
                    z = false;
                    if (Intrinsics.areEqual(e2.getValue(), entry.getValue())) {
                        z = true;
                    }
                }
                return z;
    ...
    public boolean containsValue(Object obj) {
        ...
        if (!(entrySet instanceof Collection) || !entrySet.isEmpty()) {
            ...
            while (true) {
                ...
                if (!it.hasNext()) {
                    break;
                } else if (Intrinsics.areEqual(((Map.Entry) it.next()).getValue(), obj)) {
                    z = true;
                    break;
                }
            }
        ...
        if (obj instanceof Map) {
            ...
            if (!(entrySet instanceof Collection) || !entrySet.isEmpty()) {
                ...
                while (true) {
                    ...
                    if (!it.hasNext()) {
                        break;
                    } else if (!containsEntry$kotlin_stdlib((Map.Entry) it.next())) {
                        z = false;
                        break;
                    }
                }
