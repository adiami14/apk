...
/* loaded from: ItsOnFire.jar:kotlin/collections/ArrayDeque.class */
public final class ArrayDeque<E> extends AbstractMutableList<E> {
    ...
    /* loaded from: ItsOnFire.jar:kotlin/collections/ArrayDeque$Companion.class */
    public static final class Companion {
        ...
        public final int newCapacity$kotlin_stdlib(int i2, int i3) {
            ...
            if (i5 - ArrayDeque.maxArraySize > 0) {
                int i7 = ArrayDeque.maxArraySize;
        ...
        if (!isEmpty()) {
            if (this.elementData.length == 0) {
                ...
                if (i2 < positiveMod2) {
                    ...
                    ArraysKt___ArraysJvmKt.fill(this.elementData, (Object) null, i3, positiveMod2);
                    positiveMod = i3;
                } else {
                    int length = this.elementData.length;
                    z = false;
    ...
    public boolean addAll(int i2, @NotNull Collection<? extends E> elements) {
            ...
            if (positiveMod2 < positiveMod) {
                ...
                if (i4 > objArr.length) {
                    if (i3 >= objArr.length) {
                        ...
                        ArraysKt___ArraysJvmKt.copyInto(objArr, objArr, 0, length, positiveMod);
                        Object[] objArr2 = this.elementData;
                        ArraysKt___ArraysJvmKt.copyInto(objArr2, objArr2, i3, positiveMod2, length);
                    }
                }
                ArraysKt___ArraysJvmKt.copyInto(objArr, objArr, i3, positiveMod2, positiveMod);
            } else {
                Object[] objArr3 = this.elementData;
                ArraysKt___ArraysJvmKt.copyInto(objArr3, objArr3, size, 0, positiveMod);
                Object[] objArr4 = this.elementData;
                if (i3 >= objArr4.length) {
                    ArraysKt___ArraysJvmKt.copyInto(objArr4, objArr4, i3 - objArr4.length, positiveMod2, objArr4.length);
                } else {
                    ArraysKt___ArraysJvmKt.copyInto(objArr4, objArr4, 0, objArr4.length - size, objArr4.length);
                    Object[] objArr5 = this.elementData;
                    ArraysKt___ArraysJvmKt.copyInto(objArr5, objArr5, i3, positiveMod2, objArr5.length - size);
                }
            }
        ...
        if (positiveMod2 < i5) {
            ...
            ArraysKt___ArraysJvmKt.copyInto(objArr6, objArr6, i6, i5, objArr6.length);
            Object[] objArr7 = this.elementData;
            if (size >= positiveMod2) {
                ArraysKt___ArraysJvmKt.copyInto(objArr7, objArr7, objArr7.length - size, 0, positiveMod2);
            } else {
                ArraysKt___ArraysJvmKt.copyInto(objArr7, objArr7, objArr7.length - size, 0, size);
                Object[] objArr8 = this.elementData;
                ArraysKt___ArraysJvmKt.copyInto(objArr8, objArr8, 0, size, positiveMod2);
            }
        } else if (i6 >= 0) {
            Object[] objArr9 = this.elementData;
            ArraysKt___ArraysJvmKt.copyInto(objArr9, objArr9, i6, i5, positiveMod2);
        } else {
            Object[] objArr10 = this.elementData;
            i6 += objArr10.length;
            int length2 = objArr10.length - i6;
            if (length2 >= positiveMod2 - i5) {
                ArraysKt___ArraysJvmKt.copyInto(objArr10, objArr10, i6, i5, positiveMod2);
            } else {
                ArraysKt___ArraysJvmKt.copyInto(objArr10, objArr10, i6, i5, i5 + length2);
                Object[] objArr11 = this.elementData;
                ArraysKt___ArraysJvmKt.copyInto(objArr11, objArr11, 0, this.head + length2, positiveMod2);
            }
        }
        this.head = i6;
    ...
    public final E firstOrNull() {
        return (E) (isEmpty() ? null : this.elementData[this.head]);
    }
        ...
        if (i3 < positiveMod) {
            ...
            while (true) {
                ...
                if (-1 >= positiveMod) {
                    ...
                    i2 = positiveMod + this.elementData.length;
                    break;
                }
            }
        }
    ...
    public final E lastOrNull() {
        ...
        if (isEmpty()) {
            ...
            int i2 = this.head;
            lastIndex = CollectionsKt__CollectionsKt.getLastIndex(this);
            obj = objArr[positiveMod(i2 + lastIndex)];
        }
        return (E) obj;
    }
