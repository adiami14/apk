...
/* loaded from: ItsOnFire.jar:kotlin/collections/CollectionsKt__CollectionsJVMKt.class */
public class CollectionsKt__CollectionsJVMKt {
    ...
    public static final <T> Object[] copyToArrayOfAny(@NotNull T[] tArr, boolean z) {
        ...
        if (!z || !Intrinsics.areEqual(tArr.getClass(), Object[].class)) {
            ...
            Intrinsics.checkNotNullExpressionValue(tArr, "copyOf(this, this.size, Array<Any?>::class.java)");
        }
        return tArr;
    }
