...
/* loaded from: ItsOnFire.jar:kotlin/collections/CollectionsKt__MutableCollectionsKt.class */
public class CollectionsKt__MutableCollectionsKt extends CollectionsKt__MutableCollectionsJVMKt {
    ...
    public static <T> boolean removeAll(@NotNull Collection<? super T> collection, @NotNull T[] elements) {
        ...
        if (!(elements.length == 0)) {
            z = false;
            if (collection.removeAll(BrittleContainsOptimizationKt.convertToSetForSetOperation(elements))) {
                z = true;
            }
        }
        return z;
