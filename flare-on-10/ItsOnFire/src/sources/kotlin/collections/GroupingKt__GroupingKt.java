...
/* loaded from: ItsOnFire.jar:kotlin/collections/GroupingKt__GroupingKt.class */
class GroupingKt__GroupingKt extends GroupingKt__GroupingJVMKt {
    ...
    public static final <T, K, R> Map<K, R> fold(@NotNull Grouping<T, ? extends K> grouping, R r2, @NotNull Function2<? super R, ? super T, ? extends R> operation) {
        ...
        while (sourceIterator.hasNext()) {
            ...
            R r3 = linkedHashMap.get(keyOf);
            if (r3 == null && !linkedHashMap.containsKey(keyOf)) {
                r3 = r2;
            }
            linkedHashMap.put(keyOf, operation.invoke(r3, next));
        }
        return linkedHashMap;
    }
    ...
    public static final <T, K, R, M extends Map<? super K, R>> M foldTo(@NotNull Grouping<T, ? extends K> grouping, @NotNull M destination, R r2, @NotNull Function2<? super R, ? super T, ? extends R> operation) {
        ...
        while (sourceIterator.hasNext()) {
            T next = sourceIterator.next();
            K keyOf = grouping.keyOf(next);
            R r3 = destination.get(keyOf);
            if (r3 == null && !destination.containsKey(keyOf)) {
                r3 = r2;
            }
            destination.put(keyOf, operation.invoke(r3, next));
        }
        return destination;
    }
    ...
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r0v2, types: [java.util.LinkedHashMap, java.util.Map, java.util.Map<K, S>] */
