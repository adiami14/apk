...
/* loaded from: ItsOnFire.jar:kotlin/collections/MapsKt__MapsKt.class */
public class MapsKt__MapsKt extends MapsKt__MapsJVMKt {
    ...
    public static <K, V> Map<K, V> mapOf(@NotNull Pair<? extends K, ? extends V>... pairs) {
        ...
        if (pairs.length > 0) {
            mapCapacity = MapsKt__MapsJVMKt.mapCapacity(pairs.length);
            map = toMap(pairs, new LinkedHashMap(mapCapacity));
        } else {
            emptyMap = emptyMap();
            map = emptyMap;
        }
    ...
    public static <K, V> Map<K, V> toMap(@NotNull Iterable<? extends Pair<? extends K, ? extends V>> iterable) {
        ...
        if (iterable instanceof Collection) {
            ...
            if (size == 0) {
                ...
                map = toMap(iterable, new LinkedHashMap(mapCapacity));
            } else {
    ...
    public static final <K, V> Map<K, V> toMap(@NotNull Map<? extends K, ? extends V> map) {
        ...
        if (size == 0) {
            ...
            map2 = MapsKt__MapsJVMKt.toSingletonMap(map);
        }
        return map2;
    }
    ...
    public static <K, V> Map<K, V> toMap(@NotNull Pair<? extends K, ? extends V>[] pairArr) {
        ...
        if (length == 0) {
            ...
            map = toMap(pairArr, new LinkedHashMap(mapCapacity));
        } else {
            map = MapsKt__MapsJVMKt.mapOf(pairArr[0]);
        }
        return map;
    }
