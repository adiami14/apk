...
/* loaded from: ItsOnFire.jar:kotlin/collections/builders/ListBuilder.class */
public final class ListBuilder<E> extends AbstractMutableList<E> implements List<E>, RandomAccess, Serializable, KMutableList {
    ...
    /* loaded from: ItsOnFire.jar:kotlin/collections/builders/ListBuilder$Itr.class */
    ...
    private final E removeAtInternal(int i2) {
        ListBuilder<E> listBuilder = this.backing;
        if (listBuilder != null) {
            E removeAtInternal = listBuilder.removeAtInternal(i2);
            this.length--;
    ...
    public List<E> subList(int i2, int i3) {
        ...
        return new ListBuilder(eArr, i4 + i2, i3 - i2, z, this, listBuilder);
    }
