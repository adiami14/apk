...
/* loaded from: ItsOnFire.jar:kotlin/collections/builders/MapBuilder.class */
public final class MapBuilder<K, V> implements Map<K, V>, Serializable, KMutableMap {
    ...
    /* loaded from: ItsOnFire.jar:kotlin/collections/builders/MapBuilder$Companion.class */
    ...
    /* loaded from: ItsOnFire.jar:kotlin/collections/builders/MapBuilder$EntriesItr.class */
    ...
    /* loaded from: ItsOnFire.jar:kotlin/collections/builders/MapBuilder$EntryRef.class */
    ...
    /* loaded from: ItsOnFire.jar:kotlin/collections/builders/MapBuilder$Itr.class */
    ...
    /* loaded from: ItsOnFire.jar:kotlin/collections/builders/MapBuilder$KeysItr.class */
    ...
    /* loaded from: ItsOnFire.jar:kotlin/collections/builders/MapBuilder$ValuesItr.class */
    ...
    private final void compact() {
        ...
        ListBuilderKt.resetRange(this.keysArray, i2, i3);
        if (vArr != null) {
            ListBuilderKt.resetRange(vArr, i2, this.length);
        }
        this.length = i2;
    }
    ...
    private final void ensureCapacity(int i2) {
        ...
        if (i2 > getCapacity()) {
            ...
            V[] vArr = this.valuesArray;
            this.valuesArray = vArr != null ? ListBuilderKt.copyOfUninitializedElements(vArr, i2) : null;
    ...
    private final int findValue(V v2) {
        ...
        while (true) {
            ...
            if (this.presenceArray[i3] >= 0) {
                ...
                i2 = i3;
                if (Intrinsics.areEqual(vArr[i3], v2)) {
                    return i3;
                }
            }
        }
    ...
    private final void removeHashAt(int i2) {
        ...
        do {
            ...
            if (i9 < 0) {
                ...
                i3 = i7;
                i6 = i8;
                if (((hash(this.keysArray[i10]) - i2) & (getHashSize() - 1)) >= i8) {
    ...
    public int hashCode() {
        ...
        while (true) {
            ...
            i2 = i3 + entriesIterator$kotlin_stdlib.nextHashCode$kotlin_stdlib();
        }
    }
