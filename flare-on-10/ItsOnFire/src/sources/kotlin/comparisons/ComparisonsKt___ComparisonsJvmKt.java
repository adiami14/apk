...
/* loaded from: ItsOnFire.jar:kotlin/comparisons/ComparisonsKt___ComparisonsJvmKt.class */
public class ComparisonsKt___ComparisonsJvmKt extends ComparisonsKt__ComparisonsKt {
    ...
    public static final byte maxOf(byte b2, @NotNull byte... other) {
        ...
        while (i2 < length) {
            i2++;
            b3 = (byte) Math.max((int) b3, (int) other[i2]);
        }
        return b3;
    }
    ...
    public static final short maxOf(short s2, @NotNull short... other) {
        ...
        while (i2 < length) {
            i2++;
            s3 = (short) Math.max((int) s3, (int) other[i2]);
        }
        return s3;
    }
    ...
    public static final byte minOf(byte b2, @NotNull byte... other) {
        ...
        while (i2 < length) {
            i2++;
            b3 = (byte) Math.min((int) b3, (int) other[i2]);
        }
        return b3;
    }
    ...
    public static final short minOf(short s2, @NotNull short... other) {
        ...
        while (i2 < length) {
            i2++;
            s3 = (short) Math.min((int) s3, (int) other[i2]);
        }
        return s3;
    }
}
