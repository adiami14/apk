...
/* loaded from: ItsOnFire.jar:kotlin/coroutines/ContinuationInterceptor.class */
public interface ContinuationInterceptor extends CoroutineContext.Element {
    @NotNull
    public static final Key Key = Key.$$INSTANCE;

    @Metadata(k = 3, mv = {1, 7, 1}, xi = R.styleable.AppCompatTheme_checkboxStyle)
    /* loaded from: ItsOnFire.jar:kotlin/coroutines/ContinuationInterceptor$DefaultImpls.class */
    ...
    /* loaded from: ItsOnFire.jar:kotlin/coroutines/ContinuationInterceptor$Key.class */
