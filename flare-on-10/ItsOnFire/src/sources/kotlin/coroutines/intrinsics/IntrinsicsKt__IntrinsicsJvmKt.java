...
/* loaded from: ItsOnFire.jar:kotlin/coroutines/intrinsics/IntrinsicsKt__IntrinsicsJvmKt.class */
public class IntrinsicsKt__IntrinsicsJvmKt {
    ...
    public static <T> Continuation<Unit> createCoroutineUnintercepted(@NotNull final Function1<? super Continuation<? super T>, ? extends Object> function1, @NotNull Continuation<? super T> completion) {
        ...
        if (function1 instanceof BaseContinuationImpl) {
            continuation = ((BaseContinuationImpl) function1).create(probeCoroutineCreated);
        } else {
            final CoroutineContext context = probeCoroutineCreated.getContext();
            continuation = context == EmptyCoroutineContext.INSTANCE ? new RestrictedContinuationImpl(probeCoroutineCreated, function1) { // from class: kotlin.coroutines.intrinsics.IntrinsicsKt__IntrinsicsJvmKt$createCoroutineUnintercepted$$inlined$createCoroutineFromSuspendFunction$IntrinsicsKt__IntrinsicsJvmKt$1
                ...
                public Object invokeSuspend(@NotNull Object obj) {
                    ...
                    if (i2 == 0) {
                        ...
                        obj = ((Function1) TypeIntrinsics.beforeCheckcastToFunctionOfArity(this.$this_createCoroutineUnintercepted$inlined, 1)).invoke(this);
                    } else if (i2 != 1) {
                        throw new IllegalStateException("This coroutine had already completed".toString());
                    } else {
                        this.label = 2;
    ...
    public static <R, T> Continuation<Unit> createCoroutineUnintercepted(@NotNull final Function2<? super R, ? super Continuation<? super T>, ? extends Object> function2, final R r2, @NotNull Continuation<? super T> completion) {
        ...
        if (function2 instanceof BaseContinuationImpl) {
            continuation = ((BaseContinuationImpl) function2).create(r2, probeCoroutineCreated);
        } else {
            final CoroutineContext context = probeCoroutineCreated.getContext();
            continuation = context == EmptyCoroutineContext.INSTANCE ? new RestrictedContinuationImpl(probeCoroutineCreated, function2, r2) { // from class: kotlin.coroutines.intrinsics.IntrinsicsKt__IntrinsicsJvmKt$createCoroutineUnintercepted$$inlined$createCoroutineFromSuspendFunction$IntrinsicsKt__IntrinsicsJvmKt$3
                ...
                public Object invokeSuspend(@NotNull Object obj) {
                    ...
                    if (i2 == 0) {
                        ...
                        obj = ((Function2) TypeIntrinsics.beforeCheckcastToFunctionOfArity(this.$this_createCoroutineUnintercepted$inlined, 2)).invoke(this.$receiver$inlined, this);
                    } else if (i2 != 1) {
                        throw new IllegalStateException("This coroutine had already completed".toString());
                    } else {
                        this.label = 2;
    ...
    public static <T> Continuation<T> intercepted(@NotNull Continuation<? super T> continuation) {
        ...
        return (Continuation<T>) continuation2;
    }
