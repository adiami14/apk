...
/* loaded from: ItsOnFire.jar:kotlin/coroutines/jvm/internal/BaseContinuationImpl.class */
public abstract class BaseContinuationImpl implements Continuation<Object>, CoroutineStackFrame, Serializable {
    ...
    /* JADX WARN: Type inference failed for: r0v5, types: [kotlin.coroutines.Continuation<java.lang.Object>] */
    ...
    public final void resumeWith(@NotNull Object obj) {
        ...
        do {
            ...
            Intrinsics.checkNotNull(baseContinuationImpl);
            try {
                invokeSuspend = baseContinuationImpl2.invokeSuspend(obj);
                coroutine_suspended = IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED();
            } catch (Throwable th) {
                Result.Companion companion = Result.Companion;
                obj = Result.m5849constructorimpl(ResultKt.createFailure(th));
            }
