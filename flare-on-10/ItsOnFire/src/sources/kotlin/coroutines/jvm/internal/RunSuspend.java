...
/* loaded from: ItsOnFire.jar:kotlin/coroutines/jvm/internal/RunSuspend.class */
final class RunSuspend implements Continuation<Unit> {
        ...
        synchronized (this) {
            while (true) {
                ...
                if (result == null) {
                    ...
                    ResultKt.throwOnFailure(result.m5858unboximpl());
                }
            }
        }
    }
    ...
    public final Result<Unit> m7110getResultxLWZpok() {
        return this.result;
    }
    ...
    public void resumeWith(@NotNull Object obj) {
        synchronized (this) {
            this.result = Result.m5848boximpl(obj);
            Intrinsics.checkNotNull(this, "null cannot be cast to non-null type java.lang.Object");
            notifyAll();
