...
/* loaded from: ItsOnFire.jar:kotlin/internal/ProgressionUtilKt.class */
public final class ProgressionUtilKt {
    ...
    public static final int getProgressionLastElement(int i2, int i3, int i4) {
        if (i4 > 0) {
            if (i2 < i3) {
                i3 -= differenceModulo(i3, i2, i4);
            }
        } else if (i4 >= 0) {
            throw new IllegalArgumentException("Step is zero.");
        } else {
            if (i2 > i3) {
                i3 += differenceModulo(i2, i3, -i4);
            }
        }
        return i3;
    }
    ...
    public static final long getProgressionLastElement(long j2, long j3, long j4) {
        ...
        if (i2 > 0) {
            if (j2 < j3) {
                j3 -= differenceModulo(j3, j2, j4);
            }
        } else if (i2 >= 0) {
            throw new IllegalArgumentException("Step is zero.");
        } else {
            if (j2 > j3) {
                j3 += differenceModulo(j2, j3, -j4);
            }
        }
        return j3;
    }
