...
/* loaded from: ItsOnFire.jar:kotlin/io/FilesKt__FileReadWriteKt.class */
public class FilesKt__FileReadWriteKt extends FilesKt__FilePathComponentsKt {
    ...
    public static final byte[] readBytes(@NotNull File file) {
        ...
        try {
            ...
            while (true) {
                i2 = i5;
                if (i4 <= 0 || (read = fileInputStream.read(bArr2, i2, i4)) < 0) {
                    break;
                }
                i4 -= read;
                i5 = i2 + read;
            ...
            if (i4 > 0) {
                ...
                if (read2 == -1) {
                    ...
                    copyInto = ArraysKt___ArraysJvmKt.copyInto(buffer, copyOf, i3, 0, exposingBufferByteArrayOutputStream.size());
                    bArr = copyInto;
                }
            }
            CloseableKt.closeFinally(fileInputStream, null);
