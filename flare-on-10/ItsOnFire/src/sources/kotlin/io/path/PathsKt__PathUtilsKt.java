...
/* loaded from: ItsOnFire.jar:kotlin/io/path/PathsKt__PathUtilsKt.class */
class PathsKt__PathUtilsKt extends PathsKt__PathReadWriteKt {
    ...
    public static /* synthetic */ void forEachDirectoryEntry$default(Path path, String str, Function1 action, int i2, Object obj) throws IOException {
        if ((i2 & 1) != 0) {
            str = "*";
        }
        Intrinsics.checkNotNullParameter(path, "<this>");
    ...
    public static final String getInvariantSeparatorsPathString(@NotNull Path path) {
        ...
        if (Intrinsics.areEqual(separator, "/")) {
            ...
            replace$default = StringsKt__StringsJVMKt.replace$default(obj2, separator, "/", false, 4, (Object) null);
            obj = replace$default;
        }
        return obj;
    }
    ...
    */
    public static final java.lang.String getNameWithoutExtension(@org.jetbrains.annotations.NotNull java.nio.file.Path r6) {
        /*
            r0 = r6
    ...
    public static final Path relativeToOrNull(@NotNull Path path, @NotNull Path base) {
        ...
        Intrinsics.checkNotNullParameter(base, "base");
        try {
            path2 = PathRelativizer.INSTANCE.tryRelativeTo(path, base);
        } catch (IllegalArgumentException e2) {
            path2 = null;
        }
        return path2;
    ...
    public static /* synthetic */ Object useDirectoryEntries$default(Path path, String str, Function1 block, int i2, Object obj) throws IOException {
        Sequence asSequence;
        if ((i2 & 1) != 0) {
            str = "*";
        }
