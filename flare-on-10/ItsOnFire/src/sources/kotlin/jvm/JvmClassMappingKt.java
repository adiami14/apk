...
/* loaded from: ItsOnFire.jar:kotlin/jvm/JvmClassMappingKt.class */
public final class JvmClassMappingKt {
    ...
    public static final <T> Class<T> getJavaPrimitiveType(@NotNull KClass<T> kClass) {
        ...
        if (cls2.isPrimitive()) {
            Intrinsics.checkNotNull(cls2, "null cannot be cast to non-null type java.lang.Class<T of kotlin.jvm.JvmClassMappingKt.<get-javaPrimitiveType>>");
            return cls2;
        }
