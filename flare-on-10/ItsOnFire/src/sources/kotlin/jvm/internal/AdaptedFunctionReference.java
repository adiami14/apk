...
/* loaded from: ItsOnFire.jar:kotlin/jvm/internal/AdaptedFunctionReference.class */
public class AdaptedFunctionReference implements FunctionBase, Serializable {
    ...
    public int hashCode() {
        ...
        return (((((((((((hashCode * 31) + i2) * 31) + this.name.hashCode()) * 31) + this.signature.hashCode()) * 31) + (this.isTopLevel ? 1231 : 1237)) * 31) + this.arity) * 31) + this.flags;
    }
