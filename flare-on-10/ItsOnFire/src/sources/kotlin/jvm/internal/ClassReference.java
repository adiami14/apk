...
/* loaded from: ItsOnFire.jar:kotlin/jvm/internal/ClassReference.class */
public final class ClassReference implements KClass<Object>, ClassBasedDeclarationContainer {
    ...
    /* loaded from: ItsOnFire.jar:kotlin/jvm/internal/ClassReference$Companion.class */
    public static final class Companion {
        ...
        public final String getClassQualifiedName(@NotNull Class<?> jClass) {
            ...
            if (jClass.isAnonymousClass()) {
                ...
                String str4 = (String) ClassReference.classFqNames.get(jClass.getName());
                str = str4;
                if (str4 == null) {
