...
/* loaded from: ItsOnFire.jar:kotlin/ranges/ComparableRange.class */
class ComparableRange<T extends Comparable<? super T>> implements ClosedRange<T> {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:11:0x0038, code lost:
        if (kotlin.jvm.internal.Intrinsics.areEqual(getEndInclusive(), r0.getEndInclusive()) != false) goto L7;
     */
    /*
    ...
    */
    ...
    public int hashCode() {
        ...
        if (isEmpty()) {
            ...
            hashCode = getEndInclusive().hashCode() + (getStart().hashCode() * 31);
        }
        return hashCode;
    }
