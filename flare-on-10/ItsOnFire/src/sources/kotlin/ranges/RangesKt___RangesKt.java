...
/* loaded from: ItsOnFire.jar:kotlin/ranges/RangesKt___RangesKt.class */
public class RangesKt___RangesKt extends RangesKt__RangesKt {
    ...
    public static final /* synthetic */ boolean byteRangeContains(ClosedRange closedRange, double d2) {
        ...
        return byteExactOrNull != null ? closedRange.contains(byteExactOrNull) : false;
    }
    ...
    /* JADX WARN: Type inference failed for: r5v0, types: [kotlin.ranges.ClosedFloatingPointRange<T extends java.lang.Comparable<? super T>>, java.lang.Object, kotlin.ranges.ClosedFloatingPointRange, kotlin.ranges.ClosedRange] */
    ...
    public static <T extends Comparable<? super T>> T coerceIn(@NotNull T t2, @NotNull ClosedFloatingPointRange<T> range) {
        ...
        if (!range.lessThanOrEquals(t2, range.getStart()) || range.lessThanOrEquals(range.getStart(), t2)) {
            t3 = t2;
            if (range.lessThanOrEquals(range.getEndInclusive(), t2)) {
                t3 = t2;
                if (!range.lessThanOrEquals(t2, range.getEndInclusive())) {
                    t3 = range.getEndInclusive();
                }
            }
        } else {
            t3 = range.getStart();
    ...
    public static final <T extends Comparable<? super T>> T coerceIn(@NotNull T t2, @NotNull ClosedRange<T> range) {
        ...
        if (range instanceof ClosedFloatingPointRange) {
            ...
            if (t2.compareTo(range.getStart()) < 0) {
                t3 = range.getStart();
            } else {
                t3 = t2;
                if (t2.compareTo(range.getEndInclusive()) > 0) {
                    t3 = range.getEndInclusive();
                }
            }
            return t3;
    ...
    public static final /* synthetic */ boolean intRangeContains(ClosedRange closedRange, double d2) {
        ...
        return intExactOrNull != null ? closedRange.contains(intExactOrNull) : false;
    }
    ...
    public static final /* synthetic */ boolean longRangeContains(ClosedRange closedRange, double d2) {
        ...
        return longExactOrNull != null ? closedRange.contains(longExactOrNull) : false;
    }
    ...
    public static final /* synthetic */ boolean shortRangeContains(ClosedRange closedRange, double d2) {
        ...
        return shortExactOrNull != null ? closedRange.contains(shortExactOrNull) : false;
    }
    ...
    public static final Byte toByteExactOrNull(double d2) {
        ...
        return z ? Byte.valueOf((byte) d2) : null;
    }
    ...
    public static final Byte toByteExactOrNull(float f2) {
        ...
        return z ? Byte.valueOf((byte) f2) : null;
    }

    @Nullable
    public static final Byte toByteExactOrNull(int i2) {
        return new IntRange(ByteCompanionObject.MIN_VALUE, 127).contains(i2) ? Byte.valueOf((byte) i2) : null;
    }

    @Nullable
    public static final Byte toByteExactOrNull(long j2) {
        return new LongRange(-128L, 127L).contains(j2) ? Byte.valueOf((byte) j2) : null;
    }

    @Nullable
    public static final Byte toByteExactOrNull(short s2) {
        return intRangeContains((ClosedRange<Integer>) new IntRange(ByteCompanionObject.MIN_VALUE, 127), s2) ? Byte.valueOf((byte) s2) : null;
    }
    ...
    public static final Integer toIntExactOrNull(double d2) {
        ...
        if (d2 <= 2.147483647E9d) {
            z = false;
            if (-2.147483648E9d <= d2) {
                z = true;
            }
        }
        return z ? Integer.valueOf((int) d2) : null;
    }
    ...
    public static final Integer toIntExactOrNull(float f2) {
        ...
        return z ? Integer.valueOf((int) f2) : null;
    }

    @Nullable
    public static final Integer toIntExactOrNull(long j2) {
        return new LongRange(-2147483648L, 2147483647L).contains(j2) ? Integer.valueOf((int) j2) : null;
    }
    ...
    public static final Long toLongExactOrNull(double d2) {
        ...
        return z ? Long.valueOf((long) d2) : null;
    }
    ...
    public static final Short toShortExactOrNull(double d2) {
        ...
        return z ? Short.valueOf((short) d2) : null;
    }
    ...
    public static final Short toShortExactOrNull(float f2) {
        ...
        return z ? Short.valueOf((short) f2) : null;
    }

    @Nullable
    public static final Short toShortExactOrNull(int i2) {
        return new IntRange(ShortCompanionObject.MIN_VALUE, ShortCompanionObject.MAX_VALUE).contains(i2) ? Short.valueOf((short) i2) : null;
    }

    @Nullable
    public static final Short toShortExactOrNull(long j2) {
        return new LongRange(-32768L, 32767L).contains(j2) ? Short.valueOf((short) j2) : null;
    }
