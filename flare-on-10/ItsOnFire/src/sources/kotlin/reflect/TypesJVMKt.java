...
/* loaded from: ItsOnFire.jar:kotlin/reflect/TypesJVMKt.class */
public final class TypesJVMKt {

    @Metadata(k = 3, mv = {1, 7, 1}, xi = R.styleable.AppCompatTheme_checkboxStyle)
    /* loaded from: ItsOnFire.jar:kotlin/reflect/TypesJVMKt$WhenMappings.class */
    ...
    public static final Type computeJavaType(KType kType, boolean z) {
        ...
        Type javaObjectType = z ? JvmClassMappingKt.getJavaObjectType(kClass) : JvmClassMappingKt.getJavaClass(kClass);
        ...
        if (javaObjectType.isArray()) {
            ...
            if (i2 != -1) {
                ...
                if (i2 != 1) {
                    ...
                    type = computeJavaType$default instanceof Class ? javaObjectType : new GenericArrayTypeImpl(computeJavaType$default);
                }
            }
            return type;
        }
