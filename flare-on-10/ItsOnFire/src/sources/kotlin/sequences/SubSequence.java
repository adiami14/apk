...
/* loaded from: ItsOnFire.jar:kotlin/sequences/SubSequence.class */
public final class SubSequence<T> implements Sequence<T>, DropTakeSequence<T> {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r0v3, types: [kotlin.sequences.Sequence] */
    ...
    public Sequence<T> take(int i2) {
        ...
        if (i2 >= getCount()) {
            ...
            subSequence = new SubSequence<>(sequence, i3, i2 + i3);
        }
        return subSequence;
    }
}
