...
/* loaded from: ItsOnFire.jar:kotlin/streams/jdk8/StreamsKt.class */
public final class StreamsKt {
    ...
    public static final <T> Stream<T> asStream(@NotNull final Sequence<? extends T> sequence) {
        ...
        Stream<T> stream = StreamSupport.stream(new Supplier() { // from class: i.a
            ...
            public final Object get() {
                Spliterator m7262asStream$lambda4;
                m7262asStream$lambda4 = StreamsKt.m7262asStream$lambda4(Sequence.this);
                return m7262asStream$lambda4;
            }
        }, 16, false);
    ...
    public static final Spliterator m7262asStream$lambda4(Sequence this_asStream) {
