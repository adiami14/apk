...
/* loaded from: ItsOnFire.jar:kotlin/text/CharCategory.class */
public enum CharCategory {
    ...
    /* loaded from: ItsOnFire.jar:kotlin/text/CharCategory$Companion.class */
    public static final class Companion {
        ...
        public final CharCategory valueOf(int i2) {
            ...
            if (new IntRange(0, 16).contains(i2)) {
                charCategory = CharCategory.values()[i2];
            } else if (!new IntRange(18, 30).contains(i2)) {
                throw new IllegalArgumentException("Category #" + i2 + " is not defined.");
            } else {
                charCategory = CharCategory.values()[i2 - 1];
            }
            return charCategory;
        }
    }
