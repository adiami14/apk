...
/* loaded from: ItsOnFire.jar:kotlin/text/StringsKt__StringsJVMKt.class */
public class StringsKt__StringsJVMKt extends StringsKt__StringNumberConversionsKt {
    ...
    */
    public static boolean isBlank(@org.jetbrains.annotations.NotNull java.lang.CharSequence r3) {
        /*
            r0 = r3
            ...
            if (r0 == 0) goto L59
            r0 = r3
            kotlin.ranges.IntRange r0 = kotlin.text.StringsKt__StringsKt.getIndices(r0)
            r6 = r0
            r0 = r6
        ...
        L37:
            ...
            boolean r0 = kotlin.text.CharsKt__CharJVMKt.isWhitespace(r0)
            if (r0 != 0) goto L37
            r0 = 0
            r4 = r0
        L55:
    ...
    /* JADX WARN: Type inference failed for: r0v35, types: [kotlin.collections.IntIterator, java.util.Iterator] */
    @NotNull
    ...
    public static final String replaceFirst(@NotNull String str, char c2, char c3, boolean z) {
        ...
        if (indexOf$default >= 0) {
            str = StringsKt__StringsKt.replaceRange((CharSequence) str, indexOf$default, indexOf$default + 1, (CharSequence) String.valueOf(c3)).toString();
        }
        return str;
    }
    ...
    public static final String replaceFirst(@NotNull String str, @NotNull String oldValue, @NotNull String newValue, boolean z) {
        ...
        if (indexOf$default >= 0) {
            str = StringsKt__StringsKt.replaceRange((CharSequence) str, indexOf$default, oldValue.length() + indexOf$default, (CharSequence) newValue).toString();
        }
        return str;
    }
