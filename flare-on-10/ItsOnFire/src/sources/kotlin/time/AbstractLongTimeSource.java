...
@ExperimentalTime
/* loaded from: ItsOnFire.jar:kotlin/time/AbstractLongTimeSource.class */
public abstract class AbstractLongTimeSource implements TimeSource {
    ...
    /* loaded from: ItsOnFire.jar:kotlin/time/AbstractLongTimeSource$LongTimeMark.class */
    public static final class LongTimeMark implements TimeMark {
        ...
        public TimeMark mo7292plusLRDsOJo(long j2) {
            return new LongTimeMark(this.startedAt, this.timeSource, Duration.m7335plusLRDsOJo(this.offset, j2), null);
        }
    }
    ...
    public TimeMark markNow() {
        return new LongTimeMark(read(), this, Duration.Companion.m7401getZEROUwyO8pc(), null);
    }
