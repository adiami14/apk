...
@ExperimentalTime
/* loaded from: ItsOnFire.jar:kotlin/time/AdjustedTimeMark.class */
final class AdjustedTimeMark implements TimeMark {
    ...
    public long mo7290elapsedNowUwyO8pc() {
        return Duration.m7334minusLRDsOJo(this.mark.mo7290elapsedNowUwyO8pc(), this.adjustment);
    }

    /* renamed from: getAdjustment-UwyO8pc  reason: not valid java name */
    public final long m7293getAdjustmentUwyO8pc() {
    ...
    public TimeMark mo7292plusLRDsOJo(long j2) {
        return new AdjustedTimeMark(this.mark, Duration.m7335plusLRDsOJo(this.adjustment, j2), null);
    }
}
