...
/* loaded from: ItsOnFire.jar:kotlin/time/MeasureTimeKt.class */
public final class MeasureTimeKt {
    @SinceKotlin(version = "1.3")
    @ExperimentalTime
    public static final long measureTime(@NotNull Function0<Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        long m7444markNowz9LOYto = TimeSource.Monotonic.INSTANCE.m7444markNowz9LOYto();
        block.invoke();
        return TimeSource.Monotonic.ValueTimeMark.m7447elapsedNowUwyO8pc(m7444markNowz9LOYto);
    }
    ...
    public static final long measureTime(@NotNull TimeSource.Monotonic monotonic, @NotNull Function0<Unit> block) {
        ...
        Intrinsics.checkNotNullParameter(block, "block");
        long m7444markNowz9LOYto = monotonic.m7444markNowz9LOYto();
        block.invoke();
        return TimeSource.Monotonic.ValueTimeMark.m7447elapsedNowUwyO8pc(m7444markNowz9LOYto);
    }
    ...
    public static final long measureTime(@NotNull TimeSource timeSource, @NotNull Function0<Unit> block) {
        ...
        block.invoke();
        return markNow.mo7290elapsedNowUwyO8pc();
    }
    ...
    public static final <T> TimedValue<T> measureTimedValue(@NotNull Function0<? extends T> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        return new TimedValue<>(block.invoke(), TimeSource.Monotonic.ValueTimeMark.m7447elapsedNowUwyO8pc(TimeSource.Monotonic.INSTANCE.m7444markNowz9LOYto()), null);
    }
    ...
    public static final <T> TimedValue<T> measureTimedValue(@NotNull TimeSource.Monotonic monotonic, @NotNull Function0<? extends T> block) {
        Intrinsics.checkNotNullParameter(monotonic, "<this>");
        Intrinsics.checkNotNullParameter(block, "block");
        return new TimedValue<>(block.invoke(), TimeSource.Monotonic.ValueTimeMark.m7447elapsedNowUwyO8pc(monotonic.m7444markNowz9LOYto()), null);
    }
    ...
    public static final <T> TimedValue<T> measureTimedValue(@NotNull TimeSource timeSource, @NotNull Function0<? extends T> block) {
        Intrinsics.checkNotNullParameter(timeSource, "<this>");
        Intrinsics.checkNotNullParameter(block, "block");
        return new TimedValue<>(block.invoke(), timeSource.markNow().mo7290elapsedNowUwyO8pc(), null);
    }
}
