...
/* loaded from: ItsOnFire.jar:l/a.class */
public abstract class a<E> extends l.c<E> implements n<E> {
    ...
    /* loaded from: ItsOnFire.jar:l/a$a.class */
    public static final class C0052a<E> implements p<E> {
        @JvmField
        @NotNull

        /* renamed from: a  reason: collision with root package name */
        public final a<E> f651a;
        @Nullable

        /* renamed from: b  reason: collision with root package name */
        public Object f652b = l.b.f677f;
        ...
        public final Object f(Continuation<? super Boolean> continuation) {
            ...
            Boolean createFailure;
            intercepted = IntrinsicsKt__IntrinsicsJvmKt.intercepted(continuation);
            j.r b2 = j.t.b(intercepted);
            d dVar = new d(this, b2);
            while (true) {
                if (this.f651a.a0(dVar)) {
                    this.f651a.p0(b2, dVar);
                    break;
                }
                Object l0 = this.f651a.l0();
                g(l0);
                if (l0 instanceof w) {
                    ...
                    b2.resumeWith(Result.m5849constructorimpl(createFailure));
                } else if (l0 != l.b.f677f) {
                    Boolean boxBoolean = Boxing.boxBoolean(true);
                    Function1<E, Unit> function1 = this.f651a.f682j;
    ...
    /* loaded from: ItsOnFire.jar:l/a$b.class */
    public static class b<E> extends h0<E> {
        @JvmField
        @NotNull

        /* renamed from: m  reason: collision with root package name */
        public final j.q<Object> f653m;
        @JvmField
        ...
        public r0 c(E e2, @Nullable y.d dVar) {
            if (this.f653m.C(j0(e2), dVar != null ? dVar.f2125c : null, h0(e2)) == null) {
                return null;
            }
            if (dVar != null) {
                dVar.d();
        ...
        public void i0(@NotNull w<?> wVar) {
            r createFailure;
            int i2 = this.f654n;
            j.q<Object> qVar = this.f653m;
            if (i2 == 1) {
                createFailure = r.b(r.f767b.a(wVar.f986m));
                Result.Companion companion = Result.Companion;
            } else {
                Result.Companion companion2 = Result.Companion;
                createFailure = ResultKt.createFailure(wVar.n0());
            }
            qVar.resumeWith(Result.m5849constructorimpl(createFailure));
        }
        ...
        @Override // l.j0
        public void q(E e2) {
            this.f653m.Z(j.s.f553d);
        }

        @Override // q.y
        @NotNull
        public String toString() {
            return "ReceiveElement@" + z0.b(this) + "[receiveMode=" + this.f654n + ']';
        }
    }
    ...
    /* loaded from: ItsOnFire.jar:l/a$d.class */
    public static class d<E> extends h0<E> {
        @JvmField
        @NotNull

        /* renamed from: m  reason: collision with root package name */
        public final C0052a<E> f656m;
        @JvmField
        @NotNull

        /* renamed from: n  reason: collision with root package name */
        public final j.q<Boolean> f657n;
        ...
        @Nullable
        public r0 c(E e2, @Nullable y.d dVar) {
            if (this.f657n.C(Boolean.TRUE, dVar != null ? dVar.f2125c : null, h0(e2)) == null) {
                return null;
            }
            if (dVar != null) {
                dVar.d();
        ...
        @Nullable
        public Function1<Throwable, Unit> h0(E e2) {
            Function1<E, Unit> function1 = this.f656m.f651a.f682j;
            return function1 != null ? q.i0.a(function1, e2, this.f657n.getContext()) : null;
        }

        @Override // l.h0
        public void i0(@NotNull w<?> wVar) {
            Object b2 = wVar.f986m == null ? q.a.b(this.f657n, Boolean.FALSE, null, 2, null) : this.f657n.B(wVar.n0());
            if (b2 != null) {
                this.f656m.g(wVar);
                this.f657n.Z(b2);
            }
    ...
    /* loaded from: ItsOnFire.jar:l/a$e.class */
    public static final class e<R, E> extends h0<E> implements p1 {
        @JvmField
        @NotNull

        /* renamed from: m  reason: collision with root package name */
        public final a<E> f658m;
        @JvmField
        @NotNull

        /* renamed from: n  reason: collision with root package name */
        public final t.f<R> f659n;
        @JvmField
        @NotNull

        /* renamed from: o  reason: collision with root package name */
        public final Function2<Object, Continuation<? super R>, Object> f660o;
        @JvmField
        ...
        @Nullable
        public Function1<Throwable, Unit> h0(E e2) {
            Function1<E, Unit> function1 = this.f658m.f682j;
            return function1 != null ? q.i0.a(function1, e2, this.f659n.o().getContext()) : null;
        }
        ...
        public void i0(@NotNull w<?> wVar) {
            if (this.f659n.i()) {
                int i2 = this.f661p;
                if (i2 == 0) {
                    this.f659n.v(wVar.n0());
                } else if (i2 != 1) {
                } else {
                    r.a.f(this.f660o, r.b(r.f767b.a(wVar.f986m)), this.f659n.o(), null, 4, null);
                }
            }
        }

        /* JADX WARN: Multi-variable type inference failed */
        /* JADX WARN: Type inference failed for: r0v8, types: [l.r] */
        @Override // l.j0
        public void q(E e2) {
            r.a.e(this.f660o, this.f661p == 1 ? r.b(r.f767b.c(e2)) : e2, this.f659n.o(), h0(e2));
        }

        @Override // q.y
        @NotNull
        public String toString() {
            return "ReceiveSelect@" + z0.b(this) + '[' + this.f659n + ",receiveMode=" + this.f661p + ']';
        }
    }
    ...
    /* loaded from: ItsOnFire.jar:l/a$f.class */
    public final class f extends j.g {
        @NotNull

        /* renamed from: j  reason: collision with root package name */
        public final h0<?> f662j;
        ...
        @NotNull
        public String toString() {
            return "RemoveReceiveOnCancel[" + this.f662j + ']';
        }
    }
    ...
    /* loaded from: ItsOnFire.jar:l/a$g.class */
    public static final class g<E> extends y.e<l0> {
        ...
        public Object e(@NotNull q.y yVar) {
            if (!(yVar instanceof w)) {
                yVar = !(yVar instanceof l0) ? l.b.f677f : null;
            }
            return yVar;
        }
    ...
    /* loaded from: ItsOnFire.jar:l/a$h.class */
    public static final class h extends y.c {

        /* renamed from: d  reason: collision with root package name */
        public final /* synthetic */ a f664d;
        ...
        public Object i(@NotNull q.y yVar) {
            return this.f664d.f0() ? null : q.x.a();
        }
    }
    ...
    /* loaded from: ItsOnFire.jar:l/a$i.class */
    public static final class i implements t.d<E> {

        /* renamed from: j  reason: collision with root package name */
        public final /* synthetic */ a<E> f665j;
        ...
        public <R> void L(@NotNull t.f<? super R> fVar, @NotNull Function2<? super E, ? super Continuation<? super R>, ? extends Object> function2) {
            this.f665j.o0(fVar, 0, function2);
        }
    }
    ...
    /* loaded from: ItsOnFire.jar:l/a$j.class */
    public static final class j implements t.d<r<? extends E>> {

        /* renamed from: j  reason: collision with root package name */
        public final /* synthetic */ a<E> f666j;
        ...
        public <R> void L(@NotNull t.f<? super R> fVar, @NotNull Function2<? super r<? extends E>, ? super Continuation<? super R>, ? extends Object> function2) {
            this.f666j.o0(fVar, 1, function2);
        }
    }

    @Metadata(k = 3, mv = {1, 6, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
    @DebugMetadata(c = "kotlinx.coroutines.channels.AbstractChannel", f = "AbstractChannel.kt", i = {}, l = {633}, m = "receiveCatching-JP2dKIU", n = {}, s = {})
    /* loaded from: ItsOnFire.jar:l/a$k.class */
    public static final class k extends ContinuationImpl {
        ...
        public final /* synthetic */ a<E> f668k;
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            Object coroutine_suspended;
            this.f667j = obj;
            this.f669l |= Integer.MIN_VALUE;
            Object z = this.f668k.z(this);
            coroutine_suspended = IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED();
    ...
    public final Object F(@NotNull Continuation<? super E> continuation) {
        Object l0 = l0();
        return (l0 == l.b.f677f || (l0 instanceof w)) ? n0(0, continuation) : l0;
    }
    ...
    public final void cancel(@Nullable CancellationException cancellationException) {
        ...
        if (cancellationException == null) {
            cancellationException2 = new CancellationException(z0.a(this) + " was cancelled");
        }
    ...
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r0v21, types: [l.a$b] */
    public final <R> Object n0(int i2, Continuation<? super R> continuation) {
        Continuation intercepted;
        Object coroutine_suspended;
        intercepted = IntrinsicsKt__IntrinsicsJvmKt.intercepted(continuation);
        j.r b2 = j.t.b(intercepted);
        c bVar = this.f682j == null ? new b(b2, i2) : new c(b2, i2, this.f682j);
        while (true) {
            if (!a0(bVar)) {
                Object l0 = l0();
                if (!(l0 instanceof w)) {
    ...
    public final Object v() {
        Object l0 = l0();
        return l0 == l.b.f677f ? r.f767b.b() : l0 instanceof w ? r.f767b.a(((w) l0).f986m) : r.f767b.c(l0);
    }
    ...
    */
    public final java.lang.Object z(@org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super l.r<? extends E>> r6) {
        /*
            r5 = this;
            r0 = r6
            boolean r0 = r0 instanceof l.a.k
            if (r0 == 0) goto L27
            r0 = r6
            l.a$k r0 = (l.a.k) r0
            r7 = r0
        ...
        L8f:
            ...
            r1 = 1
            r2 = r6
            java.lang.Object r0 = r0.n0(r1, r2)
            r7 = r0
            r0 = r7
            r6 = r0
            r0 = r7
