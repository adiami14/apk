...
/* loaded from: ItsOnFire.jar:l/d0.class */
public class d0<E> extends a<E> {
    ...
    public Object I(E e2, @NotNull t.f<?> fVar) {
        ...
        while (true) {
            if (d0()) {
                r0Var = super.I(e2, fVar);
            } else {
                Object r2 = fVar.r(h(e2));
                r0Var = r2;
                if (r2 == null) {
                    r0Var = b.f675d;
                }
            ...
            if (r0Var != b.f676e && r0Var != q.c.f2037b) {
                if (r0Var instanceof w) {
                    return r0Var;
                }
                throw new IllegalStateException(("Invalid result " + r0Var).toString());
            }
        }
    }
            ...
            if (obj instanceof ArrayList) {
                ...
                for (int size = arrayList.size() - 1; -1 < size; size--) {
                    ...
                    if (l0Var instanceof c.a) {
                        ...
                        d1Var2 = function1 != null ? q.i0.c(function1, ((c.a) l0Var).f684m, d1Var2) : null;
                    } else {
                        l0Var.i0(wVar);
                    }
                }
                ...
                if (l0Var2 instanceof c.a) {
                    Function1<E, Unit> function12 = this.f682j;
                    d1Var = null;
                    if (function12 != null) {
                        d1Var = q.i0.c(function12, ((c.a) l0Var2).f684m, null);
                    }
                } else {
                    l0Var2.i0(wVar);
                    d1Var = null;
