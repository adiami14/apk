...
/* loaded from: ItsOnFire.jar:l/n0.class */
public class n0<E> extends l0 {

    /* renamed from: m  reason: collision with root package name */
    public final E f742m;
    @JvmField
    @NotNull

    /* renamed from: n  reason: collision with root package name */
    public final j.q<Unit> f743n;
    ...
    public void i0(@NotNull w<?> wVar) {
        j.q<Unit> qVar = this.f743n;
        Result.Companion companion = Result.Companion;
        qVar.resumeWith(Result.m5849constructorimpl(ResultKt.createFailure(wVar.o0())));
    }

    @Override // l.l0
    @Nullable
    public r0 j0(@Nullable y.d dVar) {
        if (this.f743n.f(Unit.INSTANCE, dVar != null ? dVar.f2125c : null) == null) {
            return null;
        }
        if (dVar != null) {
            dVar.d();
