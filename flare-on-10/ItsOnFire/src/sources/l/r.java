...
@JvmInline
/* loaded from: ItsOnFire.jar:l/r.class */
public final class r<T> {
    @NotNull

    /* renamed from: b  reason: collision with root package name */
    public static final b f767b = new b(null);
    @NotNull

    /* renamed from: c  reason: collision with root package name */
    public static final c f768c = new c();
    @Nullable
    ...
    /* loaded from: ItsOnFire.jar:l/r$a.class */
    public static final class a extends c {
        @JvmField
        @Nullable

        /* renamed from: a  reason: collision with root package name */
        public final Throwable f770a;
        ...
        public boolean equals(@Nullable Object obj) {
            return (obj instanceof a) && Intrinsics.areEqual(this.f770a, ((a) obj).f770a);
        }

        public int hashCode() {
            Throwable th = this.f770a;
    ...
    /* loaded from: ItsOnFire.jar:l/r$b.class */
    ...
    /* loaded from: ItsOnFire.jar:l/r$c.class */
    ...
    public static final T i(Object obj) {
        Throwable th;
        if (obj instanceof c) {
            if (!(obj instanceof a) || (th = ((a) obj).f770a) == null) {
