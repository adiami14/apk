...
/* loaded from: ItsOnFire.jar:l/z.class */
public final class z<E> implements i<E> {

    /* renamed from: k  reason: collision with root package name */
    public static final /* synthetic */ AtomicReferenceFieldUpdater f988k;

    /* renamed from: l  reason: collision with root package name */
    public static final /* synthetic */ AtomicIntegerFieldUpdater f989l;

    /* renamed from: m  reason: collision with root package name */
    public static final /* synthetic */ AtomicReferenceFieldUpdater f990m;
    @Deprecated
    @NotNull

    /* renamed from: o  reason: collision with root package name */
    public static final r0 f992o;
    @Deprecated
    @NotNull

    /* renamed from: p  reason: collision with root package name */
    public static final c<Object> f993p;
    @NotNull
    ...
    public static final a f991n = new a(null);
    ...
    /* loaded from: ItsOnFire.jar:l/z$a.class */
    public static final class a {
        ...
        public final Throwable b() {
            ...
            if (th == null) {
                illegalStateException = new IllegalStateException(s.f771a);
            }
    ...
    /* loaded from: ItsOnFire.jar:l/z$b.class */
    ...
    /* loaded from: ItsOnFire.jar:l/z$c.class */
    ...
    /* loaded from: ItsOnFire.jar:l/z$d.class */
    public static final class d<E> extends a0<E> implements i0<E> {
        @NotNull

        /* renamed from: o  reason: collision with root package name */
        public final z<E> f997o;
    ...
    /* loaded from: ItsOnFire.jar:l/z$e.class */
    public static final class e implements t.e<E, m0<? super E>> {

        /* renamed from: j  reason: collision with root package name */
        public final /* synthetic */ z<E> f998j;
        ...
        public <R> void S(@NotNull t.f<? super R> fVar, E e2, @NotNull Function2<? super m0<? super E>, ? super Continuation<? super R>, ? extends Object> function2) {
            this.f998j.l(fVar, e2, function2);
        }
    }
    ...
    static {
        ...
        f992o = r0Var;
        f993p = new c<>(r0Var, null);
        f988k = AtomicReferenceFieldUpdater.newUpdater(z.class, Object.class, "_state");
        f989l = AtomicIntegerFieldUpdater.newUpdater(z.class, "_updating");
        f990m = AtomicReferenceFieldUpdater.newUpdater(z.class, Object.class, "onCloseHandler");
    }
    ...
    public z(E e2) {
        this();
        f988k.lazySet(this, new c(e2, null));
    }
    ...
    public boolean a(@Nullable Throwable th) {
        ...
        } while (!androidx.concurrent.futures.a.a(f988k, this, obj, th == null ? f991n : new a(th)));
        d<E>[] dVarArr = ((c) obj).f996b;
        if (dVarArr != null) {
    ...
    public i0<E> J() {
        ...
        do {
            ...
            if (obj instanceof a) {
                ...
                cVar = (c) obj;
                Object obj2 = cVar.f995a;
                if (obj2 != f992o) {
                    dVar.H(obj2);
                }
            }
        } while (!androidx.concurrent.futures.a.a(f988k, this, obj, new c(cVar.f995a, e(cVar.f996b, dVar))));
        return dVar;
    }

    @Override // l.m0
    public void Q(@NotNull Function1<? super Throwable, Unit> function1) {
        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = f990m;
        if (androidx.concurrent.futures.a.a(atomicReferenceFieldUpdater, this, null, function1)) {
            Object obj = this._state;
            if ((obj instanceof a) && androidx.concurrent.futures.a.a(atomicReferenceFieldUpdater, this, function1, l.b.f679h)) {
                function1.invoke(((a) obj).f994a);
                return;
            }
            return;
        }
    ...
    public Object T(E e2) {
        a k2 = k(e2);
        return k2 != null ? r.f767b.a(k2.a()) : r.f767b.c(Unit.INSTANCE);
    }
    ...
    public final void f(d<E> dVar) {
        ...
        } while (!androidx.concurrent.futures.a.a(f988k, this, obj, new c(obj2, m(dVarArr, dVar))));
    }
    ...
    public final void j(Throwable th) {
        ...
        if (obj == null || obj == (r0Var = l.b.f679h) || !androidx.concurrent.futures.a.a(f990m, this, obj, r0Var)) {
            return;
        }
    ...
    public final a k(E e2) {
        Object obj;
        if (f989l.compareAndSet(this, 0, 1)) {
            do {
                try {
                    obj = this._state;
                    if (obj instanceof a) {
            ...
            } while (!androidx.concurrent.futures.a.a(f988k, this, obj, new c(e2, ((c) obj).f996b)));
            d<E>[] dVarArr = ((c) obj).f996b;
            if (dVarArr != null) {
                for (d<E> dVar : dVarArr) {
                    dVar.H(e2);
