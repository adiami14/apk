...
/* loaded from: ItsOnFire.jar:o/e.class */
public final class e<T> extends p.e<T> {

    /* renamed from: o  reason: collision with root package name */
    public static final /* synthetic */ AtomicIntegerFieldUpdater f1325o = AtomicIntegerFieldUpdater.newUpdater(e.class, "consumed");
    @NotNull
    private volatile /* synthetic */ int consumed;
    @NotNull

    /* renamed from: m  reason: collision with root package name */
    public final l.i0<T> f1326m;
    ...
    public Object collect(@NotNull j<? super T> jVar, @NotNull Continuation<? super Unit> continuation) {
        ...
        o();
        Object e2 = m.e(jVar, this.f1326m, this.f1327n, continuation);
    ...
    public Object i(@NotNull l.g0<? super T> g0Var, @NotNull Continuation<? super Unit> continuation) {
        Object coroutine_suspended;
        Object e2 = m.e(new p.y(g0Var), this.f1326m, this.f1327n, continuation);
        coroutine_suspended = IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED();
    ...
    public p.e<T> j(@NotNull CoroutineContext coroutineContext, int i2, @NotNull l.m mVar) {
        return new e(this.f1326m, this.f1327n, coroutineContext, i2, mVar);
    }

    @Override // p.e
    @NotNull
    public i<T> k() {
        return new e(this.f1326m, this.f1327n, null, 0, null, 28, null);
    }
    ...
    public l.i0<T> n(@NotNull j.u0 u0Var) {
        o();
        return this.f1868k == -3 ? this.f1326m : super.n(u0Var);
    }

    public final void o() {
        if (this.f1327n) {
            boolean z = true;
            if (f1325o.getAndSet(this, 1) != 0) {
                z = false;
            }
            if (!z) {
