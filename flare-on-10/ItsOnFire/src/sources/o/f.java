...
/* loaded from: ItsOnFire.jar:o/f.class */
public class f<T> extends p.e<T> {
    @NotNull

    /* renamed from: m  reason: collision with root package name */
    public final Function2<l.g0<? super T>, Continuation<? super Unit>, Object> f1328m;
    ...
    public static /* synthetic */ Object o(f fVar, l.g0 g0Var, Continuation continuation) {
        ...
        Object invoke = fVar.f1328m.invoke(g0Var, continuation);
    ...
    public p.e<T> j(@NotNull CoroutineContext coroutineContext, int i2, @NotNull l.m mVar) {
        return new f(this.f1328m, coroutineContext, i2, mVar);
    }

    @Override // p.e
    @NotNull
    public String toString() {
        return "block[" + this.f1328m + "] -> " + super.toString();
    }
}
