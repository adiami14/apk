...
/* loaded from: ItsOnFire.jar:o/f0.class */
public final class f0<T> implements i0<T>, c<T>, p.r<T> {
    @Nullable

    /* renamed from: j  reason: collision with root package name */
    public final n2 f1329j;

    /* renamed from: k  reason: collision with root package name */
    public final /* synthetic */ i0<T> f1330k;
    ...
    public Object collect(@NotNull j<? super T> jVar, @NotNull Continuation<?> continuation) {
        return this.f1330k.collect(jVar, continuation);
    }
}
