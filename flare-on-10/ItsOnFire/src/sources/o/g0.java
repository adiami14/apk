...
/* loaded from: ItsOnFire.jar:o/g0.class */
public final class g0<T> implements t0<T>, c<T>, p.r<T> {
    @Nullable

    /* renamed from: j  reason: collision with root package name */
    public final n2 f1340j;

    /* renamed from: k  reason: collision with root package name */
    public final /* synthetic */ t0<T> f1341k;
    ...
    public Object collect(@NotNull j<? super T> jVar, @NotNull Continuation<?> continuation) {
        return this.f1341k.collect(jVar, continuation);
    }

    @Override // o.t0
    public T getValue() {
        return this.f1341k.getValue();
    }
}
