...
/* loaded from: ItsOnFire.jar:o/n.class */
public final /* synthetic */ class n {
    ...
    /* loaded from: ItsOnFire.jar:o/n$a.class */
    public static final class a<T> implements j<T> {

        /* renamed from: j */
        public final /* synthetic */ Function2<T, Continuation<? super Unit>, Object> f1447j;

        @Metadata(k = 3, mv = {1, 6, 0}, xi = Typography.degree)
        /* renamed from: o.n$a$a */
        /* loaded from: ItsOnFire.jar:o/n$a$a.class */
        public static final class C0072a extends ContinuationImpl {

            /* renamed from: j */
            public /* synthetic */ Object f1448j;
        ...
        public Object a(T t2, @NotNull Continuation<? super Unit> continuation) {
            ...
            InlineMarker.mark(5);
            this.f1447j.invoke(t2, continuation);
        ...
        public Object emit(T t2, @NotNull Continuation<? super Unit> continuation) {
            ...
            Object invoke = this.f1447j.invoke(t2, continuation);
    ...
    /* loaded from: ItsOnFire.jar:o/n$b.class */
    public static final class b<T> implements j<T> {
        ...
        /* renamed from: k */
        public final /* synthetic */ Function3<Integer, T, Continuation<? super Unit>, Object> f1452k;

        @Metadata(k = 3, mv = {1, 6, 0}, xi = Typography.degree)
        /* loaded from: ItsOnFire.jar:o/n$b$a.class */
        public static final class a extends ContinuationImpl {

            /* renamed from: j */
            public /* synthetic */ Object f1453j;
        ...
        public Object a(T t2, @NotNull Continuation<? super Unit> continuation) {
            ...
            new a(continuation);
            InlineMarker.mark(5);
            Function3<Integer, T, Continuation<? super Unit>, Object> function3 = this.f1452k;
            int i2 = this.f1451j;
            this.f1451j = i2 + 1;
            if (i2 >= 0) {
    ...
    /* loaded from: ItsOnFire.jar:o/n$c.class */
    public static final class c extends SuspendLambda implements Function2<j.u0, Continuation<? super Unit>, Object> {
        ...
        /* renamed from: k */
        public final /* synthetic */ i<T> f1457k;
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new c(this.f1457k, continuation);
        }
    ...
    public static final Object a(@NotNull i<?> iVar, @NotNull Continuation<? super Unit> continuation) {
        Object coroutine_suspended;
        Object collect = iVar.collect(p.t.f1987j, continuation);
        coroutine_suspended = IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED();
