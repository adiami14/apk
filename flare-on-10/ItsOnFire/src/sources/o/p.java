...
/* loaded from: ItsOnFire.jar:o/p.class */
public final /* synthetic */ class p {
    ...
    /* JADX WARN: Type inference failed for: r0v21, types: [o.i] */
    @NotNull
    public static final <T> i<T> b(@NotNull i<? extends T> iVar, int i2, @NotNull l.m mVar) {
        ...
        if (z) {
            if (i2 == -1) {
                mVar = l.m.DROP_OLDEST;
                i2 = 0;
            }
            return iVar instanceof p.r ? r.a.a((p.r) iVar, null, i2, mVar, 1, null) : new p.i(iVar, null, i2, mVar, 2, null);
        }
    ...
    public static final void f(CoroutineContext coroutineContext) {
        if (coroutineContext.get(n2.f531b) == null) {
            return;
        }
    ...
    public static final <T> i<T> h(@NotNull i<? extends T> iVar, @NotNull CoroutineContext coroutineContext) {
        ...
        if (!Intrinsics.areEqual(coroutineContext, EmptyCoroutineContext.INSTANCE)) {
            iVar = iVar instanceof p.r ? r.a.a((p.r) iVar, coroutineContext, 0, null, 6, null) : new p.i(iVar, coroutineContext, 0, null, 12, null);
        }
        return (i<T>) iVar;
    }
}
