...
/* loaded from: ItsOnFire.jar:o/x.class */
public final /* synthetic */ class x {
    ...
    /* loaded from: ItsOnFire.jar:o/x$a.class */
    public static final class a<T> extends SuspendLambda implements Function2<T, Continuation<? super Unit>, Object> {
        ...
        /* renamed from: k */
        public final /* synthetic */ long f1741k;
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new a(this.f1741k, continuation);
        }
    ...
    /* loaded from: ItsOnFire.jar:o/x$b.class */
    public static final class b<T> extends SuspendLambda implements Function2<j<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* renamed from: k */
        public final /* synthetic */ long f1743k;
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new b(this.f1743k, continuation);
        }
    ...
    /* loaded from: ItsOnFire.jar:o/x$d.class */
    public static final class d<T> extends SuspendLambda implements Function3<j<? super T>, Throwable, Continuation<? super Unit>, Object> {
        ...
        /* renamed from: k */
        public /* synthetic */ Object f1746k;

        /* renamed from: l */
        public /* synthetic */ Object f1747l;

        /* renamed from: m */
        public final /* synthetic */ Function1<Throwable, Boolean> f1748m;

        /* renamed from: n */
        public final /* synthetic */ T f1749n;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public d(Function1<? super Throwable, Boolean> function1, T t2, Continuation<? super d> continuation) {
            super(3, continuation);
            this.f1748m = function1;
            this.f1749n = t2;
        }

        @Nullable
        public final Object i(@NotNull j<? super T> jVar, @NotNull Throwable th, @Nullable Continuation<? super Unit> continuation) {
            d dVar = new d(this.f1748m, this.f1749n, continuation);
            dVar.f1746k = jVar;
            dVar.f1747l = th;
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i2 == 0) {
                ResultKt.throwOnFailure(obj);
                j jVar = (j) this.f1746k;
                Throwable th = (Throwable) this.f1747l;
                if (!this.f1748m.invoke(th).booleanValue()) {
                    throw th;
                }
                T t2 = this.f1749n;
                this.f1746k = null;
    ...
    /* loaded from: ItsOnFire.jar:o/x$e.class */
    public static final class e<R, T> extends SuspendLambda implements Function3<j<? super R>, T, Continuation<? super Unit>, Object> {
        ...
        /* renamed from: k */
        public /* synthetic */ Object f1751k;

        /* renamed from: l */
        public /* synthetic */ Object f1752l;

        /* renamed from: m */
        public final /* synthetic */ Function2 f1753m;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public e(Function2 function2, Continuation continuation) {
            super(3, continuation);
            this.f1753m = function2;
        }

        @Nullable
        public final Object i(@NotNull j<? super R> jVar, T t2, @Nullable Continuation<? super Unit> continuation) {
            e eVar = new e(this.f1753m, continuation);
            eVar.f1751k = jVar;
            eVar.f1752l = t2;
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i2 == 0) {
                ResultKt.throwOnFailure(obj);
                jVar = (j) this.f1751k;
                Object obj2 = this.f1752l;
                Function2 function2 = this.f1753m;
                this.f1751k = jVar;
                this.f1750j = 1;
