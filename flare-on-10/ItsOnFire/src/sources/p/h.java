...
public abstract class h<S, T> extends e<T> {
    ...
    public static final class a extends SuspendLambda implements Function2<o.j<? super T>, Continuation<? super Unit>, Object> {
        ...
        public /* synthetic */ Object f1894k;

        /* renamed from: l  reason: collision with root package name */
        public final /* synthetic */ h<S, T> f1895l;
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            a aVar = new a(this.f1895l, continuation);
            aVar.f1894k = obj;
            return aVar;
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i2 == 0) {
                ...
                o.j<? super T> jVar = (o.j) this.f1894k;
                h<S, T> hVar = this.f1895l;
                this.f1893j = 1;
    ...
    public static /* synthetic */ Object p(h hVar, o.j jVar, Continuation continuation) {
        ...
        if (hVar.f1868k == -3) {
            ...
            CoroutineContext plus = context.plus(hVar.f1867j);
    ...
    public String toString() {
        return this.f1892m + " -> " + super.toString();
    }
}
