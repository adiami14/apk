...
/* loaded from: ItsOnFire.jar:p/i.class */
public final class i<T> extends h<T, T> {
    ...
    public e<T> j(@NotNull CoroutineContext coroutineContext, int i2, @NotNull l.m mVar) {
        return new i(this.f1892m, coroutineContext, i2, mVar);
    }

    @Override // p.e
    @NotNull
    public o.i<T> k() {
        return (o.i<T>) this.f1892m;
    }
    ...
    public Object s(@NotNull o.j<? super T> jVar, @NotNull Continuation<? super Unit> continuation) {
        ...
        Object collect = this.f1892m.collect(jVar, continuation);
