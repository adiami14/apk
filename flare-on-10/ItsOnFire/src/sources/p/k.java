...
/* loaded from: ItsOnFire.jar:p/k.class */
public final class k<T> extends e<T> {
    @NotNull

    /* renamed from: m  reason: collision with root package name */
    public final Iterable<o.i<T>> f1915m;
    ...
    /* loaded from: ItsOnFire.jar:p/k$a.class */
    public static final class a extends SuspendLambda implements Function2<u0, Continuation<? super Unit>, Object> {
        ...
        public final /* synthetic */ o.i<T> f1917k;

        /* renamed from: l  reason: collision with root package name */
        public final /* synthetic */ y<T> f1918l;
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new a(this.f1917k, this.f1918l, continuation);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i2 == 0) {
                ...
                o.i<T> iVar = this.f1917k;
                y<T> yVar = this.f1918l;
                this.f1916j = 1;
    ...
    public e<T> j(@NotNull CoroutineContext coroutineContext, int i2, @NotNull l.m mVar) {
        return new k(this.f1915m, coroutineContext, i2, mVar);
    }

    @Override // p.e
    @NotNull
    public i0<T> n(@NotNull u0 u0Var) {
        return e0.d(u0Var, this.f1867j, this.f1868k, l());
    }
}
