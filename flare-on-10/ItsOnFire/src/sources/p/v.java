...
public final class v<T> extends ContinuationImpl implements o.j<T>, CoroutineStackFrame {
    ...
    public CoroutineContext f1994m;
    @Nullable

    /* renamed from: n  reason: collision with root package name */
    public Continuation<? super Unit> f1995n;
    ...
    /* loaded from: ItsOnFire.jar:p/v$a.class */
    public static final class a extends Lambda implements Function2<Integer, CoroutineContext.Element, Integer> {

        /* renamed from: j  reason: collision with root package name */
        public static final a f1996j = new a();
    ...
    public v(@NotNull o.j<? super T> jVar, @NotNull CoroutineContext coroutineContext) {
        super(s.f1985j, EmptyCoroutineContext.INSTANCE);
        this.f1991j = jVar;
        this.f1992k = coroutineContext;
        this.f1993l = ((Number) coroutineContext.fold(0, a.f1996j)).intValue();
    }
    ...
    public Object emit(T t2, @NotNull Continuation<? super Unit> continuation) {
        ...
        try {
            ...
            this.f1994m = new n(th, continuation.getContext());
            throw th;
        }
    }
    ...
    public CoroutineStackFrame getCallerFrame() {
        Continuation<? super Unit> continuation = this.f1995n;
    ...
    public CoroutineContext getContext() {
        CoroutineContext coroutineContext = this.f1994m;
    ...
    public Object invokeSuspend(@NotNull Object obj) {
        ...
        if (m5852exceptionOrNullimpl != null) {
            this.f1994m = new n(m5852exceptionOrNullimpl, getContext());
        }
        Continuation<? super Unit> continuation = this.f1995n;
    ...
    public final Object j(Continuation<? super Unit> continuation, T t2) {
        ...
        this.f1995n = continuation;
        Object invoke = w.a().invoke(this.f1991j, t2, this);
        coroutine_suspended = IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED();
    ...
    public final void k(n nVar, Object obj) {
        String trimIndent;
        trimIndent = StringsKt__IndentKt.trimIndent("\n            Flow exception transparency is violated:\n                Previous 'emit' call has thrown exception " + nVar.f1978j + ", but then emission attempt of value '" + obj + "' has been detected.\n                Emissions from 'catch' blocks are prohibited in order to avoid unspecified behaviour, 'Flow.catch' operator can be used instead.\n                For a more detailed explanation, please refer to Flow documentation.\n            ");
