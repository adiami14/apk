...
/* loaded from: ItsOnFire.jar:p/x.class */
public final class x {
    ...
    /* loaded from: ItsOnFire.jar:p/x$a.class */
    public static final class a extends Lambda implements Function2<Integer, CoroutineContext.Element, Integer> {

        /* renamed from: j  reason: collision with root package name */
        public final /* synthetic */ v<?> f1999j;
        ...
        public final Integer a(int i2, @NotNull CoroutineContext.Element element) {
            ...
            CoroutineContext.Element element2 = this.f1999j.f1992k.get(key);
            if (key != n2.f531b) {
    ...
    /* loaded from: ItsOnFire.jar:p/x$b.class */
    public static final class b<T> implements o.i<T> {

        /* renamed from: j  reason: collision with root package name */
        public final /* synthetic */ Function2<o.j<? super T>, Continuation<? super Unit>, Object> f2000j;

        @Metadata(k = 3, mv = {1, 6, 0}, xi = Typography.degree)
        /* loaded from: ItsOnFire.jar:p/x$b$a.class */
        public static final class a extends ContinuationImpl {

            /* renamed from: j  reason: collision with root package name */
            public /* synthetic */ Object f2001j;
        ...
        public Object collect(@NotNull o.j<? super T> jVar, @NotNull Continuation<? super Unit> continuation) {
            ...
            Object invoke = this.f2000j.invoke(jVar, continuation);
        ...
        public Object e(@NotNull o.j<? super T> jVar, @NotNull Continuation<? super Unit> continuation) {
            ...
            new a(continuation);
            InlineMarker.mark(5);
            this.f2000j.invoke(jVar, continuation);
    ...
    public static final void a(@NotNull v<?> vVar, @NotNull CoroutineContext coroutineContext) {
        if (((Number) coroutineContext.fold(0, new a(vVar))).intValue() == vVar.f1993l) {
            return;
        }
        throw new IllegalStateException(("Flow invariant is violated:\n\t\tFlow was collected in " + vVar.f1992k + ",\n\t\tbut emission happened in " + coroutineContext + ".\n\t\tPlease refer to 'flow' documentation or use 'flowOn' instead").toString());
    }
