...
/* loaded from: ItsOnFire.jar:q/a.class */
public class a<T> {
    @NotNull

    /* renamed from: a  reason: collision with root package name */
    public Object[] f2007a = new Object[16];
    ...
    public final void b() {
        this.f2008b = 0;
        this.f2009c = 0;
        this.f2007a = new Object[this.f2007a.length];
    }
    ...
    public final void c() {
        ...
        ArraysKt___ArraysJvmKt.copyInto$default(objArr, objArr2, 0, this.f2008b, 0, 10, (Object) null);
        Object[] objArr3 = this.f2007a;
    ...
    public final boolean d() {
        return this.f2008b == this.f2009c;
    }
    ...
    public final T e() {
        ...
        T t2 = (T) objArr[i2];
        objArr[i2] = null;
        this.f2008b = (i2 + 1) & (objArr.length - 1);
        if (t2 != null) {
            return t2;
        }
