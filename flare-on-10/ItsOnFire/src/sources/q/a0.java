...
/* loaded from: ItsOnFire.jar:q/a0.class */
public class a0<E> {

    /* renamed from: a  reason: collision with root package name */
    public static final /* synthetic */ AtomicReferenceFieldUpdater f2010a = AtomicReferenceFieldUpdater.newUpdater(a0.class, Object.class, "_cur");
    @NotNull
    ...
    public final boolean a(@NotNull E e2) {
        while (true) {
            ...
            if (a2 == 1) {
                androidx.concurrent.futures.a.a(f2010a, this, b0Var, b0Var.k());
            } else if (a2 == 2) {
                return false;
            }
        }
