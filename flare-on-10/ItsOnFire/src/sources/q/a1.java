...
/* loaded from: ItsOnFire.jar:q/a1.class */
public class a1<T extends b1 & Comparable<? super T>> {
    ...
    /* JADX WARN: Type inference failed for: r0v10, types: [q.b1[]] */
    /* JADX WARN: Type inference failed for: r0v14, types: [q.b1[]] */
    public final T[] j() {
        T[] tArr;
        T[] tArr2 = this.f2011a;
        if (tArr2 == null) {
            ...
            tArr = tArr2;
            if (g() >= tArr2.length) {
                Object[] copyOf = Arrays.copyOf(tArr2, g() * 2);
