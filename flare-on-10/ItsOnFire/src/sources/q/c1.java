...
/* loaded from: ItsOnFire.jar:q/c1.class */
public final class c1 {
    @JvmField
    @NotNull

    /* renamed from: a  reason: collision with root package name */
    public final CoroutineContext f2038a;
    @NotNull
    ...
    public final s3<Object>[] f2040c;

    /* renamed from: d  reason: collision with root package name */
    public int f2041d;

    public c1(@NotNull CoroutineContext coroutineContext, int i2) {
        this.f2038a = coroutineContext;
        this.f2039b = new Object[i2];
        this.f2040c = new s3[i2];
    }

    public final void a(@NotNull s3<?> s3Var, @Nullable Object obj) {
        Object[] objArr = this.f2039b;
        int i2 = this.f2041d;
        objArr[i2] = obj;
        s3<Object>[] s3VarArr = this.f2040c;
        this.f2041d = i2 + 1;
        s3VarArr[i2] = s3Var;
    }

    public final void b(@NotNull CoroutineContext coroutineContext) {
        int length = this.f2040c.length - 1;
        if (length < 0) {
            return;
        }
        while (true) {
            int i2 = length - 1;
            s3<Object> s3Var = this.f2040c[length];
            Intrinsics.checkNotNull(s3Var);
            s3Var.K(coroutineContext, this.f2039b[length]);
            if (i2 < 0) {
                return;
            }
            length = i2;
