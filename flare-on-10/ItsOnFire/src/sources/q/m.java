...
/* loaded from: ItsOnFire.jar:q/m.class */
public final class m {
    @NotNull

    /* renamed from: a */
    public static final r0 f2071a = new r0("UNDEFINED");
    @JvmField
    @NotNull

    /* renamed from: b */
    public static final r0 f2072b = new r0("REUSABLE_CLAIMED");
    ...
    public static final <T> void f(@NotNull Continuation<? super T> continuation, @NotNull Object obj, @Nullable Function1<? super Throwable, Unit> function1) {
        ...
        if (lVar.f2066m.isDispatchNeeded(lVar.getContext())) {
            lVar.f2068o = c2;
            lVar.f493l = 1;
            lVar.f2066m.dispatch(lVar.getContext(), lVar);
            return;
        }
        t1 b2 = u3.f572a.b();
        if (b2.B()) {
        ...
        b2.y(true);
        try {
            n2 n2Var = (n2) lVar.getContext().get(n2.f531b);
            if (n2Var == null || n2Var.b()) {
                ...
                lVar.resumeWith(Result.m5849constructorimpl(ResultKt.createFailure(u2)));
                z = true;
            }
            if (!z) {
                Continuation<T> continuation2 = lVar.f2067n;
                Object obj2 = lVar.f2069p;
                CoroutineContext context = continuation2.getContext();
                Object c3 = w0.c(context, obj2);
                c4<?> g2 = c3 != w0.f2100a ? j.n0.g(continuation2, context, c3) : null;
                lVar.f2067n.resumeWith(obj);
