...
/* loaded from: ItsOnFire.jar:q/q0.class */
public final class q0 {
    @NotNull

    /* renamed from: a  reason: collision with root package name */
    public static final String f2089a = "kotlin.coroutines.jvm.internal.BaseContinuationImpl";
    @NotNull

    /* renamed from: b  reason: collision with root package name */
    public static final String f2090b = "kotlinx.coroutines.internal.StackTraceRecoveryKt";

    /* renamed from: c  reason: collision with root package name */
    public static final String f2091c;

    /* renamed from: d  reason: collision with root package name */
    public static final String f2092d;

    static {
        Object m5849constructorimpl;
        Object m5849constructorimpl2;
        try {
            Result.Companion companion = Result.Companion;
            m5849constructorimpl = Result.m5849constructorimpl(Class.forName(f2089a).getCanonicalName());
        } catch (Throwable th) {
        ...
        if (Result.m5852exceptionOrNullimpl(m5849constructorimpl) != null) {
            m5849constructorimpl = f2089a;
        }
        f2091c = (String) m5849constructorimpl;
        try {
            Result.Companion companion3 = Result.Companion;
            m5849constructorimpl2 = Result.m5849constructorimpl(q0.class.getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.Companion;
            m5849constructorimpl2 = Result.m5849constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m5852exceptionOrNullimpl(m5849constructorimpl2) != null) {
            m5849constructorimpl2 = f2090b;
        }
        f2092d = (String) m5849constructorimpl2;
    }
    ...
    public static final <E extends Throwable> Pair<E, StackTraceElement[]> e(E e2) {
        ...
        if (cause == null || !Intrinsics.areEqual(cause.getClass(), e2.getClass())) {
            pair = TuplesKt.to(e2, new StackTraceElement[0]);
        } else {
            ...
            pair = z ? TuplesKt.to(cause, stackTrace) : TuplesKt.to(e2, new StackTraceElement[0]);
        }
        return pair;
    }
    ...
    public static final <E extends Throwable> E f(E e2, E e3, ArrayDeque<StackTraceElement> arrayDeque) {
        ...
        int i4 = 0;
        while (it.hasNext()) {
            stackTraceElementArr[i4 + i2] = it.next();
            i4++;
        }
    ...
    public static final int i(StackTraceElement[] stackTraceElementArr, String str) {
        ...
        while (true) {
            if (i2 >= length) {
                i2 = -1;
                break;
            } else if (Intrinsics.areEqual(str, stackTraceElementArr[i2].getClassName())) {
                break;
            } else {
                i2++;
            }
    ...
    public static final <E extends Throwable> E r(E e2) {
        StackTraceElement[] stackTrace = e2.getStackTrace();
        int length = stackTrace.length;
        int i2 = i(stackTrace, f2092d);
        int i3 = i(stackTrace, f2091c);
        int i4 = (length - i2) - (i3 == -1 ? 0 : length - i3);
        StackTraceElement[] stackTraceElementArr = new StackTraceElement[i4];
        int i5 = 0;
        while (i5 < i4) {
            stackTraceElementArr[i5] = i5 == 0 ? d("Coroutine boundary") : stackTrace[((i2 + 1) + i5) - 1];
            i5++;
        }
