...
/* loaded from: ItsOnFire.jar:q/x0.class */
public final class x0<T> implements s3<T> {

    /* renamed from: j  reason: collision with root package name */
    public final T f2112j;
    @NotNull

    /* renamed from: k  reason: collision with root package name */
    public final ThreadLocal<T> f2113k;
    @NotNull

    /* renamed from: l  reason: collision with root package name */
    public final CoroutineContext.Key<?> f2114l;

    public x0(T t2, @NotNull ThreadLocal<T> threadLocal) {
        this.f2112j = t2;
        this.f2113k = threadLocal;
        this.f2114l = new y0(threadLocal);
    }
    ...
    public T Y(@NotNull CoroutineContext coroutineContext) {
        T t2 = this.f2113k.get();
        this.f2113k.set(this.f2112j);
        return t2;
    }
    ...
    public <E extends CoroutineContext.Element> E get(@NotNull CoroutineContext.Key<E> key) {
        return Intrinsics.areEqual(getKey(), key) ? this : null;
    }
    ...
    public String toString() {
        return "ThreadLocal(value=" + this.f2112j + ", threadLocal = " + this.f2113k + ')';
    }
}
