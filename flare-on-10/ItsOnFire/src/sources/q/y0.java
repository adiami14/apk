...
public final class y0 implements CoroutineContext.Key<x0<?>> {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return (obj instanceof y0) && Intrinsics.areEqual(this.f2130j, ((y0) obj).f2130j);
    }

    public int hashCode() {
        return this.f2130j.hashCode();
    }

    @NotNull
    public String toString() {
        return "ThreadLocalKey(threadLocal=" + this.f2130j + ')';
    }
}
