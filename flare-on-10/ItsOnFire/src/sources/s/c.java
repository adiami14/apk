...
/* loaded from: ItsOnFire.jar:s/c.class */
public final class c extends z1 implements Executor {
    @NotNull

    /* renamed from: k  reason: collision with root package name */
    public static final c f2160k = new c();
    @NotNull

    /* renamed from: l  reason: collision with root package name */
    public static final o0 f2161l;
    ...
    static {
        ...
        d2 = v0.d(n1.f530a, coerceAtLeast, 0, 0, 12, null);
        f2161l = pVar.limitedParallelism(d2);
    }
    ...
    public void dispatch(@NotNull CoroutineContext coroutineContext, @NotNull Runnable runnable) {
        f2161l.dispatch(coroutineContext, runnable);
    }

    @Override // j.o0
    @i2
    public void dispatchYield(@NotNull CoroutineContext coroutineContext, @NotNull Runnable runnable) {
        f2161l.dispatchYield(coroutineContext, runnable);
    }
    ...
    public o0 limitedParallelism(int i2) {
        return p.f2194j.limitedParallelism(i2);
    }
