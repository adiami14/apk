...
@PublishedApi
/* loaded from: ItsOnFire.jar:s/e.class */
public class e extends z1 {
    ...
    public void dispatch(@NotNull CoroutineContext coroutineContext, @NotNull Runnable runnable) {
        try {
            a.k(this.f2167o, runnable, null, false, 6, null);
        } catch (RejectedExecutionException e2) {
            a1.f430o.dispatch(coroutineContext, runnable);
        }
    }
    ...
    public void dispatchYield(@NotNull CoroutineContext coroutineContext, @NotNull Runnable runnable) {
        try {
            a.k(this.f2167o, runnable, null, true, 2, null);
        } catch (RejectedExecutionException e2) {
            a1.f430o.dispatchYield(coroutineContext, runnable);
        }
    }
    ...
    public String toString() {
        return super.toString() + "[scheduler = " + this.f2167o + ']';
    }

    public final a v() {
        return new a(this.f2163k, this.f2164l, this.f2165m, this.f2166n);
    }

    public final void w(@NotNull Runnable runnable, @NotNull l lVar, boolean z) {
        try {
            this.f2167o.j(runnable, lVar, z);
        } catch (RejectedExecutionException e2) {
            a1.f430o.T(this.f2167o.e(runnable, lVar));
        }
    }
    ...
    public final o0 y(int i2) {
        ...
        throw new IllegalArgumentException(("Expected parallelism level lesser than core pool size (" + this.f2163k + "), but have " + i2).toString());
    }
}
