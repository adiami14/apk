...
/* loaded from: ItsOnFire.jar:s/g.class */
public final class g extends z1 implements l, Executor {

    /* renamed from: p  reason: collision with root package name */
    public static final /* synthetic */ AtomicIntegerFieldUpdater f2168p = AtomicIntegerFieldUpdater.newUpdater(g.class, "inFlightTasks");
    @NotNull

    /* renamed from: k  reason: collision with root package name */
    public final e f2169k;
    ...
    public final ConcurrentLinkedQueue<Runnable> f2173o = new ConcurrentLinkedQueue<>();
    @NotNull
    ...
    @Override // s.l
    public void c() {
        Runnable poll = this.f2173o.poll();
        if (poll != null) {
            this.f2169k.w(poll, this, true);
            return;
        }
        f2168p.decrementAndGet(this);
        Runnable poll2 = this.f2173o.poll();
        if (poll2 == null) {
            return;
        }
        s(poll2, true);
    ...
    public final void s(Runnable runnable, boolean z) {
        Runnable poll;
        do {
            AtomicIntegerFieldUpdater atomicIntegerFieldUpdater = f2168p;
            if (atomicIntegerFieldUpdater.incrementAndGet(this) <= this.f2170l) {
                this.f2169k.w(runnable, this, z);
                return;
            }
            this.f2173o.add(runnable);
            if (atomicIntegerFieldUpdater.decrementAndGet(this) >= this.f2170l) {
                return;
            }
            poll = this.f2173o.poll();
            runnable = poll;
        } while (poll != null);
    }
    ...
    public String toString() {
        String str = this.f2171m;
        String str2 = str;
        if (str == null) {
            str2 = super.toString() + "[dispatcher = " + this.f2169k + ']';
        }
        return str2;
    }
}
