...
/* loaded from: ItsOnFire.jar:s/n.class */
public final class n extends k {
    @JvmField
    @NotNull

    /* renamed from: l  reason: collision with root package name */
    public final Runnable f2183l;

    public n(@NotNull Runnable runnable, long j2, @NotNull l lVar) {
        super(j2, lVar);
        this.f2183l = runnable;
    }
    ...
    public String toString() {
        return "Task[" + z0.a(this.f2183l) + '@' + z0.b(this.f2183l) + ", " + this.f2180j + ", " + this.f2181k + ']';
    }
}
