...
/* loaded from: ItsOnFire.jar:u/i.class */
public final class i extends o0<i> {
    @NotNull

    /* renamed from: e  reason: collision with root package name */
    public /* synthetic */ AtomicReferenceArray f2292e;

    public i(long j2, @Nullable i iVar, int i2) {
        super(j2, iVar, i2);
        int i3;
        i3 = h.f2287f;
        this.f2292e = new AtomicReferenceArray(i3);
    }
