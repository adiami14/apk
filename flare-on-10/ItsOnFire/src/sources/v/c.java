...
/* loaded from: ItsOnFire.jar:v/c.class */
public final class c {

    @Metadata(d1 = {"��\u0010\n��\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010\u0003\n��\u0010��\u001a\u00020\u0001\"\u0004\b��\u0010\u00022\b\u0010\u0003\u001a\u0004\u0018\u00010\u0004H\n¢\u0006\u0002\b\u0005"}, d2 = {"<anonymous>", "", "T", "it", "", "invoke"}, k = 3, mv = {1, 6, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
    /* loaded from: ItsOnFire.jar:v/c$a.class */
    public static final class a extends Lambda implements Function1<Throwable, Unit> {

        /* renamed from: j  reason: collision with root package name */
        public final /* synthetic */ CancellationTokenSource f2295j;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public a(CancellationTokenSource cancellationTokenSource) {
            super(1);
            this.f2295j = cancellationTokenSource;
        }
    ...
    /* loaded from: ItsOnFire.jar:v/c$b.class */
    public static final class b<T> implements c1<T> {

        /* renamed from: j  reason: collision with root package name */
        public final /* synthetic */ z<T> f2296j;
        ...
        public p1 H(@NotNull Function1<? super Throwable, Unit> function1) {
            return this.f2296j.H(function1);
        }
        ...
        public n2 M(@NotNull n2 n2Var) {
            return this.f2296j.M(n2Var);
        }

        @Override // j.n2
        @NotNull
        public t.c N() {
            return this.f2296j.N();
        }
        ...
        public w X(@NotNull y yVar) {
            return this.f2296j.X(yVar);
        }

        @Override // j.n2
        @Deprecated(level = DeprecationLevel.HIDDEN, message = "Since 1.2.0, binary compatibility with versions <= 1.1.x")
        public /* synthetic */ boolean a(Throwable th) {
            return this.f2296j.a(th);
        }
        ...
        public void cancel(@Nullable CancellationException cancellationException) {
            this.f2296j.cancel(cancellationException);
        }

        @Override // j.n2
        public boolean e() {
            return this.f2296j.e();
        }

        @Override // kotlin.coroutines.CoroutineContext.Element, kotlin.coroutines.CoroutineContext
        public <R> R fold(R r2, @NotNull Function2<? super R, ? super CoroutineContext.Element, ? extends R> function2) {
            return (R) this.f2296j.fold(r2, function2);
        }

        @Override // j.c1
        @c2
        public T g() {
            return this.f2296j.g();
        }

        @Override // kotlin.coroutines.CoroutineContext.Element, kotlin.coroutines.CoroutineContext
        @Nullable
        public <E extends CoroutineContext.Element> E get(@NotNull CoroutineContext.Key<E> key) {
            return (E) this.f2296j.get(key);
        }

        @Override // kotlin.coroutines.CoroutineContext.Element
        @NotNull
        public CoroutineContext.Key<?> getKey() {
            return this.f2296j.getKey();
        }

        @Override // j.n2
        public boolean isCancelled() {
            return this.f2296j.isCancelled();
        }

        @Override // j.c1
        @NotNull
        public t.d<T> j() {
            return this.f2296j.j();
        }

        @Override // j.n2
        @NotNull
        public Sequence<n2> k() {
            return this.f2296j.k();
        }
        ...
        @Nullable
        public Throwable l() {
            return this.f2296j.l();
        }

        @Override // kotlin.coroutines.CoroutineContext.Element, kotlin.coroutines.CoroutineContext
        @NotNull
        public CoroutineContext minusKey(@NotNull CoroutineContext.Key<?> key) {
            return this.f2296j.minusKey(key);
        }

        @Override // j.n2
        @Nullable
        public Object n(@NotNull Continuation<? super Unit> continuation) {
            return this.f2296j.n(continuation);
        }

        @Override // kotlin.coroutines.CoroutineContext
        @NotNull
        public CoroutineContext plus(@NotNull CoroutineContext coroutineContext) {
            return this.f2296j.plus(coroutineContext);
        }
        ...
        public p1 r(boolean z, boolean z2, @NotNull Function1<? super Throwable, Unit> function1) {
            return this.f2296j.r(z, z2, function1);
        }

        @Override // j.n2
        public boolean start() {
            return this.f2296j.start();
        }
        ...
        public CancellationException u() {
            return this.f2296j.u();
        }

        @Override // j.c1
        @Nullable
        public Object x(@NotNull Continuation<? super T> continuation) {
            return this.f2296j.x(continuation);
        }
    }

    @Metadata(d1 = {"��\u0010\n��\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010\u0003\n��\u0010��\u001a\u00020\u0001\"\u0004\b��\u0010\u00022\b\u0010\u0003\u001a\u0004\u0018\u00010\u0004H\n¢\u0006\u0002\b\u0005"}, d2 = {"<anonymous>", "", "T", "it", "", "invoke"}, k = 3, mv = {1, 6, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
    /* renamed from: v.c$c  reason: collision with other inner class name */
    /* loaded from: ItsOnFire.jar:v/c$c.class */
    public static final class C0101c extends Lambda implements Function1<Throwable, Unit> {

        /* renamed from: j  reason: collision with root package name */
        public final /* synthetic */ CancellationTokenSource f2297j;

        /* renamed from: k  reason: collision with root package name */
        public final /* synthetic */ c1<T> f2298k;

        /* renamed from: l  reason: collision with root package name */
        public final /* synthetic */ TaskCompletionSource<T> f2299l;
        ...
        public C0101c(CancellationTokenSource cancellationTokenSource, c1<? extends T> c1Var, TaskCompletionSource<T> taskCompletionSource) {
            super(1);
            this.f2297j = cancellationTokenSource;
            this.f2298k = c1Var;
            this.f2299l = taskCompletionSource;
        }
        ...
        public final void invoke2(@Nullable Throwable th) {
            ...
            Throwable l2 = this.f2298k.l();
            if (l2 == null) {
                this.f2299l.setResult(this.f2298k.g());
                return;
            }
            TaskCompletionSource<T> taskCompletionSource = this.f2299l;
            RuntimeExecutionException runtimeExecutionException = l2 instanceof Exception ? (Exception) l2 : null;
            RuntimeExecutionException runtimeExecutionException2 = runtimeExecutionException;
            if (runtimeExecutionException == null) {
                runtimeExecutionException2 = new RuntimeExecutionException(l2);
            }
            taskCompletionSource.setException(runtimeExecutionException2);
        }
    }
    ...
    /* loaded from: ItsOnFire.jar:v/c$d.class */
    public static final class d<TResult> implements OnCompleteListener {

        /* renamed from: a  reason: collision with root package name */
        public final /* synthetic */ q<T> f2300a;
    ...
    @Metadata(d1 = {"��\u0010\n��\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010\u0003\n��\u0010��\u001a\u00020\u0001\"\u0004\b��\u0010\u00022\b\u0010\u0003\u001a\u0004\u0018\u00010\u0004H\n¢\u0006\u0002\b\u0005"}, d2 = {"<anonymous>", "", "T", "it", "", "invoke"}, k = 3, mv = {1, 6, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
    /* loaded from: ItsOnFire.jar:v/c$e.class */
    public static final class e extends Lambda implements Function1<Throwable, Unit> {

        /* renamed from: j  reason: collision with root package name */
        public final /* synthetic */ CancellationTokenSource f2301j;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public e(CancellationTokenSource cancellationTokenSource) {
            super(1);
            this.f2301j = cancellationTokenSource;
        }
    ...
    public static final <T> c1<T> e(Task<T> task, CancellationTokenSource cancellationTokenSource) {
        ...
        if (task.isComplete()) {
            ...
            task.addOnCompleteListener(v.a.f2293j, new OnCompleteListener() { // from class: v.b
                @Override // com.google.android.gms.tasks.OnCompleteListener
    ...
    public static final <T> Object j(Task<T> task, CancellationTokenSource cancellationTokenSource, Continuation<? super T> continuation) {
        ...
        rVar.E();
        task.addOnCompleteListener(v.a.f2293j, new d(rVar));
        if (cancellationTokenSource != null) {
